...
public class CommonConst
{
  ...
  //  public static string EMP_MORTGAGE_MANAGER_NAME = "曹颖思";
    ...
    /// 黄筑筠（22563）、谢芃（3030）、李蕴茹（27206）、黄瑛（10054）、黄洁珍（0025）、陈洁丽（2377）、李毅华（5042）、
    /// 陈宋林（2649）、陈秋炳（4485）、朱伟洲（0002）、潘婉霞（0091）、张焯贤（25622）、叶国安（0043）、 杜燕玲（0385）、
    /// 罗思源（0006）、易伟锋（2722）、钟惠泉（22181）、关婉莹（1649）、梁慧文（0077）、曹颖思（13161）|顾慧|彭明慧
    /// </summary>
    public static string EMP_IMMEDIATEBOSS_NAME = "黄筑筠|谢芃|罗蔼蕴|李蕴茹|黄瑛|黄洁珍|陈洁丽|李毅华|陈宋林|陈秋炳|朱伟洲|潘婉霞|张焯贤|叶国安|杜燕玲|罗思源|易伟锋|钟惠泉|关婉莹|梁慧文|曹颖思|顾慧|彭明慧";

    /// <summary>
    /// 总办2张表(减佣让佣，物业部承接一手项目报备)完成后需抄送给的人：黄筑筠,谢芃,罗蔼蕴,李红梅,张绍欣,黄瑛,张绍欣
    /// </summary>
    public static string EMP_GMO_COPYTO_NAME = "黄筑筠,谢芃,罗蔼蕴,李红梅,张绍欣,黄瑛,顾慧,彭明慧,张绍欣";

    /// <summary>
    /// 总办合作费(以及项目费用 20140528李红梅提出)完成后需抄送给的人：黄筑筠,谢芃,罗蔼蕴,陈志辉B,张绍欣,黄瑛,张绍欣
    /// </summary>
    public static string EMP_COOPCOST_COPYTO_NAME = "黄筑筠,谢芃,罗蔼蕴,陈志辉B,张绍欣,黄瑛,顾慧,彭明慧,张绍欣";
    ...
    public static Dictionary<int, string> PurviewDict()
    {
        ...
        dict.Add(18, "OA_Search_022");  //恢复营业申请表
        ...
        dict.Add(45, "OA_Search_051");  //三级市场季会活动费用的申请
        ...
        //dict.Add(0, "OA_Search_073");  //临时借用资金申请表(没有字典)
