...
public partial class Apply_NewPersInterests_Apply_NewPersInterests_Detail : BasePage
{
    ...
    public void DrawDetailTable(int n)
    {
        ...
        for (int i = 1; i <= n; i++)
        {
            ...
            SbHtml.Append("<td class=\"tl PL10\" style=\"line-height: 30px\" >亲属姓名：<input type=\"text\" id=\"txtDetail_RelativesName" + i + "\" style=\"width:150px;\"/>");
            SbHtml.Append("　所在部门：<input type=\"text\" id=\"txtDetail_InDepartment" + i + "\" style=\"width:200px;\"/><br />");
            SbHtml.Append("担任职位：<input type=\"text\" id=\"txtDetail_Position" + i + "\" style=\"width:200px;\"/> <br/>");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                RunJS("window.showModalDialog(\"../Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_PersInterests_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=340px\");if(win=='success'){window.location='../Apply.aspx'; }");
                #endregion
            }
            else
            {
    ...
    private T_OfficeAutomation_Document_NewPersInterests GetModelFromPage(Guid UndertakeProjID)
    {
        ...
        t_OfficeAutomation_Document_NewPersInterests.OfficeAutomation_Document_NewPersInterests_Apply = EmployeeName;
        ...
        t_OfficeAutomation_Document_NewPersInterests.OfficeAutomation_Document_NewPersInterests_Building = txtBuilding.Text;
