<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_OpenProve_Flow.aspx.cs" Inherits="Apply_OpenProve_Apply_OpenProve_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
...
<head id="Head1" runat="server"> 
    ...
    <script type="text/javascript">
        ...
        $(function() {
            if(isi == "1"){
                if($("#divTxtIDx1").css("display")=="none")
                    showOrHideIDx(1);
                if($("#divTxtIDx2").css("display")=="none")
                    showOrHideIDx(2);
                $("#lb1").show();
                $("#lb2").show();
                $("#a1").hide();
        ...
        function save() {
            ...
            ///循环获取默认流程52100-2016/10/14
            //content+='<%=getFixedAuditor() %>';
            ///end
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <label id="lb1" class='item' for='btnIDx1' style="display:none;">部门主管</label>
            <div id="divIDx1" class='item'><input id="btnIDx2" class="forward" type="image" src="../../Images/add.png" onclick="return showOrHideIDx(1);" />
                <label id="lblIDx1" for='btnIDx2'>部门主管</label>
            </div>
            <div id="divTxtIDx1" class='item' style="display:none;">
                <input type="text" id="txtIDx1" style="width:200px;" /><input id="hdIDx1" type="hidden" />
                <a id="a1" href="javascript:;" onclick="showOrHideIDx(1)">取消</a>
            </div>
            <img src="../../Images/forward.png" class="forward"/>


            <label id="lb2" class='item' for='btnIDx1' style="display:none;">隶属主管</label>
            <div id="divIDx2" class='item'><input id="btnIDx0" class="forward" type="image" src="../../Images/add.png" onclick="return showOrHideIDx(2);" />
                <label id="lblIDx2" for='btnIDx0'>隶属主管</label>
            </div>
            <div id="divTxtIDx2" class='item' style="display:none;">
                    <input type="text" id="txtIDx2" style="width:100px;" /><input id="hdIDx2" type="hidden" />
                    <a id="a2" href="javascript:;" onclick="showOrHideIDx(2)">取消</a>
            </div>
            <img src="../../Images/forward.png" class="forward"/>
            <div id="divIDx3" class='item'>部门负责人</div>
            <div id="divTxtIDx3" class='item'>
                <input type="text" id="txtIDx3" style="width:100px;" /><input id="hdIDx3" type="hidden" />
            </div>
