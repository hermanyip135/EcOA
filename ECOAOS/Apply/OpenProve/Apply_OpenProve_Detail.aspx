    ...
    <script type="text/javascript">
        ...
        function check() {
            ...
            for(var n = 1;n <= $("#tbDetail").find("tr[id*=trDetail]").size();n ++){
                ...
                if (!$("#rdoReasondb" + n + "1").prop('checked') && !$("#rdoReasondb" + n + "0").prop('checked')) {
                    alert("请选择第" + n + "行的开具原因。");
                ...
                if (!$("#rdoKind" + n + "1").prop('checked') && !$("#rdoKind" + n + "2").prop('checked') && !$("#rdoKind" + n + "3").prop('checked')){
                ...
                if (flag) 
                    data += $.trim($("#ddlProve" + n).find("option:selected").text())+"&&"+$.trim($("#txtDetail_No" + n).val())+"&&"+$.trim(($("#rdoReasondb" + n + "1").prop('checked')?"1":"0"))+"&&"+$.trim($("#txtDetail_Address" + n).val())+"&&"+$.trim($("#txtDetail_Sdate" + n).val())+"&&"+$.trim($("#txtDetail_Edate" + n).val())+"&&"+$.trim($("#txtDetail_AnotherR" + n).val())+"&&"+$.trim(($("#rdoKind" + n + "1").prop('checked')?"1":$("#rdoKind" + n + "2").prop('checked')?"2":$("#rdoKind" + n + "3").prop('checked')?"3":"0"))+"&&"+$.trim($("#txtDetail_AnotherKind" + n).val())+"||";
                //}
            }
            if (flag) {
		...
		function upload() {
		    var sReturnValue = window.showModalDialog("../Apply_Uploads.aspx?MainID=<%=MainID %>&AUpload=" + escape("<%=ApplyN %>") + "&href=" + window.location.href, '<%=MainID %>', "dialogHeight=165px").toString();
		...
		<div style='text-align: center'>
			...
			<%--		<td class="auto-style4">* 现职级</td>
                ...
                <tr>
                    ...
                    <td>
                          <input type="radio" id="Radio1" name="r5" value="2" /><label for="Radio12">到公司总部10楼进行签收</label>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td colspan="3">
                        <textarea runat="server" id="ExceptionalCase">
                ...
                <tr id="UploatPath">
                    ...
                    <td colspan="3" style="text-align: left; padding-left: 10px">
                        ...
                        证明申请版本的链接。
                        <br /><br />
                        2、如申请开具的证明有其他规定版本，请上传版本作为附件。如无法上传，请将附件发送至如下邮箱：zhuxq.gz@centaline.com.cn或致电83926681。
...
<%--				<tr id="trManager3" class="noborder" style="height: 85px;">
				...
				<tr class="noborder" style="height: 85px;">
					...
					<td colspan="3" class="tl PL10" style=" ">
                        ...
                        <label for="rdbYesIDx5" style="color:#008162">可签收</label>
                        <input id="rdbNoIDx5" type="radio" name="agree5" />
                        <label for="rdbNoIDx5">退回申请</label>
                        <input id="rdbOtherIDx5" type="radio" name="agree5" style="display:none" /><label for="rdbOtherIDx5" style="display:none">其他意见</label><br />
