<%@ Page Title="公积金缴存比例年度调整申请表 - 广州中原电子审批系统" Language="C#" AutoEventWireup="true" CodeFile="Apply_HousingFundAdjustment_Detail.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="Apply_HousingFundAdjustment_Apply_HousingFundAdjustment_Detail" %>
    ...
    <script type="text/javascript">
        ...
        function check() {
            ...
            $("#rowtd .tbflows").each(function () {
                ...
                temp = $(this).find("select[name='PayRate']");
                    if (temp.val() == "") {
                        alert("请选择比例");
                        temp.focus();
                        flag = false;
            ...
            <table class="tbflows" style="width: 640px; margin: 0 auto" cellpadding="0" cellspacing="0">
                <tr>
                    <td id="rowtd" colspan="4" style="padding-top: 0"> 
                        <table class="tbflows" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td class="auto-style4" rowspan="2">申请调整比例</td>
                                <td class="tl PL10" colspan="3" style="line-height: 220%">
                                    ...
                                    <div>
                                        本人已知悉，新年度的公积金个人缴存比例将按本次的申请进行调整。
                                    </div>
                                </td>
                            </tr>
                ...
                <tr>
                    <td colspan="4" style="text-align: left; text-indent: 15px">
                        ...
                        <p>2、缴存公积金的员工可根据实际情况申请调整个人缴存比例，单位缴存比例固定为8%；</p>
                        <p>3、若个人缴存比例选择不变，无需提交该申请表，公司将参考上年度的比例缴存；</p>
                        <p>4、如果非本人填写此份申请，保存后请上传员工手写板申请作为附件。</p>
                    </td>
                </tr>
                <tr>
