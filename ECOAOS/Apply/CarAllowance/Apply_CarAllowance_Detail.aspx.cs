    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (MainID == "")
            {
                ...
                if (IsImmediste)
                    RunJS("window.showModalDialog(\"../Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");alert('" + CommonConst.MSG_APPLY_SUCCESSCOMMIT + "');window.location='../Apply.aspx'; ");
                else
                    RunJS("window.showModalDialog(\"../Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_CarAllowance_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=250px\");if(win=='success'){window.location='../Apply.aspx'; }");
                #endregion
            }
            else
            {
