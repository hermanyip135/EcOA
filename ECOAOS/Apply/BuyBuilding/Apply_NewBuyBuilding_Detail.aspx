<%@ Page Language="C#" ValidateRequest="false" Title="员工购/租楼宇申报及免佣福利申请表 - 广州中原电子审批系统" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Apply_NewBuyBuilding_Detail.aspx.cs" Inherits="Apply_BuyBuilding_Apply_NewBuyBuilding_Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function() {      
            ...
            $("#<%=txtRebateDate.ClientID%>").datepicker();
         ...
         --%>
            ...
            if($("#<%=cbkFreeType1.ClientID %>").prop("checked") || $("#<%=cbkFreeType2.ClientID %>").prop("checked")) {
                ...
                if($("#<%=cbkFreeType2.ClientID %>").prop("checked")) {
                    if(!$("#<%=rdbMortgageAddress1.ClientID %>").prop("checked")&&!$("#<%=rdbMortgageAddress2.ClientID %>").prop("checked")&&!$("#<%=rdbMortgageAddress3.ClientID %>").prop("checked")) {
                        alert("请选择按揭办理地点。");
        ...
        function getEmployee2(n) {
            $.ajax({
                ...
                success: function(info) {
                    if (info != "fail") {
                        var infos = info.split("|");
                        $("#<%=txtFollowSales.ClientID%>").val(infos[1]);
                        $("#<%=txtFollowBranch.ClientID%>").val(infos[2]);
                    }
                    else{
                        $("#<%=txtFollowSales.ClientID%>").val("");
                        $("#<%=txtFollowBranch.ClientID%>").val("");
                    }
                }
            })
        }
    ...
    <div style='text-align: center; width: 840px; margin: 0px auto;'>
        ...
        <div style='text-align: center'>
            ...
            <table id="tbAround" width='640px'>
                <tr>
                    <td style="font-weight: bold; font-size: large;" colspan="4">申请人基本信息</td>
                </tr>
                <tr>
                     <td class="tl PL10">﹡部门性质</td>
                    <td class="tl PL10">
                        <asp:DropDownList ID="ddlDepartmentType" runat="server" Width="150px"></asp:DropDownList></td>
                ...
                <tr>
                    ...
                    <td class="tl PL10" style="width:122px;">﹡通过试用期日期</td>
                    <td class="tl PL10">
                ...
                <tr>
                    <td style="font-weight: bold; font-size: large;" colspan="4">购/租楼宇免佣申请内容</td>
                </tr>
                <tr>
                    <td style="font-size:inherit; text-align:left;" colspan="4">关于员工购/租楼宇免佣福利申请流程及相关规定详情请参阅《员工购/租自住楼宇免佣福利的管理制度》,免佣福利申请经批核后半年内有效。</td>
                </tr>
                 <tr>
                    <td class="tl PL10">﹡申请项目</td>
                    <td class="tl PL10" colspan="3">
                        <asp:CheckBox ID="cbkFreeType1" group="FreeType" runat="server" Text="免付公司佣金" /><asp:CheckBox ID="cbkFreeType2" group="FreeType" runat="server" Text="享受按揭优惠手续费" /></td>
                </tr>
                <tr>
                    <td class="tl PL10">﹡所购租楼宇<br />成交跟进分行</td>
                    <td class="tl PL10" colspan="3">跟进人工号：<asp:TextBox ID="txtFollowNo" runat="server" Width="60px" onblur="getEmployee2(this);"></asp:TextBox>
                        <span id="spEntrust">姓名：<input id="txtFollowSales" type="text" runat="server" readonly="readonly" style="background-color: Silver;" /></span>
                        分行：<input id="txtFollowBranch" type="text" runat="server" readonly="readonly" style="background-color: Silver;" />
                    </td>
                </tr>
                <tr>
                    <td class="tl PL10">按揭办理地点</td>
                    <td class="tl PL10" colspan="3">
                        <asp:RadioButton ID="rdbMortgageAddress1" runat="server" GroupName="MortgageAddress" Text="汇瀚" value="1" />
                        <asp:RadioButton ID="rdbMortgageAddress3" runat="server" GroupName="MortgageAddress" Text="房友圈按揭金融服务中心" value="3" />
                        <asp:RadioButton ID="rdbMortgageAddress2" runat="server" GroupName="MortgageAddress" Text="其他" value="2" /><asp:TextBox ID="txtMortgageAddress" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="tl PL10">﹡交易类型</td>
                    <td class="tl PL10">
                        <asp:RadioButton ID="rdbIntention1" runat="server" GroupName="rdbDealBuild" Text="购买" />
                        <asp:RadioButton ID="rdbIntention2" runat="server" GroupName="rdbDealBuild" Text="租赁" />
                    </td>
                    <td class="tl PL10">﹡交易物业</td>
                    <td class="tl PL10">
                        <asp:RadioButton ID="rdbDealBuild1" runat="server" GroupName="intention" Text="一手代理项目" />
                        <asp:RadioButton ID="rdbDealBuild2" runat="server" GroupName="intention" Text="二手物业" />
                    </td>
                </tr>
                <tr>
                    <td class="tl PL10">﹡购买后的业权人</td>
                    <td class="tl PL10">
                        <asp:DropDownList ID="ddlOwnerType" runat="server"></asp:DropDownList><asp:HiddenField ID="hdOwnerType" runat="server" />
                    </td>
                    <td class="tl PL10">﹡业权人姓名</td>
                    <td class="tl PL10">
                        <asp:TextBox ID="txtOwnerRelation" runat="server" Width="100px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="tl PL10">﹡业权联名<br />
                        &nbsp;&nbsp;人是否同<br />
                        为公司员工</td>
                    <td class="tl PL10">
                ...
                <tr>
                    ...
                    <td class="tl PL10" colspan="3">
                        <div id="divPersInterests">粘贴个人利益申报表地址<asp:TextBox ID="txtPersInterestsURL" runat="server" Style="width: 300px;" onblur="savePersInterestsURL();"></asp:TextBox></div>
                        <a id="aPersInterests" target="_blank" style="display: none;" onclick="if(this.href=='') alert('请先粘贴个人利益申报表地址。');">个人利益申报表</a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="tl PL10" colspan="4">
                        <div style="margin: 0px auto;" class="tl">
                            ...
                            <span>2、   申请购房免佣的人员若为1～3级营业员的，相关交易不能由本人成交，否则不予退款；</span><br />
                            <span>3、   申请购房免佣的人员若为4级及以上管理人员，原则上相关交易不能由申请人管辖之营业组别的同事成交，否则不予退款</span><br />
                            <span>4、	申请人在免佣福利操作全部完成前离职，有关款项不再退还</span><br />
                            <span>5、   若联名购房双方均为公司员工，但申请本福利时未如实填写业权人信息，有关款项不再退还。</span><br />
                            <span>6、   成功申请并享受免佣福利的员工，若在购房后一年内成功出售该物业，则须退还免付的公司佣金和按揭手续费给公司。</span><br />
            ...
            <table id="tbAround2" width='640px'>
                ...
                <tr id="trLogistics" class="noborder" style="height: 30px; display: none;">
                    <td>后勤事务部意见<br />
                        <asp:Button ID="btnWillEnd2" runat="server" Text="结束" OnClick="btnWillEnd_Click" Visible="False" /></td>
                    <td class="tl PL10" style="">
            ...
            <table id="tbAround3" width='640px'>
                 <tr>
                    <td colspan="4" style="font-weight: bold; font-size: large;">
                        购/租房免佣福利享受情况登记表（由财务部登记）
                    </td>
                </tr>
                <tr>
                    <td class="tl PL10">成交编号</td>
                    <td class="tl PL10">
                        <input id="txtTransNo" type="text" runat="server" /></td>
                    <td class="tl PL10">成交地址</td>
                    <td class="tl PL10">
                        <input id="txtTransAddress" type="text" runat="server" /></td>
                </tr>
                <tr>
                    <td class="tl PL10">成交日期</td>
                    <td class="tl PL10">
                        <input id="txtTransDate" type="text" runat="server"/></td>
                    <td class="tl PL10">房产证登记人</td>
                    <td class="tl PL10">
                        <asp:TextBox ID="txtHouseRegistrant" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="tl PL10">是否已退佣</td>
                    <td class="tl PL10">
                        <asp:DropDownList ID="drpIsRebate" runat="server">
                            <asp:ListItem Value="1">是</asp:ListItem>
                            <asp:ListItem Value="0">否</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="tl PL10">退佣日期</td>
                    <td class="tl PL10">
                        <input id="txtRebateDate" type="text" runat="server"/></td>
                </tr>
                <tr>
                    <td class="tl PL10">特殊情况说明</td>
                    <td class="tl PL10" colspan="3">
                        <asp:TextBox ID="txtInstruction" runat="server" Width="484px"></asp:TextBox></td>
                </tr>
            </table>
            <!--打印正文结束-->
        </div>
        ...
        <div id="PageBottom">
            ...
            <asp:Button runat="server" ID="btndengji" Text="登记" OnClick="btndengji_Click" Visible="false"/>
