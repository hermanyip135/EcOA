<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_HousingFundChange_Flow.aspx.cs" Inherits="Apply_HousingFundChange_Apply_HousingFundChange_Flow" %>
    ...
    <div class="flow">
        ...
        <div class="row clearfix">
            <div class="item">
                ...
                <span>直属主管</span>&nbsp;<input class="auditor" name="Auditor" type="text" Idx="1" />
        ...
        <div class="row clearfix">
            <div class="item">
                <input class="addbtn" type="image" onclick="flowon(this); return false;" src="../../Images/add.png" />
                <span>隶属主管</span>&nbsp;<input class="auditor" name="Auditor" type="text" Idx="2" />
                <input name="AuditorID" type="hidden" />
                <a class="cancelbtn" href="javascript:;" onclick="delon(this);return false;">取消</a>
            </div>
            <img class="forward" src="../../Images/forward.png" />
            <div class="item REQUIRED">
                <input class="addbtn" type="image" onclick="flowon(this); return false;" src="/Images/add.png" />
                <span>区域负责人</span>&nbsp;<input class="auditor" name="Auditor" type="text" Idx="3" />
                <input name="AuditorID" type="hidden" />
                <a class="cancelbtn" href="javascript:;" onclick="delon(this);return false;">取消</a>
            </div>
            <div class="clearfix"></div>
