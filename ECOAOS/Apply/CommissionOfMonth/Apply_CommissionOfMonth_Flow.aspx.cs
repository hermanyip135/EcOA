...
public partial class Apply_CommissionOfMonth_Apply_CommissionOfMonth_Flow : BasePage
{
    ...
    private void LoadFlow()
    {
        ...
        foreach (DataRow dr in drc)
        {
            ...
            {
                SbJs.Append("$('#btnIDx" + dr["OfficeAutomation_Flow_Idx"] + "').toggle();$('#txtIDx" + dr["OfficeAutomation_Flow_Idx"] + "').toggle();$('#aIDx" + dr["OfficeAutomation_Flow_Idx"] + "').toggle();");
                SbJs.Append("$('#txtIDx" + dr["OfficeAutomation_Flow_Idx"] + "').val('" + dr["OfficeAutomation_Flow_Employee"] + ",');");
                SbJs.Append("$('#hdIDx" + dr["OfficeAutomation_Flow_Idx"] + "').val('" + dr["OfficeAutomation_Flow_EmployeeID"] + "');");
            }
        }
