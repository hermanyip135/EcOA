<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_CommissionOfMonth_Flow.aspx.cs" Inherits="Apply_CommissionOfMonth_Apply_CommissionOfMonth_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
...
<head id="Head1" runat="server"> 
    ...
    <script type="text/javascript">
        ...
        function save(e) {
            ...
            for(var y = 1; y <= 4; y++)
            {
                if($("#txtIDx"+y).css("display")!="none") 
                {
                    if($.trim($("#txtIDx"+y).val())=="")
                    {
                        var t=$.trim($("#lblIDx"+y).html());
                        alert("请填写"+t);
                        $("#txtIDx"+y).focus();
                        e.disabled = false;
                        return false;
...
<body>
    ...
    <div>
        <div class="flow">
           ...
           <%-- <div id="divIDx1" class='item'>直属主管</div>
            ...
            <div id="divTxtIDx1" class='item'>
                ...
                <label id="lblIDx1" for='btnIDx1'>直属主管</label>
                <input type="text" id="txtIDx1" style="width:150px;display:none;" /><input id="hdIDx1" type="hidden" />
                <a id="aIDx1"  href="javascript:;" style="display:none;" onclick="showOrHideIDx(1)" >取消</a>
            </div><img src="../../Images/forward.png" class="forward"/>

           <%-- <div id="divIDx2" class='item'>隶属主管</div>
            ...
            <div id="divTxtIDx2" class='item'>
                ...
                <label id="lblIDx2" for='btnIDx2'>隶属主管</label>
                <input type="text" id="txtIDx2" style="width:200px;display:none;" /><input id="hdIDx2" type="hidden" />
                <a id="aIDx2" href="javascript:;" style="display:none;" onclick="showOrHideIDx(2)">取消</a>
            </div><img src="../../Images/forward.png" class="forward"/>
            ...
            <div id="divTxtIDx3" class='item'>
                ...
                <label id="lblIDx3" for='btnIDx3'>区域办公室</label>
                <input type="text" id="txtIDx3" style="width:200px;display:none;" />
                <a id="aIDx3" href="javascript:;" style="display:none;" onclick="showOrHideIDx(3)">取消</a>
            </div><img src="../../Images/forward.png" class="forward"/>


            
            <div id="divTxtIDx4" class='item'>
                 <label id="lblIDx4" for='btnIDx1'>部门负责人</label>
