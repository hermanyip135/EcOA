(function($) {
    ...
    * site: http://mabp.kiev.ua/content/2008/04/08/autocomplete2/
    * license: MIT & GPL
    ...
    ac.prototype = {
        ...
        init: function(ac, options) {
            ...
            self.ac = $(ac)
                ...
                .css({ width: self.width-4 }) // 18 img + 2 margin + 2 border
                .addClass('ac_input')
        ...
        suggest: function(show) {
            ...
            if (mask.length >= self.minchar) {
                ...
                if (self.check(mask) && !$.isFunction(self.url))
                    ...
                    $.ajax({ type: "GET", data: { mask: mask , d:ddv},
