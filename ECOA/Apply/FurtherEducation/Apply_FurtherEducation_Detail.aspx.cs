...
public partial class Apply_FurtherEducation_Apply_FurtherEducation_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite35"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite35"] = null;
                }
            }
            catch
            {
    ...
    public void NewPage()
    {
        ...
        //DrawDetailTable(0);
        SbJs.Append("</script>");
        lbADate.Text = lblApplyDate.Text;
        IsNewApply = true;
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_FurtherEducation_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_FurtherEducation_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_FurtherEducation_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_FurtherEducation_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_FurtherEducation_Department"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_FurtherEducation_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtNo.Text = dr["OfficeAutomation_Document_FurtherEducation_No"].ToString();
        try
        {
            txtInData.Text = DateTime.Parse(dr["OfficeAutomation_Document_FurtherEducation_InData"].ToString()).ToString("yyyy-MM-dd");
        }
        catch
        {
            txtInData.Text = dr["OfficeAutomation_Document_FurtherEducation_InData"].ToString();
        }
        try
        {
            txtOnData.Text = DateTime.Parse(dr["OfficeAutomation_Document_FurtherEducation_OnData"].ToString()).ToString("yyyy-MM-dd");
        }
        catch
        {
            txtOnData.Text = dr["OfficeAutomation_Document_FurtherEducation_OnData"].ToString();
        }
        txtPosition.Text = dr["OfficeAutomation_Document_FurtherEducation_Position"].ToString();
        txtRank.Text = dr["OfficeAutomation_Document_FurtherEducation_Rank"].ToString();
        txtSrecord.Text = dr["OfficeAutomation_Document_FurtherEducation_Srecord"].ToString();
        if (dr["OfficeAutomation_Document_FurtherEducation_Welfare"].ToString() == "True")
            rdbWelfare1.Checked = true;
        else
            rdbWelfare2.Checked = true;

        try
        {
            txtIDData.Text = DateTime.Parse(dr["OfficeAutomation_Document_FurtherEducation_IDData"].ToString()).ToString("yyyy-MM-dd");
        }
        catch
        {
            txtIDData.Text = dr["OfficeAutomation_Document_FurtherEducation_IDData"].ToString();
        }

        txtSchool.Text = dr["OfficeAutomation_Document_FurtherEducation_School"].ToString();
        txtSubjects.Text = dr["OfficeAutomation_Document_FurtherEducation_Subjects"].ToString();
        try
        {
            txtBeginData.Text = DateTime.Parse(dr["OfficeAutomation_Document_FurtherEducation_BeginData"].ToString()).ToString("yyyy-MM-dd");
        }
        catch
        {
            txtBeginData.Text = dr["OfficeAutomation_Document_FurtherEducation_BeginData"].ToString();
        }
        txtDuring.Text = dr["OfficeAutomation_Document_FurtherEducation_During"].ToString();
        try
        {
            txtEndData.Text = DateTime.Parse(dr["OfficeAutomation_Document_FurtherEducation_EndData"].ToString()).ToString("yyyy-MM-dd");
        }
        catch
        {
            txtEndData.Text = dr["OfficeAutomation_Document_FurtherEducation_EndData"].ToString();
        }
        txtFees.Text = dr["OfficeAutomation_Document_FurtherEducation_Fees"].ToString();
        txtShouldAllowance.Text = dr["OfficeAutomation_Document_FurtherEducation_ShouldAllowance"].ToString();
        txtApplyAllowance.Text = dr["OfficeAutomation_Document_FurtherEducation_ApplyAllowance"].ToString();
        txtActualyAllowance.Text = dr["OfficeAutomation_Document_FurtherEducation_ActualyAllowance"].ToString();
        if (dr["OfficeAutomation_Document_FurtherEducation_Conditions"].ToString() == "1")
            rdbConditions1.Checked = true;
        else if (dr["OfficeAutomation_Document_FurtherEducation_Conditions"].ToString() == "2")
            rdbConditions2.Checked = true;
        else
        {
            rdbConditions1.Checked = false;
            rdbConditions2.Checked = false;
        }
        try
        {
            txtAllowData.Text = DateTime.Parse(dr["OfficeAutomation_Document_FurtherEducation_AllowData"].ToString()).ToString("yyyy-MM-dd");
        }
        catch
        {
            txtAllowData.Text = dr["OfficeAutomation_Document_FurtherEducation_AllowData"].ToString();
        }
        //txtA.Text = dr["OfficeAutomation_Document_FurtherEducation_A"].ToString();
        txtRemark.Text = dr["OfficeAutomation_Document_FurtherEducation_Remark"].ToString();
        txtName.Text = dr["OfficeAutomation_Document_FurtherEducation_Name"].ToString();
        ...
        #region 登录人为特定的人时，保存编辑按钮开启。
        if (EmployeeName == "郑颖思" || EmployeeName == "许海燕")
        {
            GetAllDepartment();
            btnSave.Visible = true;
        }
        ...
        for (int i = 0; i < drc.Count; i++)
        {
            ...
            if (drc[i]["OfficeAutomation_Flow_Audit"].ToString() == "True")
            {
                SbJs.Append("$('#btnSignIDx" + drc[i]["OfficeAutomation_Flow_IDx"] + "').before('<div style=\"width: 150px; line-height: 60px; height: 2px; margin-left:0px; float:left\">"
                    + drc[i]["OfficeAutomation_Flow_Auditor"] + "</div>");
                foreach (string s in auditorIDs)
                {
                    SbJs.Append("<img src=\"" + SignImageURL + GetGIF(s) + ".gif\" height=\"60px\" style=\"margin-left:35px;margin-top:10px;\"/>");
            ...
            else
            {
                ...
                {
                    SbJs.Append("$('#btnSignIDx" + drc[i]["OfficeAutomation_Flow_IDx"] + "').before('<div style=\"width: 150px; line-height: 60px; height: 2px; margin-left:20px; float:left\">"
                                       + drc[i]["OfficeAutomation_Flow_Auditor"] + "</div>");
                    foreach (string s in auditorIDs)
                    {
                        SbJs.Append("<img src=\"" + SignImageURL + GetGIF(s) + ".gif\" height=\"60px\" style=\"margin-left:35px;margin-top:10px;\"/>");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_FurtherEducation t_OfficeAutomation_Document_FurtherEducation = new T_OfficeAutomation_Document_FurtherEducation();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "FurtherEducation" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 29; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_MainID = t_OfficeAutomation_Main.OfficeAutomation_Main_ID;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Apply = EmployeeName;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ApplyDate = DateTime.Now;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ApplyID = txtApplyID.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Department = txtDepartment.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_No = txtNo.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_InData = txtInData.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_OnData = txtOnData.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Position = txtPosition.Text;

                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Rank = txtRank.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Srecord = txtSrecord.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Welfare = rdbWelfare1.Checked ? true : false;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_IDData = txtIDData.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_School = txtSchool.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Subjects = txtSubjects.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_BeginData = txtBeginData.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_During = txtDuring.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_EndData = txtEndData.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Fees = txtFees.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_A = "";

                //t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ShouldAllowance = txtShouldAllowance.Text;
                //t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ApplyAllowance = txtApplyAllowance.Text;
                //t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ActualyAllowance = txtActualyAllowance.Text;
                //t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Conditions = rdbConditions1.Checked ? 1 : 2;
                //t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_AllowData = txtAllowData.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Name = txtName.Text;
                t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Remark = txtRemark.Text;

                //申请人改为真正申请人而不是填写人-cx
                t_OfficeAutomation_Main.OfficeAutomation_Main_Apply = this.txtName.Text.Trim();
                ...
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = txtSchool.Text;
                ...
                da_OfficeAutomation_Document_FurtherEducation_Inherit.Insert(t_OfficeAutomation_Document_FurtherEducation);//插入申请表

                //InsertFurtherEducationDetail(t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ID);
                ...
                Common.AddLog(EmployeeID, EmployeeName, 33, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_FurtherEducation_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        if (files.Count > 0)
        {
            ...
            Common.AddLog(EmployeeID, EmployeeName, 33, new Guid(MainID), 8);
        }
        else
            Alert("请勾选文件再下载！");
    }
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_FurtherEducation_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_FurtherEducation_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (int.Parse(flowIDx) >= 3)
                {
                    Update();
                    //T_OfficeAutomation_Document_FurtherEducation t_OfficeAutomation_Document_FurtherEducation = new T_OfficeAutomation_Document_FurtherEducation();

                    //ds = da_OfficeAutomation_Document_FurtherEducation_Inherit.SelectByMainID(MainID);
                    //ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_FurtherEducation_ID"].ToString();

                    //t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ID = new Guid(ID);
                    //t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_MainID = new Guid(MainID);
                    //t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ShouldAllowance = txtShouldAllowance.Text;
                    //t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ApplyAllowance = txtApplyAllowance.Text;
                    //t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ActualyAllowance = txtActualyAllowance.Text;
                    //t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Conditions = rdbConditions1.Checked ? 1 : 2;
                    ...
                    //da_OfficeAutomation_Document_FurtherEducation_Inherit.Update2(t_OfficeAutomation_Document_FurtherEducation);//修改申请表
                }
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_FurtherEducation_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_FurtherEducation_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>填写人：" + drRow["OfficeAutomation_Document_FurtherEducation_Apply"]);
                    sbMailBody.Append("<br/>申请部门：" + drRow["OfficeAutomation_Document_FurtherEducation_Department"]);
                    sbMailBody.Append("<br/>申请日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_FurtherEducation_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>资格证号码：" + drRow["OfficeAutomation_Document_FurtherEducation_ApplyID"]);
                    sbMailBody.Append("<br/>申请人：" + drRow["OfficeAutomation_Document_FurtherEducation_Name"]);
                    sbMailBody.Append("<br/>工号：" + drRow["OfficeAutomation_Document_FurtherEducation_No"]);

                    sbMailBody.Append("<br/>学校名称：" + drRow["OfficeAutomation_Document_FurtherEducation_School"]);
                    sbMailBody.Append("<br/>进修科目：" + drRow["OfficeAutomation_Document_FurtherEducation_Subjects"]);
                    sbMailBody.Append("<br/>开课日期：" + drRow["OfficeAutomation_Document_FurtherEducation_BeginData"]);
                    sbMailBody.Append("<br/>进修期限：" + drRow["OfficeAutomation_Document_FurtherEducation_During"]);
                    sbMailBody.Append("<br/>预计毕业日期：" + drRow["OfficeAutomation_Document_FurtherEducation_EndData"]);
                    sbMailBody.Append("<br/>本年度培训费/学费：" + drRow["OfficeAutomation_Document_FurtherEducation_Fees"]);
                    sbMailBody.Append("<br/>本年度可享受津贴：" + drRow["OfficeAutomation_Document_FurtherEducation_ShouldAllowance"]);
                    sbMailBody.Append("<br/>申请津贴：" + drRow["OfficeAutomation_Document_FurtherEducation_ApplyAllowance"]);
                    sbMailBody.Append("<br/>实际享受津贴：" + drRow["OfficeAutomation_Document_FurtherEducation_ActualyAllowance"]);
                    sbMailBody.Append("<br/>发放时间：" + drRow["OfficeAutomation_Document_FurtherEducation_AllowData"]);
                    sbMailBody.Append("<br/>备注：" + drRow["OfficeAutomation_Document_FurtherEducation_Remark"]);
                    sbMailBody.Append("<br/><br/>");

                    //sbMailBody.Append("<br/>其它坏账详细情况：");

                    //ds = da_OfficeAutomation_Document_FurtherEducation_Detail_Inherit.SelectByMainID(MainID);
                    //foreach (DataRow dr in ds.Tables[0].Rows)
                    //{
                    //    sbMailBody.Append("<br/>经办人：" + dr["OfficeAutomation_Document_FurtherEducation_Detail_Controler"]);
                    //    sbMailBody.Append("<br/>物业成交编号：" + dr["OfficeAutomation_Document_FurtherEducation_Detail_PropertyID"]);
                    //    sbMailBody.Append("<br/>物业成交日期：" + dr["OfficeAutomation_Document_FurtherEducation_Detail_PropertyDate"]);
                    //    sbMailBody.Append("<br/>原成交价：" + dr["OfficeAutomation_Document_FurtherEducation_Detail_OldDeal"]);
                    //    sbMailBody.Append("<br/>现成交价：" + dr["OfficeAutomation_Document_FurtherEducation_Detail_NewDeal"]);
                    //    sbMailBody.Append("<br/>成交价调整：" + dr["OfficeAutomation_Document_FurtherEducation_Detail_AjustDeal"]);
                    //    sbMailBody.Append("<br/>应收佣金：" + dr["OfficeAutomation_Document_FurtherEducation_Detail_ShouldComm"]);
                    //    sbMailBody.Append("<br/>实收佣金：" + dr["OfficeAutomation_Document_FurtherEducation_Detail_ActualComm"]);
                    //    sbMailBody.Append("<br/>调整佣金：" + dr["OfficeAutomation_Document_FurtherEducation_Detail_AjustComm"]);
                    //    sbMailBody.Append("<br/>客户联系电话：" + dr["OfficeAutomation_Document_FurtherEducation_Detail_Commitment"]);
                    //    sbMailBody.Append("<br/>坏帐原因：" + dr["OfficeAutomation_Document_FurtherEducation_Detail_Reason"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_FurtherEducation_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private void Update()
    {
        ...
        //申请人改为表内申请人，而不是登录人。 cx

        string apply = this.txtName.Text;
      //  string apply = EmployeeName;
        
        string depname = txtDepartment.Text;
        string summary = txtSchool.Text;
        string applydate = "";
        string mainid = MainID;

        da_OfficeAutomation_Main_Inherit.UpdateMain(mainid, depname, apply, applydate, summary);
        da_OfficeAutomation_Document_FurtherEducation_Inherit.Update1(t_OfficeAutomation_Document_FurtherEducation);//修改申请表

        if (EmployeeName == "郑颖思" || EmployeeName == "许海燕" || EmployeeName == "林曼莹")
        {
            t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ShouldAllowance = txtShouldAllowance.Text;
            t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ApplyAllowance = txtApplyAllowance.Text;
            t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_ActualyAllowance = txtActualyAllowance.Text;
            ...
            t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_AllowData = txtAllowData.Text;
            //t_OfficeAutomation_Document_FurtherEducation.OfficeAutomation_Document_FurtherEducation_Remark = txtRemark.Text;
            da_OfficeAutomation_Document_FurtherEducation_Inherit.Update2(t_OfficeAutomation_Document_FurtherEducation);
        }

        //DA_OfficeAutomation_Document_FurtherEducation_Detail_Inherit da_OfficeAutomation_Document_FurtherEducation_Detail_Inherit = new DA_OfficeAutomation_Document_FurtherEducation_Detail_Inherit();
        //da_OfficeAutomation_Document_FurtherEducation_Detail_Inherit.Delete(ID);
        //InsertFurtherEducationDetail(new Guid(ID));

        Common.AddLog(EmployeeID, EmployeeName, 33, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    #region 新增进修津贴申请表坏帐明细表

    /// <summary>
    /// 新增进修津贴申请表坏帐明细表
    /// </summary>
    /// <param name="gFurtherEducationID"></param>
    //private void InsertFurtherEducationDetail(Guid gFurtherEducationID)
    //{
    //    if (hdDetail.Value == "")
    //        return;

    //    T_OfficeAutomation_Document_FurtherEducation_Detail t_OfficeAutomation_Document_FurtherEducation_Detail;
    //    DA_OfficeAutomation_Document_FurtherEducation_Detail_Inherit da_OfficeAutomation_Document_FurtherEducation_Detail_Inherit = new DA_OfficeAutomation_Document_FurtherEducation_Detail_Inherit();
    ...
    //            if (detail[0] == "")
    //                continue;
    //            t_OfficeAutomation_Document_FurtherEducation_Detail = new T_OfficeAutomation_Document_FurtherEducation_Detail();
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_ID = Guid.NewGuid();
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_MainID = gFurtherEducationID;
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_Property = detail[0];
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_Controler = detail[1];
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_PropertyID = detail[2];
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_PropertyDate = detail[3];
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_OldDeal = detail[4];
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_NewDeal = detail[5];
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_AjustDeal = detail[6];
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_ShouldComm = detail[7];
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_ActualComm = detail[8];
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_AjustComm = detail[9];
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_LeadReason = int.Parse(detail[10]);
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_Commitment = detail[11];
    //            t_OfficeAutomation_Document_FurtherEducation_Detail.OfficeAutomation_Document_FurtherEducation_Detail_Reason = detail[12];

    //            da_OfficeAutomation_Document_FurtherEducation_Detail_Inherit.Insert(t_OfficeAutomation_Document_FurtherEducation_Detail);
    //        }
    //    }
    //    catch (Exception ee)
    //    {
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite35"] = "1";
        Response.Write("<script>window.open('Apply_FurtherEducation_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("进修津贴申请表.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_FurtherEducation_Inherit da_OfficeAutomation_Document_FurtherEducation_Inherit = new DA_OfficeAutomation_Document_FurtherEducation_Inherit();
            DataSet ds = da_OfficeAutomation_Document_FurtherEducation_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_FurtherEducation_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_FurtherEducation_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
