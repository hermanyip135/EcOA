...
public partial class Apply_Apply_UploadFile : BasePage
{
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        else if (this.txtFilePath.PostedFile.ContentType.ToString() == "application/x-zip-compressed")
        {
            sFileName = tempName + ".cdr";
        }
        ...
        try
        {
            ...
            //this.txtFilePath.PostedFile.SaveAs(Server.MapPath(sFilePath));
