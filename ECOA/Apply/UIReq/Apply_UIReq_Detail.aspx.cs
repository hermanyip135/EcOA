...
public partial class Apply_UIReq_Apply_UIReq_Detail : BasePage
{
    ...
    public void LoadPage()
    {
        ...
        ID = dr["OfficeAutomation_Document_UIReq_ID"].ToString();
        this.txtDispatchDepartment.Text = dr["OfficeAutomation_Document_UIReq_Department"].ToString();
        this.hdDispatchDepartmentID.Value = dr["OfficeAutomation_Document_UIReq_DepartmentID"].ToString();
        this.txtApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_UIReq_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        this.txtHopeDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_UIReq_HopeDate"].ToString()).ToString("yyyy-MM-dd");
        this.txtApplicant.Text = dr["OfficeAutomation_Document_UIReq_Apply"].ToString();
        ApplyN = dr["OfficeAutomation_Document_UIReq_Apply"].ToString();
    
        this.txtReqContent.Text = dr["OfficeAutomation_Document_UIReq_ReqContent"].ToString();
        this.txtApplyDepHeader.Text = dr["OfficeAutomation_Document_UIReq_ApplyDepHeader"].ToString();
        this.txtFollower.Text = dr["OfficeAutomation_Document_UIReq_Follower"].ToString();
        this.txtPlanTime.Text = dr["OfficeAutomation_Document_UIReq_PlanTime"].ToString();
        ...
        if (EmployeeName == dr["OfficeAutomation_Document_UIReq_Apply"].ToString())
        {
        ...
        if (EmployeeName == dr["OfficeAutomation_Document_UIReq_Apply"].ToString() || Common.IsShowBtnUpload(EmployeeID, MainID))
        {
            sbJS.Append("$(\"#btnUpload\").show();");
        }
        #endregion
        ...
        if (dr["OfficeAutomation_Main_FlowStateID"].ToString() == "3" && dr["OfficeAutomation_Document_UIReq_Follower"].ToString().Contains(EmployeeName))
        {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_UIReq t_OfficeAutomation_Document_UIReq = new T_OfficeAutomation_Document_UIReq();
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "UIREQ" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 98;//在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_MainID = t_OfficeAutomation_Main.OfficeAutomation_Main_ID;
                t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_DepartmentID = new Guid(this.hdDispatchDepartmentID.Value);
                t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_Department = this.txtDispatchDepartment.Text;
                t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_Apply = this.txtApplicant.Text;
                t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_ApplyDepHeader = this.txtApplyDepHeader.Text;
                t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_ApplyDate = DateTime.Parse(this.txtApplyDate.Text);
                t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_HopeDate = DateTime.Parse(this.txtHopeDate.Text);
             
                t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_ReqContent = this.txtReqContent.Text;

                t_OfficeAutomation_Main.OfficeAutomation_Main_Apply = t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_Apply;
                t_OfficeAutomation_Main.OfficeAutomation_Main_Department = t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_Department;
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = this.txtDispatchDepartment.Text;
                t_OfficeAutomation_Main.OfficeAutomation_Main_ApplyDate = t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_ApplyDate;

                da_OfficeAutomation_Main_Inherit.Insert(t_OfficeAutomation_Main);//插入公文主表
                da_OfficeAutomation_Document_UIReq_Inherit.Add(t_OfficeAutomation_Document_UIReq);//插入软件系统开发需求申请表
                ...
                Common.AddLog(EmployeeID, EmployeeName, 91, new Guid(MainID), 1);//日志，创建软件系统开发需求申请表

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");"
                    + "var win=window.showModalDialog(\"Apply_UIReq_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=250px\");"
                    + "if(win=='success'){alert('UI需求申请创建成功，已发通知给部门负责人提醒审批，请耐心等待。');window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
                ...
                if (Purview.Contains("OA_ITPower_001"))//是否有编辑权限
                {
                    DataSet ds = new DataSet();
                    ds = da_OfficeAutomation_Document_UIReq_Inherit.SelectByMainID(MainID);
                    ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_UIReq_ID"].ToString();

                    t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_ID = new Guid(ID);
                    t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_DepartmentID = new Guid(this.hdDispatchDepartmentID.Value);
                    t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_Department = this.txtDispatchDepartment.Text;
                    t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_Apply = this.txtApplicant.Text;
                    t_OfficeAutomation_Document_UIReq.OfficeAutomation_Document_UIReq_ApplyDepHeader = this.txtApplyDepHeader.Text;
                    ...
                    string summary = this.txtDispatchDepartment.Text;// this.ddlSystemName.SelectedItem.Text;
                    ...
                    da_OfficeAutomation_Document_UIReq_Inherit.Edit(t_OfficeAutomation_Document_UIReq);//修改UI需求申请表

                    Common.AddLog(EmployeeID, EmployeeName, 5, new Guid(MainID), 98);//日志，修改软件系统开发需求申请表
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                DA_OfficeAutomation_Document_UIReq_Inherit da_OfficeAutomation_Document_UIReq_Inherit = new DA_OfficeAutomation_Document_UIReq_Inherit();
                ds = da_OfficeAutomation_Document_UIReq_Inherit.SelectByMainID(MainID);
                string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_UIReq_Apply"].ToString();
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.open('Apply_UIReq_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("UI设计需求申请表.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_UIReq_Inherit da_OfficeAutomation_Document_UIReq_Inherit = new DA_OfficeAutomation_Document_UIReq_Inherit();
            DataSet ds = da_OfficeAutomation_Document_UIReq_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_UIReq_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
            string department = drRow["OfficeAutomation_Document_UIReq_Department"].ToString();
    ...
    protected void btnSAlterC_Click(object sender, EventArgs e) //20141216：M_AlterC
    {
        try
        {
            ...
            if (Purview.Contains("OA_ITPower_001"))//是否有编辑权限
            {
                ...
                da_OfficeAutomation_Document_UIReq_Inherit.Edit(t_OfficeAutomation_Document_UIReq);//修改软件系统开发需求申请表
                da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "3");
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_UIReq_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
