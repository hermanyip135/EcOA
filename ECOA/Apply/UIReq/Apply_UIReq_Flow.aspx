<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_UIReq_Flow.aspx.cs" Inherits="Apply_UIReq_Apply_UIReq_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
    ...
    <script type="text/javascript">
        ...
        function save() {        
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "text",
                data: 'action=saveUIReqFlow&id=<%=EmployeeID %>&name=<%=EmployeeName %>&purview=<%=Purview %>&mainid=<%=MainID %>&content=' + content,
    ...
    <div>
        <div class="flow">
            ...
            <div id="divIDx1" class='item'>
                ...
                <label id="lblIDx1" for='btnIDx1'>部门主管</label>
            </div>
            ...
            <div id="divIDx2" class='item'>
                ...
                <label id="lblIDx2" for='btnIDx2'>部门负责人</label>
            </div>
            ...
            <br /><input type="button" id="btnSave2" value="保存并通知审批" onclick="save();" class="btn button"/>
        </div>
    </div>
    </form>
    <%=sbJS.ToString() %>
