...
public partial class Apply_GeneralApply_Apply_GeneralApply_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    public void LoadPage()
    {
        ...
        ID = dr["OfficeAutomation_Document_GeneralApply_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_GeneralApply_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_GeneralApply_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_GeneralApply_Department"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_GeneralApply_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtReplyPhone.Text = dr["OfficeAutomation_Document_GeneralApply_ReplyPhone"].ToString();
        txtSubject.Text = dr["OfficeAutomation_Document_GeneralApply_Subject"].ToString();
        txtFax.Text = dr["OfficeAutomation_Document_GeneralApply_Fax"].ToString();

        txtCanSeeEmp.Text = dr["OfficeAutomation_Document_GeneralApply_CanSeeEmployeeName"].ToString();

        txtDescribe.Text = dr["OfficeAutomation_Document_GeneralApply_Describe"].ToString();
        lbDescribe.Text = dr["OfficeAutomation_Document_GeneralApply_Describe"].ToString();
        ...
        txtReceiveDepartment.Text = dr["OfficeAutomation_Document_GeneralApply_ReceiveDepartment"].ToString();
        txtCCDepartment.Text = dr["OfficeAutomation_Document_GeneralApply_CCDepartment"].ToString();
        SerialNumber = dr["OfficeAutomation_SerialNumber"].ToString();
        //用于验证申请内容是否有变
        this.hdChangeChecking.Value = dr["OfficeAutomation_Document_GeneralApply_ApplyID"].ToString()
                + dr["OfficeAutomation_Document_GeneralApply_Department"].ToString()
                + dr["OfficeAutomation_Document_GeneralApply_ReplyPhone"].ToString()
                + dr["OfficeAutomation_Document_GeneralApply_Subject"].ToString()
                + dr["OfficeAutomation_Document_GeneralApply_Fax"].ToString()
                + dr["OfficeAutomation_Document_GeneralApply_Describe"].ToString()
                + dr["OfficeAutomation_Document_GeneralApply_ReceiveDepartment"].ToString()
                + dr["OfficeAutomation_Document_GeneralApply_CCDepartment"].ToString();
        #endregion
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_GeneralApply t_OfficeAutomation_Document_GeneralApply = new T_OfficeAutomation_Document_GeneralApply();
        ...
        try
        {
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "GeneralApply" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 39; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_GeneralApply = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_GeneralApply_Inherit.Insert(t_OfficeAutomation_Document_GeneralApply);//插入申请表
                InsertGeneralApplyDetail(t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_ID);

                Common.AddLog(EmployeeID, EmployeeName, 43, new Guid(MainID), 1);//日志，创建申请表
    ...
    {
        var SerialNumber = "GeneralApply" + DateTime.Now.ToString("yyyyMMddHHmmssfff");
        var DocumentID = 39;
        ...
        {
            var GeneralApply_ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_GeneralApply_ID"].ToString();
            t_OfficeAutomation_Document_GeneralApply = GetModelFromPage(new Guid(GeneralApply_ID));
        }

        var result = da_OfficeAutomation_Document_GeneralApply_Inherit.HandleBase(t_OfficeAutomation_Document_GeneralApply);                      //只插入关键必填字段；
        if (result)
        {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_GeneralApply_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_GeneralApply_ID"].ToString(); 
            ...
            try
            {
               ...
               // }
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_GeneralApply_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_GeneralApply_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_GeneralApply_Apply"]);
                    sbMailBody.Append("<br/>发文部门：" + drRow["OfficeAutomation_Document_GeneralApply_Department"]);
                    sbMailBody.Append("<br/>发文日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_GeneralApply_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>发文编号：" + drRow["OfficeAutomation_Document_GeneralApply_ApplyID"]);
                    sbMailBody.Append("<br/>收文部门：" + drRow["OfficeAutomation_Document_GeneralApply_ReceiveDepartment"]);
                    sbMailBody.Append("<br/>抄送部门：" + drRow["OfficeAutomation_Document_GeneralApply_CCDepartment"]);
                    sbMailBody.Append("<br/>回复电话：" + drRow["OfficeAutomation_Document_GeneralApply_ReplyPhone"]);
                    sbMailBody.Append("<br/>回复传真：" + drRow["OfficeAutomation_Document_GeneralApply_Fax"]);
                    sbMailBody.Append("<br/>文件主题：关于" + drRow["OfficeAutomation_Document_GeneralApply_Subject"] + "的申请");
                    sbMailBody.Append("<br/>正 文：" + drRow["OfficeAutomation_Document_GeneralApply_Describe"]);
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_GeneralApply_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_GeneralApply_ID"].ToString();

        t_OfficeAutomation_Document_GeneralApply = GetModelFromPage(new Guid(ID));
        ...
        da_OfficeAutomation_Document_GeneralApply_Inherit.Update(t_OfficeAutomation_Document_GeneralApply);//修改申请表
        ...
        Common.AddLog(EmployeeID, EmployeeName, 43, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    private T_OfficeAutomation_Document_GeneralApply GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_GeneralApply t_OfficeAutomation_Document_GeneralApply = new T_OfficeAutomation_Document_GeneralApply();
        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_ID = UndertakeProjID;
        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_Apply = EmployeeName;
        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_Department = txtDepartment.Text;

        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_Subject = txtSubject.Text;
        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_ReplyPhone = txtReplyPhone.Text;
        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_Fax = txtFax.Text;
        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_ReceiveDepartment = txtReceiveDepartment.Text;
        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_CCDepartment = txtCCDepartment.Text;
        //t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_Describe = HiddenField1.Value;
        //t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_Describe = ckeDescribe.Text;
        //t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_Describe = editor_id.Text;
        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_Describe = txtDescribe.Text;

        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_CanSeeEmployeeID = hdCanSeeEmpCode.Value;
        t_OfficeAutomation_Document_GeneralApply.OfficeAutomation_Document_GeneralApply_CanSeeEmployeeName = txtCanSeeEmp.Text;

        return t_OfficeAutomation_Document_GeneralApply;
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.open('Apply_GeneralApply_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("通用申请表.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_GeneralApply_Inherit da_OfficeAutomation_Document_GeneralApply_Inherit = new DA_OfficeAutomation_Document_GeneralApply_Inherit();
            DataSet ds = da_OfficeAutomation_Document_GeneralApply_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_GeneralApply_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnSAlterC_Click(object sender, EventArgs e) //20141216：M_AlterC
    {
        try
        {
            ...
            if (Purview.Contains("OA_ITPower_001"))//是否有编辑权限
            {
                ...
                txtSubject.Text == dr["OfficeAutomation_Document_GeneralApply_Subject"].ToString() &&
                txtFax.Text == dr["OfficeAutomation_Document_GeneralApply_Fax"].ToString() &&
                    Repc(txtDescribe.Text) == Repc(dr["OfficeAutomation_Document_GeneralApply_Describe"].ToString())
                 && txtReceiveDepartment.Text == dr["OfficeAutomation_Document_GeneralApply_ReceiveDepartment"].ToString() &&
                txtCCDepartment.Text == dr["OfficeAutomation_Document_GeneralApply_CCDepartment"].ToString())
                {
    ...
    protected void btnShouldJump_Click(object sender, EventArgs e)
    {
        ...
        {
            da_OfficeAutomation_Flow_Inherit.DeleteFlowsForJump(MainID, hdShouldJump.Value);
            da_OfficeAutomation_Document_GeneralApply_Detail_Inherit.DeleteByDpmAndMID(MainID, hdShouldJump.Value);
        }
    ...
    protected void btnWillEndC_Click(object sender, EventArgs e)
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Main_Inherit da_OfficeAutomation_Main_Inherit = new DA_OfficeAutomation_Main_Inherit();
        if (!da_OfficeAutomation_Flow_Inherit.DeleteFlowsForJump(MainID, "总经办"))
            if (!da_OfficeAutomation_Flow_Inherit.DeleteFlowsForJump(MainID, "董事总经理"))
                da_OfficeAutomation_Flow_Inherit.DeleteFlowsForJump(MainID, "董事总经理审批");
        da_OfficeAutomation_Flow_Inherit.DeleteFlowsByME(MainID, "0001");
        DA_OfficeAutomation_Document_GeneralApply_Detail_Inherit da_OfficeAutomation_Document_GeneralApply_Detail_Inherit = new DA_OfficeAutomation_Document_GeneralApply_Detail_Inherit();
        da_OfficeAutomation_Document_GeneralApply_Detail_Inherit.DeleteByDpmAndMID(MainID, "总经办");
        da_OfficeAutomation_Document_GeneralApply_Detail_Inherit.DeleteByDpmAndMID(MainID, "总办");
        da_OfficeAutomation_Document_GeneralApply_Detail_Inherit.DeleteByDpmAndMID(MainID, "董事总经理");
        da_OfficeAutomation_Document_GeneralApply_Detail_Inherit.DeleteByDpmAndMID(MainID, "董事总经理审批");
        da_OfficeAutomation_Main_Inherit.UpdateFlowStateForAudit(MainID);
        Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 3); //添加日志，删除流程
