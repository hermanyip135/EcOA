...
public partial class Apply_ProjOfficialSeal_Apply_ProjOfficialSeal_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    public void LoadPage()
    {
        ...
        DA_OfficeAutomation_Document_ProjectOfficialSeal_Inherit da_OfficeAutomation_Document_ProjectOfficialSeal_Inherit = new DA_OfficeAutomation_Document_ProjectOfficialSeal_Inherit();
        DA_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit da_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit = new DA_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit();
        ...
        ds = da_OfficeAutomation_Document_ProjectOfficialSeal_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_ProjectOfficialSeal_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_ProjectOfficialSeal_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_ProjectOfficialSeal_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_ProjectOfficialSeal_Department"].ToString();
        flowsl = Server.UrlEncode(dr["OfficeAutomation_Document_ProjectOfficialSeal_Department"].ToString());
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ProjectOfficialSeal_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        if (dr["OfficeAutomation_Document_ProjectOfficialSeal_Species"].ToString() == "True")
            rdbSpecies1.Checked = true;
        else
        {
            rdbSpecies2.Checked = true;
            txtAnotherSeal.Text = dr["OfficeAutomation_Document_ProjectOfficialSeal_AnotherSeal"].ToString();
        }
        txtAnotherFile.Text = dr["OfficeAutomation_Document_ProjectOfficialSeal_AnotherFile"].ToString();
        if (dr["OfficeAutomation_Document_ProjectOfficialSeal_FileSpecies"].ToString() == "1")
        {
            rdbFileSpecies2.Checked = true;

        }
        else if (dr["OfficeAutomation_Document_ProjectOfficialSeal_FileSpecies"].ToString() == "2")
        {
        ...
        txtFileCount.Text = dr["OfficeAutomation_Document_ProjectOfficialSeal_FileCount"].ToString();
        try
        {
            txtRecyclingData.Text = DateTime.Parse(dr["OfficeAutomation_Document_ProjectOfficialSeal_RecyclingData"].ToString()).ToString("yyyy-MM-dd");
        }
        catch
        {
            txtRecyclingData.Text = dr["OfficeAutomation_Document_ProjectOfficialSeal_RecyclingData"].ToString();
        }
        txtSureDepartment.Text = dr["OfficeAutomation_Document_ProjectOfficialSeal_SureDepartment"].ToString();
        txtSureMenber.Text = dr["OfficeAutomation_Document_ProjectOfficialSeal_SureMenber"].ToString();
        try
        {
            txtSureData.Text = DateTime.Parse(dr["OfficeAutomation_Document_ProjectOfficialSeal_SureData"].ToString()).ToString("yyyy-MM-dd");
        }
        catch
        {
            txtSureData.Text = dr["OfficeAutomation_Document_ProjectOfficialSeal_SureData"].ToString();
        }
        txtBranchPhone.Text = dr["OfficeAutomation_Document_ProjectOfficialSeal_BranchPhone"].ToString();
        txtSurePhone.Text = dr["OfficeAutomation_Document_ProjectOfficialSeal_SurePhone"].ToString();
        txtSureCommissioner.Text = dr["OfficeAutomation_Document_ProjectOfficialSeal_SureCommissioner"].ToString();

        SerialNumber = dr["OfficeAutomation_SerialNumber"].ToString();

        ds = da_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit.SelectByID(ID);
        ...
        else
        {
            ...
            for (int n = 0; n < detailCount; n++)
            {
                ...
                SbJs.Append("$('#selTransFile" + i + "').val('" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_TransFile"] + "');");
                SbJs.Append("$('#selTransFile" + i + "').find(\"option:selected\").text('" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_TransFile"] + "');");
                SbJs.Append("$('#txtFileName" + i + "').val('" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_FileName"] + "');");
                try
                {
                    SbJs.Append("$('#txtAgentBeginData" + i + "').val('" + DateTime.Parse(dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_AgentBeginData"].ToString()).ToString("yyyy-MM-dd") + "');");
                }
                catch
                {
                    SbJs.Append("$('#txtAgentBeginData" + i + "').val('" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_AgentBeginData"] + "');");
                }
                try
                {
                    SbJs.Append("$('#txtAgentEndData" + i + "').val('" + DateTime.Parse(dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_AgentEndData"].ToString()).ToString("yyyy-MM-dd") + "');");
                }
                catch
                {
                    SbJs.Append("$('#txtAgentEndData" + i + "').val('" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_AgentEndData"] + "');");
                }
                SbJs.Append("$('#txtBN" + i + "').val('" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_BN"].ToString().Replace("\r", "\\r").Replace("\n", "\\n") + "');");
                SbJs.Append("$('#txtCompany" + i + "').val('" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_Company"] + "');");
                SbJs.Append("$('#txtUse" + i + "').val('" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_Use"].ToString().Replace("\r", "\\r").Replace("\n", "\\n") + "');");
            }
        }
        ...
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
            if (EmployeeName == "朱晓晴"
               ...
               || EmployeeName == "潘焕心"
               || EmployeeName == "欧凤霞"
               || ds.Tables[0].Rows[0]["UnitName"].ToString() == "项目部秘书组" || txtDepartment.Text.Contains("项目") || txtDepartment.Text.Contains("事业") || txtDepartment.Text.Contains("拓展") || txtDepartment.Text.Contains("顾问") || txtDepartment.Text.Contains("销售"))
            {
                SbJs.Append("$(\"#btnUpload\").show();");
            }
        }
        ...
        bool flge = false;
        ds = da_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit.SelectByID(ID); //A_Marking 20150909
        for (int n = 0; n < detailCount; n++)
        {
            dr = ds.Tables[0].Rows[n];
            if (kwg.Contains(dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_TransFile"].ToString()))
                flge = true;
        }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_ProjectOfficialSeal t_OfficeAutomation_Document_ProjectOfficialSeal = new T_OfficeAutomation_Document_ProjectOfficialSeal();
        T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "ProjOfficialSeal" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 97; //在《申请表字典表》找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_MainID = t_OfficeAutomation_Main.OfficeAutomation_Main_ID;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_Apply = EmployeeName;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_ApplyDate = DateTime.Now;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_ApplyID = txtApplyID.Text;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_Department = txtDepartment.Text;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_Species = rdbSpecies1.Checked ? true : false;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_AnotherSeal = txtAnotherSeal.Text;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_FileSpecies = rdbFileSpecies1.Checked ? 0 : rdbFileSpecies2.Checked ? 1 : 2;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_AnotherFile = txtAnotherFile.Text;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_FileCount = txtFileCount.Text;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_RecyclingData = txtRecyclingData.Text;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_SureDepartment = txtSureDepartment.Text;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_SureMenber = txtSureMenber.Text;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_SureData = txtSureData.Text;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_BranchPhone = txtBranchPhone.Text;
                t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_SurePhone = txtSurePhone.Text;
                if (EmployeeName == "李小清" || EmployeeName == "顾思娜")
                {
                    t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_SureCommissioner = txtSureCommissioner.Text;
                }
                else
                {
                    t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_SureCommissioner = "";
                }

                string detail = InsertOfficialSealDetail(t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_ID);
                ...
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = (string.IsNullOrEmpty(t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_SureCommissioner) ? "" : "(√★)") + detail + (string.IsNullOrEmpty(t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_SureCommissioner) ? "" : txtSureData.Text);
                ...
                da_OfficeAutomation_Document_ProjectOfficialSeal_Inherit.Add(t_OfficeAutomation_Document_ProjectOfficialSeal);//插入申请表
                ...
                Common.AddLog(EmployeeID, EmployeeName, 88, new Guid(MainID), 1);//日志，创建申请表
                ...
                if (ds.Tables[0].Rows[0]["UnitName"].ToString() == "项目部秘书组" || txtDepartment.Text.Contains("项目") || txtDepartment.Text.Contains("事业") || txtDepartment.Text.Contains("拓展") || txtDepartment.Text.Contains("顾问"))
                    RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_ProjOfficialSeal_Flow.aspx?MainID=" + MainID + "&dpm=" + Server.UrlEncode(txtDepartment.Text) + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                    ...
                    ) //A_Marking 20150909
                {
                    ...
                    RunJS("var win=window.showModalDialog(\"Apply_ProjOfficialSeal_Flow.aspx?MainID=" + MainID + "&dpm=" + Server.UrlEncode(txtDepartment.Text) + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
                ...
                if (Purview.Contains("OA_ITPower_001"))//是否有编辑权限
                {
                    ...
                    string departmentName = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ProjectOfficialSeal_Department"].ToString();
                    //页面上的部门名称
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        if (files.Count > 0)
        {
            ...
            Common.AddLog(EmployeeID, EmployeeName, 88, new Guid(MainID), 8);
        }
        else
            Alert("请勾选文件再下载！");
    }
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_ProjectOfficialSeal_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_ProjectOfficialSeal_ID"].ToString();
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ProjectOfficialSeal_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_ProjectOfficialSeal_Department"].ToString();
                    string applyUrl = Page.Request.Url.ToString();
                    applyUrl = applyUrl.Substring(applyUrl.IndexOf("/Apply/"));
                    applyUrl = "内部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["InternalURL"] + applyUrl;
                    //+ "<br />外部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["ExternalURL"] + applyUrl;
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_ProjectOfficialSeal_Apply"]);
                    sbMailBody.Append("<br/>申请部门：" + drRow["OfficeAutomation_Document_ProjectOfficialSeal_Department"]);
                    sbMailBody.Append("<br/>申请日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_ProjectOfficialSeal_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>分行电话：" + drRow["OfficeAutomation_Document_ProjectOfficialSeal_BranchPhone"]);
                    sbMailBody.Append("<br/>编号：" + drRow["OfficeAutomation_Document_ProjectOfficialSeal_ApplyID"]);
                    sbMailBody.Append("<br/>申请盖章部门：" + drRow["OfficeAutomation_Document_ProjectOfficialSeal_Department"]);

                    sbMailBody.Append("<br/>申请盖章文件的份数：" + drRow["OfficeAutomation_Document_ProjectOfficialSeal_FileCount"]);
                    sbMailBody.Append("<br/>预计回收日期：" + drRow["OfficeAutomation_Document_ProjectOfficialSeal_RecyclingData"]);
                    sbMailBody.Append("<br/>确认盖章部门：" + drRow["OfficeAutomation_Document_ProjectOfficialSeal_SureDepartment"]);
                    sbMailBody.Append("<br/>确认盖章人员：" + drRow["OfficeAutomation_Document_ProjectOfficialSeal_SureMenber"]);
                    sbMailBody.Append("<br/>确认人电话：" + drRow["OfficeAutomation_Document_ProjectOfficialSeal_SurePhone"]);
                    sbMailBody.Append("<br/>确认盖章日期：" + drRow["OfficeAutomation_Document_ProjectOfficialSeal_SureData"]);
                    sbMailBody.Append("<br/>盖章专责人员：" + drRow["OfficeAutomation_Document_ProjectOfficialSeal_SureCommissioner"]);
                    sbMailBody.Append("<br/><br/>");

                    sbMailBody.Append("<br/>其它坏账详细情况：");

                    ds = da_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit.SelectByMainID(MainID);
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        sbMailBody.Append("<br/>事务文件：" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_TransFile"]);
                        sbMailBody.Append("<br/>文件名称：" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_FileName"]);
                        sbMailBody.Append("<br/>代理期开始时间：" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_AgentBeginData"]);
                        sbMailBody.Append("<br/>代理期结束时间：" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_AgentEndData"]);
                        sbMailBody.Append("<br/>项目（楼盘）名称/成交编号：" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_BN"]);
                        sbMailBody.Append("<br/>对方公司名称：" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_Company"]);
                        sbMailBody.Append("<br/>用途：" + dr["OfficeAutomation_Document_ProjectOfficialSeal_Detail_Use"]);
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_ProjectOfficialSeal_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ProjectOfficialSeal_ID"].ToString();

        t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_ID = new Guid(ID);
        t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_Apply = EmployeeName;
        t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_ProjectOfficialSeal.OfficeAutomation_Document_ProjectOfficialSeal_Department = txtDepartment.Text;
        ...
        DA_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit da_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit = new DA_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit();
        da_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit.DelByMainID(ID);
        ...
        da_OfficeAutomation_Document_ProjectOfficialSeal_Inherit.Edit(t_OfficeAutomation_Document_ProjectOfficialSeal);//修改申请表
        ...
        Common.AddLog(EmployeeID, EmployeeName, 88, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    private string InsertOfficialSealDetail(Guid gProjOfficialSealID)
    {
        if (hdDetail.Value == "")
            return "";

        T_OfficeAutomation_Document_ProjectOfficialSeal_Detail t_OfficeAutomation_Document_ProjectOfficialSeal_Detail;
        DA_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit da_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit = new DA_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit();
        ...
        try
        {
            for (int i = 0; i < details.Length; i++)
            {
                ...
                if (detail[0] == "")
                    continue;
                t_OfficeAutomation_Document_ProjectOfficialSeal_Detail = new T_OfficeAutomation_Document_ProjectOfficialSeal_Detail();
                t_OfficeAutomation_Document_ProjectOfficialSeal_Detail.OfficeAutomation_Document_ProjectOfficialSeal_Detail_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_ProjectOfficialSeal_Detail.OfficeAutomation_Document_ProjectOfficialSeal_Detail_MainID = gProjOfficialSealID;
                t_OfficeAutomation_Document_ProjectOfficialSeal_Detail.OfficeAutomation_Document_ProjectOfficialSeal_Detail_TransFile = detail[0];
                t_OfficeAutomation_Document_ProjectOfficialSeal_Detail.OfficeAutomation_Document_ProjectOfficialSeal_Detail_FileName = detail[1];
                t_OfficeAutomation_Document_ProjectOfficialSeal_Detail.OfficeAutomation_Document_ProjectOfficialSeal_Detail_AgentBeginData = detail[2];
                t_OfficeAutomation_Document_ProjectOfficialSeal_Detail.OfficeAutomation_Document_ProjectOfficialSeal_Detail_AgentEndData = detail[3];
                t_OfficeAutomation_Document_ProjectOfficialSeal_Detail.OfficeAutomation_Document_ProjectOfficialSeal_Detail_BN = detail[4];
                t_OfficeAutomation_Document_ProjectOfficialSeal_Detail.OfficeAutomation_Document_ProjectOfficialSeal_Detail_Company = detail[5];
                t_OfficeAutomation_Document_ProjectOfficialSeal_Detail.OfficeAutomation_Document_ProjectOfficialSeal_Detail_Use = detail[6];
                result += detail[4] + "，";
                ViewState["TransFiles"] += detail[0] + "|";
                da_OfficeAutomation_Document_ProjectOfficialSeal_Detail_Inherit.Add(t_OfficeAutomation_Document_ProjectOfficialSeal_Detail);
            }
            return result;
        }
        catch (Exception ee)
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.open('Apply_ProjectOfficialSeal_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("公章使用申请表(项目部).pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_ProjectOfficialSeal_Inherit da_OfficeAutomation_Document_ProjectOfficialSeal_Inherit = new DA_OfficeAutomation_Document_ProjectOfficialSeal_Inherit();
            DataSet ds = da_OfficeAutomation_Document_ProjectOfficialSeal_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ProjectOfficialSeal_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnSAlterC_Click(object sender, EventArgs e) //20141216：M_AlterC
    {
        try
        {
            ...
            ds = da_OfficeAutomation_Document_ProjectOfficialSeal_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ProjectOfficialSeal_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_ProjOfficialSeal_Flow.aspx?MainID=" + MainID + "&dpm=" + Server.UrlEncode(txtDepartment.Text) + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
