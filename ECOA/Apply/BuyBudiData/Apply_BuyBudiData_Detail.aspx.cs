...
public partial class Apply_BuyBudiData_Apply_BuyBudiData_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    public StringBuilder SbHtml1 = new StringBuilder(); //M_Detail：20151030
    public string ApplyDisplayPart = "$(\"#btnAddRow1\").show();$(\"#btnDeleteRow1\").show();";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite71"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite71"] = null;
                }
            }
            catch
            {
    ...
    public void InitPage()
    {
        ...
        DrawDetailTable(1); //M_Detail：20151030
        SbJs.Append("<script type=\"text/javascript\">" + ApplyDisplayPart + "</script>");
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_BuyBudiData_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_BuyBudiData_ID"].ToString();

        string applicant = dr["OfficeAutomation_Document_BuyBudiData_Apply"].ToString();
        ApplyN = applicant;
        lblApply.Text = applicant;
        txtDepartment.Text = dr["OfficeAutomation_Document_BuyBudiData_Department"].ToString();
        txtApplyID.Text = dr["OfficeAutomation_Document_BuyBudiData_ApplyID"].ToString();
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_BuyBudiData_ApplyDate"].ToString()).ToString("yyyy-MM-dd");

        txtArea.Text = dr["OfficeAutomation_Document_BuyBudiData_Area"].ToString();
        txtWriter.Value = dr["OfficeAutomation_Document_BuyBudiData_Writer"].ToString();
        txtPhone.Text = dr["OfficeAutomation_Document_BuyBudiData_Phone"].ToString();
        hdTbDetail.Value = dr["OfficeAutomation_Document_BuyBudiData_Bname"].ToString(); //M_Detail：20151030
        txtDealOfficeOther.Text = dr["OfficeAutomation_Document_BuyBudiData_DealOfficeOther"].ToString();
        txtBDCount.Text = dr["OfficeAutomation_Document_BuyBudiData_BDCount"].ToString();
        txtBSDCount.Text = dr["OfficeAutomation_Document_BuyBudiData_BSDCount"].ToString();
        txtPurpose.Text = dr["OfficeAutomation_Document_BuyBudiData_Purpose"].ToString();
        txtWay.Text = dr["OfficeAutomation_Document_BuyBudiData_Way"].ToString();
        txtHaventTax.Text = dr["OfficeAutomation_Document_BuyBudiData_HaventTax"].ToString();
        txtHaveTax.Text = dr["OfficeAutomation_Document_BuyBudiData_HaveTax"].ToString();
        txtTax.Text = dr["OfficeAutomation_Document_BuyBudiData_Tax"].ToString();
        txtAvgHaventTax.Text = dr["OfficeAutomation_Document_BuyBudiData_AvgHaventTax"].ToString();
        txtAvgHaveTax.Text = dr["OfficeAutomation_Document_BuyBudiData_AvgHaveTax"].ToString();
        txtRealP.Text = dr["OfficeAutomation_Document_BuyBudiData_RealP"].ToString();
        txtCanUseP.Text = dr["OfficeAutomation_Document_BuyBudiData_CanUseP"].ToString();
        txtEntryP.Text = dr["OfficeAutomation_Document_BuyBudiData_EntryP"].ToString();
        txtAnother.Text = dr["OfficeAutomation_Document_BuyBudiData_Another"].ToString();
        txtMonth1.Text = dr["OfficeAutomation_Document_BuyBudiData_Month1"].ToString();
        txtMonth2.Text = dr["OfficeAutomation_Document_BuyBudiData_Month2"].ToString();
        txtMonth3.Text = dr["OfficeAutomation_Document_BuyBudiData_Month3"].ToString();
        txtMonth4.Text = dr["OfficeAutomation_Document_BuyBudiData_Month4"].ToString();
        txtMonth5.Text = dr["OfficeAutomation_Document_BuyBudiData_Month5"].ToString();
        txtMonth6.Text = dr["OfficeAutomation_Document_BuyBudiData_Month6"].ToString();
        txtRCount1.Text = dr["OfficeAutomation_Document_BuyBudiData_RCount1"].ToString();
        txtRCount2.Text = dr["OfficeAutomation_Document_BuyBudiData_RCount2"].ToString();
        txtRCount3.Text = dr["OfficeAutomation_Document_BuyBudiData_RCount3"].ToString();
        txtRCount4.Text = dr["OfficeAutomation_Document_BuyBudiData_RCount4"].ToString();
        txtRCount5.Text = dr["OfficeAutomation_Document_BuyBudiData_RCount5"].ToString();
        txtRCount6.Text = dr["OfficeAutomation_Document_BuyBudiData_RCount6"].ToString();
        txtSCresult1.Text = dr["OfficeAutomation_Document_BuyBudiData_SCresult1"].ToString();
        txtSCresult2.Text = dr["OfficeAutomation_Document_BuyBudiData_SCresult2"].ToString();
        txtSCresult3.Text = dr["OfficeAutomation_Document_BuyBudiData_SCresult3"].ToString();
        txtSCresult4.Text = dr["OfficeAutomation_Document_BuyBudiData_SCresult4"].ToString();
        txtSCresult5.Text = dr["OfficeAutomation_Document_BuyBudiData_SCresult5"].ToString();
        txtSCresult6.Text = dr["OfficeAutomation_Document_BuyBudiData_SCresult6"].ToString();
        txtProfits1.Text = dr["OfficeAutomation_Document_BuyBudiData_Profits1"].ToString();
        txtProfits2.Text = dr["OfficeAutomation_Document_BuyBudiData_Profits2"].ToString();
        txtProfits3.Text = dr["OfficeAutomation_Document_BuyBudiData_Profits3"].ToString();
        txtProfits4.Text = dr["OfficeAutomation_Document_BuyBudiData_Profits4"].ToString();
        txtProfits5.Text = dr["OfficeAutomation_Document_BuyBudiData_Profits5"].ToString();
        txtProfits6.Text = dr["OfficeAutomation_Document_BuyBudiData_Profits6"].ToString();
        txtSumRCount.Text = dr["OfficeAutomation_Document_BuyBudiData_SumRCount"].ToString();
        txtSumSCresult.Text = dr["OfficeAutomation_Document_BuyBudiData_SumSCresult"].ToString();
        txtApplyNo.Text = dr["OfficeAutomation_Document_BuyBudiData_ApplyNo"].ToString();
        txtSumProfits.Text = dr["OfficeAutomation_Document_BuyBudiData_SumProfits"].ToString();

        InitListControler(dr["OfficeAutomation_Document_BuyBudiData_DealOfficeTypeIDs"].ToString());
        SerialNumber = dr["OfficeAutomation_SerialNumber"].ToString();

        string[] details = Regex.Split(this.hdTbDetail.Value, "\\|\\|"); //M_Detail：20151030
        ...
        for (int i = 0; i < details.Length; i++)
        {
            ...
            //{
                int n = i + 1;
                SbJs.Append("$('#txtDetail_Bname" + n + "').val('" + detail[0] + "');");
                SbJs.Append("$('#txtDetail_Baddress" + n + "').val('" + detail[1] + "');");
            //}
        }
        ...
        if (isApplicant)
        {
            SbJs.Append(ApplyDisplayPart); //M_Detail：20151030
            if (flowState == "1")
            {
                GetAllDepartment();
                btnSave.Visible = true;
        ...
        try
        {
            ...
            {
                SbJs.Append("$(\"#btnUpload\").hide();$(\"#btnPrint\").hide();" + ApplyDisplayPart);
                SbJs.Append("</script>");
                GetAllDepartment();
                btnSPDF.Visible = false; //M_PDF
                btnSave.Visible = true;
        ...
        if (flowState == "1" && applicant == EmployeeName)
            this.FlowShow1.ShowEditBtn = true;  //显示流程编辑按钮
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_BuyBudiData t_OfficeAutomation_Document_BuyBudiData = new T_OfficeAutomation_Document_BuyBudiData();
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "BuyBudiData" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 66; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_BuyBudiData = GetModelFromPage(Guid.NewGuid());
                ...
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = this.txtArea.Text;
                ...
                da_OfficeAutomation_Document_BuyBudiData_Inherit.Insert(t_OfficeAutomation_Document_BuyBudiData);//插入申请表
                ...
                Common.AddLog(EmployeeID, EmployeeName, 70, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_BuyBudiData_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    public void DrawDetailTable(int n1) //M_Detail：20151030
    {
        for (int i = 1; i <= n1; i++)
        {
            SbHtml1.Append("<tr id='trTbDetail" + i + "'>");
            SbHtml1.Append("     <td style=\"width:40%\">楼盘名：<input type=\"text\" id=\"txtDetail_Bname" + i + "\" style=\"width:75%\"/></td>");
            SbHtml1.Append("     <td style=\"width:70%\">地址： <input type=\"text\" id=\"txtDetail_Baddress" + i + "\" style=\"width:85%\"/></td>");
            SbHtml1.Append("</tr>");
        }
        //SbJs.Append("i1=" + n1 + ";");
    }
    ...
    private T_OfficeAutomation_Document_BuyBudiData GetModelFromPage(Guid BuyBudiDataID)
    {
        T_OfficeAutomation_Document_BuyBudiData t_OfficeAutomation_Document_BuyBudiData = new T_OfficeAutomation_Document_BuyBudiData();
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_ID = BuyBudiDataID;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Apply = EmployeeName;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Department = txtDepartment.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_ApplyDate = DateTime.Now;
        
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Area = txtArea.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Writer = txtWriter.Value;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Phone = txtPhone.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Bname = hdTbDetail.Value; //M_Detail：20151030
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Baddress = "";
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_DealOfficeOther = txtDealOfficeOther.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_BDCount = txtBDCount.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_BSDCount = txtBSDCount.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Purpose = txtPurpose.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Way = txtWay.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_HaventTax = txtHaventTax.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_HaveTax = txtHaveTax.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Tax = txtTax.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_AvgHaventTax = txtAvgHaventTax.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_AvgHaveTax = txtAvgHaveTax.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_RealP = txtRealP.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_CanUseP = txtCanUseP.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_EntryP = txtEntryP.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Another = txtAnother.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Month1 = txtMonth1.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Month2 = txtMonth2.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Month3 = txtMonth3.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Month4 = txtMonth4.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Month5 = txtMonth5.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Month6 = txtMonth6.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_RCount1 = txtRCount1.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_RCount2 = txtRCount2.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_RCount3 = txtRCount3.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_RCount4 = txtRCount4.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_RCount5 = txtRCount5.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_RCount6 = txtRCount6.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_SCresult1 = txtSCresult1.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_SCresult2 = txtSCresult2.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_SCresult3 = txtSCresult3.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_SCresult4 = txtSCresult4.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_SCresult5 = txtSCresult5.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_SCresult6 = txtSCresult6.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Profits1 = txtProfits1.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Profits2 = txtProfits2.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Profits3 = txtProfits3.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Profits4 = txtProfits4.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Profits5 = txtProfits5.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_Profits6 = txtProfits6.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_SumRCount = txtSumRCount.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_SumSCresult = txtSumSCresult.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_ApplyNo = txtApplyNo.Text;
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_SumProfits = txtSumProfits.Text;
        ...
        t_OfficeAutomation_Document_BuyBudiData.OfficeAutomation_Document_BuyBudiData_DealOfficeTypeIDs = sOfficeType;
   
        return t_OfficeAutomation_Document_BuyBudiData;
    }
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_BuyBudiData_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_BuyBudiData_ID"].ToString();
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_BuyBudiData_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_BuyBudiData_Department"].ToString();
                    string applyUrl = Page.Request.Url.ToString();
                    //string plantime = drRow["OfficeAutomation_Document_BuyBudiData_PlanDate"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_BuyBudiData_Writer"]);
                    sbMailBody.Append("<br/>申请日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_BuyBudiData_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>填写人：" + drRow["OfficeAutomation_Document_BuyBudiData_Apply"]);
                    sbMailBody.Append("<br/>申请部门/分行：" + drRow["OfficeAutomation_Document_BuyBudiData_Department"]);
                    sbMailBody.Append("<br/>申请人姓名：" + drRow["OfficeAutomation_Document_BuyBudiData_Writer"]);
                    sbMailBody.Append("<br/>申请区域：" + drRow["OfficeAutomation_Document_BuyBudiData_Area"]);
                    sbMailBody.Append("<br/>回复电话：" + drRow["OfficeAutomation_Document_BuyBudiData_Phone"]);
                    ...
                    if (hdIsAgree.Value != "0")//同意或其他意见
                    {
                        ...
                        if (da_OfficeAutomation_Flow_Inherit.IsFlowComplete(MainID))
                        {
                            ...
                            if (employeeList.Contains("黄轩明"))
                                employname = CommonConst.EMP_GMO_NAME + "，黄志超,黄洁珍";
                            else
                                employname = "黄志超,黄洁珍";
                            employnames = employname.Split(',');
                            for (int i = 0; i < employnames.Length; i++)
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_BuyBudiData_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_BuyBudiData_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_BuyBudiData_ID"].ToString();

        t_OfficeAutomation_Document_BuyBudiData = GetModelFromPage(new Guid(ID));

        string apply = EmployeeName;
        string depname = txtDepartment.Text;
        string summary = txtArea.Text;
        string applydate = "";
        string mainid = MainID;

        da_OfficeAutomation_Main_Inherit.UpdateMain(mainid, depname, apply, applydate, summary);
        da_OfficeAutomation_Document_BuyBudiData_Inherit.Update(t_OfficeAutomation_Document_BuyBudiData);//修改申请表

        AddMaster();

        Common.AddLog(EmployeeID, EmployeeName, 70, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite71"] = "1";
        Response.Write("<script>window.open('Apply_BuyBudiData_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("物业部购买楼盘资料申请.pdf"));//强制下载 
    ...
    protected void btnSaveLogisticsFlow_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_BuyBudiData_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_BuyBudiData_ID"].ToString(); //在不同的表要注意修改
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_BuyBudiData_Inherit da_OfficeAutomation_Document_BuyBudiData_Inherit = new DA_OfficeAutomation_Document_BuyBudiData_Inherit();
            DataSet ds = da_OfficeAutomation_Document_BuyBudiData_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_BuyBudiData_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_BuyBudiData_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    protected void lbtAddLogistics_Click(object sender, EventArgs e)
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
        ...
        if (flows == null)
        {
            ...
            da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);
            RunJS("alert('后勤事务部的审批流程已添加');window.location.href='" + Page.Request.Url + "';");
        }
        else
        {
            //if (string.IsNullOrEmpty(flows.OfficeAutomation_Flow_AuditorID))
            //{
            //    da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "12,13");
            //    RunJS("alert('已删除后勤事务部的审批流程');window.location.href='" + Page.Request.Url + "';");
            //}
            //else
            //    RunJS("alert('后勤事务部人员已审批，不能再删除了');window.location.href='" + Page.Request.Url + "';");
            RunJS("alert('后勤事务部的审批流程已添加');window.location.href='" + Page.Request.Url + "';");
        }
    }
    ...
    protected void AddMaster()
    {
        ...
        if (float.Parse(txtHaveTax.Text) > 20000 || txtDepartment.Text.Contains("工商"))
        {
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_BuyBudiData_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_BuyBudiData_Inherit();
