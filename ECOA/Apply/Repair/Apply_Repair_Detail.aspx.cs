...
public partial class Apply_Repair_Apply_Repair_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite59"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite59"] = null;
                }
            }
            catch
            {
    ...
    private void InitDDl(string svl)
    {
        DataSet ds = new DataSet();
        DA_Dic_OfficeAutomation_Supplier_Operate da_Dic_OfficeAutomation_Supplier_Operate = new DA_Dic_OfficeAutomation_Supplier_Operate();
        ds = da_Dic_OfficeAutomation_Supplier_Operate.SelectSupply();
        DropDownListBind(ddlRealBrand, ds.Tables[0], "OfficeAutomation_Document_Supplier_No", "OfficeAutomation_Document_Supplier_Supply", svl, "-请选择-");
    }
    ...
    public void LoadPage()
    {
        ...
        DA_OfficeAutomation_Document_Repair_Detail_Inherit da_OfficeAutomation_Document_Repair_Detail_Inherit = new DataAccess.Operate.DA_OfficeAutomation_Document_Repair_Detail_Inherit();
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_Repair_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_Repair_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_Repair_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_Repair_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_Repair_Department"].ToString();
        lblApply.Text = applicant;
        txtApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_Repair_ApplyDate"].ToString()).ToString("yyyy-MM-dd");

        //txtSumBrand.Text = dr["OfficeAutomation_Document_Repair_SumBrand"].ToString();
        //txtSumUnit.Text = dr["OfficeAutomation_Document_Repair_SumUnit"].ToString();
        //txtSumPrice.Text = dr["OfficeAutomation_Document_Repair_SumPrice"].ToString();
        //txtSumNum.Text = dr["OfficeAutomation_Document_Repair_SumNum"].ToString();
        txtSumMoney.Text = dr["OfficeAutomation_Document_Repair_SumMoney"].ToString();
        txtSummarySum.Text = dr["OfficeAutomation_Document_Repair_SummarySum"].ToString();
        //txtTaxBrand.Text = dr["OfficeAutomation_Document_Repair_TaxBrand"].ToString();
        //txtTaxUnit.Text = dr["OfficeAutomation_Document_Repair_TaxUnit"].ToString();
        //txtTaxPrice.Text = dr["OfficeAutomation_Document_Repair_TaxPrice"].ToString();
        //txtTaxNum.Text = dr["OfficeAutomation_Document_Repair_TaxNum"].ToString();
        txtTaxMoney.Text = dr["OfficeAutomation_Document_Repair_TaxMoney"].ToString();
        txtSummaryTax.Text = dr["OfficeAutomation_Document_Repair_SummaryTax"].ToString();
        //txtCouBrand.Text = dr["OfficeAutomation_Document_Repair_CouBrand"].ToString();
        //txtCouUnit.Text = dr["OfficeAutomation_Document_Repair_CouUnit"].ToString();
        //txtCouPrice.Text = dr["OfficeAutomation_Document_Repair_CouPrice"].ToString();
        if (dr["OfficeAutomation_Document_Repair_CouNum"].ToString() == "1")
        {
            txtRealBrand.Visible = false;
            ddlRealBrand.Visible = true;
            rdbCouNum1.Checked = true;
        }
        else if (dr["OfficeAutomation_Document_Repair_CouNum"].ToString() == "2")
        {
            txtRealBrand.Visible = true;
            ddlRealBrand.Visible = false;
            rdbCouNum2.Checked = true;
            txtRealBrand.Text = dr["OfficeAutomation_Document_Repair_RealBrand"].ToString();
        }
        InitDDl(dr["OfficeAutomation_Document_Repair_RealBrand"].ToString());
        txtCouMoney.Text = dr["OfficeAutomation_Document_Repair_CouMoney"].ToString();
        txtSummaryCou.Text = dr["OfficeAutomation_Document_Repair_SummaryCou"].ToString();
        //txtRealBrand.Text = dr["OfficeAutomation_Document_Repair_RealBrand"].ToString();
        txtRealUnit.Text = dr["OfficeAutomation_Document_Repair_RealUnit"].ToString();
        txtRealPrice.Text = dr["OfficeAutomation_Document_Repair_RealPrice"].ToString();
        txtRealNum.Text = dr["OfficeAutomation_Document_Repair_RealNum"].ToString();
        txtRealMoney.Text = dr["OfficeAutomation_Document_Repair_RealMoney"].ToString();
        txtSummaryReal.Text = dr["OfficeAutomation_Document_Repair_SummaryReal"].ToString();
        txtMerchant.Text = dr["OfficeAutomation_Document_Repair_Merchant"].ToString();
        txtConneter.Text = dr["OfficeAutomation_Document_Repair_Conneter"].ToString();
        txtPhone.Text = dr["OfficeAutomation_Document_Repair_Phone"].ToString();
        txtCtime.Text = dr["OfficeAutomation_Document_Repair_Ctime"].ToString();
        txtCname.Text = dr["OfficeAutomation_Document_Repair_Cname"].ToString();
        txtEmail.Text = dr["OfficeAutomation_Document_Repair_Email"].ToString();
        txtTax.Text = dr["OfficeAutomation_Document_Repair_Tax"].ToString();

        SerialNumber = dr["OfficeAutomation_SerialNumber"].ToString();

        ds = da_OfficeAutomation_Document_Repair_Detail_Inherit.SelectByID(ID);
        ...
        else
        {
            ...
            for (int n = 0; n < detailCount; n++)
            {
                ...
                SbJs.Append("$('#txtDetail_No" + i + "').html('" + dr["OfficeAutomation_Document_Repair_Detail_No"] + "');");
                SbJs.Append("$('#txtDetail_Pname" + i + "').val('" + dr["OfficeAutomation_Document_Repair_Detail_Pname"] + "');");
                SbJs.Append("$('#txtDetail_Brand" + i + "').val('" + dr["OfficeAutomation_Document_Repair_Detail_Brand"] + "');");
                SbJs.Append("$('#txtDetail_Unit" + i + "').val('" + dr["OfficeAutomation_Document_Repair_Detail_Unit"] + "');");
                SbJs.Append("$('#txtDetail_Price" + i + "').val('" + dr["OfficeAutomation_Document_Repair_Detail_Price"] + "');");
                SbJs.Append("$('#txtDetail_Num" + i + "').val('" + dr["OfficeAutomation_Document_Repair_Detail_Num"] + "');");
                SbJs.Append("$('#txtDetail_Money" + i + "').val('" + dr["OfficeAutomation_Document_Repair_Detail_Money"] + "');");
                SbJs.Append("$('#txtDetail_Summary" + i + "').val('" + dr["OfficeAutomation_Document_Repair_Detail_Summary"].ToString().Replace("\r\n","") + "');");
            }
        }
    ...
    public void DrawDetailTable(int n)
    {
        ...
        for (int i = 1; i <= n; i++)
        {
            ...
            SbHtml.Append("<td><textarea id=\"txtDetail_Pname" + i + "\" style=\"width:200px\"/></textarea></td>");
            SbHtml.Append("<td><textarea id=\"txtDetail_Brand" + i + "\" style=\"width:50px\"/></textarea></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtDetail_Unit" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtDetail_Price" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtDetail_Num" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtDetail_Money" + i + "\" style=\"width:70px\"/></td>");
            SbHtml.Append("<td><textarea id=\"txtDetail_Summary" + i + "\" style=\"width:90px\"/></textarea></td>");

            //SbHtml.Append("<td colspan=\"3\" style=\"line-height: 30px; padding-left: 10px; text-align: left;\">");
            //SbHtml.Append("项目序号：<span id=\"txtDetail_No" + i + "\">"+i+"</span><br/>");
            //SbHtml.Append("<div><span style=\"vertical-align: top\">项　目：</span><textarea id=\"txtDetail_Pname" + i + "\" style=\"width:505px\"/></textarea></div>");
            //SbHtml.Append("品　牌：<input type=\"text\" id=\"txtDetail_Brand" + i + "\" style=\"width:505px\"/><br/>");
            //SbHtml.Append("单　位：<input type=\"text\" id=\"txtDetail_Unit" + i + "\" style=\"width:200px\"/>　　");
            //SbHtml.Append("单价（元）：<input type=\"text\" id=\"txtDetail_Price" + i + "\" style=\"width:200px\"/><br/>");
            //SbHtml.Append("数　量：<input type=\"text\" id=\"txtDetail_Num" + i + "\" style=\"width:200px\"/>　　");
            //SbHtml.Append("金额（元）：<input type=\"text\" id=\"txtDetail_Money" + i + "\" style=\"width:200px\"/><br/>");
            //SbHtml.Append("<div style=\"margin-bottom: 5px;\"><span style=\"vertical-align: top\">备　注：</span><textarea id=\"txtDetail_Summary" + i + "\" rows=\"6\" style=\"width:505px\"/></textarea></div>");
            //SbHtml.Append("</td>");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_Repair t_OfficeAutomation_Document_Repair = new T_OfficeAutomation_Document_Repair();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "Repair" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 54; //在《申请表字典表》找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_Repair = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_Repair_Inherit.Insert(t_OfficeAutomation_Document_Repair);//插入申请表

                InsertRepairDetail(t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_ID); //新增详情表
                ...
                Common.AddLog(EmployeeID, EmployeeName, 54, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_Repair_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=340px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        if (files.Count > 0)
        {
            ...
            Common.AddLog(EmployeeID, EmployeeName, 54, new Guid(MainID), 8);
        }
        else
            Alert("请勾选文件再下载！");
    }
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DA_OfficeAutomation_Document_Repair_Inherit da_OfficeAutomation_Document_Repair_Inherit = new DA_OfficeAutomation_Document_Repair_Inherit();
        DA_OfficeAutomation_Document_Repair_Detail_Inherit da_OfficeAutomation_Document_Repair_Detail_Inherit = new DA_OfficeAutomation_Document_Repair_Detail_Inherit();

        DataSet ds = da_OfficeAutomation_Document_Repair_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_Repair_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Repair_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_Repair_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_Repair_Apply"]);
                    sbMailBody.Append("<br/>申请分行：" + drRow["OfficeAutomation_Document_Repair_Department"]);
                    sbMailBody.Append("<br/>维修日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_Repair_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>维修商：" + drRow["OfficeAutomation_Document_Repair_Merchant"]);
                    sbMailBody.Append("<br/>联系人：" + drRow["OfficeAutomation_Document_Repair_Conneter"]);
                    sbMailBody.Append("<br/>联系电话：" + drRow["OfficeAutomation_Document_Repair_Phone"]);
                    sbMailBody.Append("<br/>邮箱地址：" + drRow["OfficeAutomation_Document_Repair_Email"]);
                    sbMailBody.Append("<br/>税费：" + drRow["OfficeAutomation_Document_Repair_Tax"]);
                    ...
                    if (hdIsAgree.Value != "0")//同意或其他意见
                    {
                        ...
                        if (da_OfficeAutomation_Flow_Inherit.IsFlowComplete(MainID))
                        {
                            ...
                            //employname = CommonConst.EMP_GMO_NAME + "李蓬桂,陈宇平,何恺鹏,苏秉星,潘焕心";//,陈洁丽
                            //employnames = employname.Split(',');
                            //for (int i = 0; i < employnames.Length; i++)
                            //{
                            //    if (!employeeList.Contains(employnames[i]))
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_Repair_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private T_OfficeAutomation_Document_Repair GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_Repair t_OfficeAutomation_Document_Repair = new T_OfficeAutomation_Document_Repair();
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_ID = UndertakeProjID;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_Apply = EmployeeName;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_ApplyDate = string.IsNullOrEmpty(this.txtApplyDate.Text) ? DateTime.Now : Convert.ToDateTime(this.txtApplyDate.Text); //DateTime.Now;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_Department = txtDepartment.Text;

        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_SumBrand = "";
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_SumUnit = "";
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_SumPrice = "";
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_SumNum = "";
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_SumMoney = txtSumMoney.Text; //
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_SummarySum = txtSummarySum.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_TaxBrand = "";
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_TaxUnit = "";
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_TaxPrice = "";
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_TaxNum = "";
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_TaxMoney = txtTaxMoney.Text; //
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_SummaryTax = txtSummaryTax.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_CouBrand = "";
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_CouUnit = "";
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_CouPrice = "";
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_CouNum = rdbCouNum1.Checked ? "1" : rdbCouNum2.Checked ? "2" : "0";
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_CouMoney = txtCouMoney.Text; //
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_SummaryCou = txtSummaryCou.Text;
        if(rdbCouNum1.Checked)
            t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_RealBrand = ddlRealBrand.SelectedValue;
        else
            t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_RealBrand = txtRealBrand.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_RealUnit = txtRealUnit.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_RealPrice = txtRealPrice.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_RealNum = txtRealNum.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_RealMoney = txtRealMoney.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_SummaryReal = txtSummaryReal.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_Merchant = txtMerchant.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_Conneter = txtConneter.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_Phone = txtPhone.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_Ctime = txtCtime.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_Cname = txtCname.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_Email = txtEmail.Text;
        t_OfficeAutomation_Document_Repair.OfficeAutomation_Document_Repair_Tax = txtTax.Text;

        return t_OfficeAutomation_Document_Repair;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_Repair_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Repair_ID"].ToString();

        t_OfficeAutomation_Document_Repair = GetModelFromPage(new Guid(ID));

        string apply = EmployeeName;
        string depname = txtDepartment.Text;
        string summary = txtApplyID.Text;
        string applydate = "";
        string mainid = MainID;

        da_OfficeAutomation_Main_Inherit.UpdateMain(mainid, depname, apply, applydate, summary);
        da_OfficeAutomation_Document_Repair_Inherit.Update(t_OfficeAutomation_Document_Repair); //修改申请表

        //先删除后增加详情表
        DA_OfficeAutomation_Document_Repair_Detail_Inherit da_OfficeAutomation_Document_Repair_Detail_Inherit = new DA_OfficeAutomation_Document_Repair_Detail_Inherit();
        da_OfficeAutomation_Document_Repair_Detail_Inherit.Delete(ID);
        InsertRepairDetail(new Guid(ID));

        Common.AddLog(EmployeeID, EmployeeName, 54, new Guid(MainID), 2); //日志，修改申请表
    }
    ...
    /// 新增详情表
    /// </summary>
    /// <param name="gRepairID"></param>
    private void InsertRepairDetail(Guid gRepairID)
    {
        if (hdDetail.Value == "")
            return;

        T_OfficeAutomation_Document_Repair_Detail t_OfficeAutomation_Document_Repair_Detail;
        DA_OfficeAutomation_Document_Repair_Detail_Inherit da_OfficeAutomation_Document_Repair_Detail_Inherit = new DA_OfficeAutomation_Document_Repair_Detail_Inherit();
        ...
        try
        {
            for (int i = 0; i < details.Length; i++)
            {
                ...
                //if (detail[0] == "")
                //    continue;
                t_OfficeAutomation_Document_Repair_Detail = new T_OfficeAutomation_Document_Repair_Detail();
                t_OfficeAutomation_Document_Repair_Detail.OfficeAutomation_Document_Repair_Detail_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_Repair_Detail.OfficeAutomation_Document_Repair_Detail_MainID = gRepairID;
                t_OfficeAutomation_Document_Repair_Detail.OfficeAutomation_Document_Repair_Detail_No = detail[0];

                t_OfficeAutomation_Document_Repair_Detail.OfficeAutomation_Document_Repair_Detail_Pname = detail[1];
                t_OfficeAutomation_Document_Repair_Detail.OfficeAutomation_Document_Repair_Detail_Brand = detail[2];
                t_OfficeAutomation_Document_Repair_Detail.OfficeAutomation_Document_Repair_Detail_Unit = detail[3];
                t_OfficeAutomation_Document_Repair_Detail.OfficeAutomation_Document_Repair_Detail_Price = detail[4];
                t_OfficeAutomation_Document_Repair_Detail.OfficeAutomation_Document_Repair_Detail_Num = detail[5];
                t_OfficeAutomation_Document_Repair_Detail.OfficeAutomation_Document_Repair_Detail_Money = detail[6];
                t_OfficeAutomation_Document_Repair_Detail.OfficeAutomation_Document_Repair_Detail_Summary = detail[7];

                da_OfficeAutomation_Document_Repair_Detail_Inherit.Insert(t_OfficeAutomation_Document_Repair_Detail);
            }
        }
        catch(Exception ee)
        {
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite59"] = "1";
        Response.Write("<script>window.open('Apply_Repair_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    #region 自动导入详情表
    /// <summary>
    /// 自动导入详情表
    ...
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("新增、维修项目报价（结算）明细表.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_Repair_Inherit da_OfficeAutomation_Document_Repair_Inherit = new DA_OfficeAutomation_Document_Repair_Inherit();
            DataSet ds = da_OfficeAutomation_Document_Repair_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Repair_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "11");
            da_OfficeAutomation_Flow_Inherit.InsertFlowsByAlter(MainID, 5); //在不同的表中要修改，开发新表时要注意
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_Repair_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=340px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    protected void rdbCouNum1_CheckedChanged(object sender, EventArgs e)
    {
        if (rdbCouNum1.Checked)
        {
            if (ddlRealBrand.SelectedItem.Text != "-请选择-")
            {
                DataSet ds = new DataSet();
                DA_Dic_OfficeAutomation_Supplier_Operate da_Dic_OfficeAutomation_Supplier_Operate = new DA_Dic_OfficeAutomation_Supplier_Operate();
                ds = da_Dic_OfficeAutomation_Supplier_Operate.SelectSupplyByName(ddlRealBrand.SelectedItem.Text);
                txtRealUnit.Text = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Supplier_Conneter"].ToString();
                txtRealPrice.Text = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Supplier_Telephone"].ToString();
                txtRealNum.Text = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Supplier_Email"].ToString();
            }
            ddlRealBrand.Visible = true;
            txtRealBrand.Visible = false;
        }
    ...
    protected void ddlRealBrand_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlRealBrand.SelectedItem.Text != "-请选择-")
        {
            DataSet ds = new DataSet();
