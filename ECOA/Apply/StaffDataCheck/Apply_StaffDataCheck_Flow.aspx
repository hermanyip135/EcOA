<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_StaffDataCheck_Flow.aspx.cs" Inherits="Apply_StaffDataCheck_Apply_StaffDataCheck_Flow" %>
    ...
    <div class="flow">
        ...
        <div class="row clearfix">
            <div class="item REQUIRED">
                ...
                <span>资料核查人</span>&nbsp;<input class="auditor" name="Auditor" type="text" Idx="1" />
...
<%--            <div class="item REQUIRED">
                <input class="addbtn" type="image" onclick="flowon(this); return false;" src="/Images/add.png" />
                <span>资料复核人</span>&nbsp;<input class="auditor" name="Auditor" type="text" Idx="2" />
                <input name="AuditorID" type="hidden" />
                <a class="cancelbtn" href="javascript:;" onclick="delon(this);return false;">取消</a>
            </div>
            <img class="forward" src="/Images/forward.png" />
        ...
        <div class="row clearfix">
            <div class="item REQUIRED">
                <input class="addbtn" type="image" onclick="flowon(this); return false;" src="/Images/add.png" />
                <span>区域负责人</span>&nbsp;<input class="auditor" name="Auditor" type="text" Idx="7" />
                <input name="AuditorID" type="hidden" />
                <a class="cancelbtn" href="javascript:;" onclick="delon(this);return false;">取消</a>
            </div>
            <div class="clearfix"></div>
