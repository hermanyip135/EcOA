...
public partial class Apply_ITSpecialModify_Apply_ITSpecialModify_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    public void LoadPage()
    {
        ...
        ID = dr["OfficeAutomation_Document_ITSpecialModify_ID"].ToString();
        this.txtDispatchDepartment.Text = dr["OfficeAutomation_Document_ITSpecialModify_Department"].ToString();
        this.hdDispatchDepartmentID.Value = dr["OfficeAutomation_Document_ITSpecialModify_DepartmentID"].ToString();
        this.txtApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ITSpecialModify_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        this.txtHopeDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ITSpecialModify_HopeDate"].ToString()).ToString("yyyy-MM-dd");
        this.txtApplicant.Text = dr["OfficeAutomation_Document_ITSpecialModify_Apply"].ToString();
        ApplyN = dr["OfficeAutomation_Document_ITSpecialModify_Apply"].ToString();
        DropDownListBind(ddlSystemName, dsSoftSystem.Tables[0], "OfficeAutomation_SoftSystem_ID", "OfficeAutomation_SoftSystem_Name", dr["OfficeAutomation_Document_ITSpecialModify_SystemName"].ToString());
        this.txtReqContent.Text = dr["OfficeAutomation_Document_ITSpecialModify_ReqContent"].ToString();
        this.txtApplyDepHeader.Text = dr["OfficeAutomation_Document_ITSpecialModify_ApplyDepHeader"].ToString();
        this.txtFollower.Text = dr["OfficeAutomation_Document_ITSpecialModify_Follower"].ToString();
        this.txtPlanTime.Text = dr["OfficeAutomation_Document_ITSpecialModify_PlanTime"].ToString();
        this.txtTransferRemark.Text = dr["OfficeAutomation_Document_ITSpecialModify_TransferRemark"].ToString();
        ...
        if (EmployeeName == dr["OfficeAutomation_Document_ITSpecialModify_Apply"].ToString())
        {
        ...
        if (EmployeeName == dr["OfficeAutomation_Document_ITSpecialModify_Apply"].ToString() || Common.IsShowBtnUpload(EmployeeID, MainID))
        {
            sbJS.Append("$(\"#btnUpload\").show();");
        }
        #endregion
        ...
        if (dr["OfficeAutomation_Main_FlowStateID"].ToString() == "3" && dr["OfficeAutomation_Document_ITSpecialModify_Follower"].ToString().Contains(EmployeeName))
        {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_ITSpecialModify t_OfficeAutomation_Document_ITSpecialModify = new T_OfficeAutomation_Document_ITSpecialModify();
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "ITSpecialModify" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 87;
                ...
                t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_MainID = t_OfficeAutomation_Main.OfficeAutomation_Main_ID;
                t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_DepartmentID = new Guid(this.hdDispatchDepartmentID.Value);
                t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_Department = this.txtDispatchDepartment.Text;
                t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_Apply = this.txtApplicant.Text;
                t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_ApplyDepHeader = this.txtApplyDepHeader.Text;
                t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_ApplyDate = DateTime.Parse(this.txtApplyDate.Text);
                t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_HopeDate = DateTime.Parse(this.txtHopeDate.Text);
                t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_SystemName = this.ddlSystemName.SelectedValue;
                t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_ReqContent = this.txtReqContent.Text;

                t_OfficeAutomation_Main.OfficeAutomation_Main_Apply = t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_Apply;
                t_OfficeAutomation_Main.OfficeAutomation_Main_Department = t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_Department;
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = this.ddlSystemName.SelectedItem.Text;
                t_OfficeAutomation_Main.OfficeAutomation_Main_ApplyDate = t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_ApplyDate;

                da_OfficeAutomation_Main_Inherit.Insert(t_OfficeAutomation_Main);//插入公文主表
                da_OfficeAutomation_Document_ITSpecialModify_Inherit.Insert(t_OfficeAutomation_Document_ITSpecialModify);//插入软件系统开发需求申请表
                ...
                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");"
                    + "var win=window.showModalDialog(\"Apply_ITSpecialModify_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=250px\");"
                    + "if(win=='success'){alert('软件系统特殊修改申请创建成功，已发通知给部门负责人提醒审批，请耐心等待。');window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
                ...
                if (Purview.Contains("OA_ITPower_001"))//是否有编辑权限
                {
                    DataSet ds = new DataSet();
                    ds = da_OfficeAutomation_Document_ITSpecialModify_Inherit.SelectByMainID(MainID);
                    ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ITSpecialModify_ID"].ToString();

                    t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_ID = new Guid(ID);
                    t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_DepartmentID = new Guid(this.hdDispatchDepartmentID.Value);
                    t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_Department = this.txtDispatchDepartment.Text;
                    t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_Apply = this.txtApplicant.Text;
                    t_OfficeAutomation_Document_ITSpecialModify.OfficeAutomation_Document_ITSpecialModify_ApplyDepHeader = this.txtApplyDepHeader.Text;
                    ...
                    da_OfficeAutomation_Document_ITSpecialModify_Inherit.Update(t_OfficeAutomation_Document_ITSpecialModify);//修改软件系统开发需求申请表
    ...
    protected void btnTransmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ITSpecialModify_Apply"].ToString();
            ...
            if (ds != null && ds.Tables != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow))
                {
                    ...
                    da_OfficeAutomation_Document_ITSpecialModify_Inherit.UpdateTransferRemarkByID(ID, this.txtTransferRemark.Text);
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.open('Apply_ITSpecialModify_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_ITSpecialModify_Inherit da_OfficeAutomation_Document_ITSpecialModify_Inherit = new DA_OfficeAutomation_Document_ITSpecialModify_Inherit();
            DataSet ds = da_OfficeAutomation_Document_ITSpecialModify_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ITSpecialModify_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
            string department = drRow["OfficeAutomation_Document_ITSpecialModify_Department"].ToString();
