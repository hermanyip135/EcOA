<%@ Page Title="软件系统特殊修改申请表 - 广州中原电子审批系统" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Apply_ITSpecialModify_Detail.aspx.cs" Inherits="Apply_ITSpecialModify_Apply_ITSpecialModify_Detail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        var follower=$('#<%=txtFollower.ClientID %>').val();
                if(idx=='4' && $.trim(follower)!=''){
                    $.ajax({
                        ...
                        type: "post",
                        dataType: "text",
                        data: "action=saveITSpecialModifyfollower&sysreqid=<%=ID %>&follower=" + follower+"&apply=" + $.trim($("#<%=txtApplicant.ClientID %>").val()),
                        success: function() {}
                    })
                }
        ...
        function editflow(){
            ...
            if(win=='success')
                window.location="Apply_ITSpecialModify_Detail.aspx?MainID=<%=MainID %>";
        }
        ...
        function savePlanTime() {
            ...
            { 
                $.ajax({
                    ...
                    type: "post",
                    dataType: "text",
                    data: "action=saveITSpecialModifyplantime&sysreqid=<%=ID %>&plantime=" + plantime + "&follower=<%=EmployeeName %>&apply=" + $.trim($("#<%=txtApplicant.ClientID %>").val()),
        ...
        <div style='text-align:center'>            
            ...
            <table id="tbAround"  width='640px'>
                ...
                <tr>
                    ...
                    <td class="auto-style2"><asp:TextBox ID="txtDispatchDepartment" runat="server" Width="184px"></asp:TextBox><asp:HiddenField ID="hdDispatchDepartmentID" runat="server" /></td>
                    <td class="auto-style3">申请时间</td>
                    <td class="auto-style4"><asp:TextBox ID="txtApplyDate" runat="server" Width="150px"></asp:TextBox></td>
                </tr>	
                <tr>
                    <td>系统名称</td>
                    <td class="tl PL5">
