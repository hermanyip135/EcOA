<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_ITSpecialModify_Flow.aspx.cs" Inherits="Apply_ITSpecialModify_Apply_ITSpecialModify_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
    ...
    <script type="text/javascript">
        ...
        function save() {        
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "text",
                data: 'action=saveITSpecialModifyFlow&id=<%=EmployeeID %>&name=<%=EmployeeName %>&purview=<%=Purview %>&mainid=<%=MainID %>&content=' + content,
