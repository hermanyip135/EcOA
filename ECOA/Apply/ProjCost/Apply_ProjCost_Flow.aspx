<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_ProjCost_Flow.aspx.cs" Inherits="Apply_ProjCost_Apply_ProjCost_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
    ...
    <form id="form1" runat="server">
        <div>
            <div class="flow">
                ...
                参照部门或组别：<input type="text" id="txtDepartment" style="width: 200px;" /><br />
                <br />
                <div id="divIDx1" class='item'>
                    <input id="btnIDx1" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(1);" /><label id="lblIDx1" for='btnIDx1'>部门负责人</label></div>
                <div id="divTxtIDx1" class='item' style="display: none;">
                    <input type="text" id="txtIDx1" style="width: 200px;" /><input id="hdIDx1" type="hidden" /></div>
                <br />
                <br />
