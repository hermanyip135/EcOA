<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_SolHold_Flow.aspx.cs" Inherits="Apply_SolHold_Apply_SolHold_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
...
<body>
    <form id="form1" runat="server">
        <div class="flow">
            <div class="flow">
                ...
                <div class="row clearfix">
                    ...
                    <div class="item">
                        <input class="addbtn" type="image" onclick="flowon(this); return false;" src="/Images/add.png" />
                        <span>部门主管</span>&nbsp;<input class="auditor" name="Auditor" type="text" idx="2" />
                        <input name="AuditorID" type="hidden" />
                        <a class="cancelbtn" href="javascript:;" onclick="delon(this);return false;">取消</a>
                    </div>
                    <img class="forward" src="/Images/forward.png" />
                ...
                <div class="row clearfix">
                    <div class="item REQUIRED">
                        <input class="addbtn" type="image" onclick="flowon(this); return false;" src="/Images/add.png" />
                        <span>负责人（总监）</span>&nbsp;<input class="auditor" name="Auditor" type="text" idx="3" />
                        <input name="AuditorID" type="hidden" />
                        <a class="cancelbtn" href="javascript:;" onclick="delon(this);return false;">取消</a>
                    </div>
                    <div class="clearfix"></div>
        ...
        <div class="flow">
            <input type="button" id="Button1" value="保存并通知审批" onclick="save(this);return false;" class="btn button" />
        </div>
    </form>
    <script type="text/javascript">
        PageInit();
