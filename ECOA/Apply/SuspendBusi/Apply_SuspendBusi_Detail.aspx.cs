...
public partial class Apply_SuspendBusi_Apply_SuspendBusi_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite23"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite23"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_SuspendBusi_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_SuspendBusi_ID"].ToString();

        string applicant = dr["OfficeAutomation_Document_SuspendBusi_Apply"].ToString();
        ApplyN = applicant;
        lblApply.Text = applicant;
        txtDepartment.Value = dr["OfficeAutomation_Document_SuspendBusi_Department"].ToString();
        lblApplyID.Text = dr["OfficeAutomation_Document_SuspendBusi_ApplyID"].ToString();
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_SuspendBusi_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtReplyFax.Text = dr["OfficeAutomation_Document_SuspendBusi_ReplyFax"].ToString();
        txtReplyPhone.Text = dr["OfficeAutomation_Document_SuspendBusi_ReplyPhone"].ToString();
        InitListControler(dr["OfficeAutomation_Document_SuspendBusi_DepartmentTypeID"].ToString(), dr["OfficeAutomation_Document_SuspendBusi_MajordomoID"].ToString());
        txtDepartmentName.Text = dr["OfficeAutomation_Document_SuspendBusi_DepartmentName"].ToString();
        txtDepartmentAddress.Text = dr["OfficeAutomation_Document_SuspendBusi_DepartmentAddress"].ToString();
        txtExpireDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_SuspendBusi_ExpireDate"].ToString()).ToString("yyyy-MM-dd");
        txtStartDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_SuspendBusi_StartDate"].ToString()).ToString("yyyy-MM-dd");
        txtEndDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_SuspendBusi_EndDate"].ToString()).ToString("yyyy-MM-dd");

        txtRent.Text = dr["OfficeAutomation_Document_SuspendBusi_Rent"].ToString();
        txtSuspensionBeginDate.Text = dr["OfficeAutomation_Document_SuspendBusi_SuspensionBeginDate"].ToString();
        txtSuspensionEndDate.Text = dr["OfficeAutomation_Document_SuspendBusi_SuspensionEndDate"].ToString();
        txtSuspensionMonth.Text = dr["OfficeAutomation_Document_SuspendBusi_SuspensionMonth"].ToString();
        txtSEMonth.Text = dr["OfficeAutomation_Document_SuspendBusi_SEMonth"].ToString();
        if (dr["OfficeAutomation_Document_SuspendBusi_Default"].ToString() == "1")
            rdbDefault1.Checked = true;
        else if (dr["OfficeAutomation_Document_SuspendBusi_Default"].ToString() == "2")
            rdbDefault2.Checked = true;
        if (dr["OfficeAutomation_Document_SuspendBusi_Deposit"].ToString() == "1")
            rdbDeposit1.Checked = true;
        else if (dr["OfficeAutomation_Document_SuspendBusi_Deposit"].ToString() == "2")
            rdbDeposit2.Checked = true;
        txtMoneyD1.Text = dr["OfficeAutomation_Document_SuspendBusi_MoneyD1"].ToString();
        if (dr["OfficeAutomation_Document_SuspendBusi_Aeposit"].ToString() == "1")
            rdbAeposit1.Checked = true;
        else if (dr["OfficeAutomation_Document_SuspendBusi_Aeposit"].ToString() == "2")
            rdbAeposit2.Checked = true;
        txtMoneyD2.Text = dr["OfficeAutomation_Document_SuspendBusi_MoneyD2"].ToString();
        if (dr["OfficeAutomation_Document_SuspendBusi_IsD"].ToString() == "1")
            rdbIsD1.Checked = true;
        else if (dr["OfficeAutomation_Document_SuspendBusi_IsD"].ToString() == "2")
            rdbIsD2.Checked = true;
        txtMoneyD3.Text = dr["OfficeAutomation_Document_SuspendBusi_MoneyD3"].ToString();
        txtExpireEndDate.Text = dr["OfficeAutomation_Document_SuspendBusi_ExpireEndDate"].ToString();

        txtReason.Text = dr["OfficeAutomation_Document_SuspendBusi_Reason"].ToString();
        switch (dr["OfficeAutomation_Document_SuspendBusi_LeaseStateID"].ToString())
        {
            case "1":
                rdbLeaseState1.Checked = true;
                break;
            case "2":
                rdbLeaseState2.Checked = true;
                break;
        }
        if (dr["OfficeAutomation_Document_SuspendBusi_AssetHandleIDs"].ToString().Contains("1"))
        {
            cbxAssetHandle1.Checked = true;
        }
        if (dr["OfficeAutomation_Document_SuspendBusi_AssetHandleIDs"].ToString().Contains("2"))
        {
            cbxAssetHandle2.Checked = true;
        }
        if (dr["OfficeAutomation_Document_SuspendBusi_AssetHandleIDs"].ToString().Contains("3"))
        {
            cbxAssetHandle3.Checked = true;
        }
        txtAssetHandleOther.Text = dr["OfficeAutomation_Document_SuspendBusi_AssetHandleOther"].ToString();
        switch (dr["OfficeAutomation_Document_SuspendBusi_InsureHandleID"].ToString())
        {
            case "1":
                rdbInsureHandle1.Checked = true;
                break;
            case "2":
                rdbInsureHandle2.Checked = true;
                break;
        }
        switch (dr["OfficeAutomation_Document_SuspendBusi_PhoneHandleID"].ToString())
        {
            case "1":
        ...
        rdbIsFlyLine.Checked = dr["OfficeAutomation_Document_SuspendBusi_IsFlyLine"].ToString() == "True";
        txtFlyLineFrom.Text = dr["OfficeAutomation_Document_SuspendBusi_FlyLineFrom"].ToString();
        txtFlyLineTo.Text = dr["OfficeAutomation_Document_SuspendBusi_FlyLineTo"].ToString();
        switch (dr["OfficeAutomation_Document_SuspendBusi_RayHandleID"].ToString())
        {
            case "1":
                rdbRayHandle1.Checked = true;
                break;
            case "2":
                rdbRayHandle2.Checked = true;
                break;
        }
        switch (dr["OfficeAutomation_Document_SuspendBusi_ADHandleID"].ToString())
        {
            case "1":
                rdbADHandle1.Checked = true;
                break;
            case "2":
                rdbADHandle2.Checked = true;
                break;
        }
        switch (dr["OfficeAutomation_Document_SuspendBusi_StationeryHandleID"].ToString())
        {
            case "1":
                rdbStationeryHandle1.Checked = true;
                break;
            case "2":
                rdbStationeryHandle2.Checked = true;
                break;
        }
        txtPaymentAmortizeEndDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_SuspendBusi_PaymentAmortizeEndDate"].ToString()).ToString("yyyy-MM-dd");
        txtPaymentAmortizeRemaining.Text = dr["OfficeAutomation_Document_SuspendBusi_PaymentAmortizeRemaining"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_SuspendBusi t_OfficeAutomation_Document_SuspendBusi = new T_OfficeAutomation_Document_SuspendBusi();
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "SuspendBusi" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 20;
                ...
                t_OfficeAutomation_Document_SuspendBusi = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_SuspendBusi_Inherit.Add(t_OfficeAutomation_Document_SuspendBusi);//插入申请表
                ...
                Common.AddLog(EmployeeID, EmployeeName, 24, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_SuspendBusi_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    private T_OfficeAutomation_Document_SuspendBusi GetModelFromPage(Guid SuspendBusiID)
    {
        T_OfficeAutomation_Document_SuspendBusi t_OfficeAutomation_Document_SuspendBusi = new T_OfficeAutomation_Document_SuspendBusi();
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_ID = SuspendBusiID;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_Apply = EmployeeName;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_ApplyID = lblApplyID.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_Department = txtDepartment.Value;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_ReplyPhone = txtReplyPhone.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_ReplyFax = txtReplyFax.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_DepartmentTypeID = int.Parse(ddlDepartmentType.SelectedValue);
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_MajordomoID = int.Parse(ddlMajordomo.SelectedValue);
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_DepartmentName = txtDepartmentName.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_DepartmentAddress = txtDepartmentAddress.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_ExpireDate = DateTime.Parse(txtExpireDate.Text);
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_StartDate = DateTime.Parse(txtStartDate.Text);
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_EndDate = DateTime.Parse(txtEndDate.Text);

        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_Rent = txtRent.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_SuspensionBeginDate = txtSuspensionBeginDate.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_SuspensionEndDate = txtSuspensionEndDate.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_SuspensionMonth = txtSuspensionMonth.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_SEMonth = txtSEMonth.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_Default = rdbDefault1.Checked ? "1" : rdbDefault2.Checked ? "2" : "0";
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_Deposit = rdbDeposit1.Checked ? "1" : rdbDeposit2.Checked ? "2" : "0";
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_MoneyD1 = txtMoneyD1.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_Aeposit = rdbAeposit1.Checked ? "1" : rdbAeposit2.Checked ? "2" : "0";
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_MoneyD2 = txtMoneyD2.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_IsD = rdbIsD1.Checked ? "1" : rdbIsD2.Checked ? "2" : "0";
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_MoneyD3 = txtMoneyD3.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_ExpireEndDate = txtExpireEndDate.Text;

        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_Reason = txtReason.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_LeaseStateID = rdbLeaseState1.Checked ? 1 : 2;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_AssetHandleIDs = (cbxAssetHandle1.Checked ? "1" : "") + (cbxAssetHandle2.Checked ? "2" : "") + (cbxAssetHandle3.Checked ? "3" : "");
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_AssetHandleOther = txtAssetHandleOther.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_PhoneHandleID = rdbPhoneHandle1.Checked ? 1 : 2;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_InsureHandleID = rdbInsureHandle1.Checked ? 1 : 2;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_IsFlyLine = rdbIsFlyLine.Checked;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_FlyLineFrom = txtFlyLineFrom.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_FlyLineTo = txtFlyLineTo.Text;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_RayHandleID = rdbRayHandle1.Checked ? 1 : 2;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_ADHandleID = rdbADHandle1.Checked ? 1 : 2;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_StationeryHandleID = rdbStationeryHandle1.Checked ? 1 : 2;
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_PaymentAmortizeEndDate = DateTime.Parse(txtPaymentAmortizeEndDate.Text);
        t_OfficeAutomation_Document_SuspendBusi.OfficeAutomation_Document_SuspendBusi_PaymentAmortizeRemaining = txtPaymentAmortizeRemaining.Text;

        return t_OfficeAutomation_Document_SuspendBusi;
    }
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_SuspendBusi_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_SuspendBusi_ID"].ToString();
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_SuspendBusi_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_SuspendBusi_DepartmentName"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>区域：" + drRow["OfficeAutomation_DepartmentType_Name"]);
                    sbMailBody.Append("<br/>区域负责人：" + drRow["OfficeAutomation_Majordomo_Name"]);
                    sbMailBody.Append("<br/>分行名称：" + drRow["OfficeAutomation_Document_SuspendBusi_DepartmentName"]);
                    sbMailBody.Append("<br/>分行地址：" + drRow["OfficeAutomation_Document_SuspendBusi_DepartmentAddress"]);
                    sbMailBody.Append("<br/>租约到" + DateTime.Parse(drRow["OfficeAutomation_Document_SuspendBusi_ExpireDate"].ToString()).ToString("yyyy-MM-dd") + "届满");
                    sbMailBody.Append("<br/>分行暂停营业起止日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_SuspendBusi_StartDate"].ToString()).ToString("yyyy-MM-dd") + "~" + DateTime.Parse(drRow["OfficeAutomation_Document_SuspendBusi_EndDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>分行暂停营业原因：" + drRow["OfficeAutomation_Document_SuspendBusi_Reason"]);
                    sbMailBody.Append("<br/>分行转租/暂停营业期间店铺状态：");
                    sbMailBody.Append("<br/>租赁情况：" + (drRow["OfficeAutomation_Document_SuspendBusi_LeaseStateID"].ToString() == "1" ? "转租" : (drRow["OfficeAutomation_Document_SuspendBusi_LeaseStateID"].ToString() == "2" ? "分租" : "停机留号")));
                    string assethandleids = drRow["OfficeAutomation_Document_SuspendBusi_AssetHandleIDs"].ToString();
                    ...
                    if (assethandleids.Contains("3"))
                        sbMailBody.Append("<br/>其他说明：" + drRow["OfficeAutomation_Document_SuspendBusi_AssetHandleOther"]);
                    sbMailBody.Append("<br/>保险处理：" + (drRow["OfficeAutomation_Document_SuspendBusi_InsureHandleID"].ToString() == "1" ? "继续购买" : "停止保险"));
                    sbMailBody.Append("<br/>电话处理：" + (drRow["OfficeAutomation_Document_SuspendBusi_PhoneHandleID"].ToString() == "1" ? "全部撤销" : "停机留号"));
                    sbMailBody.Append("<br/>是否飞线：" + (drRow["OfficeAutomation_Document_SuspendBusi_IsFlyLine"].ToString() == "True" ? ("是，从" + drRow["OfficeAutomation_Document_SuspendBusi_FlyLineFrom"] + "至" + drRow["OfficeAutomation_Document_SuspendBusi_FlyLineTo"]) : "否"));
                    sbMailBody.Append("<br/>光纤：" + (drRow["OfficeAutomation_Document_SuspendBusi_RayHandleID"].ToString() == "1" ? "暂停服务" : "撤销"));
                    sbMailBody.Append("<br/>AD：" + (drRow["OfficeAutomation_Document_SuspendBusi_ADHandleID"].ToString() == "1" ? "暂停服务" : "撤销"));
                    sbMailBody.Append("<br/>文具、印刷品、复印机、饮用水等配置：" + (drRow["OfficeAutomation_Document_SuspendBusi_StationeryHandleID"].ToString() == "1" ? "暂停服务" : "撤销"));
                    ...
                    if (hdIsAgree.Value != "0")//同意或其他意见
                    {
                        ...
                        {
                            //审批流程完成，通知申请人
                            msnBody = "您好，" + apply + "：关于“" + department + "" + documentName + " ”，公司已审批完毕并同意通过，详细批复意见请查阅申请表，"
                                + "暂停营业时间为" + DateTime.Parse(drRow["OfficeAutomation_Document_SuspendBusi_StartDate"].ToString()).ToString("yyyy-MM-dd")
                                + "~" + DateTime.Parse(drRow["OfficeAutomation_Document_SuspendBusi_EndDate"].ToString()).ToString("yyyy-MM-dd")
                                + "，请相关部门配合该铺暂停营业期间物质配送的及电信业务的停办处理，谢谢！<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
                            email = apply;
                            ...
                            foreach (DataRow dr in dsFlow.Tables[0].Rows)
                            {
                                ...
                                for (int i = 0; i < employnames.Length; i++)
                                {
                                    ...
                                    {
                                        msnBody = "您好，" + employnames[i] + "：关于“" + department + "" + documentName + " ”，公司已审批完毕并同意通过，详细批复意见请查阅申请表，"
                                            + "暂停营业时间为" + DateTime.Parse(drRow["OfficeAutomation_Document_SuspendBusi_StartDate"].ToString()).ToString("yyyy-MM-dd")
                                            + "~" + DateTime.Parse(drRow["OfficeAutomation_Document_SuspendBusi_EndDate"].ToString()).ToString("yyyy-MM-dd")
                                            + "，请相关部门配合该铺暂停营业期间物质配送的及电信业务的停办处理，谢谢！<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
                                        email = employnames[i];
                            ...
                            string employemail = CommonConst.EMAILLIST_ADMIN + "," + sg +",沈凯飞,梁文英,潘海燕,源浩灵,黄志超,黄洁珍,张绍欣,黄瑛,叶凤霞,黄轩明";
                            string[] employemails = employemail.Split(',');
                            for (int i = 0; i < employemails.Length; i++)
                            {
                                if (!employeeList.Contains(employemails[i]))
                                {
                                    msnBody = "您好：关于“" + department + "" + documentName + " ”，公司已审批完毕并同意通过，详细批复意见请查阅申请表，"
                                        + "暂停营业时间为" + DateTime.Parse(drRow["OfficeAutomation_Document_SuspendBusi_StartDate"].ToString()).ToString("yyyy-MM-dd")
                                        + "~" + DateTime.Parse(drRow["OfficeAutomation_Document_SuspendBusi_EndDate"].ToString()).ToString("yyyy-MM-dd")
                                        + "，请相关部门配合该铺暂停营业期间物质配送的及电信业务的停办处理，谢谢！" + sagree + "<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_SuspendBusi_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_SuspendBusi_ID"].ToString();

        t_OfficeAutomation_Document_SuspendBusi = GetModelFromPage(new Guid(ID));
        string apply = "";
        ...
        da_OfficeAutomation_Document_SuspendBusi_Inherit.Update(t_OfficeAutomation_Document_SuspendBusi);//修改申请表

        Common.AddLog(EmployeeID, EmployeeName, 24, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite23"] = "1";
        Response.Write("<script>window.open('Apply_SuspendBusi_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("暂停营业申请表.pdf"));//强制下载 
    ...
    protected void btnSaveLogisticsFlow_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_SuspendBusi_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_SuspendBusi_ID"].ToString(); //在不同的表要注意修改
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_SuspendBusi_Inherit da_OfficeAutomation_Document_SuspendBusi_Inherit = new DA_OfficeAutomation_Document_SuspendBusi_Inherit();
            DataSet ds = da_OfficeAutomation_Document_SuspendBusi_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_SuspendBusi_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
            string department = drRow["OfficeAutomation_Document_SuspendBusi_Department"].ToString();
            string applyUrl = Page.Request.Url.ToString();
            applyUrl = applyUrl.Substring(applyUrl.IndexOf("/Apply/"));
            applyUrl = "内部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["InternalURL"] + applyUrl;
                        //+ "<br />外部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["ExternalURL"] + applyUrl;
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_SuspendBusi_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_SuspendBusi_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_SuspendBusi_Inherit();
