			...
			<table id="tbAround"  width='640px'>
                ...
                <tr>
					...
					<td class="tl PL10">
                        ...
                        <span>共<asp:TextBox ID="txtSEMonth" runat="server" Width="65px"></asp:TextBox>个月</span>
					</td>
                ...
                <tr id="trManager1" class="noborder" style="height: 85px; border-top:1px solid #000000;">
					...
					<td colspan="3" class="tl PL10">
						...
						<textarea id="txtIDx1" style="width: 98%; overflow: auto; height: 86px;"></textarea><input type="button" id="btnSignIDx1" value="签名" onclick="sign('1')" style="display: none;" />
