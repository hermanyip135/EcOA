	...
	<div style='text-align: center; width: 840px; margin: 0 auto;'>
		...
		<div style='text-align: center'>
			...
			<table id="tbAround"  width='640px'>
                ...
                <tr>
					<td>租约届满日期</td>
					<td class="tl PL10"><asp:TextBox ID="txtExpireDate" runat="server" Width="80px"></asp:TextBox></td>
                    <td>分行暂停营业<br />起止日期</td>
					<td class="tl PL10"><asp:TextBox ID="txtStartDate" runat="server" Width="80px"></asp:TextBox>~<asp:TextBox ID="txtEndDate" runat="server" Width="80px"></asp:TextBox></td>
				</tr>
                <tr>
                    <td>暂停营业原因</td>
                ...
                <tr id="trManager1" class="noborder" style="height: 85px; border-top:1px solid #000000;">
					...
					<td colspan="3" class="tl PL10">
						...
						<textarea id="txtIDx1" style="width: 98%; overflow: auto; height: 86px;"></textarea><input type="button" id="btnSignIDx1" value="签名" onclick="sign('1')" style="display: none;" /><div class="signdate">日期：<span id="spanDateIDx1">_________</span></div>
					</td>
				</tr>
				<tr id="trManager2" class="noborder" style="height: 85px;">
					...
					<td colspan="3" class="tl PL10">
						...
						<textarea id="txtIDx2" style="width: 98%; overflow: auto; height: 86px;"></textarea><input type="button" id="btnSignIDx2" value="签名" onclick="sign('2')" style="display: none;" /><div class="signdate">日期：<span id="spanDateIDx2">_________</span></div>
					</td>
				</tr>
