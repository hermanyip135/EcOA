						...
						<table class='sample tc' width='100%'>
                            <tr>
                                <td colspan="6" class="tl PL10" style="font-weight:bold;">
                                    1.<asp:RadioButton ID="rdbBill11" GroupName="Bill1" runat="server" Text="需我司代扣税费合作人" value="1" />/
                                    <asp:RadioButton ID="rdbBill12" GroupName="Bill1" runat="server" Text="合作方提供发票领款人" value="2" /> 
                ...
                <tr>
					<td class="tl PL10 PR10" colspan="4">
						<table class='sample tc' width='100%'>
                            <tr>
                                <td colspan="6" class="tl PL10" style="font-weight:bold;">
                                    2.<asp:RadioButton ID="rdbBill21" GroupName="Bill2" runat="server" Text="需我司代扣税费合作人" value="1" />/
                                    <asp:RadioButton ID="rdbBill22" GroupName="Bill2" runat="server" Text="合作方提供发票领款人" value="2" /> 
					...
					<td class="tl PL10 PR10" colspan="4">
						<table class='sample tc' width='100%' style="font-weight:bold;">
                            <tr>
                                ...
                                <td><asp:TextBox ID="txtCoopMoney" runat="server" Width="100px"></asp:TextBox>元</td>
                                <td>占总佣比例</td>
                                <td><asp:TextBox ID="txtCoopTotalScale" runat="server" Width="100px"></asp:TextBox>%</td>
							</tr>
                            <tr>
