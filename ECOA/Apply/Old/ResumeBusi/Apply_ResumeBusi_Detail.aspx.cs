...
public partial class Apply_ResumeBusi_Apply_ResumeBusi_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite21"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite21"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_ResumeBusi_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_ResumeBusi_ID"].ToString();

        string applicant = dr["OfficeAutomation_Document_ResumeBusi_Apply"].ToString();
        ApplyN = applicant;
        lblApply.Text = applicant;
        txtDepartment.Value = dr["OfficeAutomation_Document_ResumeBusi_Department"].ToString();
        lblApplyID.Text = dr["OfficeAutomation_Document_ResumeBusi_ApplyID"].ToString();
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ResumeBusi_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtDepartment.Value = dr["OfficeAutomation_Document_ResumeBusi_Department"].ToString();
        txtReplyPhone.Text = dr["OfficeAutomation_Document_ResumeBusi_ReplyPhone"].ToString();
        txtReplyFax.Text = dr["OfficeAutomation_Document_ResumeBusi_ReplyFax"].ToString();
        InitListControler(dr["OfficeAutomation_Document_ResumeBusi_DepartmentTypeID"].ToString(), dr["OfficeAutomation_Document_ResumeBusi_MajordomoID"].ToString());
        txtDepartmentName.Text = dr["OfficeAutomation_Document_ResumeBusi_DepartmentName"].ToString();
        txtPlanDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ResumeBusi_PlanDate"].ToString()).ToString("yyyy-MM-dd");
        txtReason.Text = dr["OfficeAutomation_Document_ResumeBusi_Reason"].ToString();
        ...
        for (int i = 0; i < drc.Count; i++)
        {
            ...
            if ((curidx == "1" || curidx == "2" || curidx == "3" || EmployeeName == "黄轩明") && curemp2.Contains(EmployeeID) && showf) //M_HideFlows：20150330
            {
                ...
                SbJs.Append("$(\"#trShowFlow10\").hide();$(\"#trShowFlow11\").prepend('<td>财务部意见</td>');");
                SbJs.Append("$(\"#trShowFlow12\").hide();$(\"#trLogistics2\").prepend('<td>后勤事务部<br />意见<br /><asp:Button ID=\"btnWillEnd\" runat=\"server\" Text=\"结束\" OnClick=\"btnWillEnd_Click\" Visible=\"False\" /></td>');");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_ResumeBusi t_OfficeAutomation_Document_ResumeBusi = new T_OfficeAutomation_Document_ResumeBusi();
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "ResumeBusi" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 18;
                ...
                t_OfficeAutomation_Document_ResumeBusi = GetModelFromPage(Guid.NewGuid());
                da_OfficeAutomation_Document_ResumeBusi_Inherit.Add(t_OfficeAutomation_Document_ResumeBusi);//插入申请表
                ...
                Common.AddLog(EmployeeID, EmployeeName, 22, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_ResumeBusi_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    private T_OfficeAutomation_Document_ResumeBusi GetModelFromPage(Guid ResumeBusiID)
    {
        T_OfficeAutomation_Document_ResumeBusi t_OfficeAutomation_Document_ResumeBusi = new T_OfficeAutomation_Document_ResumeBusi();
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_ID = ResumeBusiID;
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_Apply = EmployeeName;
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_ApplyID = lblApplyID.Text;
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_Department = txtDepartment.Value;
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_ReplyPhone = txtReplyPhone.Text;
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_ReplyFax = txtReplyFax.Text;
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_DepartmentTypeID = int.Parse(ddlDepartmentType.SelectedValue);
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_MajordomoID = int.Parse(ddlMajordomo.SelectedValue);
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_DepartmentName = txtDepartmentName.Text;
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_PlanDate = DateTime.Parse(txtPlanDate.Text);
        t_OfficeAutomation_Document_ResumeBusi.OfficeAutomation_Document_ResumeBusi_Reason = txtReason.Text;
   
        return t_OfficeAutomation_Document_ResumeBusi;
    }
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_ResumeBusi_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_ResumeBusi_ID"].ToString();
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ResumeBusi_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_ResumeBusi_DepartmentName"].ToString();
                    string applyUrl = Page.Request.Url.ToString();
                    string plantime = drRow["OfficeAutomation_Document_ResumeBusi_PlanDate"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请正文：" + drRow["OfficeAutomation_Document_ResumeBusi_Reason"]);
                    ...
                    if (hdIsAgree.Value != "0")//同意或其他意见
                    {
                        ...
                        {
                            //审批流程完成，通知申请人
                            msnBody = "您好，" + apply + "：关于“" + departmenttype + department + "" + documentName + " ”，公司已审批完毕并同意通过，详细批复意见请查阅申请表，该分行计划于" + plantime + "恢复营业，具体回复营业时间以行政部于SPS平台通告为准，请相关部门配合该铺恢复营业的各项工作安排，谢谢！<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
                            email = apply;
                            ...
                            foreach (DataRow dr in dsFlow.Tables[0].Rows)
                            {
                                ...
                                for (int i = 0; i < employnames.Length; i++)
                                {
                                    ...
                                    {
                                        msnBody = "您好，" + employnames[i] + "：关于“" + departmenttype + department + "" + documentName + " ”，公司已审批完毕并同意通过，详细批复意见请查阅申请表，该分行计划于" + plantime + "恢复营业，具体回复营业时间以行政部于SPS平台通告为准，请相关部门配合该铺恢复营业的各项工作安排，谢谢！<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
                                        email = employnames[i];
                                        if (hdIsAgree.Value == "2")
                            ...
                            for (int i = 0; i < employemails.Length; i++)
                            {
                                ...
                                {
                                    msnBody = "您好：关于“" + departmenttype + department + "" + documentName + " ”，公司已审批完毕并同意通过，详细批复意见请查阅申请表，该分行计划于" + plantime + "恢复营业，具体回复营业时间以行政部于SPS平台通告为准，请相关部门配合该铺恢复营业的各项工作安排，谢谢！" + sagree + "<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_ResumeBusi_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ResumeBusi_ID"].ToString();

        t_OfficeAutomation_Document_ResumeBusi = GetModelFromPage(new Guid(ID));
        da_OfficeAutomation_Document_ResumeBusi_Inherit.Update(t_OfficeAutomation_Document_ResumeBusi);//修改申请表

        Common.AddLog(EmployeeID, EmployeeName, 22, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite21"] = "1";
        Response.Write("<script>window.open('Apply_ResumeBusi_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("恢复营业申请表.pdf"));//强制下载 
    ...
    protected void btnSaveLogisticsFlow_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_ResumeBusi_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ResumeBusi_ID"].ToString(); //在不同的表要注意修改
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_ResumeBusi_Inherit da_OfficeAutomation_Document_ResumeBusi_Inherit = new DA_OfficeAutomation_Document_ResumeBusi_Inherit();
            DataSet ds = da_OfficeAutomation_Document_ResumeBusi_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ResumeBusi_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
            string department = drRow["OfficeAutomation_Document_ResumeBusi_Department"].ToString();
            string applyUrl = Page.Request.Url.ToString();
            applyUrl = applyUrl.Substring(applyUrl.IndexOf("/Apply/"));
            applyUrl = "内部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["InternalURL"] + applyUrl;
                        //+ "<br />外部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["ExternalURL"] + applyUrl;
            if (flows != null)
            {
                ...
                if (i <= 10 && EmployeeID == "13545") //M_AddNWX：20150511
                {
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_ResumeBusi_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_ResumeBusi_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_ResumeBusi_Inherit();
