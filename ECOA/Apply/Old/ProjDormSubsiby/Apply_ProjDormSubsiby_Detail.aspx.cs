...
public partial class Apply_ProjDormSubsiby_Apply_ProjDormSubsiby_Detail : BasePage
{
    ...
    private T_OfficeAutomation_Document_ProjDormSubsiby GetModelFromPage(Guid ProjDormSubsibyID)
    {
        ...
        model.OfficeAutomation_Document_ProjDormSubsiby_LastYear = "";
        model.OfficeAutomation_Document_ProjDormSubsiby_LastMonth = "";
        model.OfficeAutomation_Document_ProjDormSubsiby_LastRent = "";
