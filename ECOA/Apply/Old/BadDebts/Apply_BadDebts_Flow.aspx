<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_BadDebts_Flow.aspx.cs" Inherits="Apply_BadDebts_Apply_BadDebts_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
                    ...
                    $.ajax({
                        ...
                        success: function(info) {
                            ...
                            else
                            {
                                ...
                                {
                                    hideAll();
                                    if($.trim($("#txtDepartment").val())=="工商铺部")
                                    {
                                        $("#txtIDx3").val("黄轩明");
                                    }
                                    else
        ...
        function save() {
            ...
            for(var y = 1; y <= 3; y++)
            {
                if($("#txtIDx"+y).parent().css("display")!="none") {
                    ...
                    if(y==3&&($("#txtIDx"+y).val() == "黄轩明" || $("#txtIDx"+y).val() == "黄轩明,"))
                        is3 = "1";
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "text",
                data: 'action=saveBadDebtsFlow&id=<%=EmployeeID %>&name=<%=EmployeeName %>&purview=<%=Purview %>&mainid=<%=MainID %>&is3='+ is3 + '&content=' + content,
                success: function(info) {
                    if (info == "success") {
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <div id="divIDx3" class='item'><input id="btnIDx3" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(3);" /><label id="lblIDx3" for='btnIDx3'>部门负责人</label></div><div id="divTxtIDx3" class='item' style="display:none;"><input type="text" id="txtIDx3" style="width:100px; background-color:Silver;" readonly="readonly" /><input id="hdIDx3" type="hidden" /></div>
            <br /><br />
