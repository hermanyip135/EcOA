...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<div style='text-align: center; width: 1040px; margin: 0 auto;'>
		<%=SbFlow.ToString() %>
		...
		<div style='text-align: center'>
			...
			<table id="tbAround"  width='740px'>
				...
				<tr>
					...
					<td class="tl PL10">关于<asp:textbox id="txtBuilding" runat="server" Width="165px"></asp:textbox>的坏账申请</td>
				...
				<tr id="trShowFlow6" class="noborder" style="height: 85px;">
					...
					<td colspan="3" class="tl PL10" style=" ">
						...
						<textarea id="txtIDx6" rows="5" style="width: 98%; overflow: auto;"></textarea><input type="button" id="btnSignIDx6" value="签署意见" onclick="check();sign('6');" style="display: none;" /><div class="signdate">日期：<span id="spanDateIDx6">_________</span></div>
					</td>
				</tr>
