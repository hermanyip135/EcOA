...
public partial class Apply_UndertakeProj_201908_Apply_UtNewProj_Detail_New : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    public string FLG_ReWrite = string.Empty;
    #endregion
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        GetCCESP(this.txtProject.Value);
    ...
    public void InitPage()
    {
        ...
        this.lblApply.InnerText = EmployeeName;
        this.lblApplyDate.InnerText = DateTime.Now.ToString("yyyy-MM-dd");
    ...
    private void InitListControler(string departmentTypeSelectedValue, string projectPropertySelectedValue, string agentPropertySelectedValue, string dealTypeSelectedValue, string dealOfficeTypeSelectedValue)
    {
        ...
        HtmlSelectListBind(this.sbDealType, ds.Tables[0], "OfficeAutomation_DealType_ID", "OfficeAutomation_DealType_Name", dealTypeSelectedValue, "-请选择-");
        ...
        HtmlSelectListBind(this.sbCorporateType, ds.Tables[0], "OfficeAutomation_DirectContractType_ID", "OfficeAutomation_DirectContractType_Name", "", "-请选择-");
    }
    ...
    public void LoadPage()
    {
        ...
        var MainDocumentObj = new T_OfficeAutomation_Document_UtNewProj_New();
        ...
        if (Mainobj.OfficeAutomation_Main_FlowStateID == 7)
        {
            ...
            //var obj = new Common().GetTempSaveEntity<Apply_UtNewProj_New>("UtNewProjDetail", "", Mainobj.OfficeAutomation_SerialNumber);
        }
        else
        {
            //隐藏暂存按钮
            ...
            MainDocumentObj = DA_OfficeAutomation_Document_UtNewProj_New_Inherit.SelectByMainID(MainID);
        }
        ...
        ID = MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_ID.ToString();
        string applicant = MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_ApplyEmpName.ToString();
        ...
        txtOneFront.Value = MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_OneFront.ToString();
        txtOneAfter.Value = MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_OneAfter.ToString();
        txtTurnFront.Value = MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_TurnFront.ToString();
        txtTurnAfter.Value = MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_TurnAfter.ToString();

        txtProject.Value = MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_Project.ToString();
        txtDeveloper.Value = MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_Developer.ToString();

        string BaseAgent = MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_BaseAgent.ToString();
        ...
        if (BaseAgent.Contains("4"))
        {
            ...
            this.txtBaseAgentOther.Value = MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_BaseAgentOther.ToString();
        }

        this.txtCorporateName.Value = MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_CorporateName.ToString();
        ...
        string sl = MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_Lack.ToString();
        if (sl.Contains("1"))
        ...
        ddlProjectAddressBind(MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_ProjectAddress.ToString());
        SerialNumber = Mainobj.OfficeAutomation_SerialNumber.ToString();
        InitListControler("", "", "", MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_DealType.ToString(), MainDocumentObj.OfficeAutomation_Document_UtNewProj_New_DealOfficeType.ToString());
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_UtNewProj_New utNewProj_New = new T_OfficeAutomation_Document_UtNewProj_New();
        ...
        try
        {
            FLG_ReWrite = ViewState["FLG_ReWrite"] == null ? "" : ViewState["FLG_ReWrite"].ToString();
            //if (ViewState["FLG_ReWrite"].ToString() == "1")
            if (FLG_ReWrite == "1")
            {
                //MainID = "";
        ...
        this.txtProject.Value = this.ToDBC(this.txtProject.Value);
        //if (da_OfficeAutomation_Document_UtNewProj_Inherit.IsRepeat(MainID, this.txtProject.Value))
        if (DA_OfficeAutomation_Document_UtNewProj_New_Inherit.SelectByProjectNameAndMainID(MainID, this.txtProject.Value) != null)
        {
            Alert("新增项目名重复！");
            return;
        }
        ...
        if (IsNewApply && flowState != "7")
        {
            ...
            t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "UtNewProjNew" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
            t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 101;
            ...
            utNewProj_New = GetModelFromPage(Guid.NewGuid(), true);

            t_OfficeAutomation_Main.OfficeAutomation_Main_Apply = EmployeeName;

            t_OfficeAutomation_Main.OfficeAutomation_Main_Department = this.hidDepartment.Value;
            t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = this.txtProject.Value;
            ...
            DA_OfficeAutomation_Document_UtNewProj_New_Inherit.InsertOrModifyOrDeleteOne(utNewProj_New, "Insert");//插入申请表
            InsertUtNewProjDetail(utNewProj_New.OfficeAutomation_Document_UtNewProj_New_ID);//插入申请子表
            //统筹分佣
            ...
            Common.AddLog(EmployeeID, EmployeeName, 93, new Guid(MainID), 1);//日志，创建申请表
            Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程`12·1
            ...
            RunJS("var win=window.showModalDialog(\"Apply_UtProj_Flow.aspx?MainID=" + MainID + "&dpm=" + Server.UrlEncode(this.hidDepartment.Value) + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
            #endregion
        }
        else
        {
    ...
    protected void btnTempSave_Click(object sender, EventArgs e)
    {
        ...
        var SerialNumber = "UtNewProjNew" + DateTime.Now.ToString("yyyyMMddHHmmssffffff");
        var DocumentID = 101;
        var Creater = EmployeeName;
        var da_OfficeAutomation_Main_Inherit = new DA_OfficeAutomation_Main_Inherit();
        DA_OfficeAutomation_Document_UtNewProj_New_Inherit UtNewProj_New_Inherit = new DA_OfficeAutomation_Document_UtNewProj_New_Inherit();
        //this.txtProject.Text = this.ToDBC(this.txtProject.Text);
        ...
        var t_OfficeAutomation_Main = da_OfficeAutomation_Main_Inherit.InsertMain(MainID, SerialNumber, DocumentID, EmployeeName, UnitName);
        ...
        var UtNewProj_New = new T_OfficeAutomation_Document_UtNewProj_New();
        var UtNewProj_Detail_New = new List<T_OfficeAutomation_Document_UtNewProj_New_Detail>();
        UtNewProj_New = DA_OfficeAutomation_Document_UtNewProj_New_Inherit.SelectByMainID(MainID);

        if (UtNewProj_New == null)
        {
            UtNewProj_New = GetModelFromPage(Guid.NewGuid(), true);
        }
        ...
        UtNewProj_Detail_New = GetUtNewProjDetail(UtNewProj_New.OfficeAutomation_Document_UtNewProj_New_ID);
        DA_OfficeAutomation_Document_UtNewProj_New_Inherit.HandleBase(UtNewProj_New);


        var obj = new DataEntity.PageModel.Apply_UtNewProj_Detail_New();
        obj.MainEntity = t_OfficeAutomation_Main;
        obj.UtNewProjNew = UtNewProj_New;
        obj.UtNewProjNew_Detail = UtNewProj_Detail_New;
        //暂存数据保存到xml文件中
        var result = new Common().SaveTempSaveFile<DataEntity.PageModel.Apply_UtNewProj_Detail_New>(obj, "UtNewProjDetailNew", "", t_OfficeAutomation_Main.OfficeAutomation_SerialNumber);
        if (result)
        {
            ...
            if (flows != null)
            {
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    for (int i2 = 0; i2 < employnames.Length; i2++)
                    {
                        ...
                        if (email != "") Common.SendMessageEX(false, email, "申请已被" + signEmployeeName + "撤销审理", msnBody, msnBody);
                    }
                }
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            RunJS("var win=window.showModalDialog(\"Apply_UtProj_Flow.aspx?MainID=" + MainID + "&dpm=" + Server.UrlEncode(this.hidDepartment.Value) + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    private T_OfficeAutomation_Document_UtNewProj_New GetModelFromPage(Guid UtNewProjID, bool isn)
    {
        ...
        T_OfficeAutomation_Document_UtNewProj_New utNewProjNew = new T_OfficeAutomation_Document_UtNewProj_New();

        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ID = UtNewProjID;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_MainID = new Guid(MainID);
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ApplyEmpCode = EmployeeID;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ApplyEmpName = EmployeeName;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ApplyDate = Convert.ToDateTime(this.lblApplyDate.InnerText);
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ApplyDeptID = UnitID;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_Project = this.txtProject.Value;
        //utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ProjectID = Convert.ToInt32(this.hidProjectID.Value);
        int length = this.hidProjectID.Value.Length;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ProjectID = Convert.ToInt32(length*2+1);
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ProjectLocation = this.sbProjectLocation.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ProjectAddress = this.txtProjectAddress.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_Developer = this.txtDeveloper.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_DeveloperContacter = this.txtDeveloperContacter.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_DeveloperContacterPosition = this.txtDeveloperContacterPosition.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_DeveloperContacterPhone = this.txtDeveloperContacterPhone.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CoordinatorCode = this.txtCoordinatorCode.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CoordinatorName = this.txtCoordinatorName.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CoordinatorPhone = this.txtCoordinatorPhone.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CoordinatorDept = this.txtCoordinatorDept.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_AreaCheckDataerCode = this.txtAreaCheckDataerCode.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_AreaCheckDataerName = this.txtAreaCheckDataer.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_AreaCheckDataerPhone = this.txtAreaCheckDataerPhone.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsPreSale = this.hidIsPreSale.Value == "1" ? true : false;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsOneOrTwo = this.hidIsOneOrTwo.Value == "1" ? true : false;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_DealType = Convert.ToInt32(this.sbDealType.Value);
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_DealOfficeType = Convert.ToInt32(this.hidDealOfficeTypeCount.Value);
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_BaseAgent = this.hidBaseAgent.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_BaseAgentOther = this.txtBaseAgentOther.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_AgentCompanyInfo = Convert.ToInt32(this.hidAgentCompanyInfoCount.Value);

        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsSwipeCard = false;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_PrePayMoney = string.Empty;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_DiscountMoney = string.Empty;

        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsRenovation = false;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_RenovationFee = string.Empty;

        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsOther = false;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_OtherFeeType = string.Empty;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_OtherFee = string.Empty;


        var cet = this.hidCustomerExtraThings.Value;

        switch (cet)
        {
            case "1":
                utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsSwipeCard = true;
                utNewProjNew.OfficeAutomation_Document_UtNewProj_New_PrePayMoney = this.txtPrePayMoney.Value;
                utNewProjNew.OfficeAutomation_Document_UtNewProj_New_DiscountMoney = this.txtDiscountMoney.Value;
                break;
            case "2":
                utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsRenovation = true;
                utNewProjNew.OfficeAutomation_Document_UtNewProj_New_RenovationFee = this.txtRenovationFee.Value;
                break;
            case "3":
                utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsOther = true;
                utNewProjNew.OfficeAutomation_Document_UtNewProj_New_OtherFeeType = this.txtOtherFeeType.Value;
                utNewProjNew.OfficeAutomation_Document_UtNewProj_New_OtherFee = this.txtOtherFee.Value;
                break;
            default:
                break;
        }
        ...
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_AgentStartDate = Convert.ToDateTime(this.txtAgentStartDate.Value);
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_AgentEndDate = Convert.ToDateTime(this.txtAgentEndDate.Value);
        string cgsd = this.txtClientGuardStartDate.Value;
        string cgse = this.txtClientGuardEndDate.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ClientGuardStartDate = string.IsNullOrEmpty(cgsd) == true ? SqlDateTime.MinValue.Value : Convert.ToDateTime(cgsd);
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ClientGuardEndDate = string.IsNullOrEmpty(cgse) == true ? SqlDateTime.MinValue.Value : Convert.ToDateTime(cgse);

        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CommFeeTypeInfo = Convert.ToInt32(this.hidCommFeeTypeInfoCount.Value);

        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CorporateName = string.Empty;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CorporateType = string.Empty;
        //utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CashPrize = string.Empty;

        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CalCashPrizeWay = string.Empty;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CalCashPrizeConditions = string.Empty;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CalCashPrizeColumns = string.Empty;

        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_PayCashPrizeConditions = string.Empty;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CashPrizePayType = string.Empty;

        var isHaveCashPrize = this.hidIsHaveCashPrize.Value;
        if (isHaveCashPrize == "1")
        {
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsHaveCashPrize = true;
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CorporateName = this.txtCorporateName.Value;
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CorporateType = this.sbCorporateType.Value;
            //utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CashPrize = this.txtCashPrize.Value;

            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CalCashPrizeWay = string.Empty;
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CalCashPrizeConditions = string.Empty;
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CalCashPrizeColumns = string.Empty;

            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_PayCashPrizeConditions = this.txtaPayCashPrizeConditions.Value;
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_CashPrizePayType = this.hidCashPrizePayType.Value;
        }
        else
        {
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsHaveCashPrize = false;
        }

        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsMyPay = this.hidIsMyPay.Value == "1" ? true : false;

        var areaConfirm = this.hidIsAreaConfirm.Value;
        if (areaConfirm == "1")
        {
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsAreaConfirm = true;
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ReturnBackDate = SqlDateTime.MinValue.Value;
        }
        else
        {

            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsAreaConfirm = false;
            string rbd = this.txtReturnBackDate.Value;
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_ReturnBackDate = string.IsNullOrEmpty(rbd) == true ? SqlDateTime.MinValue.Value : Convert.ToDateTime(rbd);
        }

        var panfang = this.hidPanFangTuoDiCompany.Value;
        if (panfang.Contains("1"))
        {
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsChoiceZY = true;
        }

        if (panfang.Contains("2"))
        {
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsChoiceFYQ = true;
        }

        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_PanFangRate = this.txtPanFangRate.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_NewHouseRate = this.txtNewHouseRate.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsDeveloperAndZYHaveContract = this.hidIsDeveloperAndZYHaveContract.Value == "1" ? true : false;


        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsNoCashback = false;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsProbity = false;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsZoneRestrictions = false;

        var lack = this.hidLack.Value;
        if (panfang.Contains("1"))
        {
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsNoCashback = true;
        }

        if (panfang.Contains("2"))
        {
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsProbity = true;
        }

        if (panfang.Contains("3"))
        {
            utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsZoneRestrictions = true;
        }


        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_LimitArea = this.txtLimitArea.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_Lack = lack;

        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_OneFront = this.txtOneFront.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_OneAfter = this.txtOneAfter.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_TurnFront = this.txtTurnFront.Value;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_TurnAfter = this.txtTurnAfter.Value;
        //utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsDelete = false;
        utNewProjNew.OfficeAutomation_Document_UtNewProj_New_IsNew = true;
    ...
    protected void ddlProjectAddressBind(string Selected)
    {
        ...
        foreach (var model in list)
        {
            ...
            this.sbProjectLocation.Items.Add(new ListItem(model.OfficeAutomation_AddressArea_ProjectAddress, model.OfficeAutomation_AddressArea_Code));
        }

        this.sbProjectLocation.Items.Insert(0, new ListItem("请选择", "0"));
        if (Selected != "" && Selected != null)
        {
            this.sbProjectLocation.Items.Add(new ListItem("阳江-闸坡镇", "YJ5"));
            this.sbProjectLocation.Items.Add(new ListItem("清远-高新区", "QY9"));
            this.sbProjectLocation.Value = Selected;
        }
    }
    ...
    private void Update()
    {
        ...
        T_OfficeAutomation_Document_UtNewProj_New utNewProjNew_New = new T_OfficeAutomation_Document_UtNewProj_New();
        T_OfficeAutomation_Document_UtNewProj_New utNewProjNew_Old = new T_OfficeAutomation_Document_UtNewProj_New();
        //DA_OfficeAutomation_Document_UtNewProj_Inherit da_OfficeAutomation_Document_UtNewProj_Inherit = new DA_OfficeAutomation_Document_UtNewProj_Inherit();
        ...
        MakeLawFlows();
        utNewProjNew_Old = DA_OfficeAutomation_Document_UtNewProj_New_Inherit.SelectByMainID(MainID);
        ID = utNewProjNew_Old.OfficeAutomation_Document_UtNewProj_New_ID.ToString();
        utNewProjNew_New = GetModelFromPage(new Guid(ID), false);

        string apply = "";
        //string depname = txtDepartment.Text;
        //string summary = txtProject.Text;

        string depname = this.hidDepartment.Value;
        string summary = this.txtProject.Value;
        string applydate = "";
        ...
        DA_OfficeAutomation_Document_UtNewProj_New_Inherit.InsertOrModifyOrDeleteOne(utNewProjNew_New, "Modify");
        ...
        Common.AddLog(EmployeeID, EmployeeName, 93, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    {
        T_OfficeAutomation_Document_UtNewProj_New_Detail utNewProj_new_detail;


        string[] details = Regex.Split(this.hidDealOfficeTypeContent.Value, "\\|\\|");
        for (int i = 0; i < details.Length; i++)
        {
            string[] detail = Regex.Split(details[i], "\\&\\&");
            utNewProj_new_detail = new T_OfficeAutomation_Document_UtNewProj_New_Detail();
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_ID = new Guid();
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_MainID = gUtNewProjID;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_TypeID = 1;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_DealOfficeTypeID = Convert.ToInt32(detail[0]);
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_DiskSourceID = Convert.ToInt32(detail[1]);
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_TotalSize = detail[2];
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_TotalUnitCount = detail[3];
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_UnitPrice = detail[4];
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_SizeSegments = detail[5];
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_PreCompleteCount = detail[6];
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_PreComm = detail[7];
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_AgentCompanyName = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_AgentCompanyTypeID = 0;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_AgentFeeAndCashPrizeSituation = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_CommFeeTypeID = 0;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_ContractingCompanyName = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_OwnerCommJump = 0;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_AgentConditions = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_CommConditions = null;

            DA_OfficeAutomation_Document_UtNewProj_New_Detail_Inherit.InsertOrModifyOrDeleteOne(utNewProj_new_detail, "Insert");
        }

        details = Regex.Split(this.hidCommFeeTypeInfoContent.Value, "\\|\\|");
        for (int i = 0; i < details.Length; i++)
        {
            string[] detail = Regex.Split(details[i], "\\&\\&");
            utNewProj_new_detail = new T_OfficeAutomation_Document_UtNewProj_New_Detail();
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_ID = new Guid();
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_MainID = gUtNewProjID;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_TypeID = 2;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_DealOfficeTypeID = 0;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_DiskSourceID = 0;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_TotalSize = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_TotalUnitCount = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_UnitPrice = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_SizeSegments = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_PreCompleteCount = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_PreComm = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_AgentCompanyName = detail[0];
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_AgentCompanyTypeID = Convert.ToInt32(detail[1]);
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_AgentFeeAndCashPrizeSituation = detail[2];
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_CommFeeTypeID = 0;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_ContractingCompanyName = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_OwnerCommJump = 0;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_AgentConditions = null;
        ...
        for (int i = 0; i < details.Length; i++)
        {
            ...
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_ID = new Guid();
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_MainID = gUtNewProjID;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_TypeID = 3;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_DealOfficeTypeID = 0;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_DiskSourceID = 0;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_TotalSize = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_TotalUnitCount = null;
            ...
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_AgentCompanyTypeID = 0;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_AgentFeeAndCashPrizeSituation = null;
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_CommFeeTypeID = Convert.ToInt32(detail[0]);
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_ContractingCompanyName = detail[1];
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_OwnerCommJump = Convert.ToInt32(detail[2]);
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_AgentConditions = detail[3];
            utNewProj_new_detail.OfficeAutomation_Document_UtNewProj_New_Detail_CommConditions = detail[4];
    ...
    private List<T_OfficeAutomation_Document_UtNewProj_New_Detail> GetUtNewProjDetail(Guid gUtNewProjID)
    {
        T_OfficeAutomation_Document_UtNewProj_New_Detail utNewProj_new_detail;
        var list = new List<T_OfficeAutomation_Document_UtNewProj_New_Detail>();
        ...
        for (int i = 0; i < details.Length; i++)
        {
            ...
            list.Add(utNewProj_new_detail);
        }

        details = Regex.Split(this.hidAgentCompanyInfoContent.Value, "\\|\\|");
        for (int i = 0; i < details.Length; i++)
        {
            string[] detail = Regex.Split(details[i], "\\&\\&");
