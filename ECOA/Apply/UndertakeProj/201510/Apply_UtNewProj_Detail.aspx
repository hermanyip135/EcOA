...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function check() {
            ...
            var appcount=$("#<%=AppendixCount.ClientID%>").val() 
          
            if(isUploaded < 1 && isNewApply&&appcount=="0"){
                alert("请上传相关的资料！");
                return false;
            }
            ...
            if ($.trim($("#<%=txtPreCompleteNumber.ClientID%>").val()) == "") { alert("预估代理期内完成货量不可为空！"); $("#<%=txtPreCompleteNumber.ClientID%>").focus(); return false; }
            if ($.trim($("#<%=txtPreCompleteMoney.ClientID%>").val()) == "") { alert("预估代理期内完成货量金额不可为空！"); $("#<%=txtPreCompleteMoney.ClientID%>").focus(); return false; }
            if ($.trim($("#<%=txtPreCompleteComm.ClientID%>").val()) == "") { alert("预估代理期内完成佣金收入！"); $("#<%=txtPreCompleteComm.ClientID%>").focus(); return false; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style='text-align: center; width: 840px; margin: 0 auto;'>
        ...
        <div style='text-align: center'>
            ...
            <table id="tbAround" width='720px'>
                <tr>
                    ...
                    <td class="tl PL10" colspan="3">
                        <asp:TextBox ID="txtProject" runat="server" Width="92%"></asp:TextBox></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="display: none">
                        <span style="display: none">项目所在区域</span>

                    </td>
                    <td class="tl PL10" style="display: none"><span style="display: none">
                        <asp:TextBox ID="txtProjectArea" runat="server"></asp:TextBox></span></td>
                </tr>
                <tr>
                    <td>是否限购
                    </td>
                ...
                <tr>
                    <td>项目地址</td>
                    <td class="tl PL10" colspan="3">
                        <asp:TextBox ID="txtProjectAddress" runat="server" Width="92%"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>报数地址</td>
                    <td class="tl PL10" colspan="3">
                        <asp:TextBox ID="txtReportAddress" runat="server" Width="92%"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>发展商<br />
                        联系人</td>
                ...
                <tr>
                    ...
                    <td colspan="3" class="tl PL10">
                        ...
                        <asp:TextBox ID="txtECommerceName2" runat="server" Width="415px"></asp:TextBox>
                ...
                <tr>
                    <td class="auto-style2">是否与行家联合代理<br />
                        或轮流代理</td>
                    <td colspan="3" style="text-align: left; padding-left: 10px" class="auto-style2">
                    ...
                    <td colspan="3" class="tl PL10">(1)发展商佣：（若要计算单套现金奖，合同代理费必须填写用来表示百分比的纯数字）
                        ...
                        <table id="tEB" class='sample tc' width='100%' style="border: none;">
                            <tr id="trEB1" style="border: none;">
                                <td style="border: none;">
                                    <input type="text" id="txtEBCommFloatSetNumberStart1" style="width: 50px" readonly="readonly" value="0" />至<input type="text" id="txtEBCommFloatSetNumberEnd1" style="width: 50px" />套/<input type="text" id="txtEBCommFloatMoneyStart1" style="width: 50px" readonly="readonly" value="0" />至<input type="text" id="txtEBCommFloatMoneyEnd1" style="width: 50px" />元销售额（套数及销售额二选一），<input type="text" id="txtEBCommFloatKind1" style="width: 80px" />（填写住宅/公寓/别墅等不同类型）合同代理费<input type="text" id="txtEBCommFloatScale1" style="width: 50px" />%，公布代理费<input type="text" id="txtEBCommPublishedScale1" style="width: 50px" />%</td>
                            </tr>
                            <%=SbHtml3.ToString()%>
                        </table>
                        ...
                        <div id="SingleRewardC2">
                            <asp:RadioButton ID="rdbHaveSingleReward2" runat="server" Text="有，此项目实收佣金比例<2%" GroupName="HaveSingleReward" />，现金奖全数上缴公司，可计入员工业绩，但不计算员工佣金；</div>
                        <div id="SingleRewardC3">
                            <asp:RadioButton ID="rdbHaveSingleReward3" runat="server" Text="无，此项目不设现金奖。" GroupName="HaveSingleReward" /></div>
                        <div id="SingleRewardC4">
                            <asp:RadioButton ID="rdbHaveSingleReward4" runat="server" Text="其他情况" GroupName="HaveSingleReward" /></div>
                        <div id="AnotherRewardC" style="display: none">
                            <asp:TextBox ID="txtAnotherRewardC" runat="server" Height="80px" TextMode="MultiLine" Width="98%"></asp:TextBox></div>
                        <br />
                        现金奖的操作：<br />
                        （1）发展商支付现金奖的条件：<br />
                        ...
                        <div id="COtherCondtion" style="display: none">
                            <asp:TextBox ID="txtOtherCondtion" runat="server" Height="80px" TextMode="MultiLine" Width="98%"></asp:TextBox></div>
                        <br />
                        区域是否已提交发展商奖金确认书？
                ...
                <tr>
                    <td>申请部门接盘模式</td>
                    <td colspan="3" class="tl PL10">
                        <asp:RadioButton ID="rdbSaleMode1" runat="server" Checked="true" Text="独立接盘，" GroupName="SaleMode" /><label for="r2d2b2">统筹区<asp:TextBox ID="txtAreaScale1" runat="server" Width="110px" Enabled="false"></asp:TextBox>拆分成交的<asp:TextBox ID="txtMainAreaScale" runat="server" Width="50px"></asp:TextBox>%， 成交区占<asp:TextBox ID="txtDealAreaScale" runat="server" Width="50px"></asp:TextBox>%</label>
                        <br />
                        （成交区拆分不得少于85%）
                        <div id="divSaleMode2" style="margin-top: 10px; margin-bottom: 10px;">
                            ...
                            <label for="r2d2b2">
                                <asp:TextBox ID="txtAreaScale" Enabled="false" runat="server" Width="60%" Height="40px" TextMode="MultiLine"></asp:TextBox>，
                ...
                <tr class="noborder" style="height: 85px; display: none;" id="tr14">
                    ...
                    <td colspan="3" class="tl PL10" style="">
                        ...
                        <textarea id="txtIDx14" rows="3" style="width: 98%; overflow: auto;"></textarea><input type="button" id="btnSignIDx14" value="签名" onclick="sign('14')" style="display: none;" />
                        <br />
                ...
                <tr id="trAddAnoF3" class="noborder" style="height: 85px; display: none;">
                    ...
                    <td colspan="3" class="tl PL10" style="">
                        ...
                        <textarea id="txtIDx220" runat="server" rows="6" style="width: 98%; overflow: auto;" cols="3"></textarea>
            ...
            <div style="width: 640px; margin: 0 auto;"><span class="tl" style="float: left;">备注：1物业部承接一手项目/一手货尾盘，需上此报备申请表。<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2物业部承接二手物业达20套或以上的属批量项目，需上此报备申请表。</span></div>
            <!--打印正文结束-->
        </div>
        ...
        <div class="noprint">
            ...
            <div id="PageBottom">
                ...
                <%--            <asp:button runat="server" id="Button1" text="ddddddd" onclick="btnSign_Click" />--%>
