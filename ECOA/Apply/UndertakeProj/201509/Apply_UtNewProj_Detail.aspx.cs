...
public partial class Apply_UtNewProj_Apply_UtNewProj_Detail : BasePage
{
            ...
            //{
                ...
                if (isSignSuccess)
                {
                    ...
                    else //不同意
                    {
                        ...
                        T_OfficeAutomation_Flow flowsf1, flowsf2;
                        flowsf1 = da_OfficeAutomation_Flow_Inherit.SelectByMainIDAndIdx(MainID, 5);
                        flowsf2 = da_OfficeAutomation_Flow_Inherit.SelectByMainIDAndIdx(MainID, 4);
    ...
    private T_OfficeAutomation_Document_UtNewProj GetModelFromPage(Guid UtNewProjID, bool isn)
    {
        ...
        t_OfficeAutomation_Document_UtNewProj.OfficeAutomation_Document_UtNewProj_Lack6 = "";
        t_OfficeAutomation_Document_UtNewProj.OfficeAutomation_Document_UtNewProj_AS2 = "";
        t_OfficeAutomation_Document_UtNewProj.OfficeAutomation_Document_UtNewProj_MS2 = "";
