...
using DataEntity.PageModel;//2016/8/18 52100

public partial class Apply_PullafewTwo_Apply_PullafewTwo_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite66"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite66"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        DA_OfficeAutomation_Document_PullafewTwo_Detail_Inherit da_OfficeAutomation_Document_PullafewTwo_Detail_Inherit = new DataAccess.Operate.DA_OfficeAutomation_Document_PullafewTwo_Detail_Inherit();
        DA_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit da_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit = new DataAccess.Operate.DA_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit();
        DA_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit da_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit = new DataAccess.Operate.DA_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit();
        ...
        DataSet pullafewTwo = new DataSet();
        ...
        {
            //从暂存xml中读取
            var obj = new Common().GetTempSaveEntity<DataEntity.PageModel.Apply_PullafewTwo_Detail>("PullafewTwoDetail", "", Mainobj.OfficeAutomation_SerialNumber);
            pullafewTwo = Common.GetPageDetailDS<T_OfficeAutomation_Document_PullafewTwo>(obj.PullafewTwo, Mainobj);
            detail = Common.GetDataSet<T_OfficeAutomation_Document_PullafewTwo_Detail>(obj.PullafewTwo_Detail);
            leaseTerm = Common.GetDataSet<T_OfficeAutomation_Document_PullafewTwo_LeaseTerm>(obj.LeaseTerm);
            statistical = Common.GetDataSet<T_OfficeAutomation_Document_PullafewTwo_Statistical>(obj.Statistical);
            IsTempSave = true;
        }
        else
        {
            ...
            //从数据库中读取
            pullafewTwo = da_OfficeAutomation_Document_PullafewTwo_Inherit.SelectByMainID(MainID);
            ID = pullafewTwo.Tables[0].Rows[0]["OfficeAutomation_Document_PullafewTwo_ID"].ToString();
            detail = ds = da_OfficeAutomation_Document_PullafewTwo_Detail_Inherit.SelectByID(ID);
            leaseTerm = da_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit.SelectByID(ID);
            statistical = da_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit.SelectByID(ID);
        }

        //获取当前申请主表数据填充ds
        //ds = da_OfficeAutomation_Document_PullafewTwo_Inherit.SelectByMainID(MainID);
        ds = pullafewTwo;
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_PullafewTwo_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_PullafewTwo_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_PullafewTwo_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_PullafewTwo_Department"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_PullafewTwo_ApplyDate"].ToString()).ToString("yyyy-MM-dd");

        txt1a.Text = dr["OfficeAutomation_Document_PullafewTwo_1a"].ToString();
        txt1b.Text = dr["OfficeAutomation_Document_PullafewTwo_1b"].ToString();
        txt1c.Text = dr["OfficeAutomation_Document_PullafewTwo_1c"].ToString();
        txt1d.Text = dr["OfficeAutomation_Document_PullafewTwo_1d"].ToString();
        txt1e.Text = dr["OfficeAutomation_Document_PullafewTwo_1e"].ToString();
        txt1f.Text = dr["OfficeAutomation_Document_PullafewTwo_1f"].ToString();
        txt1g.Text = dr["OfficeAutomation_Document_PullafewTwo_1g"].ToString();
        txt1h.Text = dr["OfficeAutomation_Document_PullafewTwo_1h"].ToString();
        txt1i.Text = dr["OfficeAutomation_Document_PullafewTwo_1i"].ToString();
        txt1ii.Text = dr["OfficeAutomation_Document_PullafewTwo_1ii"].ToString();
        txt1j.Text = dr["OfficeAutomation_Document_PullafewTwo_1j"].ToString();
        txt1k.Text = dr["OfficeAutomation_Document_PullafewTwo_1k"].ToString();
        txt1l.Text = dr["OfficeAutomation_Document_PullafewTwo_1l"].ToString();
        txt1m.Text = dr["OfficeAutomation_Document_PullafewTwo_1m"].ToString();
        txt1n.Text = dr["OfficeAutomation_Document_PullafewTwo_1n"].ToString();
        txt1o.Text = dr["OfficeAutomation_Document_PullafewTwo_1o"].ToString();
        txt1p.Text = dr["OfficeAutomation_Document_PullafewTwo_1p"].ToString();
        txt1q.Text = dr["OfficeAutomation_Document_PullafewTwo_1q"].ToString();
        txt1r.Text = dr["OfficeAutomation_Document_PullafewTwo_1r"].ToString();
        txt1s.Text = dr["OfficeAutomation_Document_PullafewTwo_1s"].ToString();
        txt1t.Text = dr["OfficeAutomation_Document_PullafewTwo_1t"].ToString();
        txt1u.Text = dr["OfficeAutomation_Document_PullafewTwo_1u"].ToString();
        txt1v.Text = dr["OfficeAutomation_Document_PullafewTwo_1v"].ToString();

        txt2a.Text = dr["OfficeAutomation_Document_PullafewTwo_2a"].ToString();
        txt2b.Text = dr["OfficeAutomation_Document_PullafewTwo_2b"].ToString();
        txt2c.Text = dr["OfficeAutomation_Document_PullafewTwo_2c"].ToString();
        txt2cc.Text = dr["OfficeAutomation_Document_PullafewTwo_2cc"].ToString();
        txt2d.Text = dr["OfficeAutomation_Document_PullafewTwo_2d"].ToString();
        txt2f.Text = dr["OfficeAutomation_Document_PullafewTwo_2f"].ToString();
        txt2g.Text = dr["OfficeAutomation_Document_PullafewTwo_2g"].ToString();
        txt2h.Text = dr["OfficeAutomation_Document_PullafewTwo_2h"].ToString();

        txt4a.Text = dr["OfficeAutomation_Document_PullafewTwo_4a"].ToString();
        txt4b.Text = dr["OfficeAutomation_Document_PullafewTwo_4b"].ToString();
        txt4c.Text = dr["OfficeAutomation_Document_PullafewTwo_4c"].ToString();
        txt4cc.Text = dr["OfficeAutomation_Document_PullafewTwo_4cc"].ToString();
        txt4d.Text = dr["OfficeAutomation_Document_PullafewTwo_4d"].ToString();
        txt4dd.Text = dr["OfficeAutomation_Document_PullafewTwo_4dd"].ToString();
        txt4e.Text = dr["OfficeAutomation_Document_PullafewTwo_4e"].ToString();
        txt4f.Text = dr["OfficeAutomation_Document_PullafewTwo_4f"].ToString();
        txt4g.Text = dr["OfficeAutomation_Document_PullafewTwo_4g"].ToString();

        SerialNumber = dr["OfficeAutomation_SerialNumber"].ToString();
        #region 获取申请资料表数据
        //获取申请资料表数据填充ds
        //ds = da_OfficeAutomation_Document_PullafewTwo_Detail_Inherit.SelectByID(ID);
        ds = detail;
        if (ds!=null) {
            ...
            else
            {
                ...
                for (int n = 0; n < detailCount; n++)
                {
                    ...
                    SbJs.Append("$('#txtDetail_1a" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1a"] + "');");
                    SbJs.Append("$('#txtDetail_1b" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1b"] + "');");
                    //SbJs.Append("$('#txtDetail_1c" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1c"] + "');");
                    SbJs.Append("$('#txtDetail_1d" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1d"] + "');");
                    SbJs.Append("$('#txtDetail_1e" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1e"] + "');");
                    SbJs.Append("$('#txtDetail_1f" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1f"] + "');");
                    SbJs.Append("$('#txtDetail_1ff" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1ff"] + "');");
                    SbJs.Append("$('#txtDetail_1g" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1g"] + "');");
                    SbJs.Append("$('#txtDetail_1h" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1h"] + "');");
                }
            }
        } else {
            DrawDetailTable(1);
        ...
        #region 获取欠合同拉数统计表
        //获取欠合同拉数统计表数据填充ds
        //ds = da_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit.SelectByID(ID);
        ds = leaseTerm;
        if (ds != null)
        {
            ...
            else
            {
                ...
                for (int n = 0; n < detailCount3; n++)
                {
                    ...
                    SbJs.Append("$('#txtLeaseTerm_1a" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_LeaseTerm_1a"] + "');");
                    SbJs.Append("$('#txtLeaseTerm_1b" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_LeaseTerm_1b"] + "');");
                    SbJs.Append("$('#txtLeaseTerm_1c" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_LeaseTerm_1c"] + "');");
                    SbJs.Append("$('#txtLeaseTerm_1d" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_LeaseTerm_1d"] + "');");
                    SbJs.Append("$('#txtLeaseTerm_1e" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_LeaseTerm_1e"] + "');");
                    SbJs.Append("$('#txtLeaseTerm_1f" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_LeaseTerm_1f"] + "');");
                    SbJs.Append("$('#txtLeaseTerm_1g" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_LeaseTerm_1g"] + "');");
                    SbJs.Append("$('#txtLeaseTerm_1h" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_LeaseTerm_1h"] + "');");
                    SbJs.Append("$('#txtLeaseTerm_1i" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_LeaseTerm_1i"] + "');");
                }
            }
        }
        else
        ...
        #region 获取实际拉数业绩数据
        //获取实际拉数业绩数据填充ds
        //ds = da_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit.SelectByID(ID);
        ds = statistical;
        if (ds != null)
        {
            ...
            else
            {
                ...
                for (int n = 0; n < detailCount2; n++)
                {
                    ...
                    SbJs.Append("$('#txtStatistical_1a" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1a"] + "');");
                    SbJs.Append("$('#txtStatistical_1b" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1b"] + "');");
                    SbJs.Append("$('#txtStatistical_1c" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1c"] + "');");
                    SbJs.Append("$('#txtStatistical_1d" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1d"] + "');");
                    SbJs.Append("$('#txtStatistical_1e" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1e"] + "');");
                    SbJs.Append("$('#txtStatistical_1f" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1f"] + "');");
                    SbJs.Append("$('#txtStatistical_1g" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1g"] + "');");
                    SbJs.Append("$('#txtStatistical_1h" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1h"] + "');");
                    SbJs.Append("$('#txtStatistical_1i" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1i"] + "');");
                    SbJs.Append("$('#txtStatistical_1j" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1j"] + "');");
                    //SbJs.Append("$('#txtStatistical_1jk" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1jk"] + "');");
                    SbJs.Append("$('#txtStatistical_1k" + i + "').val('" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1k"] + "');");
                }
            }
        }
        else
        ...
        for (int i = 0; i < drc.Count; i++)
        {
            ...
            //
            if (drc[i]["OfficeAutomation_Flow_IDx"].ToString() == "201")
            {
                SbJs.Append("$(\"#trShowFlow201\").show();");
            }
    ...
    public void DrawDetailTable(int n)
    {
        ...
        for (int i = 1; i <= n; i++)
        {
            ...
            SbHtml.Append("<td><textarea id=\"txtDetail_1ff" + i + "\" style=\"width: 80px; overflow: hidden;\" rows=\"1\"></textarea></td>");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_PullafewTwo t_OfficeAutomation_Document_PullafewTwo = new T_OfficeAutomation_Document_PullafewTwo();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "PullafewTwo" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 61; //在《申请表字典表》找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_PullafewTwo = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_PullafewTwo_Inherit.Insert(t_OfficeAutomation_Document_PullafewTwo);//插入申请表

                InsertPullafewTwoDetail(t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_ID);
                InsertPullafewTwoDetail2(t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_ID);
                InsertPullafewTwoDetail3(t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_ID);
                ...
                Common.AddLog(EmployeeID, EmployeeName, 65, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_PullafewTwo_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
                ...
                if (Purview.Contains("OA_ITPower_001"))//是否有编辑权限
                {
                    ...
                    if (tempsave)
                    {
                        ...
                        ds = da_OfficeAutomation_Document_Flow_Inherit.SelectByMainID(MainObj.OfficeAutomation_Main_ID.ToString());
                        if (ds != null && ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                        {
                            foreach (DataRow dr in ds.Tables[0].Rows)
                            {
    ...
    {
        var SerialNumber = "PullafewTwo" + DateTime.Now.ToString("yyyyMMddHHmmssfffff");
        var DocumentID = 61;
        var Creater = EmployeeName;
        var da_OfficeAutomation_Main_Inherit = new DA_OfficeAutomation_Main_Inherit();
        var PullafewTwo_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_Inherit();
        ...
        //判断是否多次点击保存按钮
        DataSet ds = new DataSet();
        var PullafewTwo = new T_OfficeAutomation_Document_PullafewTwo();
        ds = PullafewTwo_Inherit.SelectByMainID(MainID);
        if (ds.Tables[0].Rows.Count == 0)
        {
            PullafewTwo = GetModelFromPage(Guid.NewGuid());
        }
        else
        {
            var PullafewTwo_ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_PullafewTwo_ID"].ToString();
            PullafewTwo = GetModelFromPage(new Guid(PullafewTwo_ID));
        }
        var obj = new Apply_PullafewTwo_Detail();
        obj.MainEntity = t_OfficeAutomation_Main;

        //var PullafewTwo = GetModelFromPage(Guid.NewGuid());
        PullafewTwo_Inherit.HandleBase(PullafewTwo);                      //只插入关键必填字段；
        var Detail = GetPullafewTwoDetail(PullafewTwo.OfficeAutomation_Document_PullafewTwo_ID);
        var LeaseTerm = GetPullafewTwoDetail3(PullafewTwo.OfficeAutomation_Document_PullafewTwo_ID);
        var Statistical = GetPullafewTwoDetail2(PullafewTwo.OfficeAutomation_Document_PullafewTwo_ID);

        obj.PullafewTwo = PullafewTwo;
        obj.Statistical = Statistical;
        obj.LeaseTerm = LeaseTerm;
        obj.PullafewTwo_Detail = Detail;

        //暂存数据保存到xml文件中
        var result = new Common().SaveTempSaveFile<Apply_PullafewTwo_Detail>(obj, "PullafewTwoDetail", "", t_OfficeAutomation_Main.OfficeAutomation_SerialNumber);
        if (result)
        {
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        if (files.Count > 0)
        {
            ...
            Common.AddLog(EmployeeID, EmployeeName, 65, new Guid(MainID), 8);
        }
        else
            Alert("请勾选文件再下载！");
    }
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DA_OfficeAutomation_Document_PullafewTwo_Inherit da_OfficeAutomation_Document_PullafewTwo_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_Inherit();
        DA_OfficeAutomation_Document_PullafewTwo_Detail_Inherit da_OfficeAutomation_Document_PullafewTwo_Detail_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_Detail_Inherit();
        DA_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit da_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit();
        
        DataSet ds = da_OfficeAutomation_Document_PullafewTwo_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_PullafewTwo_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_PullafewTwo_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_PullafewTwo_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_PullafewTwo_Apply"]);
                    sbMailBody.Append("<br/>申请部门：" + drRow["OfficeAutomation_Document_PullafewTwo_Department"]);
                    sbMailBody.Append("<br/>申请日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_PullafewTwo_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>发文编号: " + drRow["OfficeAutomation_Document_PullafewTwo_ApplyID"].ToString());
                    sbMailBody.Append("<br/><br/>");

                    sbMailBody.Append("<br/>二级市场一手项目欠必要性文件拉数申请：");
                    ds = da_OfficeAutomation_Document_PullafewTwo_Detail_Inherit.SelectByMainID(MainID);
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        sbMailBody.Append("<br/>项目负责人：" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1a"]);
                        sbMailBody.Append("<br/>楼盘名称：" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1b"]);
                        sbMailBody.Append("<br/>代理期：" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1c"]);
                        sbMailBody.Append("<br/>成交总宗数：" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1d"]);
                        sbMailBody.Append("<br/>成交总业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1e"]);
                        sbMailBody.Append("<br/>二级市场欠收业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1f"]);
                        sbMailBody.Append("<br/>三级市场欠收业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1ff"]);
                        sbMailBody.Append("<br/>欠收业绩合计：" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1g"]);
                        sbMailBody.Append("<br/>拉数原因：" + dr["OfficeAutomation_Document_PullafewTwo_Detail_1h"]);
                        sbMailBody.Append("<br/>");
                    }
                    sbMailBody.Append("<br/>");

                    sbMailBody.Append("<br/>三级市场自接项目各成交区域实际拉数业绩：");
                    ds = da_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit.SelectByMainID(MainID);
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        sbMailBody.Append("<br/>项目负责人：" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1a"]);
                        sbMailBody.Append("<br/>楼盘名称：" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1b"]);
                        sbMailBody.Append("<br/>海珠区欠收业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1c"]);
                        sbMailBody.Append("<br/>天河区欠收业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1d"]);
                        sbMailBody.Append("<br/>白云区欠收业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1e"]);
                        sbMailBody.Append("<br/>越秀区欠收业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1f"]);
                        sbMailBody.Append("<br/>花都欠收业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1g"]);
                        sbMailBody.Append("<br/>番禺欠收业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1h"]);
                        sbMailBody.Append("<br/>工商铺（罗思源)欠收业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1i"]);
                        sbMailBody.Append("<br/>工商铺（谢伟中）欠收业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1j"]);
                        //sbMailBody.Append("<br/>项目部欠收业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1jk"]);
                        sbMailBody.Append("<br/>合计欠收业绩：" + dr["OfficeAutomation_Document_PullafewTwo_Statistical_1k"]);
                        sbMailBody.Append("<br/>");
                    }
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_PullafewTwo_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private T_OfficeAutomation_Document_PullafewTwo GetModelFromPage(Guid PullafewTwoID)
    {
        T_OfficeAutomation_Document_PullafewTwo t_OfficeAutomation_Document_PullafewTwo = new T_OfficeAutomation_Document_PullafewTwo();
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_ID = PullafewTwoID;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_Apply = EmployeeName;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_Department = txtDepartment.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_ApplyDate = DateTime.Now;

        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1a = txt1a.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1b = txt1b.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1c = txt1c.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1d = txt1d.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1e = txt1e.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1f = txt1f.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1g = txt1g.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1h = txt1h.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1i = txt1i.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1ii = txt1ii.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1j = txt1j.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1k = txt1k.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1l = txt1l.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1m = txt1m.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1n = txt1n.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1o = txt1o.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1p = txt1p.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1q = txt1q.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1r = txt1r.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1s = txt1s.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1t = txt1t.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1u = txt1u.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_1v = txt1v.Text;

        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_2a = txt2a.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_2b = txt2b.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_2c = txt2c.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_2cc = txt2cc.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_2d = txt2d.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_2f = txt2f.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_2g = txt2g.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_2h = txt2h.Text;

        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_4a = txt4a.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_4b = txt4b.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_4c = txt4c.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_4cc = txt4cc.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_4d = txt4d.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_4dd = txt4dd.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_4e = txt4e.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_4f = txt4f.Text;
        t_OfficeAutomation_Document_PullafewTwo.OfficeAutomation_Document_PullafewTwo_4g = txt4g.Text;

        return t_OfficeAutomation_Document_PullafewTwo;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_PullafewTwo_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_PullafewTwo_ID"].ToString();

        t_OfficeAutomation_Document_PullafewTwo = GetModelFromPage(new Guid(ID));
        ...
        da_OfficeAutomation_Document_PullafewTwo_Inherit.Update(t_OfficeAutomation_Document_PullafewTwo);//修改申请表

        DA_OfficeAutomation_Document_PullafewTwo_Detail_Inherit da_OfficeAutomation_Document_PullafewTwo_Detail_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_Detail_Inherit();
        da_OfficeAutomation_Document_PullafewTwo_Detail_Inherit.Delete(ID);
        InsertPullafewTwoDetail(new Guid(ID));

        DA_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit da_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit();
        da_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit.Delete(ID);
        InsertPullafewTwoDetail2(new Guid(ID));

        DA_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit da_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit();
        da_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit.Delete(ID);
        InsertPullafewTwoDetail3(new Guid(ID));

        Common.AddLog(EmployeeID, EmployeeName, 65, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    /// 新增广告宣传需求申请摊分情况表
    /// </summary>
    /// <param name="gPullafewTwoID"></param>
    private void InsertPullafewTwoDetail(Guid gPullafewTwoID)
    {
        if (hdDetail.Value == "")
            return;

        T_OfficeAutomation_Document_PullafewTwo_Detail t_OfficeAutomation_Document_PullafewTwo_Detail;
        DA_OfficeAutomation_Document_PullafewTwo_Detail_Inherit da_OfficeAutomation_Document_PullafewTwo_Detail_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_Detail_Inherit();
        ...
        try
        {
            for (int i = 0; i < details.Length; i++)
            {
                ...
                //if (detail[0] == "")
                //    continue;
                t_OfficeAutomation_Document_PullafewTwo_Detail = new T_OfficeAutomation_Document_PullafewTwo_Detail();
                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_MainID = gPullafewTwoID;

                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_1a = detail[0];
                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_1b = detail[1];
                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_1c = "";
                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_1d = detail[2];
                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_1e = detail[3];
                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_1f = detail[4];
                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_1ff = detail[5];
                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_1g = detail[6];
                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_1h = detail[7];

                da_OfficeAutomation_Document_PullafewTwo_Detail_Inherit.Insert(t_OfficeAutomation_Document_PullafewTwo_Detail);
            }
        }
        catch(Exception ee)
        {
    ...
    /// <summary>
    /// 新增二级市场一手项目欠必要性文件拉数申请欠合同拉数统计表
    /// </summary>
    /// <param name="gPullafewTwoID"></param>
    private void InsertPullafewTwoDetail3(Guid gPullafewTwoID)
    {
        if (hdDetail3.Value == "")
            return;

        T_OfficeAutomation_Document_PullafewTwo_LeaseTerm t_OfficeAutomation_Document_PullafewTwo_LeaseTerm;
        DA_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit da_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit();
        ...
        try
        {
            for (int i = 0; i < details.Length; i++)
            {
                ...
                //if (detail[0] == "")
                //    continue;
                t_OfficeAutomation_Document_PullafewTwo_LeaseTerm = new T_OfficeAutomation_Document_PullafewTwo_LeaseTerm();
                t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_MainID = gPullafewTwoID;

                t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_1a = detail[0];
                t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_1b = detail[1];
                t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_1c = detail[2];
                t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_1d = detail[3];
                t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_1e = detail[4];
                t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_1f = detail[5];
                t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_1g = detail[6];
                t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_1h = detail[7];
                t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_1i = detail[8];

                da_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit.Insert(t_OfficeAutomation_Document_PullafewTwo_LeaseTerm);
            }
        }
        catch (Exception ee)
        {
    ...
    /// </summary>
    /// <param name="gPullafewTwoID"></param>
    private void InsertPullafewTwoDetail2(Guid gPullafewTwoID)
    {
        if (hdDetail2.Value == "")
            return;

        T_OfficeAutomation_Document_PullafewTwo_Statistical t_OfficeAutomation_Document_PullafewTwo_Statistical;
        DA_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit da_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit();
        ...
        try
        {
            for (int i = 0; i < details.Length; i++)
            {
                ...
                //if (detail[0] == "")
                //    continue;
                t_OfficeAutomation_Document_PullafewTwo_Statistical = new T_OfficeAutomation_Document_PullafewTwo_Statistical();
                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_MainID = gPullafewTwoID;

                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1a = detail[0];
                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1b = detail[1];
                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1c = detail[2];
                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1d = detail[3];
                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1e = detail[4];
                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1f = detail[5];
                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1g = detail[6];
                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1h = detail[7];
                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1i = detail[8];
                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1j = detail[9];
                //t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1jk = detail[10];
                t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1k = detail[10];

                da_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit.Insert(t_OfficeAutomation_Document_PullafewTwo_Statistical);
            }
        }
        catch (Exception ee)
        {
    ...
    /// <summary>
    /// 二级市场一手项目欠必要性文件拉数申请资料表
    /// </summary>
    /// <param name="gPullafewTwoID"></param>
    private List<T_OfficeAutomation_Document_PullafewTwo_Detail> GetPullafewTwoDetail(Guid gPullafewTwoID)
    {
        if (hdDetail.Value == "")
            return null;
        ...
        string[] details = Regex.Split(hdDetail.Value, "\\|\\|");
		var list = new List<T_OfficeAutomation_Document_PullafewTwo_Detail>();
        for (int i = 0; i < details.Length; i++)
            {
                string[] detail = Regex.Split(details[i], "\\&\\&");
                t_OfficeAutomation_Document_PullafewTwo_Detail = new T_OfficeAutomation_Document_PullafewTwo_Detail();
                ...
                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_1g = detail[6];
                t_OfficeAutomation_Document_PullafewTwo_Detail.OfficeAutomation_Document_PullafewTwo_Detail_1h = detail[7]; 
                list.Add(t_OfficeAutomation_Document_PullafewTwo_Detail);				
            }
        return list;
    }
    ...
    /// </summary>
    /// <param name="gPullafewTwoID"></param>
    private List<T_OfficeAutomation_Document_PullafewTwo_LeaseTerm> GetPullafewTwoDetail3(Guid gPullafewTwoID)
    {
        if (hdDetail3.Value == "")
            return null;
        ...
        DA_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit da_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_LeaseTerm_Inherit();
        string[] details = Regex.Split(hdDetail3.Value, "\\|\\|");
        var list = new List<T_OfficeAutomation_Document_PullafewTwo_LeaseTerm>();
        for (int i = 0; i < details.Length; i++)
        {
            string[] detail = Regex.Split(details[i], "\\&\\&");
            t_OfficeAutomation_Document_PullafewTwo_LeaseTerm = new T_OfficeAutomation_Document_PullafewTwo_LeaseTerm();
            ...
            t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_1h = detail[7];
            t_OfficeAutomation_Document_PullafewTwo_LeaseTerm.OfficeAutomation_Document_PullafewTwo_LeaseTerm_1i = detail[8];
            list.Add(t_OfficeAutomation_Document_PullafewTwo_LeaseTerm);
        }
        return list;
    }
    ...
    /// </summary>
    /// <param name="gPullafewTwoID"></param>
    private List<T_OfficeAutomation_Document_PullafewTwo_Statistical> GetPullafewTwoDetail2(Guid gPullafewTwoID)
    {
        if (hdDetail2.Value == "")
            return null;
        ...
        DA_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit da_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit();
        string[] details = Regex.Split(hdDetail2.Value, "\\|\\|");
        var list = new List<T_OfficeAutomation_Document_PullafewTwo_Statistical>();
        for (int i = 0; i < details.Length; i++)
        {
            string[] detail = Regex.Split(details[i], "\\&\\&");
            t_OfficeAutomation_Document_PullafewTwo_Statistical = new T_OfficeAutomation_Document_PullafewTwo_Statistical();
            ...
            //t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1jk = detail[10];
            t_OfficeAutomation_Document_PullafewTwo_Statistical.OfficeAutomation_Document_PullafewTwo_Statistical_1k = detail[10];
            list.Add(t_OfficeAutomation_Document_PullafewTwo_Statistical);
        }
        return list;
    }
    #endregion
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite66"] = "1";
        Response.Write("<script>window.open('Apply_PullafewTwo_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("二级市场一手项目欠必要性文件拉数申请.pdf"));//强制下载 
    ...
    //    DataSet ds = new DataSet();
    //    ds = da_OfficeAutomation_Document_PullafewTwo_Inherit.SelectByMainID(MainID);
    //    ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_PullafewTwo_ID"].ToString(); //在不同的表要注意修改
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_PullafewTwo_Inherit da_OfficeAutomation_Document_PullafewTwo_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_Inherit();
            DataSet ds = da_OfficeAutomation_Document_PullafewTwo_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_PullafewTwo_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_PullafewTwo_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_PullafewTwo_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_PullafewTwo_Inherit();
    ...
    protected void btnImport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            for (i = 1; i <= range.Rows.Count; i++)
            {
                try
                {
                    if (!string.IsNullOrEmpty(values[i, 2].ToString()))
                    {
                        ...
                        SbJs.Append("$('#txtDetail_1c" + i + "').val('" + values[i, 3].ToString().Trim() + "');");
                        SbJs.Append("$('#txtDetail_1d" + i + "').val('" + values[i, 4].ToString().Trim() + "');");
                        SbJs.Append("$('#txtDetail_1e" + i + "').val('" + values[i, 5].ToString().Trim() + "');");
                        SbJs.Append("$('#txtDetail_1f" + i + "').val('" + values[i, 6].ToString().Trim() + "');");
                        SbJs.Append("$('#txtDetail_1ff" + i + "').val('" + values[i, 7].ToString().Trim() + "');");
                        SbJs.Append("$('#txtDetail_1g" + i + "').val('" + values[i, 8].ToString().Trim() + "');");
                        SbJs.Append("$('#txtDetail_1h" + i + "').val('" + values[i, 9].ToString().Trim() + "');");

                        tg += float.Parse(values[i, 4].ToString().Trim());
                        th += float.Parse(values[i, 5].ToString().Trim());
                        ti += float.Parse(values[i, 6].ToString().Trim());
                        tii += float.Parse(values[i, 7].ToString().Trim());
                        tj += float.Parse(values[i, 8].ToString().Trim());
                    }
                }
                catch
                {
            ...
            txt1ii.Text = tii.ToString();
            txt1j.Text = tj.ToString();
            ...
            ran = ws.get_Range("D2", "E2");
            value = (object[,])ran.Value2;
            range = ws.get_Range("A4", "I" + rowCount);
            ...
            txt2cc.Text = st2.Substring(st2.IndexOf("年") + 1, st2.IndexOf("月") - st2.IndexOf("年") - 1);
            ...
            for (i = 1; i <= range.Rows.Count; i++)
            {
                try
                {
                    if (!string.IsNullOrEmpty(values[i, 2].ToString()))
                    {
                        ...
                        SbJs.Append("$('#txtLeaseTerm_1c" + i + "').val('" + values[i, 3].ToString().Trim() + "');");
                        SbJs.Append("$('#txtLeaseTerm_1d" + i + "').val('" + values[i, 4].ToString().Trim() + "');");
                        SbJs.Append("$('#txtLeaseTerm_1e" + i + "').val('" + values[i, 5].ToString().Trim() + "');");
                        SbJs.Append("$('#txtLeaseTerm_1f" + i + "').val('" + values[i, 6].ToString().Trim() + "');");
                        SbJs.Append("$('#txtLeaseTerm_1g" + i + "').val('" + values[i, 7].ToString().Trim() + "');");
                        SbJs.Append("$('#txtLeaseTerm_1h" + i + "').val('" + values[i, 8].ToString().Trim() + "');");
                        SbJs.Append("$('#txtLeaseTerm_1i" + i + "').val('" + values[i, 9].ToString().Trim() + "');");
            ...
            txt2d.Text = tg.ToString();
            txt2f.Text = th.ToString();
            txt2g.Text = ti.ToString();
            txt2h.Text = tii.ToString();
            ...
            //value = (object[,])ran.Value2;
            range = ws.get_Range("A4", "J" + rowCount);
            values = (object[,])range.Value2;
            tg = 0; th = 0; ti = 0; tii = 0; tj = 0;
            float tr = 0, ts = 0, tt = 0, tu = 0, kk;
