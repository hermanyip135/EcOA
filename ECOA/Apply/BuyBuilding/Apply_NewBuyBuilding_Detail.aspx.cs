...
public partial class Apply_BuyBuilding_Apply_NewBuyBuilding_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    public void NewPage()
    {
        ...
        RunJS("alert('如需申请享受员工购/租楼宇免佣福利，请先上员工个人利益申报表');");
    }
    ...
    public void InitPage()
    {
        ...
        ds = da_Dic_OfficeAutomation_DepartmentType_Operate.SelectByDocumentID(8);
    ...
    public void LoadPage()
    {
        ...
        ddlDepartmentType.SelectedValue = dr["OfficeAutomation_Document_BuyBuilding_DepartmentType"].ToString();
        this.txtFollowNo.Text = dr["OfficeAutomation_Document_BuyBuilding_FollowNo"].ToString();
        this.txtTransNo.Value = dr["OfficeAutomation_Document_BuyBuilding_TransNo"].ToString();
        this.txtTransAddress.Value = dr["OfficeAutomation_Document_BuyBuilding_TransAddress"].ToString();
        this.txtTransDate.Value = dr["OfficeAutomation_Document_BuyBuilding_TransDate"].ToString();
        this.txtHouseRegistrant.Text = dr["OfficeAutomation_Document_BuyBuilding_HouseRegistrant"].ToString();
        this.drpIsRebate.SelectedValue = dr["OfficeAutomation_Document_BuyBuilding_IsRebate"].ToString();
        this.txtRebateDate.Value = dr["OfficeAutomation_Document_BuyBuilding_RebateDate"].ToString();
        this.txtInstruction.Text = dr["OfficeAutomation_Document_BuyBuilding_Instruction"].ToString();
        ...
        txtFollowBranch.Value = dr["OfficeAutomation_Document_BuyBuilding_FollowBranch"].ToString();
        txtFollowSales.Value = dr["OfficeAutomation_Document_BuyBuilding_FollowSales"].ToString();
        switch (dr["OfficeAutomation_Document_BuyBuilding_MortgageAddressTypeID"].ToString())
        {
            ...
            case "2":
                ...
                break;
            case "3":
                this.rdbMortgageAddress3.Checked = true;
                break;
            default:
                break;
        }
        ...
        //if ((EmployeeID == "16945" || EmployeeID == "42900") && flowState=="3")

        //2019-10-21 财务部将 胡雅丝（16945） 权限移交比 钟惠贤（43781）
        if ((EmployeeID == "43781" || EmployeeID == "42900") && flowState == "3")
        {
            this.btndengji.Visible = true;
        }
        ...
        //20170502注释掉修改为如果有131的话就显示第二个汇瀚审批框
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_ContactAddress = "";
                ...
                t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_FollowBranch = this.txtFollowBranch.Value;
                t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_FollowSales = this.txtFollowSales.Value;
                t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_MortgageAddressTypeID = this.rdbMortgageAddress1.Checked ? 1 : this.rdbMortgageAddress2.Checked ? 2 : this.rdbMortgageAddress3.Checked ? 3 : 0;
                ...
                t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_DepartmentType = hdDepartmentType.Value;
                t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_FollowNo = txtFollowNo.Text;
                ...
                if (isImmediste)
                    ...
                    RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_BuyBuilding_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=250px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                //SYSREQ201807161459317966103 朱晓晴或张晓莹任意一个审批完即到下一个审批层（郑纯宁）
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.open('Apply_NewBuyBuilding_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    ...
    //由财务部登登记
    protected void btndengji_Click(object sender, EventArgs e)
    {
        ...
        t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_ID = new Guid(ID);
        t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_TransNo = txtTransNo.Value;
        t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_TransAddress = txtTransAddress.Value;
        t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_TransDate = txtTransDate.Value;
        t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_HouseRegistrant = txtHouseRegistrant.Text;
        t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_IsRebate = drpIsRebate.SelectedValue;
        t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_RebateDate = txtRebateDate.Value;
        t_OfficeAutomation_Document_BuyBuilding.OfficeAutomation_Document_BuyBuilding_Instruction = txtInstruction.Text;

        da_OfficeAutomation_Document_BuyBuilding_Inherit.updateForCaiWu(t_OfficeAutomation_Document_BuyBuilding);

        Common.AddLog(EmployeeID, EmployeeName, 9, new Guid(MainID), 2);//日志，修改申请表

        RunJS("alert('登记成功！');window.location='" + Page.Request.Url + "'");
