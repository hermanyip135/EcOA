...
public partial class Apply_Maintenance_Apply_Maintenance_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite58"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite58"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_Maintenance_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_Maintenance_ID"].ToString();

        string applicant = dr["OfficeAutomation_Document_Maintenance_Apply"].ToString();
        ApplyN = applicant;
        lblApply.Text = applicant;
        txtDepartment.Text = dr["OfficeAutomation_Document_Maintenance_Department"].ToString();
        txtApplyID.Text = dr["OfficeAutomation_Document_Maintenance_ApplyID"].ToString();
        if (dr["OfficeAutomation_Document_Maintenance_ApplyDate"].ToString()!="") 
        {
            lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_Maintenance_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        }
        txtReceiveDepartment.Text = dr["OfficeAutomation_Document_Maintenance_ReceiveDepartment"].ToString();
        txtCCDepartment.Text = dr["OfficeAutomation_Document_Maintenance_CCDepartment"].ToString();
        txtTelephone.Text = dr["OfficeAutomation_Document_Maintenance_ReplyPhone"].ToString();
        txtFax.Text = dr["OfficeAutomation_Document_Maintenance_Fax"].ToString();
        txtSubject.Text = dr["OfficeAutomation_Document_Maintenance_Subject"].ToString();

        txtStartDate.Text = dr["OfficeAutomation_Document_Maintenance_StartDate"].ToString();
        txtCycle.Text = dr["OfficeAutomation_Document_Maintenance_Cycle"].ToString();
        txtDepreciationB.Text = dr["OfficeAutomation_Document_Maintenance_DepreciationB"].ToString();
        txtDContent.Text = dr["OfficeAutomation_Document_Maintenance_DContent"].ToString();
        txtDueToDate.Text = dr["OfficeAutomation_Document_Maintenance_DueToDate"].ToString();
        txtRenovationDate.Text = dr["OfficeAutomation_Document_Maintenance_RenovationDate"].ToString();
        txtRContent.Text = dr["OfficeAutomation_Document_Maintenance_RContent"].ToString();
        txtRprice.Text = dr["OfficeAutomation_Document_Maintenance_Rprice"].ToString();
        txtResultsBeginDate.Text = dr["OfficeAutomation_Document_Maintenance_ResultsBeginDate"].ToString();
        txtResultsEndDate.Text = dr["OfficeAutomation_Document_Maintenance_ResultsEndDate"].ToString();
        txtProfitBeginDate.Text = dr["OfficeAutomation_Document_Maintenance_ProfitBeginDate"].ToString();
        txtProfitEndDate.Text = dr["OfficeAutomation_Document_Maintenance_ProfitEndDate"].ToString();
        txtLeaseDate.Text = dr["OfficeAutomation_Document_Maintenance_LeaseDate"].ToString();
        txtResultsCoast.Text = dr["OfficeAutomation_Document_Maintenance_ResultsCoast"].ToString();
        txtProfitCoast.Text = dr["OfficeAutomation_Document_Maintenance_ProfitCoast"].ToString();
        if (dr["OfficeAutomation_Document_Maintenance_IsLease"].ToString() == "True")
            rdbIsLease1.Checked = true;
        else if (dr["OfficeAutomation_Document_Maintenance_IsLease"].ToString() == "False")
            rdbIsLease2.Checked = true;

        txtStartDateMonth.Text = dr["OfficeAutomation_Document_Maintenance_StartDateMonth"].ToString();
        txtCycleMonth.Text = dr["OfficeAutomation_Document_Maintenance_CycleMonth"].ToString();
        txtDescribe.Text = dr["OfficeAutomation_Document_Maintenance_Describe"].ToString();
        ...
        //if (dr["OfficeAutomation_Document_Maintenance_Department"].ToString() == "市场部")
        //    SbJs.Append("$(\"#trMs1\").hide();$(\"#trMs2\").hide();$(\"#trMs3\").hide();$(\"#trMs4\").hide();");
        //else
            SbJs.Append("$(\"#trMs1\").show();$(\"#trMs2\").show();$(\"#trMs3\").show();$(\"#trMs4\").show();");
        ...
        for (int i = 0; i < drc.Count; i++)
        {
            ...
            if (EmployeeName == "黄轩明" && curemp2.Contains(EmployeeID) && showf) //M_HideFlows：20150330
            {
                showf = false;
                SbJs.Append("$(\"#trMs1\").hide();$(\"#trMs2\").prepend('<td>行政部</td>');");
                SbJs.Append("$(\"#trMs3\").hide();$(\"#trMs4\").prepend('<td>财务部</td>');");
                SbJs.Append("$(\"#trLogistics\").hide();$(\"#trLogistics2\").prepend('<td>后勤事务部<br />意见<br /><asp:Button ID=\"btnWillEnd\" runat=\"server\" Text=\"结束\" OnClick=\"btnWillEnd_Click\" Visible=\"False\" /></td>');");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_Maintenance t_OfficeAutomation_Document_Maintenance = new T_OfficeAutomation_Document_Maintenance();
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "Maintenance" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 53; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_Maintenance = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_Maintenance_Inherit.Insert(t_OfficeAutomation_Document_Maintenance);//插入申请表
                ...
                Common.AddLog(EmployeeID, EmployeeName, 57, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_Maintenance_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    {
        var SerialNumber = "Maintenance" + DateTime.Now.ToString("yyyyMMddHHmmssfffff");
        var DocumentID = 53;
        ...
        //判断是否多次点击保存按钮
        DataSet ds = new DataSet();
        var Maintenance_Inherit = new DA_OfficeAutomation_Document_Maintenance_Inherit();
        var Maintenance = new T_OfficeAutomation_Document_Maintenance();
        ds = Maintenance_Inherit.SelectByMainID(MainID);
        if (ds.Tables[0].Rows.Count == 0)
        {
            Maintenance = GetModelMFromPage(Guid.NewGuid());
        }
        else
        {
            var Maintenance_ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Maintenance_ID"].ToString();
            Maintenance = GetModelMFromPage(new Guid(Maintenance_ID));
        }

        var result = Maintenance_Inherit.HandleBase(Maintenance);                      //只插入关键必填字段；
        if (result)
        {
    ...
    private T_OfficeAutomation_Document_Maintenance GetModelFromPage(Guid MaintenanceID)
    {
        T_OfficeAutomation_Document_Maintenance t_OfficeAutomation_Document_Maintenance = new T_OfficeAutomation_Document_Maintenance();
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ID = MaintenanceID;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_Apply = EmployeeName;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_Department = txtDepartment.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ReceiveDepartment = txtReceiveDepartment.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_CCDepartment = txtCCDepartment.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ReplyPhone = txtTelephone.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_Fax = txtFax.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_Subject = txtSubject.Text;

        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_StartDate = txtStartDate.Text;
        if (hdCycle.Value != "")
            t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_Cycle = hdCycle.Value;
        else
            t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_Cycle = txtCycle.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_DepreciationB = txtDepreciationB.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_DContent = txtDContent.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_DueToDate = txtDueToDate.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_RenovationDate = txtRenovationDate.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_RContent = txtRContent.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_Rprice = txtRprice.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ResultsBeginDate = txtResultsBeginDate.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ResultsEndDate = txtResultsEndDate.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ProfitBeginDate = txtProfitBeginDate.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ProfitEndDate = txtProfitEndDate.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_LeaseDate = txtLeaseDate.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ResultsCoast = txtResultsCoast.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ProfitCoast = txtProfitCoast.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_IsLease = rdbIsLease1.Checked;

        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_StartDateMonth = txtStartDateMonth.Text;
        if (hdCycleMonth.Value != "")
            t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_CycleMonth = hdCycleMonth.Value;
        else
            t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_CycleMonth = txtCycleMonth.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_Describe = txtDescribe.Text;

        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_Describe = HiddenField1.Value;
   
        return t_OfficeAutomation_Document_Maintenance;
    }

    private T_OfficeAutomation_Document_Maintenance GetModelMFromPage(Guid MaintenanceID)
    {
        T_OfficeAutomation_Document_Maintenance t_OfficeAutomation_Document_Maintenance = new T_OfficeAutomation_Document_Maintenance();
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ID = MaintenanceID;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_MainID = new Guid(MainID);
        ...
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ResultsCoast = txtResultsCoast.Text;
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_ProfitCoast = txtProfitCoast.Text;
        if (rdbIsLease1.Checked || rdbIsLease2.Checked) 
        {
            t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_IsLease = rdbIsLease1.Checked;
        }
        t_OfficeAutomation_Document_Maintenance.OfficeAutomation_Document_Maintenance_StartDateMonth = txtStartDateMonth.Text;
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_Maintenance_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_Maintenance_ID"].ToString();
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Maintenance_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_Maintenance_Department"].ToString();
                    string applyUrl = Page.Request.Url.ToString();
                    //string plantime = drRow["OfficeAutomation_Document_Maintenance_PlanDate"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_Maintenance_Apply"]);
                    sbMailBody.Append("<br/>发文日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_Maintenance_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>发文编号：" + drRow["OfficeAutomation_Document_Maintenance_ApplyID"]);
                    sbMailBody.Append("<br/>发文部门：" + drRow["OfficeAutomation_Document_Maintenance_Department"]);
                    sbMailBody.Append("<br/>收文部门：" + drRow["OfficeAutomation_Document_Maintenance_ReceiveDepartment"]);
                    sbMailBody.Append("<br/>回复电话：" + drRow["OfficeAutomation_Document_Maintenance_ReplyPhone"]);
                    sbMailBody.Append("<br/>回复传真：" + drRow["OfficeAutomation_Document_Maintenance_Fax"]);
                    sbMailBody.Append("<br/>文件主题：" + drRow["OfficeAutomation_Document_Maintenance_Subject"]);

                    sbMailBody.Append("<br/>分行开业时间：" + drRow["OfficeAutomation_Document_Maintenance_StartDate"].ToString() + "年" + drRow["OfficeAutomation_Document_Maintenance_StartDateMonth"].ToString() + "月");
                    sbMailBody.Append("<br/>分行开铺时长：" + drRow["OfficeAutomation_Document_Maintenance_Cycle"].ToString() + "年" + drRow["OfficeAutomation_Document_Maintenance_CycleMonth"].ToString() + "月");
                    sbMailBody.Append("<br/>装修折旧余额：" + drRow["OfficeAutomation_Document_Maintenance_DepreciationB"]);
                    sbMailBody.Append("<br/>装修折旧内容：" + drRow["OfficeAutomation_Document_Maintenance_DContent"]);
                    sbMailBody.Append("<br/>装修折旧到期日：" + drRow["OfficeAutomation_Document_Maintenance_DueToDate"]);
                    sbMailBody.Append("<br/>最近翻新时间：" + drRow["OfficeAutomation_Document_Maintenance_RenovationDate"]);
                    sbMailBody.Append("<br/>最近翻新内容：" + drRow["OfficeAutomation_Document_Maintenance_RContent"]);
                    sbMailBody.Append("<br/>最近翻新金额：" + drRow["OfficeAutomation_Document_Maintenance_Rprice"]);
                    sbMailBody.Append("<br/>业绩数据开始时间：" + drRow["OfficeAutomation_Document_Maintenance_ResultsBeginDate"]);
                    sbMailBody.Append("<br/>业绩数据结束时间：" + drRow["OfficeAutomation_Document_Maintenance_ResultsEndDate"]);
                    sbMailBody.Append("<br/>业绩数据金额：" + drRow["OfficeAutomation_Document_Maintenance_ResultsCoast"]);
                    sbMailBody.Append("<br/>盈利数据开始时间：" + drRow["OfficeAutomation_Document_Maintenance_ProfitBeginDate"]);
                    sbMailBody.Append("<br/>盈利数据结束时间：" + drRow["OfficeAutomation_Document_Maintenance_ProfitEndDate"]);
                    sbMailBody.Append("<br/>盈利数据金额：" + drRow["OfficeAutomation_Document_Maintenance_ProfitCoast"]);
                    sbMailBody.Append("<br/>租约到期日：" + drRow["OfficeAutomation_Document_Maintenance_LeaseDate"]);
                    sbMailBody.Append("<br/>是否续租：" + (drRow["OfficeAutomation_Document_Maintenance_IsLease"].ToString() == "True" ? "是" : "否"));

                    sbMailBody.Append("<br/>申请正文：" + drRow["OfficeAutomation_Document_Maintenance_Describe"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_Maintenance_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_Maintenance_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Maintenance_ID"].ToString();

        t_OfficeAutomation_Document_Maintenance = GetModelFromPage(new Guid(ID));
        ...
        da_OfficeAutomation_Document_Maintenance_Inherit.Update(t_OfficeAutomation_Document_Maintenance);//修改申请表

        Common.AddLog(EmployeeID, EmployeeName, 57, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite58"] = "1";
        Response.Write("<script>window.open('Apply_Maintenance_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("大额维修申请表.pdf"));//强制下载 
    ...
    protected void btnSaveLogisticsFlow_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_Maintenance_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Maintenance_ID"].ToString(); //在不同的表要注意修改
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_Maintenance_Inherit da_OfficeAutomation_Document_Maintenance_Inherit = new DA_OfficeAutomation_Document_Maintenance_Inherit();
            DataSet ds = da_OfficeAutomation_Document_Maintenance_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Maintenance_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            ...
            if (flows != null)
            {
                ...
                if (i <= 16 && EmployeeID == "13545") //M_AddNWX：20150511
                {
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_Maintenance_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_Maintenance_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_Maintenance_Inherit();
