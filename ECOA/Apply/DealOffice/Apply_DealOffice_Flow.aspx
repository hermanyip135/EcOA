<%@ Page Title="流程编辑 - 广州中原电子审批系统"  Language="C#" AutoEventWireup="true" CodeFile="Apply_DealOffice_Flow.aspx.cs" Inherits="Apply_DealOffice_Apply_DealOffice_Flow" %>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "text",
                data: 'action=saveDealOfficeFlow&id=<%=EmployeeID %>&name=<%=EmployeeName %>&purview=<%=Purview %>&mainid=<%=MainID %>&content=' + content,
                success: function(info) {
                    if (info == "success") {
                        alert('流程编辑成功!');
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <div id="divIDx1" class='item'><input id="btnIDx1" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(1);" /><label id="lblIDx1" for='btnIDx1'>部门主管</label></div><div id="divTxtIDx1" class='item' style="display:none;"><input type="text" id="txtIDx1" style="width:200px;" /><input id="hdIDx1" type="hidden" /><a href="javascript:;" onclick="return showOrHideIDx(1);">取消</a></div><img src="/Images/forward.png" class="forward"/>
            <div id="divIDx2" class='item'><input id="btnIDx2" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(2);" /><label id="lblIDx2" for='btnIDx2'>隶属主管</label></div><div id="divTxtIDx2" class='item' style="display:none;"><input type="text" id="txtIDx2" style="width:100px;" /><input id="hdIDx2" type="hidden" /><a href="javascript:;" onclick="return showOrHideIDx(2);">取消</a></div><img src="/Images/forward.png" class="forward"/>
            <div id="divIDx3" class='item'><input id="btnIDx3" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(3);" /><label id="lblIDx3" for='btnIDx3'>部门负责人</label></div><div id="divTxtIDx3" class='item' style="display:none;"><input type="text" id="txtIDx3" style="width:100px;" /><input id="hdIDx3" type="hidden" /><a href="javascript:;" onclick="return showOrHideIDx(3);">取消</a></div>
            <br /><br />
