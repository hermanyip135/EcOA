...
public partial class Apply_DealOffice_Apply_DealOffice_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite7"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite7"] = null;
                }
            }
            catch
            {
    ...
    public void InitPage()
    {
        ...
        this.lblApply.Text = EmployeeName;
        this.lblApplyDate.Text = DateTime.Now.ToString("yyyy-MM-dd");

        this.btnSave.Visible = true;

        DA_Dic_OfficeAutomation_DealOfficeType_Operate da_Dic_OfficeAutomation_DealOfficeType_Operate = new DA_Dic_OfficeAutomation_DealOfficeType_Operate();
        DataSet ds = da_Dic_OfficeAutomation_DealOfficeType_Operate.SelectByDocumentID(6);
        DropDownListBind(ddlType, ds.Tables[0], "OfficeAutomation_DealOfficeType_ID", "OfficeAutomation_DealOfficeType_Name", "1");
    }
    ...
    public void LoadPage()
    {
        ...
        ID = dr["OfficeAutomation_Document_DealOffice_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_DealOffice_Apply"].ToString();
        ApplyN = applicant;
        this.lblApply.Text = applicant;
        this.txtDepartment.Text = dr["OfficeAutomation_Document_DealOffice_Department"].ToString();
        this.lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_DealOffice_ApplyDate"].ToString()).ToString("yyyy-MM-dd"); 
        this.txtReplyPhone.Text = dr["OfficeAutomation_Document_DealOffice_ReplyPhone"].ToString();
        this.txtReplyFax.Text = dr["OfficeAutomation_Document_DealOffice_ReplyFax"].ToString();
        this.txtWorkArea.Text = dr["OfficeAutomation_Document_DealOffice_WorkArea"].ToString();
        this.txtBranch.Text = dr["OfficeAutomation_Document_DealOffice_Branch"].ToString();
        this.lblBranch.Text = dr["OfficeAutomation_Document_DealOffice_Branch"].ToString();

        DA_Dic_OfficeAutomation_DealOfficeType_Operate da_Dic_OfficeAutomation_DealOfficeType_Operate = new DA_Dic_OfficeAutomation_DealOfficeType_Operate();
        DataSet dsType = da_Dic_OfficeAutomation_DealOfficeType_Operate.SelectByDocumentID(6);
        DropDownListBind(ddlType, dsType.Tables[0], "OfficeAutomation_DealOfficeType_ID", "OfficeAutomation_DealOfficeType_Name", dr["OfficeAutomation_Document_DealOffice_TypeID"].ToString());

        this.txtArea.Text = dr["OfficeAutomation_Document_DealOffice_OfficeArea"].ToString();
        this.txtAddress.Text = dr["OfficeAutomation_Document_DealOffice_OfficeAddress"].ToString();

        this.txtDealArea.Text = dr["OfficeAutomation_Document_DealOffice_DealArea"].ToString();
        this.txtDealPrice.Text = dr["OfficeAutomation_Document_DealOffice_DealPrice"].ToString();
        this.txtDealOwnerMoney.Text = dr["OfficeAutomation_Document_DealOffice_DealOwnerMoney"].ToString();
        this.txtDealOwnerPercent.Text = dr["OfficeAutomation_Document_DealOffice_DealOwnerPercent"].ToString();
        this.txtDealClientMoney.Text = dr["OfficeAutomation_Document_DealOffice_DealClientMoney"].ToString();
        this.txtDealClientPercent.Text = dr["OfficeAutomation_Document_DealOffice_DealClientPercent"].ToString();
        this.txtDealMoney.Text = dr["OfficeAutomation_Document_DealOffice_DealMoney"].ToString();
        this.txtDealPercent.Text = dr["OfficeAutomation_Document_DealOffice_DealPercent"].ToString();

        this.txtLeaseArea.Text = dr["OfficeAutomation_Document_DealOffice_LeaseArea"].ToString();
        this.txtLeasePrice.Text = dr["OfficeAutomation_Document_DealOffice_LeasePrice"].ToString();
        this.txtLeaseOwnerMoney.Text = dr["OfficeAutomation_Document_DealOffice_LeaseOwnerMoney"].ToString();
        this.txtLeaseOwnerPercent.Text = dr["OfficeAutomation_Document_DealOffice_LeaseOwnerPercent"].ToString();
        this.txtLeaseClientMoney.Text = dr["OfficeAutomation_Document_DealOffice_LeaseClientMoney"].ToString();
        this.txtLeaseClientPercent.Text = dr["OfficeAutomation_Document_DealOffice_LeaseClientPercent"].ToString();
        this.txtLeaseMoney.Text = dr["OfficeAutomation_Document_DealOffice_LeaseMoney"].ToString();
        this.txtLeasePercent.Text = dr["OfficeAutomation_Document_DealOffice_LeasePercent"].ToString();

        this.txtCrossAreaRemark.Text = dr["OfficeAutomation_Document_DealOffice_CrossAreaRemark"].ToString();
        this.txtMoneyRemark.Text = dr["OfficeAutomation_Document_DealOffice_MoneyRemark"].ToString();
        ...
        bool IsApplicant = EmployeeName == dr["OfficeAutomation_Document_DealOffice_Apply"].ToString();
        if (IsApplicant)
        {
            //sbJS.Append("$(\"#btnUpload\").show();");
            if (flowState == "1")
        ...
        for (int i = 0; i < drc.Count; i++)
        {
            ...
            else
            {
                ...
                {
                    sbJS.Append("$('#btnSignIDx" + drc[i]["OfficeAutomation_Flow_IDx"].ToString() + "').before('<div style=\"width: 150px; line-height: 20px; height: 20px; margin-left:20px; float:left;\">"
                                       + drc[i]["OfficeAutomation_Flow_Auditor"] + "</div>");
                    foreach (string s in auditorIDs)
                    {
                        if (da_OfficeAutomation_Agent_Inherit.IsHaveCancelPower(drc[i]["OfficeAutomation_Flow_Employee"].ToString(), s,
        ...
        if (flows != null)
            sbJS.Append("$('#trLogistics1').hide();$('#trLogistics2').hide();$('#tlsc1').show();");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_DealOffice t_OfficeAutomation_Document_DealOffice = new T_OfficeAutomation_Document_DealOffice();
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "DealOffice" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 6;
                ...
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_MainID = t_OfficeAutomation_Main.OfficeAutomation_Main_ID;
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_Apply = EmployeeName;
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_ApplyDate = DateTime.Now;
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_Department = this.txtDepartment.Text;
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_ReplyPhone = this.txtReplyPhone.Text;
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_ReplyFax = this.txtReplyFax.Text;
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_WorkArea = this.txtWorkArea.Text;
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_Branch = this.txtBranch.Text;
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_TypeID = int.Parse(this.ddlType.SelectedValue);
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_OfficeArea = this.txtArea.Text;
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_OfficeAddress = this.txtAddress.Text;

                if (this.txtDealArea.Text != "")
                {
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealArea = Decimal.Parse(this.txtDealArea.Text);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealPrice = Decimal.Parse(this.txtDealPrice.Text);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealOwnerMoney = Decimal.Parse(this.txtDealOwnerMoney.Text);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealOwnerPercent = Decimal.Parse(this.hdDealOwnerPercent.Value);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealClientMoney = Decimal.Parse(this.txtDealClientMoney.Text);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealClientPercent = Decimal.Parse(this.hdDealClientPercent.Value);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealMoney = Decimal.Parse(this.txtDealMoney.Text);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealPercent = Decimal.Parse(this.hdDealPercent.Value);
                }

                if (this.txtLeaseArea.Text != "")
                {
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeaseArea = Decimal.Parse(this.txtLeaseArea.Text);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeasePrice = Decimal.Parse(this.txtLeasePrice.Text);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeaseOwnerMoney = Decimal.Parse(this.txtLeaseOwnerMoney.Text);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeaseOwnerPercent = Decimal.Parse(this.hdLeaseOwnerPercent.Value);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeaseClientMoney = Decimal.Parse(this.txtLeaseClientMoney.Text);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeaseClientPercent = Decimal.Parse(this.hdLeaseClientPercent.Value);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeaseMoney = Decimal.Parse(this.txtLeaseMoney.Text);
                    t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeasePercent = Decimal.Parse(this.hdLeasePercent.Value);
                }

                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_CrossAreaRemark = this.txtCrossAreaRemark.Text;
                t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_MoneyRemark = this.txtMoneyRemark.Text;
                ...
                da_OfficeAutomation_Document_DealOffice_Inherit.Insert(t_OfficeAutomation_Document_DealOffice);//插入申请表
                ...
                Common.AddLog(EmployeeID, EmployeeName, 10, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程
                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_DealOffice_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=300px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_DealOffice_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_DealOffice_ID"].ToString();
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                //if (da_OfficeAutomation_Flow_Inherit.UpdateContainIsAgreeForSignAndMulti(MainID, signEmployeeID, signEmployeeName, hdSuggestion.Value, flowIDx, hdIsAgree.Value))
                {
                    ...
                    ds = da_OfficeAutomation_Document_DealOffice_Inherit.SelectByMainID(MainID);
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_DealOffice_Apply"].ToString();
                    string employname;
                    ...
                    if (hdIsAgree.Value != "0")//同意或其他意见
                    {
                        ...
                        if (da_OfficeAutomation_Flow_Inherit.IsFlowComplete(MainID))
                        {
                            ...
                            DataRow drDealOffice = da_OfficeAutomation_Document_DealOffice_Inherit.SelectByMainID(MainID).Tables[0].Rows[0];
                            string msnBody = "";
                            string mailBody = "<br/><br/>发文人员：" + drDealOffice["OfficeAutomation_Document_DealOffice_Apply"].ToString()
                                + "<br/>发文日期：" + drDealOffice["OfficeAutomation_Document_DealOffice_ApplyDate"].ToString()
                                + "<br/>发文部门：" + drDealOffice["OfficeAutomation_Document_DealOffice_Department"].ToString()
                                + "<br/>回复电话：" + drDealOffice["OfficeAutomation_Document_DealOffice_ReplyPhone"].ToString()
                                + "<br/>" + drDealOffice["OfficeAutomation_Document_DealOffice_WorkArea"].ToString() + "区域" + drDealOffice["OfficeAutomation_Document_DealOffice_Branch"].ToString() + "现有一间" + drDealOffice["OfficeAutomation_DealOfficeType_Name"].ToString() + "即将成交。"
                                + "<br/>物业所在区域 " + drDealOffice["OfficeAutomation_Document_DealOffice_OfficeArea"].ToString() + "区  地址" + drDealOffice["OfficeAutomation_Document_DealOffice_OfficeAddress"].ToString()
                                + "<br/>成交价：" + drDealOffice["OfficeAutomation_Document_DealOffice_DealPrice"].ToString() + "/月租金" + drDealOffice["OfficeAutomation_Document_DealOffice_LeasePrice"].ToString()
                                + "<br/>总佣比例：" + drDealOffice["OfficeAutomation_Document_DealOffice_DealPercent"].ToString() + "%/相当于" + drDealOffice["OfficeAutomation_Document_DealOffice_LeasePercent"].ToString() + "个月租金"
                                + "<br/>若是跨区成交的详细说明原因：" + (drDealOffice["OfficeAutomation_Document_DealOffice_CrossAreaRemark"].ToString() == "" ? "无" : drDealOffice["OfficeAutomation_Document_DealOffice_CrossAreaRemark"].ToString())
                                + "<br/>若是买卖单总佣点数小于1%或租赁单总佣点数小于0.5个月租金的详细说明原因：" + (drDealOffice["OfficeAutomation_Document_DealOffice_MoneyRemark"].ToString() == "" ? "无" : drDealOffice["OfficeAutomation_Document_DealOffice_MoneyRemark"].ToString());
                            ...
                            #region 2014/02/26 根据需求取消给财务部经办人发通知：http://gzs-terminal01:8003/Apply/SysReq/Apply_SysReq_Detail.aspx?MainID=01e52fba-bc0d-4d8a-8cf3-0d99ffb6f262&dep=&apply=&start=&end=&type=2&state=&curpage=0 

                            //msnBody = "您好，" + CommonConst.EMP_FINANCE_OPERATOR2_NAME + "：编号为" + serialNumber + "的" + documentName + "已通过所有人的审理。申请表地址为：" + Page.Request.Url.ToString();
                            //email = CommonConst.EMP_FINANCE_OPERATOR2_NAME;
                            //if (hdIsAgree.Value == "2")
                            //    Common.SendMessageEX(false, email, "其他意见", msnBody + mailBody, msnBody);
                            //else
                            //    Common.SendMessageEX(false, email, "申请已同意", msnBody + mailBody, msnBody);
    ...
    private void Update()
    {
        ...
        ds = da_OfficeAutomation_Document_DealOffice_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_DealOffice_ID"].ToString();
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_ID = new Guid(ID);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_MainID = new Guid(MainID);

        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_Apply = EmployeeName;
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_ApplyDate = DateTime.Parse(this.lblApplyDate.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_Department = this.txtDepartment.Text;
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_ReplyPhone = this.txtReplyPhone.Text;
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_ReplyFax = this.txtReplyFax.Text;
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_WorkArea = this.txtWorkArea.Text;
        ...
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealPrice = Decimal.Parse(this.txtDealPrice.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealOwnerMoney = Decimal.Parse(this.txtDealOwnerMoney.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealOwnerPercent = Decimal.Parse(this.txtDealOwnerPercent.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealClientMoney = Decimal.Parse(this.txtDealClientMoney.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealClientPercent = Decimal.Parse(this.txtDealClientPercent.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealMoney = Decimal.Parse(this.txtDealMoney.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_DealPercent = Decimal.Parse(this.txtDealPercent.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeaseArea = Decimal.Parse(this.txtLeaseArea.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeasePrice = Decimal.Parse(this.txtLeasePrice.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeaseOwnerMoney = Decimal.Parse(this.txtLeaseOwnerMoney.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeaseOwnerPercent = Decimal.Parse(this.txtLeaseOwnerPercent.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeaseClientMoney = Decimal.Parse(this.txtLeaseClientMoney.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeaseClientPercent = Decimal.Parse(this.txtLeaseClientPercent.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeaseMoney = Decimal.Parse(this.txtLeaseMoney.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_LeasePercent = Decimal.Parse(this.txtLeasePercent.Text);
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_CrossAreaRemark = this.txtCrossAreaRemark.Text;
        t_OfficeAutomation_Document_DealOffice.OfficeAutomation_Document_DealOffice_MoneyRemark = this.txtMoneyRemark.Text;
        ...
        string summary = "";
        string applydate = this.lblApplyDate.Text;
        string mainid = MainID;

        da_OfficeAutomation_Main_Inherit.UpdateMain(mainid, depname, apply, applydate, summary);
        da_OfficeAutomation_Document_DealOffice_Inherit.Update(t_OfficeAutomation_Document_DealOffice);//修改

        Common.AddLog(EmployeeID, EmployeeName, 10, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite7"] = "1";
        Response.Write("<script>window.open('Apply_DealOffice_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("物业部成交商铺/写字楼备案申请表.pdf"));//强制下载 
    ...
    protected void btnSaveLogisticsFlow_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_DealOffice_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_DealOffice_ID"].ToString(); //在不同的表要注意修改
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_DealOffice_Inherit da_OfficeAutomation_Document_DealOffice_Inherit = new DA_OfficeAutomation_Document_DealOffice_Inherit();
            DataSet ds = da_OfficeAutomation_Document_DealOffice_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_DealOffice_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
            string department = drRow["OfficeAutomation_Document_DealOffice_Department"].ToString();
            string applyUrl = Page.Request.Url.ToString();
            applyUrl = applyUrl.Substring(applyUrl.IndexOf("/Apply/"));
            applyUrl = "内部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["InternalURL"] + applyUrl;
                        //+ "<br />外部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["ExternalURL"] + applyUrl;
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_DealOffice_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_DealOffice_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_DealOffice_Inherit();
