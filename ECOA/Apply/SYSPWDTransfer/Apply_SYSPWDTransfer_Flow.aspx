<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_SYSPWDTransfer_Flow.aspx.cs" Inherits="Apply_SYSPWDTransfer_Apply_SYSPWDTransfer_Flow" %>
...
//return '<%=CommonConst.MSG_FLOW_ISCLOSING %>';
        ...
        window.onbeforeunload =  function (){
            if($.trim($("#txtIDx1").val())==""  || $.trim($("#txtIDx2").val())=="" || $.trim($("#txtIDx3").val())=="")
                return '此流程第1至第3环节必须填写不能为空，否则申请将作废！';   
        }
    </script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div class="flow">
            ...
            <br /><img src="/Images/forward.png" class="forward"/><div id="divIDx3" class='item'>秘书主管</div><div id="divTxtIDx3" class='item'><input type="text" id="txtIDx3" style="width:200px;" /><input id="hdIDx3" type="hidden" /></div>
            <br /><br />
