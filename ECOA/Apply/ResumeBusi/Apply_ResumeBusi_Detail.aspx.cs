...
public partial class Apply_ResumeBusi_Apply_ResumeBusi_Detail : BasePage
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = txtDepartment.Value;
                ...
                if (isSignSuccess)
                {
                    ...
                    if (hdIsAgree.Value != "0")//同意或其他意见
                    {
                        ...
                        if (da_OfficeAutomation_Flow_Inherit.IsFlowComplete(MainID))
                        {
                            ...
                            string employemail = CommonConst.EMAILLIST_ADMIN + "," + sg + ",叶凤霞,沈凯飞,梁文英,潘海燕,黄志超,黄洁珍,张绍欣,黄瑛,黄轩明";
    ...
    private void Update()
    {
        ...
        string summary = txtDepartment.Value;
        string applydate = "";
