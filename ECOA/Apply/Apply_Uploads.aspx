<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_Uploads.aspx.cs" Inherits="Apply_Apply_Uploads" Title="上传附件 - 广州中原电子审批系统" %>
...
<body>
    <form id="form1" runat="server">
        <div id="main" >
            <div>
                <div>
                    <input id="txtFilePath" runat="server" name="Uploads" style="font-size: 14px; width: 470px; height:30px; margin:10px 0 10px 10px" type="file" />
                </div>
