<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_SignedG_Flow.aspx.cs" Inherits="Apply_SignedG_Apply_SignedG_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "text",
                data: 'action=saveCommonFlow&id=<%=EmployeeID %>&name=<%=EmployeeName %>&purview=<%=Purview %>&mainid=<%=MainID %>&content=' + content+'&deleteidxs=1',
...
<body>
 ...
 <%--           <div id="divIDx1" class='item'><input id="btnIDx2" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(1);" />
                <label id="lblIDx1" for='btnIDx2'>申请人</label>
            </div>
