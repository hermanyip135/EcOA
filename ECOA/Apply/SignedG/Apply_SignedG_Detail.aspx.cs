...
public partial class Apply_SignedG_Apply_SignedG_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite64"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite64"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_SignedG_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_SignedG_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_SignedG_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_SignedG_ApplyID"].ToString();
        ddlDepartment.Text = dr["OfficeAutomation_Document_SignedG_Department"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_SignedG_ApplyDate"].ToString()).ToString("yyyy-MM-dd");

        txtReceiveDP.Text = dr["OfficeAutomation_Document_SignedG_ReceiveDP"].ToString();
        txtCCDepartment.Text = dr["OfficeAutomation_Document_SignedG_CCDepartment"].ToString();
        txtTelephone.Text = dr["OfficeAutomation_Document_SignedG_Telephone"].ToString();
        txtFax.Text = dr["OfficeAutomation_Document_SignedG_Fax"].ToString();
        txtSubject.Text = dr["OfficeAutomation_Document_SignedG_Subject"].ToString();
        txtCaseNo.Text = dr["OfficeAutomation_Document_SignedG_CaseNo"].ToString();
        txtDealer.Text = dr["OfficeAutomation_Document_SignedG_Dealer"].ToString();
        txtAddress.Text = dr["OfficeAutomation_Document_SignedG_Address"].ToString();
        txtOwner.Text = dr["OfficeAutomation_Document_SignedG_Owner"].ToString();
        txtBuyer.Text = dr["OfficeAutomation_Document_SignedG_Buyer"].ToString();
        txtLoanBank.Text = dr["OfficeAutomation_Document_SignedG_LoanBank"].ToString();
        txtCmoney.Text = dr["OfficeAutomation_Document_SignedG_Cmoney"].ToString();
        txtLmoney.Text = dr["OfficeAutomation_Document_SignedG_Lmoney"].ToString();
        txtDmoney.Text = dr["OfficeAutomation_Document_SignedG_Dmoney"].ToString();
        txtReason.Text = dr["OfficeAutomation_Document_SignedG_Reason"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_SignedG t_OfficeAutomation_Document_SignedG = new T_OfficeAutomation_Document_SignedG();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "SignedG" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 59; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_SignedG = GetModelFromPage(Guid.NewGuid());

                t_OfficeAutomation_Main.OfficeAutomation_Main_Apply = EmployeeName;
                t_OfficeAutomation_Main.OfficeAutomation_Main_Department = this.ddlDepartment.SelectedValue;
                ...
                da_OfficeAutomation_Document_SignedG_Inherit.Insert(t_OfficeAutomation_Document_SignedG);//插入申请表

                //InsertSignedGDetail(t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_ID);
                ...
                //da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "2,3");
                string fir = "";
                if (ddlDepartment.SelectedValue == "业务一部" || ddlDepartment.SelectedValue == "业务三部" || ddlDepartment.SelectedValue == "业务四部")
                {
                    if (ddlDepartment.SelectedValue == "业务一部")
                    {
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = "1928";
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = "叶英健";
                        fir = t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee;
                    }
                    else if (ddlDepartment.SelectedValue == "业务三部")
                    {
                ...
                else if (ddlDepartment.SelectedValue == "业务二部" || ddlDepartment.SelectedValue == "业务五部" || ddlDepartment.SelectedValue == "业务六部" || ddlDepartment.SelectedValue == "番禺业务部")
                {
                    if (ddlDepartment.SelectedValue == "业务二部")
                    {
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = "6787";
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = "麦淑姗";
                        fir = t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee;
                    }
                    else if (ddlDepartment.SelectedValue == "业务五部")
                    {
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = "4909";
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = "吴远斌";
                        fir = t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee;
                    }
                    else if (ddlDepartment.SelectedValue == "业务六部")
                    {
                ...
                else if (ddlDepartment.SelectedValue == "业务八部" || ddlDepartment.SelectedValue == "业务九部" || ddlDepartment.SelectedValue == "业务十部")
                {
                    if (ddlDepartment.SelectedValue == "业务八部")
                    {
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = "67828";
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = "黄兆辉";
                        fir = t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee;
                    }
                    else if (ddlDepartment.SelectedValue == "业务九部")
                    {
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = "67578";
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = "梁海源";
                        fir = t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee;
                    }
                    else if (ddlDepartment.SelectedValue == "业务十部")
                    {
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = "58703";
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = "吴宏斌";
                        fir = t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee;
                    }
                    t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
                    t_OfficeAutomation_Flow.OfficeAutomation_Flow_Idx = 2;
                ...
                Common.AddLog(EmployeeID, EmployeeName, 63, new Guid(MainID), 1);//日志，创建申请表
                ...
                string messageBody = "您好，" + fir + "：有一份关于签署两方版本担保协议书的申请需要您审批。<br />文档编码为：" + t_OfficeAutomation_Main.OfficeAutomation_SerialNumber + "<br />申请表地址为：" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
                Common.SendMessageEX(true, "关于签署两方版本担保协议书的申请", fir, "请审批", messageBody, messageBody, MainID);

                RunJS("alert('申请表保存成功！');var returnVaulue=window.showModalDialog(\"/Apply/Apply_UploadFile20M.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");window.location='/Apply/Apply_Search.aspx';");
                //RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile20M.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_SignedG_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_SignedG_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_SignedG_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_SignedG_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_SignedG_Department"].ToString();
                    string applyUrl = Page.Request.Url.ToString();
                    applyUrl = applyUrl.Substring(applyUrl.IndexOf("/Apply/"));
                    applyUrl = "内部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["InternalURL"] + applyUrl;
                        //+ "<br />外部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["ExternalURL"] + applyUrl;
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_SignedG_Apply"]);
                    sbMailBody.Append("<br/>发文日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_SignedG_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>发文编号：" + drRow["OfficeAutomation_Document_SignedG_ApplyID"]);
                    sbMailBody.Append("<br/>发文部门：" + drRow["OfficeAutomation_Document_SignedG_Department"]);
                    sbMailBody.Append("<br/>收文部门：" + drRow["OfficeAutomation_Document_SignedG_ReceiveDP"]);
                    sbMailBody.Append("<br/>回复电话：" + drRow["OfficeAutomation_Document_SignedG_Telephone"]);
                    sbMailBody.Append("<br/>回复传真：" + drRow["OfficeAutomation_Document_SignedG_Fax"]);
                    sbMailBody.Append("<br/>文件主题：" + drRow["OfficeAutomation_Document_SignedG_Subject"]);
                    sbMailBody.Append("<br/>汇瀚案号：" + drRow["OfficeAutomation_Document_SignedG_CaseNo"]);
                    sbMailBody.Append("<br/>经办：" + drRow["OfficeAutomation_Document_SignedG_Dealer"]);
                    sbMailBody.Append("<br/>物业地址：" + drRow["OfficeAutomation_Document_SignedG_Address"]);
                    sbMailBody.Append("<br/>业主：" + drRow["OfficeAutomation_Document_SignedG_Owner"]);
                    sbMailBody.Append("<br/>买家：" + drRow["OfficeAutomation_Document_SignedG_Buyer"]);
                    sbMailBody.Append("<br/>贷款银行：" + drRow["OfficeAutomation_Document_SignedG_LoanBank"]);
                    sbMailBody.Append("<br/>担保金额：" + drRow["OfficeAutomation_Document_SignedG_Cmoney"]);
                    sbMailBody.Append("<br/>贷款金额：" + drRow["OfficeAutomation_Document_SignedG_Lmoney"]);
                    sbMailBody.Append("<br/>成交金额：" + drRow["OfficeAutomation_Document_SignedG_Dmoney"]);
                    sbMailBody.Append("<br/>原因：" + drRow["OfficeAutomation_Document_SignedG_Reason"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_SignedG_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private T_OfficeAutomation_Document_SignedG GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_SignedG t_OfficeAutomation_Document_SignedG = new T_OfficeAutomation_Document_SignedG();
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_ID = UndertakeProjID;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Apply = EmployeeName;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Department = ddlDepartment.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_ReceiveDP = txtReceiveDP.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_CCDepartment = txtCCDepartment.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Telephone = txtTelephone.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Fax = txtFax.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Subject = txtSubject.Text;

        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_CaseNo = txtCaseNo.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Dealer = txtDealer.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Address = txtAddress.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Owner = txtOwner.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Buyer = txtBuyer.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_LoanBank = txtLoanBank.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Cmoney = txtCmoney.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Lmoney = txtLmoney.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Dmoney = txtDmoney.Text;
        t_OfficeAutomation_Document_SignedG.OfficeAutomation_Document_SignedG_Reason = txtReason.Text;

        return t_OfficeAutomation_Document_SignedG;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_SignedG_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_SignedG_ID"].ToString();

        t_OfficeAutomation_Document_SignedG = GetModelFromPage(new Guid(ID));
        ...
        string depname = this.ddlDepartment.SelectedValue;
        ...
        da_OfficeAutomation_Document_SignedG_Inherit.Update(t_OfficeAutomation_Document_SignedG);//修改申请表

        //DA_OfficeAutomation_Document_SignedG_Detail_Inherit da_OfficeAutomation_Document_SignedG_Detail_Inherit = new DA_OfficeAutomation_Document_SignedG_Detail_Inherit();
        //da_OfficeAutomation_Document_SignedG_Detail_Inherit.Delete(ID);
        //InsertSignedGDetail(new Guid(ID));

        Common.AddLog(EmployeeID, EmployeeName, 63, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    /// 新增明细表
    /// </summary>
    /// <param name="gSignedGID"></param>
    //private void InsertSignedGDetail(Guid gSignedGID)
    //{
    //    if (hdDetail.Value == "")
    //        return;

    //    T_OfficeAutomation_Document_SignedG_Detail t_OfficeAutomation_Document_SignedG_Detail;
    //    DA_OfficeAutomation_Document_SignedG_Detail_Inherit da_OfficeAutomation_Document_SignedG_Detail_Inherit = new DA_OfficeAutomation_Document_SignedG_Detail_Inherit();
    ...
    //            if (detail[0] == "")
    //                continue;
    //            t_OfficeAutomation_Document_SignedG_Detail = new T_OfficeAutomation_Document_SignedG_Detail();
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_ID = Guid.NewGuid();
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_MainID = gSignedGID;
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_Property = detail[0];
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_Controler = detail[1];
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_PropertyID = detail[2];
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_PropertyDate = detail[3];
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_OldDeal = detail[4];
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_NewDeal = detail[5];
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_AjustDeal = detail[6];
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_ShouldComm = detail[7];
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_ActualComm = detail[8];
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_AjustComm = detail[9];
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_LeadReason = int.Parse(detail[10]);
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_Commitment = detail[11];
    //            t_OfficeAutomation_Document_SignedG_Detail.OfficeAutomation_Document_SignedG_Detail_Reason = detail[12];

    //            da_OfficeAutomation_Document_SignedG_Detail_Inherit.Insert(t_OfficeAutomation_Document_SignedG_Detail);
    //        }
    //    }
    //    catch (Exception ee)
    //    {
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite64"] = "1";
        Response.Write("<script>window.open('Apply_SignedG_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("关于签署两方版本担保协议书的申请.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_SignedG_Inherit da_OfficeAutomation_Document_SignedG_Inherit = new DA_OfficeAutomation_Document_SignedG_Inherit();
            DataSet ds = da_OfficeAutomation_Document_SignedG_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_SignedG_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_SignedG_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
