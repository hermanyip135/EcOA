<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_Guarantee_Flow.aspx.cs" Inherits="Apply_Guarantee_Apply_Guarantee_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
...
<head id="Head1" runat="server"> 
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            for(var y = 1; y <= 1; y++)
            {
                if($("#txtIDx"+y).parent().css("display")!="none" && y != 2) 
                {
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <div id="divIDx1" class='item'>部门负责人</div>
            <div id="divTxtIDx1" class='item'><input type="text" id="txtIDx1" style="width: 200px" /><input id="hdIDx1" type="hidden" /></div>
...
<%--            <div id="divIDx3" class='item'>部门负责人</div>
            <div id="divTxtIDx3" class='item'><input type="text" id="txtIDx3" style="width: 200px" /><input id="hdIDx3" type="hidden" /></div>--%>
