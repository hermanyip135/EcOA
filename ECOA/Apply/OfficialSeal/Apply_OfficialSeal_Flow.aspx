<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_OfficialSeal_Flow.aspx.cs" Inherits="Apply_OfficialSeal_Apply_OfficialSeal_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "text",
                data: 'action=SaveOfficialSealFlow&id=<%=EmployeeID %>&name=<%=EmployeeName %>&purview=<%=Purview %>&mainid=<%=MainID %>&content=' + content+'&deleteidxs=1|2',
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <%--<div id="divIDx1" class='item'>授权签批人员</div>--%>
           <%-- <div id="divTxtIDx1" class='item'>
                <input type="text" id="txtIDx1" style="width:200px;" /><input id="hdIDx1" type="hidden" />
            </div>--%>
            <div id="divIDx1" class='item' style="display:none;"><input id="btnIDx1" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(1);" />
                <label id="lblIDx1" for='btnIDx1'>授权签批人员</label>
            </div>
            <div id="divTxtIDx1" class='item' >
                 <label id="Label1" for='btnIDx1'>授权签批人员</label>
                <input type="text" id="txtIDx1" style="width:200px;" /><input id="hdIDx1" type="hidden" />
                <a id="a1" href="javascript:;" onclick="showOrHideIDx(1)">取消</a>
            </div>
            <img src="/Images/forward.png" class="forward"/>

            <div id="divIDx2" class='item'>部门负责人</div>
            <div id="divTxtIDx2" class='item'>
                <input type="text" id="txtIDx2" style="width:200px;" /><input id="hdIDx2" type="hidden" />
            </div>
            <br /><br />
            <input type="button" id="Button1" value="保存并通知审批" onclick="save()"; class="btn button"/>
