<%@ Page ValidateRequest="false" Title="公章使用申请表 - 广州中原电子审批系统" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Apply_OfficialSeal_Detail.aspx.cs" Inherits="Apply_OfficialSeal_Apply_OfficialSeal_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div id="summaryRight" style="float: right; width: 20%; padding-top: 75px; padding-right: 5px;display:none; padding-left: 10px;">
        ...
        <span>
            ...
            　　涉及招聘等合同类（费用1万以下）：<br />
                <span style="margin-left:25px;">(1)、营业部自主招聘类：物业部/工商铺（<span style="color: #FF0000">审批流程：申请部门-王子君/谭丽仪A/朱素会/罗斌C-郑纯宁</span>）</span><br />
                <span style="margin-left:25px;">(2)、项目部招聘类申请：（<span style="color: #FF0000">审批流程：申请部门-王子君/谭丽仪A/朱素会/罗斌C-郑纯宁</span>）</span>
                <span style="margin-left:25px;">(3)、涉及费用招聘合同/协议（含物业部及项目部)：（<span style="color: #FF0000">审批流程：申请部门-王子君/谭丽仪A/朱素会/罗斌C-郑纯宁-法律部</span>）</span>
        </span>
        <br /><br />
        ...
        　　《1》区域广告位合同、广日报纸广告合同（<span style="color: #008000">流程：申请部门-李粤湘-法律部</span>）<br />        
			...
			<table id="tbAround" width='640px'>
                ...
                <tr id="trM18" style="height: 85px; display:none;">
					...
					<td colspan="3" class="tl PL10" style="  ">
                        ...
                        <br />
                                <span style="padding-right: 30px; padding-bottom: 10px; text-align: right; float: right;">日期：<span id="spanDateIDx18">_________</span>
                                </span>
					</td>
				</tr>
                ...
                <tr id="trM19" style="height: 85px; display:none;">
					...
					<td colspan="3" class="tl PL10" style="  ">
                        ...
                        <br />
                                <span style="padding-right: 30px; padding-bottom: 10px; text-align: right; float: right;">日期：<span id="spanDateIDx19">_________</span>
                                </span>
					</td>
				</tr>
                ...
                <tr id="trM27" style="height: 85px; display:none;">
					...
					<td colspan="3" class="tl PL10"  style="  ">
                        ...
                        <br />
                                <span style="padding-right: 30px; padding-bottom: 10px; text-align: right; float: right;">日期：<span id="spanDateIDx27">_________</span>
                                </span>
					</td>
				</tr>
                <tr id="trM28" style="height: 85px; display:none;">
					...
					<td colspan="3" class="tl PL10"  style="  ">
                        ...
                        <br />
                                <span style="padding-right: 30px; padding-bottom: 10px; text-align: right; float: right;">日期：<span id="spanDateIDx28">_________</span>
                                </span>
					</td>
				</tr>
				<tr id="trM29" style="height: 85px; display:none;">
					...
					<td colspan="3" class="tl PL10" style="  ">
                        ...
                        <br />
                                <span style="padding-right: 30px; padding-bottom: 10px; text-align: right; float: right;">日期：<span id="spanDateIDx29">_________</span>
                                </span>
					</td>
				</tr>
                ...
                <tr id="trM30" class="noborder" style="height: 85px; display:none; ">
					...
					<td colspan="3" class="tl PL10"  style=" ">
                        ...
                        <br />
                                <span style="padding-right: 30px; padding-bottom: 10px; text-align: right; float: right;">日期：<span id="spanDateIDx30">_________</span>
                                </span>
					</td>
				</tr>
				...
				<tr id="trM100" style="height: 85px; display:none;">
					...
					<td colspan="3" class="tl PL10" style="  ">
                        ...
                        <br />
                                <span style="padding-right: 30px; padding-bottom: 10px; text-align: right; float: right;">日期：<span id="spanDateIDx100">_________</span>
                                </span>
					</td>
				</tr>
                ...
                <tr id="trM105" style="height: 85px; display:none;">
					...
					<td colspan="3" class="tl PL10" style="  ">
                        ...
                        <br />
                                <span style="padding-right: 30px; padding-bottom: 10px; text-align: right; float: right;">日期：<span id="spanDateIDx105">_________</span>
                                </span>
					</td>
				</tr>
                ...
                <tr id="trM106" class="noborder" style="height: 85px; display:none;">
					...
					<td colspan="3" class="tl PL10" style=" ">
                        ...
                        <br />
                                <span style="padding-right: 30px; padding-bottom: 10px; text-align: right; float: right;">日期：<span id="spanDateIDx106">_________</span>
                                </span>
					</td>
				</tr>
    ...
    <script type="text/javascript">
        ...
        if($("#selTransFile1").val()=="微信认证")
        {
            ...
            //2019-01-24
            $("#trM26").find(".auto-style1").html("资讯科技部");
            $("#trM29").find(".auto-style1").html("资讯科技部");
        }
    </script>
    </span>
    </asp:Content>
