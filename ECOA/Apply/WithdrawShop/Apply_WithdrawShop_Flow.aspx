<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_WithdrawShop_Flow.aspx.cs" Inherits="Apply_WithdrawShop_Apply_WithdrawShop_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
...
<head id="Head1" runat="server"> 
    ...
    <script type="text/javascript">
        ...
        function save(e) {
            <% //20150119：M_EditFlowC
                //dsgffs = da_OfficeAutomation_Main_InheritDeleteForFlows.SelectByMainID(MainID);
                //if (dsgffs.Tables[0].Rows[0]["OfficeAutomation_Main_FlowStateID"].ToString() == "3")
                //{
                //    RunJS("alert('该表已审批完毕，不能再修改了');");
                //    return;
                //}
            %>
            e.disabled = true;
