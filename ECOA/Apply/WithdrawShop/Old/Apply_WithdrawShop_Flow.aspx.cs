...
public partial class Apply_WithdrawShop_Apply_WithdrawShop_Flow : BasePage
{
    public StringBuilder SbJs = new StringBuilder();
    public StringBuilder SbJson = new StringBuilder();
    public StringBuilder SbDepartmentJson = new StringBuilder();

    //public DataSet dsgffs = new DataSet(); //20150119：M_EditFlowC
    //public DA_OfficeAutomation_Main_Inherit da_OfficeAutomation_Main_InheritDeleteForFlows = new DA_OfficeAutomation_Main_Inherit();
