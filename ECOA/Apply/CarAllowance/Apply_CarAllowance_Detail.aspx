<%@ Page ValidateRequest="false" Title="小汽车津贴申请表 - 广州中原电子审批系统" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Apply_CarAllowance_Detail.aspx.cs" Inherits="Apply_CarAllowance_Apply_CarAllowance_Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function() {      
            ...
            $("#rdbYesIDx6").on("click",function(){
                $("#divAgreeMoneyGrade").show();
            });

            $("#rdbNoIDx6").on("click",function(){
        ...
        function upload() {
            ...
            if(sReturnValue=='success')
                window.location='Apply_CarAllowance_Detail.aspx?MainID=<%=MainID %>';
        }

        function editflow(){
            var win=window.showModalDialog("Apply_CarAllowance_Flow.aspx?MainID=<%=MainID %>","","dialogWidth=800px;dialogHeight=250px");
                    if(win=='success')
                        window.location="Apply_CarAllowance_Detail.aspx?MainID=<%=MainID %>";
        }
        ...
        function sign(idx) {
            ...
            if($("#rdbYesIDx6").prop("checked")&&$.trim($("#<%=hdAgreeMoneyGradeID.ClientID%>").val())=="") {   
                alert("请选择同意报销金额。");
                return;
            }
    ...
    <div style='text-align: center; width: 840px; margin: 0 auto;'>
        ...
        <div style='text-align: center'>
            ...
            <table id="tbAround"  width='640px'>
                ...
                <tr class="noborder" style="height: 30px;">
                    <td colspan="3" class="tl PL10" style=" ">
                        <input id="rdbYesIDx6" type="radio" name="agree6" /><label for="rdbYesIDx6">同意</label><span id="divAgreeMoneyGrade" style="display:none;"> 
                            ...
                            <asp:hiddenfield id="hdAgreeMoneyGradeID" runat="server" value="" /></span><input id="rdbNoIDx6" type="radio" name="agree6" />
