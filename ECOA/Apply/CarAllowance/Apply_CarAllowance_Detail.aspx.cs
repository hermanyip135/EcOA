...
public partial class Apply_CarAllowance_Apply_CarAllowance_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    {
        DA_Dic_OfficeAutomation_MoneyGrade_Operate da_Dic_OfficeAutomation_MoneyGrade_Operate = new DA_Dic_OfficeAutomation_MoneyGrade_Operate();
    ...
    public void LoadPage()
    {
        ...
        ID = dr["OfficeAutomation_Document_CarAllowance_ID"].ToString();
        string applicant=dr["OfficeAutomation_Document_CarAllowance_Apply"].ToString();
        ApplyN = applicant;
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_CarAllowance_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtName.Value = dr["OfficeAutomation_Document_CarAllowance_ApplyForName"].ToString();
        txtCode.Text = dr["OfficeAutomation_Document_CarAllowance_ApplyForCode"].ToString();
        txtEntryDate.Value = DateTime.Parse(dr["OfficeAutomation_Document_CarAllowance_EntryDate"].ToString()).ToString("yyyy-MM-dd");
        txtDepartment.Value = dr["OfficeAutomation_Document_CarAllowance_Department"].ToString();
        txtPosition.Value = dr["OfficeAutomation_Document_CarAllowance_Position"].ToString();
        txtGrade.Value = dr["OfficeAutomation_Document_CarAllowance_Grade"].ToString();
        switch (dr["OfficeAutomation_Document_CarAllowance_IsPositive"].ToString())
        {
            case "True":
        ...
        rblMoneyGrade.Items.FindByValue(dr["OfficeAutomation_Document_CarAllowance_MoneyGradeID"].ToString()).Selected = true;
        hdMoneyGradeID.Value = dr["OfficeAutomation_Document_CarAllowance_MoneyGradeID"].ToString();
        txtEffectiveDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_CarAllowance_EffectiveDate"].ToString()).ToString("yyyy-MM-dd");
        if (dr["OfficeAutomation_Document_CarAllowance_AgreeMoneyGradeID"].ToString() != "")
        {
            rblAgreeMoneyGrade.Items.FindByValue(dr["OfficeAutomation_Document_CarAllowance_AgreeMoneyGradeID"].ToString()).Selected = true;
        }
        hdAgreeMoneyGradeID.Value = dr["OfficeAutomation_Document_CarAllowance_AgreeMoneyGradeID"].ToString();
        ...
        bool isApplicant=EmployeeName == dr["OfficeAutomation_Document_CarAllowance_Apply"].ToString();
        if (isApplicant)
        {
            //SbJs.Append("$(\"#btnUpload\").show();");
            if (flowState == "1")
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_CarAllowance t_OfficeAutomation_Document_CarAllowance = new T_OfficeAutomation_Document_CarAllowance();
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "CarAllowance" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 10;
                ...
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_MainID = t_OfficeAutomation_Main.OfficeAutomation_Main_ID;
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_Apply = EmployeeName;
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_ApplyDate = DateTime.Now;
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_ApplyForName = txtName.Value;
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_ApplyForCode = txtCode.Text;
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_EntryDate = DateTime.Parse(txtEntryDate.Value);
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_Department = txtDepartment.Value;
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_Position = txtPosition.Value;
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_Grade = txtGrade.Value;
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_IsPositive = rdbIsPositive1.Checked;
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_MoneyGradeID = int.Parse(hdMoneyGradeID.Value);
                t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_EffectiveDate = DateTime.Parse(txtEffectiveDate.Text);
                ...
                da_OfficeAutomation_Document_CarAllowance_Inherit.Insert(t_OfficeAutomation_Document_CarAllowance);//插入申请表
                ...
                if (ds != null && ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (string boss in immediateboss)
                    {
                        if (t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_ApplyForName == boss)
                        {
                            IsImmediste = true;
                ...
                Common.AddLog(EmployeeID, EmployeeName, 14, new Guid(MainID), 1);//日志，创建申请表
                ...
                if (IsImmediste)
                    ...
                    RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_CarAllowance_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=250px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DA_OfficeAutomation_Document_CarAllowance_Inherit da_OfficeAutomation_Document_CarAllowance_Inherit=new DA_OfficeAutomation_Document_CarAllowance_Inherit();
        DataSet ds = da_OfficeAutomation_Document_CarAllowance_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_CarAllowance_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (da_OfficeAutomation_Flow_Inherit.UpdateContainIsAgreeForSignAndMulti(MainID, signEmployeeId, signEmployeeName, hdSuggestion.Value, flowIDx, hdIsAgree.Value))
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_CarAllowance_Apply"].ToString();
                    string employname;
                    string serialNumber = ds.Tables[0].Rows[0]["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    ...
                    if (hdIsAgree.Value != "0")//同意或其他意见
                    {
                        ...
                        if (flowIDx == "6")
                            da_OfficeAutomation_Document_CarAllowance_Inherit.UpdateAgreeMoneyGradeIDByID(ID, hdAgreeMoneyGradeID.Value);
                        ...
                        if (da_OfficeAutomation_Flow_Inherit.IsFlowComplete(MainID))
                        {
                            ...
                            DataRow drCarAllowance = da_OfficeAutomation_Document_CarAllowance_Inherit.SelectByMainID(MainID).Tables[0].Rows[0];
                            StringBuilder sbMailBody = new StringBuilder();
                            sbMailBody.Append("<br/><br/>申请人：" + drCarAllowance["OfficeAutomation_Document_CarAllowance_ApplyForName"]);
                            sbMailBody.Append("<br/>申请日期：" + DateTime.Parse(drCarAllowance["OfficeAutomation_Document_CarAllowance_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                            sbMailBody.Append("<br/>入职日期：" + DateTime.Parse(drCarAllowance["OfficeAutomation_Document_CarAllowance_EntryDate"].ToString()).ToString("yyyy-MM-dd"));
                            sbMailBody.Append("<br/>现任职部门：" + drCarAllowance["OfficeAutomation_Document_CarAllowance_Department"]);
                            sbMailBody.Append("<br/>现职位：" + drCarAllowance["OfficeAutomation_Document_CarAllowance_Position"]);
                            sbMailBody.Append("<br/>现职级：" + drCarAllowance["OfficeAutomation_Document_CarAllowance_Grade"]);
                            sbMailBody.Append("<br/>通过试用期：" + (drCarAllowance["OfficeAutomation_Document_CarAllowance_IsPositive"].ToString() == "True" ? "是" : "否"));
                            sbMailBody.Append("<br/>生效日期：" + DateTime.Parse(drCarAllowance["OfficeAutomation_Document_CarAllowance_EffectiveDate"].ToString()).ToString("yyyy-MM-dd"));
                            sbMailBody.Append("<br/>申请金额档次：" + drCarAllowance["MoneyGrade"]);
                            sbMailBody.Append("<br/>同意申请金额档次：" + drCarAllowance["AgreeMoneyGrade"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (EmployeeName == CommonConst.EMP_HR_OPERATOR1_NAME)
                da_OfficeAutomation_Document_CarAllowance_Inherit.AddRemarkByID(ID, CommonConst.SIGN_HR);
            Alert("标记成功。");
        }
        catch
        {
    ...
    private void Update()
    {
        ...
        t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_ID = new Guid(ID);
        t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_ApplyForName = txtName.Value;
        t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_ApplyForCode = txtCode.Text;
        t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_EntryDate = DateTime.Parse(txtEntryDate.Value);
        t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_Department = txtDepartment.Value;
        ...
        t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_Grade = txtGrade.Value;
        t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_IsPositive = rdbIsPositive1.Checked;
        //t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_MoneyGradeID = int.Parse(rblMoneyGrade.SelectedValue);
        t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_MoneyGradeID = int.Parse(hdMoneyGradeID.Value);
        t_OfficeAutomation_Document_CarAllowance.OfficeAutomation_Document_CarAllowance_EffectiveDate = DateTime.Parse(txtEffectiveDate.Text);
        ...
        da_OfficeAutomation_Document_CarAllowance_Inherit.Update(t_OfficeAutomation_Document_CarAllowance);//修改申请表
        ...
        Common.AddLog(EmployeeID, EmployeeName, 14, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite5"] = "1";
        Response.Write("<script>window.open('Apply_CarAllowance_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("小汽车津贴申请表.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_CarAllowance_Inherit da_OfficeAutomation_Document_CarAllowance_Inherit = new DA_OfficeAutomation_Document_CarAllowance_Inherit();
            DataSet ds = da_OfficeAutomation_Document_CarAllowance_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_CarAllowance_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
            string department = drRow["OfficeAutomation_Document_CarAllowance_Department"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_CarAllowance_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_CarAllowance_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_CarAllowance_Inherit();
