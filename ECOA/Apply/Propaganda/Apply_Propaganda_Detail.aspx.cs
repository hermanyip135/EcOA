...
public partial class Apply_Propaganda_Apply_Propaganda_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Document_Propaganda = GetModelFromPage(Guid.NewGuid());
                ...
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = txtSummary.Text;
                ...
                if (isSignSuccess)
                {
                    ...
                    if (hdIsAgree.Value != "0")//同意或其他意见
                    {
                        ...
                        if (da_OfficeAutomation_Flow_Inherit.IsFlowComplete(MainID))
                        {
                            ...
                            //完成后抄送
                            employname = "王萍,周燕妮,招琛彤,王珏萍," + ddlDesigner.Text;
                            employnames = employname.Split(',');
                            for (int i = 0; i < employnames.Length; i++)
                            {
                                if (!employeeList.Contains(employnames[i]))
    ...
    private T_OfficeAutomation_Document_Propaganda GetModelFromPage(Guid PropagandaID)
    {
        ...
        t_OfficeAutomation_Document_Propaganda.OfficeAutomation_Document_Propaganda_Summary = txtSummary.Text;
        t_OfficeAutomation_Document_Propaganda.OfficeAutomation_Document_Propaganda_Width = txtWidth.Text;
        t_OfficeAutomation_Document_Propaganda.OfficeAutomation_Document_Propaganda_Height = txtHeight.Text;
        t_OfficeAutomation_Document_Propaganda.OfficeAutomation_Document_Propaganda_Count = txtCount.Text;
        t_OfficeAutomation_Document_Propaganda.OfficeAutomation_Document_Propaganda_Package = txtPackage.Text;
        t_OfficeAutomation_Document_Propaganda.OfficeAutomation_Document_Propaganda_DemandDate = txtDemandDate.Text;
        string PaySituation = "";
