<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_Propaganda_Flow.aspx.cs" Inherits="Apply_Propaganda_Apply_Propaganda_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
        ...
        function save() {
            ...
            for(var y = 1; y <= 2; y++)
            {
                if($("#txtIDx"+y).parent().css("display")!="none") {
                    if(isi == "1" && y == 1){
                        var z = $("#txtIDx1").val().replace("，",",").split(",");
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <label id="lb1" class='item' for='btnIDx' style="display:none;">部门/分行/组别主管</label>
            <div id="divIDx1" class='item'><input id="btnIDx1" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(1);" /><label id="lblIDx1" for='btnIDx1'>部门/分行/组别主管</label></div><div id="divTxtIDx1" class='item' style="display:none;"><input type="text" id="txtIDx1" style="width:200px;" /><input id="hdIDx1" type="hidden" /><a id="a1" href="javascript:;" onclick="showOrHideIDx(1)">取消</a></div><img src="/Images/forward.png" class="forward"/>
            <label id="lb2" class='item' for='btnIDx' style="display:none;">总监/区域负责人</label>
            <div id="divIDx2" class='item'><input id="btnIDx2" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(2);" /><label id="lblIDx2" for='btnIDx2'>总监/区域负责人</label></div><div id="divTxtIDx2" class='item' style="display:none;"><input type="text" id="txtIDx2" style="width:100px;" /><input id="hdIDx2" type="hidden" /><a id="a2" href="javascript:;" onclick="showOrHideIDx(2)">取消</a></div>
            <br /><br />
