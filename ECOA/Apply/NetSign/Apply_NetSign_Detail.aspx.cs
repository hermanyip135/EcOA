...
public partial class Apply_NetSign_Apply_NetSign_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite46"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite46"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_NetSign_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_NetSign_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_NetSign_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_NetSign_ApplyID"].ToString();
        ddlDepartment.Text = dr["OfficeAutomation_Document_NetSign_Department"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_NetSign_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        ddlKindOfApply.Text = dr["OfficeAutomation_Document_NetSign_KindOfApply"].ToString();
        txtHHManage.Text = dr["OfficeAutomation_Document_NetSign_HHManage"].ToString();
        txtBudingAddress.Text = dr["OfficeAutomation_Document_NetSign_BudingAddress"].ToString();
        txtTakeBranch.Text = dr["OfficeAutomation_Document_NetSign_TakeBranch"].ToString();
        txtZYFollows.Text = dr["OfficeAutomation_Document_NetSign_ZYFollows"].ToString();
        txtSendBank.Text = dr["OfficeAutomation_Document_NetSign_SendBank"].ToString();
        txtBorrower.Text = dr["OfficeAutomation_Document_NetSign_Borrower"].ToString();
        txtPrice.Text = dr["OfficeAutomation_Document_NetSign_Price"].ToString();
        txtDealPrice.Text = dr["OfficeAutomation_Document_NetSign_DealPrice"].ToString();
        txtLoan.Text = dr["OfficeAutomation_Document_NetSign_Loan"].ToString();
        txtCompany1.Text = dr["OfficeAutomation_Document_NetSign_Company1"].ToString();
        txtAssessment1.Text = dr["OfficeAutomation_Document_NetSign_Assessment1"].ToString();
        txtCompany2.Text = dr["OfficeAutomation_Document_NetSign_Company2"].ToString();
        txtAssessment2.Text = dr["OfficeAutomation_Document_NetSign_Assessment2"].ToString();
        txtCompany3.Text = dr["OfficeAutomation_Document_NetSign_Company3"].ToString();
        txtAssessment3.Text = dr["OfficeAutomation_Document_NetSign_Assessment3"].ToString();
        txtDescribe.Text = dr["OfficeAutomation_Document_NetSign_Describe"].ToString();
        txtSpace.Text = dr["OfficeAutomation_Document_NetSign_Space"].ToString();
        ...
        try
        {
            ...
            {
                //SbJs.Append(ApplyDisplayPart);
                SbJs.Append("$(\"#btnPrint\").hide();$(\"#HeadA\").show();");
                SbJs.Append("</script>");
                GetAllDepartment();
                //txtDepartment.Text = "";
                btnSPDF.Visible = false; //M_PDF
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_NetSign t_OfficeAutomation_Document_NetSign = new T_OfficeAutomation_Document_NetSign();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                //    return;
                //}
                if (ddlKindOfApply.Text == "超成数10%（含）以下备案" && float.Parse(HidAutoN.Value) > 10)
                {
                    RunJS("alert('请选择符合超出比例的申请类型！');");
                    return;
                }
                else if (ddlKindOfApply.Text == "超成数10%（不含）以上备案" && float.Parse(HidAutoN.Value) <= 10)
                {
                    RunJS("alert('请选择符合超出比例的申请类型。');");
                    return;
                }
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "NetSign" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 41; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_NetSign = GetModelFromPage(Guid.NewGuid());

                t_OfficeAutomation_Main.OfficeAutomation_Main_Apply = EmployeeName;
                t_OfficeAutomation_Main.OfficeAutomation_Main_Department = ddlDepartment.Text;
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = txtBudingAddress.Text;
                ...
                da_OfficeAutomation_Document_NetSign_Inherit.Insert(t_OfficeAutomation_Document_NetSign);//插入申请表

                IsNewApply = false;

                //InsertNetSignDetail(t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_ID);

                SaveFlows(t_OfficeAutomation_Main.OfficeAutomation_Main_ID);

                Common.AddLog(EmployeeID, EmployeeName, 45, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                //RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_NetSign_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
            ...
            else
            {
                ...
                if (Purview.Contains("OA_ITPower_001"))//是否有编辑权限
                {
                    if (ddlKindOfApply.Text == "超成数10%（含）以下备案" && float.Parse(HidAutoN.Value) > 10)
                    {
                        RunJS("alert('请选择符合超出比例的申请类型！');window.location.href='" + Page.Request.Url + "';");
                        return;
                    }
                    else if (ddlKindOfApply.Text == "超成数10%（不含）以上备案" && float.Parse(HidAutoN.Value) <= 10)
                    {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_NetSign_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_NetSign_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_NetSign_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_NetSign_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_NetSign_Apply"]);
                    sbMailBody.Append("<br/>分部名：" + drRow["OfficeAutomation_Document_NetSign_Department"]);
                    sbMailBody.Append("<br/>发文日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_NetSign_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>案号：" + drRow["OfficeAutomation_Document_NetSign_ApplyID"]);
                    sbMailBody.Append("<br/>申请类型：" + drRow["OfficeAutomation_Document_NetSign_KindOfApply"]);
                    sbMailBody.Append("<br/>汇瀚业务经办：" + drRow["OfficeAutomation_Document_NetSign_HHManage"]);

                    sbMailBody.Append("<br/>物业地址：" + drRow["OfficeAutomation_Document_NetSign_BudingAddress"]);
                    sbMailBody.Append("<br/>承接分行：" + drRow["OfficeAutomation_Document_NetSign_TakeBranch"]);
                    sbMailBody.Append("<br/>中原跟进营业员：" + drRow["OfficeAutomation_Document_NetSign_ZYFollows"]);
                    sbMailBody.Append("<br/>送审银行：" + drRow["OfficeAutomation_Document_NetSign_SendBank"]);
                    sbMailBody.Append("<br/>借款人姓名：" + drRow["OfficeAutomation_Document_NetSign_Borrower"]);
                    sbMailBody.Append("<br/>网签价格：" + drRow["OfficeAutomation_Document_NetSign_Price"]);
                    sbMailBody.Append("<br/>分行成交双方约价格：" + drRow["OfficeAutomation_Document_NetSign_DealPrice"]);
                    sbMailBody.Append("<br/>房屋面积：" + drRow["OfficeAutomation_Document_NetSign_Describe"]);
                    sbMailBody.Append("<br/>自动计算超出比例：" + HidAutoC.Value);
                    sbMailBody.Append("<br/>贷款额：" + drRow["OfficeAutomation_Document_NetSign_Loan"]);
                    sbMailBody.Append("<br/>评估公司1：" + drRow["OfficeAutomation_Document_NetSign_Company1"]);
                    sbMailBody.Append("<br/>评估价1：" + drRow["OfficeAutomation_Document_NetSign_Assessment1"]);
                    sbMailBody.Append("<br/>评估公司2：" + drRow["OfficeAutomation_Document_NetSign_Company2"]);
                    sbMailBody.Append("<br/>评估价2：" + drRow["OfficeAutomation_Document_NetSign_Assessment2"]);
                    sbMailBody.Append("<br/>评估公司3：" + drRow["OfficeAutomation_Document_NetSign_Company3"]);
                    sbMailBody.Append("<br/>评估价3：" + drRow["OfficeAutomation_Document_NetSign_Assessment3"]);
                    sbMailBody.Append("<br/>申请说明原因：" + drRow["OfficeAutomation_Document_NetSign_Describe"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_NetSign_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private T_OfficeAutomation_Document_NetSign GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_NetSign t_OfficeAutomation_Document_NetSign = new T_OfficeAutomation_Document_NetSign();
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_ID = UndertakeProjID;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Apply = EmployeeName;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Department = ddlDepartment.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_KindOfApply = ddlKindOfApply.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_HHManage = txtHHManage.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_BudingAddress = txtBudingAddress.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_TakeBranch = txtTakeBranch.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_ZYFollows = txtZYFollows.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_SendBank = txtSendBank.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Borrower = txtBorrower.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Price = txtPrice.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_DealPrice = txtDealPrice.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Loan = txtLoan.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Company1 = txtCompany1.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Assessment1 = txtAssessment1.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Company2 = txtCompany2.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Assessment2 = txtAssessment2.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Company3 = txtCompany3.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Assessment3 = txtAssessment3.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Describe = txtDescribe.Text;
        t_OfficeAutomation_Document_NetSign.OfficeAutomation_Document_NetSign_Space = txtSpace.Text;


        return t_OfficeAutomation_Document_NetSign;
    }

    #endregion

    #region 保存默认流程
    private void SaveFlows(Guid mainid)
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
        ...
        if (ddlKindOfApply.SelectedValue == "超成数10%（不含）以上备案")
        {
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_NetSign_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_NetSign_ID"].ToString();

        t_OfficeAutomation_Document_NetSign = GetModelFromPage(new Guid(ID));

        string apply = EmployeeName;
        string depname = ddlDepartment.Text;
        string summary = txtBudingAddress.Text;
        string applydate = "";
        string mainid = MainID;

        da_OfficeAutomation_Main_Inherit.UpdateMain(mainid, depname, apply, applydate, summary);
        da_OfficeAutomation_Document_NetSign_Inherit.Update(t_OfficeAutomation_Document_NetSign);//修改申请表

        //DA_OfficeAutomation_Document_NetSign_Detail_Inherit da_OfficeAutomation_Document_NetSign_Detail_Inherit = new DA_OfficeAutomation_Document_NetSign_Detail_Inherit();
        //da_OfficeAutomation_Document_NetSign_Detail_Inherit.Delete(ID);
        //InsertNetSignDetail(new Guid(ID));
        SaveFlows(new Guid(MainID));


        Common.AddLog(EmployeeID, EmployeeName, 45, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite46"] = "1";
        Response.Write("<script>window.open('Apply_NetSign_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("超成数备案.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_NetSign_Inherit da_OfficeAutomation_Document_NetSign_Inherit = new DA_OfficeAutomation_Document_NetSign_Inherit();
            DataSet ds = da_OfficeAutomation_Document_NetSign_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_NetSign_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_NetSign_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
