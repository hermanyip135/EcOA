...
public partial class Apply_ProjDormSubsiby_Apply_ProjDormSubsiby_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite16"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite16"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_ProjDormSubsiby_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_ProjDormSubsiby_ID"].ToString();

        string applicant = dr["OfficeAutomation_Document_ProjDormSubsiby_Apply"].ToString();
        ApplyN = applicant;
        txtDepartment.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_Department"].ToString();
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ProjDormSubsiby_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        lblApply.Text = applicant;
        txtReplyPhone.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_ReplyPhone"].ToString();
        txtApplyID.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_ApplyID"].ToString();
        txtProjName.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_ProjName"].ToString();
        txtDeveloperName.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_DeveloperName"].ToString();
        txtProjAddress.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_ProjAddress"].ToString();
        txtAgentStartDate.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_AgentStartDate"].ToString();
        txtAgentEndDate.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_AgentEndDate"].ToString();
        txtSaleDate.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_SaleDate"].ToString();

        InitListControler(dr["OfficeAutomation_Document_ProjDormSubsiby_DealOfficeTypeIDs"].ToString());

        txtDealOfficeOther.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_DealOfficeOther"].ToString();
        txtGoodsQuantity.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_GoodsQuantity"].ToString();
        txtGoodsValue.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_GoodsValue"].ToString();
        txtPreComm.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_PreComm"].ToString();

        switch (dr["OfficeAutomation_Document_ProjDormSubsiby_AgentModel"].ToString())
        {
            case "1":
        ...
        txtCommPoint.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_CommPoint"].ToString();
        if (!string.IsNullOrEmpty(dr["OfficeAutomation_Document_ProjDormSubsiby_RentStartDate"].ToString()))
            txtRentStartDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ProjDormSubsiby_RentStartDate"].ToString()).ToString("yyyy-MM-dd");
        if (!string.IsNullOrEmpty(dr["OfficeAutomation_Document_ProjDormSubsiby_RentEndDate"].ToString()))
            txtRentEndDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ProjDormSubsiby_RentEndDate"].ToString()).ToString("yyyy-MM-dd");

        switch (dr["OfficeAutomation_Document_ProjDormSubsiby_RentType"].ToString())
        {
            case "1":
                rdbRentType1.Checked = true;
                break;
            case "2":
                rdbRentType2.Checked = true;
                break;
            default:
                break;
        }

        txtLiveNumber.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_LiveNumber"].ToString();
        txtDormAddress.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_DormAddress"].ToString();
        txtDormArea.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_DormArea"].ToString();
        txtDormType.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_DormType"].ToString();
        txtMonthlyRent.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_MonthlyRent"].ToString();
        txtDeposit.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_Deposit"].ToString();
        txtAgencyFee.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_AgencyFee"].ToString();
        txtMonthlyEstimatedCost.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_MonthlyEstimatedCost"].ToString();
        txtManagermentCost.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_ManagermentCost"].ToString();
        txtElectricCharge.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_ElectricCharge"].ToString();
        txtWaterCharge.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_WaterCharge"].ToString();
        txtGasCharge.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_GasCharge"].ToString();
        txtMonthlyCost.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_MonthlyCost"].ToString();
        txtDormRemark.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_DormRemark"].ToString();

        txtDormitoryMonth.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_DormitoryMonth"].ToString();
        txtDormitoryMan.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_DormitoryMan"].ToString();
        txtDormitoryMdm.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_DormitoryMdm"].ToString();
        if (!string.IsNullOrEmpty(dr["OfficeAutomation_Document_ProjDormSubsiby_DormitoryStartDate"].ToString()))
            txtDormitoryStartDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ProjDormSubsiby_DormitoryStartDate"].ToString()).ToString("yyyy-MM-dd");
        if (!string.IsNullOrEmpty(dr["OfficeAutomation_Document_ProjDormSubsiby_DormitoryEndDate"].ToString()))
            txtDormitoryEndDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ProjDormSubsiby_DormitoryEndDate"].ToString()).ToString("yyyy-MM-dd");
        txtDormitoryRemark.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_DormitoryRemark"].ToString();
        txtApplyMoney.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_ApplyMoney"].ToString();
        txtTrafficApplyMoney.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_TrafficApplyMoney"].ToString();

        txtLastYear.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_LastYear"].ToString();
        txtLastMonth.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_LastMonth"].ToString();
        txtLastRent.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_LastRent"].ToString();

        txtStartPlace.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_StartPlace"].ToString();
        txtEndPlace.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_EndPlace"].ToString();
        txtRoundTripMoney.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_RoundTripMoney"].ToString();
        txtNumberOfTimes.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_NumberOfTimes"].ToString();
        txtSumOfMoney.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_SumOfMoney"].ToString();
        if (!string.IsNullOrEmpty(dr["OfficeAutomation_Document_ProjDormSubsiby_SubsibyValidityStartDate"].ToString()))
            txtSubsibyValidityStartDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ProjDormSubsiby_SubsibyValidityStartDate"].ToString()).ToString("yyyy-MM-dd");
        if (!string.IsNullOrEmpty(dr["OfficeAutomation_Document_ProjDormSubsiby_SubsibyValidityEndDate"].ToString()))
            txtSubsibyValidityEndDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ProjDormSubsiby_SubsibyValidityEndDate"].ToString()).ToString("yyyy-MM-dd");
        txtSubsibyRemark.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_SubsibyRemark"].ToString();
        txtSumPerformance.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_SumPerformance"].ToString();
        txtSumProfit.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_SumProfit"].ToString();
        txtProjGoodsQuantity.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_ProjGoodsQuantity"].ToString();
        txtProjGoodsValue.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_ProjGoodsValue"].ToString();
        txtProjCommission.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_ProjCommission"].ToString();
        txtProjCommPoint.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_ProjCommPoint"].ToString();
        txtDormSumCost.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_DormSumCost"].ToString();
        txtSubsibySumCost.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_SubsibySumCost"].ToString();
        txtDormSumCostScale.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_DormSumCostScale"].ToString();
        txtSubsibySumCostScale.Text = dr["OfficeAutomation_Document_ProjDormSubsiby_SubsibySumCostScale"].ToString();
        lblDormValidityStartDate.Text = txtRentStartDate.Text;
        lblDormValidityEndDate.Text = txtRentEndDate.Text;
        lblSubsibyValidityStartDate.Text = txtSubsibyValidityStartDate.Text;
        lblSubsibyValidityEndDate.Text = txtSubsibyValidityEndDate.Text;

        lbDormitoryStartDate.Text = txtDormitoryStartDate.Text;
        lbDormitoryEndDate.Text = txtDormitoryEndDate.Text;

        SerialNumber = dr["OfficeAutomation_SerialNumber"].ToString();

        InitListControler(dr["OfficeAutomation_Document_ProjDormSubsiby_DealOfficeTypeIDs"].ToString());

        string[] enjoyPersonInfo = Regex.Split(dr["OfficeAutomation_Document_ProjDormSubsiby_EnjoyPersonInfo"].ToString(), "\\|\\|");
        string[] performanceProfitInfo = Regex.Split(dr["OfficeAutomation_Document_ProjDormSubsiby_PerformanceProfitInfo"].ToString(), "\\|\\|");

        DrawDetailTable(enjoyPersonInfo.Length, performanceProfitInfo.Length);

        for (int n = 0; n < enjoyPersonInfo.Length; n++)
        {
            if (enjoyPersonInfo[n]!= "")
            {
                string[] info = Regex.Split(enjoyPersonInfo[n], "\\&\\&");

                int i = n + 1;

                SbJs.Append("$('#txtEnjoyPersonName" + i + "').val('" +info[0] + "');");
                SbJs.Append("$('#txtEnjoyPersonPosition" + i + "').val('" + info[1] + "');");
                SbJs.Append("$('#txtEnjoyPersonID" + i + "').val('" + info[2] + "');");
                SbJs.Append("$('#txtEnjoyPersonLiveAddress" + i + "').val('" + info[3] + "');");
            }
        }
        ...
        for (int i = 0; i < drc.Count; i++)
        {
            ...
            if ((curidx == "1" || curidx == "2" || EmployeeName == "黄轩明") && curemp2.Contains(EmployeeID) && showf) //M_HideFlows：20150330
            {
                ...
                SbJs.Append("$(\"#trShowFlow6\").hide();$(\"#trShowFlow7\").prepend('<td>人力资源部<br />意见</td>');");
                SbJs.Append("$(\"#trShowFlow8\").hide();$(\"#trShowFlow9\").prepend('<td>财务部意见</td>');");
        ...
        flows = da_OfficeAutomation_Flow_Inherit.SelectByMainIDAndIdx(MainID, 131);
        if (flows != null)
            SbJs.Append("$('#tlsc2').show();");
        ...
        //if ((flowState == "1" || flowState == "2") && applicant == EmployeeName && !tpdf && showf) //20141215：M_AlterC
    ...
    public void DrawDetailTable(int n1,int n2)
    {
        for (int i = 1; i <= n1; i++)
        {
            SbHtml1.Append("<tr id='trEnjoyPerson" + i + "'>");
            SbHtml1.Append("    <td><input type=\"text\" id=\"txtEnjoyPersonName" + i + "\" style=\"width:80px\"/></td>");
            SbHtml1.Append("    <td><input type=\"text\" id=\"txtEnjoyPersonPosition" + i + "\" style=\"width:80px\"/></td>");
            SbHtml1.Append("    <td><input type=\"text\" id=\"txtEnjoyPersonID" + i + "\" style=\"width:95%\"/></td>");
            SbHtml1.Append("    <td><input type=\"text\" id=\"txtEnjoyPersonLiveAddress" + i + "\" style=\"width:95%\"/></td>");
            SbHtml1.Append("</tr>");
        }
        SbJs.Append("i1=" + n1 + ";");
        ...
        for (int i = 1; i <= n2; i++)
        {
            SbHtml2.Append("<tr id='trPerformanceProfit" + i + "'>");
            SbHtml2.Append("     <td><input type=\"text\" id=\"txtStartYear" + i + "\" style=\"width:90px\"/>至<input type=\"text\" id=\"txtEndYear" + i + "\" style=\"width:90px\"/></td>");
            SbHtml2.Append("     <td><input type=\"text\" id=\"txtPerformance" + i + "\"/></td>");
            SbHtml2.Append("     <td><input type=\"text\" id=\"txtProfit" + i + "\"/></td>");
            SbHtml2.Append("</tr>");
        }
        SbJs.Append("i2=" + n2 + ";");
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_ProjDormSubsiby t_OfficeAutomation_Document_ProjDormSubsiby = new T_OfficeAutomation_Document_ProjDormSubsiby();
        ...
        try
        {
            ...
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "ProjDormSubsiby" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 23;
                ...
                t_OfficeAutomation_Document_ProjDormSubsiby = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_ProjDormSubsiby_Inherit.Add(t_OfficeAutomation_Document_ProjDormSubsiby);//插入申请表
                ...
                #region 如果有宿舍申请，或津贴申请大于20000元，则需要董事总经理审批 

                try
                {
                    if (t_OfficeAutomation_Document_ProjDormSubsiby.OfficeAutomation_Document_ProjDormSubsiby_RentStartDate != null || decimal.Parse(t_OfficeAutomation_Document_ProjDormSubsiby.OfficeAutomation_Document_ProjDormSubsiby_SumOfMoney) > 2000)
                    {
                ...
                //SYSREQ201901031430099084194 需求，故作下面内容的备注
                //if (rdbRentType1.Checked)
                //{
                //    string se = string.IsNullOrEmpty(txtLastYear.Text) ? "0" : txtLastYear.Text;
                //    if (((float.Parse(se) >= 1 || float.Parse(txtLastMonth.Text) >= 12) 
                //        && (float.Parse(txtMonthlyRent.Text) - float.Parse(txtLastRent.Text)) / float.Parse(txtLastRent.Text) <= 0.1
                //        )
                //        || (float.Parse(se) == 0 && float.Parse(txtLastMonth.Text) < 12))
                //        da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndAfterIdxs(MainID, 5);
                //}

                if(!string.IsNullOrEmpty(txtDormitoryMonth.Text))
                    da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndAfterIdxs(MainID, 5);
                ...
                Common.AddLog(EmployeeID, EmployeeName, 27, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_ProjDormSubsiby_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=250px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_ProjDormSubsiby_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_ProjDormSubsiby_ID"].ToString();
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ProjDormSubsiby_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_ProjDormSubsiby_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请部门：" + drRow["OfficeAutomation_Document_ProjDormSubsiby_Department"]);
                    sbMailBody.Append("<br/>申请日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_ProjDormSubsiby_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>跟进人：" + drRow["OfficeAutomation_Document_ProjDormSubsiby_Apply"]);
                    sbMailBody.Append("<br/>跟进人联系电话：" + drRow["OfficeAutomation_Document_ProjDormSubsiby_ReplyPhone"]);
                    sbMailBody.Append("<br/>项目名称：" + drRow["OfficeAutomation_Document_ProjDormSubsiby_ProjName"]);
                    sbMailBody.Append("<br/>开发商名称：" + drRow["OfficeAutomation_Document_ProjDormSubsiby_DeveloperName"]);
                    sbMailBody.Append("<br/>项目地址：" + drRow["OfficeAutomation_Document_ProjDormSubsiby_ProjAddress"]);
                    sbMailBody.Append("<br/>代理期：" + DateTime.Parse(drRow["OfficeAutomation_Document_ProjDormSubsiby_AgentStartDate"].ToString()).ToString("yyyy-MM-dd") + "至" + DateTime.Parse(drRow["OfficeAutomation_Document_ProjDormSubsiby_AgentEndDate"].ToString()).ToString("yyyy-MM-dd"));
                    DateTime saleDate = new DateTime();
                    string sSaleDate;
                    if (DateTime.TryParse(drRow["OfficeAutomation_Document_ProjDormSubsiby_SaleDate"].ToString(), out saleDate))
                        sSaleDate = saleDate.ToString("yyyy-MM-dd");
                    else
                        sSaleDate = drRow["OfficeAutomation_Document_ProjDormSubsiby_SaleDate"].ToString();
                    sbMailBody.Append("<br/>开售日：" + sSaleDate);
                    sbMailBody.Append("<br/>货量：" + drRow["OfficeAutomation_Document_ProjDormSubsiby_GoodsQuantity"]);
                    sbMailBody.Append("<br/>货值：" + drRow["OfficeAutomation_Document_ProjDormSubsiby_GoodsValue"]);
                    sbMailBody.Append("<br/>预计创佣：" + drRow["OfficeAutomation_Document_ProjDormSubsiby_PreComm"]);
                    sbMailBody.Append("<br/>佣金点数：" + drRow["OfficeAutomation_Document_ProjDormSubsiby_CommPoint"]);
                    sbMailBody.Append("<br/>其他情况请详见申请表。");
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_ProjDormSubsiby_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_ProjDormSubsiby_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ProjDormSubsiby_ID"].ToString();

        t_OfficeAutomation_Document_ProjDormSubsiby = GetModelFromPage(new Guid(ID));
        ...
        da_OfficeAutomation_Document_ProjDormSubsiby_Inherit.Update(t_OfficeAutomation_Document_ProjDormSubsiby);//修改申请表
        ...
        //T_OfficeAutomation_Flow flows = new T_OfficeAutomation_Flow();
        ...
        //    string se = string.IsNullOrEmpty(txtLastYear.Text) ? "0" : txtLastYear.Text;
        //    if (((float.Parse(se) >= 1
        //        || float.Parse(txtLastMonth.Text) >= 12
        //        ) && (float.Parse(txtMonthlyRent.Text) - float.Parse(txtLastRent.Text)) / float.Parse(txtLastRent.Text) <= 0.1
        //        )
        //        || (float.Parse(se) == 0 && float.Parse(txtLastMonth.Text) < 12))
        //        da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndAfterIdxs(MainID, 5);
        ...
        if (flows != null)
        {
            try
            {
                ...
                if (txtRentStartDate.Text != "" || decimal.Parse(txtSumOfMoney.Text) > 2000)
                {
                    t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = CommonConst.EMP_GENERALMANAGER_ID;
                    t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = CommonConst.EMP_GENERALMANAGER_NAME;
                    t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
        ...
        Common.AddLog(EmployeeID, EmployeeName, 27, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    private T_OfficeAutomation_Document_ProjDormSubsiby GetModelFromPage(Guid ProjDormSubsibyID)
    {
        DataEntity.T_OfficeAutomation_Document_ProjDormSubsiby model = new DataEntity.T_OfficeAutomation_Document_ProjDormSubsiby();
        model.OfficeAutomation_Document_ProjDormSubsiby_ID = ProjDormSubsibyID;
        model.OfficeAutomation_Document_ProjDormSubsiby_MainID = new Guid(MainID); //*-
        model.OfficeAutomation_Document_ProjDormSubsiby_Department = txtDepartment.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_ApplyDate = DateTime.Now;
        model.OfficeAutomation_Document_ProjDormSubsiby_Apply = EmployeeName;
        model.OfficeAutomation_Document_ProjDormSubsiby_ReplyPhone = txtReplyPhone.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_ApplyID = txtApplyID.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_ProjName = txtProjName.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_DeveloperName = txtDeveloperName.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_ProjAddress = txtProjAddress.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_AgentStartDate = txtAgentStartDate.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_AgentEndDate = txtAgentEndDate.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_SaleDate = txtSaleDate.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_DealOfficeTypeIDs = sOfficeType; // hdDealOfficeType.Value;
        model.OfficeAutomation_Document_ProjDormSubsiby_DealOfficeOther = txtDealOfficeOther.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_GoodsQuantity = txtGoodsQuantity.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_GoodsValue = txtGoodsValue.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_PreComm = txtPreComm.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_AgentModel = rdbAgentModel1.Checked ? 1 : 2;
        model.OfficeAutomation_Document_ProjDormSubsiby_CommPoint = txtCommPoint.Text;
        if (!string.IsNullOrEmpty(txtRentStartDate.Text))
            model.OfficeAutomation_Document_ProjDormSubsiby_RentStartDate = DateTime.Parse(txtRentStartDate.Text);
        if (!string.IsNullOrEmpty(txtRentEndDate.Text))
            model.OfficeAutomation_Document_ProjDormSubsiby_RentEndDate = DateTime.Parse(txtRentEndDate.Text);
        model.OfficeAutomation_Document_ProjDormSubsiby_RentType = rdbRentType1.Checked ? 1 : 2;
        model.OfficeAutomation_Document_ProjDormSubsiby_LiveNumber = txtLiveNumber.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_DormAddress = txtDormAddress.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_DormArea = txtDormArea.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_DormType = txtDormType.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_MonthlyRent = txtMonthlyRent.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_Deposit = txtDeposit.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_AgencyFee = txtAgencyFee.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_MonthlyEstimatedCost = txtMonthlyEstimatedCost.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_ManagermentCost = txtManagermentCost.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_ElectricCharge = txtElectricCharge.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_WaterCharge = txtWaterCharge.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_GasCharge = txtGasCharge.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_MonthlyCost = txtMonthlyCost.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_DormRemark = txtDormRemark.Text;

        model.OfficeAutomation_Document_ProjDormSubsiby_DormitoryMonth = txtDormitoryMonth.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_DormitoryMan = txtDormitoryMan.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_DormitoryMdm = txtDormitoryMdm.Text;
        if (!string.IsNullOrEmpty(txtDormitoryStartDate.Text))
            model.OfficeAutomation_Document_ProjDormSubsiby_DormitoryStartDate = DateTime.Parse(txtDormitoryStartDate.Text);
        if (!string.IsNullOrEmpty(txtDormitoryEndDate.Text))
            model.OfficeAutomation_Document_ProjDormSubsiby_DormitoryEndDate = DateTime.Parse(txtDormitoryEndDate.Text);
        model.OfficeAutomation_Document_ProjDormSubsiby_DormitoryRemark = txtDormitoryRemark.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_ApplyMoney = txtApplyMoney.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_TrafficApplyMoney = txtTrafficApplyMoney.Text;

        model.OfficeAutomation_Document_ProjDormSubsiby_LastYear = txtLastYear.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_LastMonth = txtLastMonth.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_LastRent = txtLastRent.Text;

        model.OfficeAutomation_Document_ProjDormSubsiby_StartPlace = txtStartPlace.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_EndPlace = txtEndPlace.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_RoundTripMoney = txtRoundTripMoney.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_NumberOfTimes = txtNumberOfTimes.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_SumOfMoney = txtSumOfMoney.Text;
        if (!string.IsNullOrEmpty(txtSubsibyValidityStartDate.Text))
            model.OfficeAutomation_Document_ProjDormSubsiby_SubsibyValidityStartDate = DateTime.Parse(txtSubsibyValidityStartDate.Text);
        if (!string.IsNullOrEmpty(txtSubsibyValidityEndDate.Text))
            model.OfficeAutomation_Document_ProjDormSubsiby_SubsibyValidityEndDate = DateTime.Parse(txtSubsibyValidityEndDate.Text);
        model.OfficeAutomation_Document_ProjDormSubsiby_SubsibyRemark = txtSubsibyRemark.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_EnjoyPersonInfo = hdEnjoyPerson.Value;
        model.OfficeAutomation_Document_ProjDormSubsiby_PerformanceProfitInfo = hdPerformanceProfit.Value;
        model.OfficeAutomation_Document_ProjDormSubsiby_SumPerformance = txtSumPerformance.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_SumProfit = txtSumProfit.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_ProjGoodsQuantity = txtProjGoodsQuantity.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_ProjGoodsValue = txtProjGoodsValue.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_ProjCommission = txtProjCommission.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_ProjCommPoint = txtProjCommPoint.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_DormSumCost = txtDormSumCost.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_SubsibySumCost = txtSubsibySumCost.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_DormSumCostScale = txtDormSumCostScale.Text;
        model.OfficeAutomation_Document_ProjDormSubsiby_SubsibySumCostScale = txtSubsibySumCostScale.Text;
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite16"] = "1";
        Response.Write("<script>window.open('Apply_ProjDormSubsiby_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("项目宿舍及津贴费用申请表.pdf"));//强制下载 
    ...
    protected void btnSaveLogisticsFlow_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_ProjDormSubsiby_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ProjDormSubsiby_ID"].ToString(); //在不同的表要注意修改
        ...
        if (txtRentStartDate.Text != null || int.Parse(txtSumOfMoney.Text) > 2000 || ism)
        {
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_ProjDormSubsiby_Inherit da_OfficeAutomation_Document_ProjDormSubsiby_Inherit = new DA_OfficeAutomation_Document_ProjDormSubsiby_Inherit();
            DataSet ds = da_OfficeAutomation_Document_ProjDormSubsiby_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ProjDormSubsiby_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            ...
            if (flows != null)
            {
                ...
                if (i <= 8 && EmployeeID == "13545") //M_AddNWX：20150511
                {
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_ProjDormSubsiby_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_ProjDormSubsiby_Inherit();
