...
public partial class Apply_Record_Apply_Record_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite80"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite80"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_Record_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_Record_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_Record_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_Record_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_Record_Department"].ToString();
        lblApply.Text = applicant;
        txtApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_Record_ApplyDate"].ToString()).ToString("yyyy-MM-dd");

        txtAddress.Text = dr["OfficeAutomation_Document_Record_Address"].ToString();
        txtAName.Text = dr["OfficeAutomation_Document_Record_AName"].ToString();
        txtAPhone.Text = dr["OfficeAutomation_Document_Record_APhone"].ToString();
        txtBname.Text = dr["OfficeAutomation_Document_Record_Bname"].ToString();
        txtBphone.Text = dr["OfficeAutomation_Document_Record_Bphone"].ToString();
        txtClerk.Text = dr["OfficeAutomation_Document_Record_Clerk"].ToString();
        txtMaster.Text = dr["OfficeAutomation_Document_Record_Master"].ToString();
        txtTurnDate.Text = dr["OfficeAutomation_Document_Record_TurnDate"].ToString();
        txtReason.Text = dr["OfficeAutomation_Document_Record_Reason"].ToString();
        ddlBusiness.SelectedValue = dr["OfficeAutomation_Document_Record_Business"].ToString();
        txtTname.Text = dr["OfficeAutomation_Document_Record_Tname"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_Record t_OfficeAutomation_Document_Record = new T_OfficeAutomation_Document_Record();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "Record" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 75; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_Record = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_Record_Inherit.Insert(t_OfficeAutomation_Document_Record);//插入申请表

                //InsertRecordDetail(t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_ID);
                ...
                Common.AddLog(EmployeeID, EmployeeName, 79, new Guid(MainID), 1);//日志，创建申请表
                ...
                //RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_Record_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void SendMess()//*-
    {
        ...
        DA_OfficeAutomation_Document_Record_Inherit da_OfficeAutomation_Document_Record_Inherit = new DA_OfficeAutomation_Document_Record_Inherit();
        DataSet ds = da_OfficeAutomation_Document_Record_Inherit.SelectByMainID(MainID); //在不同的表中要修改
        DataRow drRow = ds.Tables[0].Rows[0];
        string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Record_Apply"].ToString();
        string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
        string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
        string department = drRow["OfficeAutomation_Document_Record_Department"].ToString();
        ...
        sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_Record_Apply"]);
        sbMailBody.Append("<br/>分行名称：" + drRow["OfficeAutomation_Document_Record_Department"]);
        sbMailBody.Append("<br/>成交日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_Record_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
        sbMailBody.Append("<br/>成交编号：" + drRow["OfficeAutomation_Document_Record_ApplyID"]);
        sbMailBody.Append("<br/>成交查册地址：" + drRow["OfficeAutomation_Document_Record_Address"]);
        sbMailBody.Append("<br/>业主姓名：" + drRow["OfficeAutomation_Document_Record_AName"]);

        sbMailBody.Append("<br/>业主电话：" + drRow["OfficeAutomation_Document_Record_APhone"]);
        sbMailBody.Append("<br/>买家姓名：" + drRow["OfficeAutomation_Document_Record_Bname"]);
        sbMailBody.Append("<br/>买家电话：" + drRow["OfficeAutomation_Document_Record_Bphone"]);
        sbMailBody.Append("<br/>营业员姓名：" + drRow["OfficeAutomation_Document_Record_Clerk"]);
        sbMailBody.Append("<br/>分行主管姓名：" + drRow["OfficeAutomation_Document_Record_Master"]);
        sbMailBody.Append("<br/>预计审核转介时间：" + drRow["OfficeAutomation_Document_Record_TurnDate"]);
        sbMailBody.Append("<br/>备案原因：" + drRow["OfficeAutomation_Document_Record_Reason"]);
        sbMailBody.Append("<br/>转介汇瀚部门：" + drRow["OfficeAutomation_Document_Record_Business"]);
        sbMailBody.Append("<br/>转介汇瀚人员：" + drRow["OfficeAutomation_Document_Record_Tname"]);
        ...
        foreach (DataRow dr in ds.Tables[0].Rows)
        {
            employnames = ("吴嘉瑜,梁婉华," + txtTname.Text.Trim()).Split(',');
            for (int i2 = 0; i2 < employnames.Length; i2++)
            {
                msnBody = "您好，" + employnames[i2] + "：现有一份编号为：" + serialNumber + "的" + documentName + "需要您跟进。<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
                email = employnames[i2]; if (email != "")
                    Common.SendMessageEX(false, email, "请跟进", msnBody + mailBody, msnBody);
            }
        }
    }
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_Record_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_Record_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    StringBuilder sbMailBody = new StringBuilder();
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_Record_Apply"]);
                    sbMailBody.Append("<br/>分行（组别）：" + drRow["OfficeAutomation_Document_Record_Department"]);
                    sbMailBody.Append("<br/>填写日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_Record_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>成交编号：" + drRow["OfficeAutomation_Document_Record_ApplyID"]);
                    sbMailBody.Append("<br/>区名：" + drRow["OfficeAutomation_Document_Record_Area"]);
                    sbMailBody.Append("<br/>营业员：" + drRow["OfficeAutomation_Document_Record_Clerk"]);

                    sbMailBody.Append("<br/>成交物业时间：" + drRow["OfficeAutomation_Document_Record_DealDate"]);
                    sbMailBody.Append("<br/>成交物业地址：" + drRow["OfficeAutomation_Document_Record_Address"]);
                    sbMailBody.Append("<br/>原因：" + drRow["OfficeAutomation_Document_Record_Reason"]);
                    sbMailBody.Append("<br/>网上转介时间：" + drRow["OfficeAutomation_Document_Record_TurnDate"]);
                    sbMailBody.Append("<br/><br/>");
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_Record_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private T_OfficeAutomation_Document_Record GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_Record t_OfficeAutomation_Document_Record = new T_OfficeAutomation_Document_Record();
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_ID = UndertakeProjID;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_Apply = EmployeeName;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_Department = txtDepartment.Text;

        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_Address = txtAddress.Text;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_AName = txtAName.Text;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_APhone = txtAPhone.Text;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_Bname = txtBname.Text;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_Bphone = txtBphone.Text;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_Clerk = txtClerk.Text;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_Master = txtMaster.Text;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_TurnDate = txtTurnDate.Text;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_Reason = txtReason.Text;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_Business = ddlBusiness.SelectedValue;
        t_OfficeAutomation_Document_Record.OfficeAutomation_Document_Record_Tname = txtTname.Text;

        return t_OfficeAutomation_Document_Record;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_Record_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Record_ID"].ToString();

        t_OfficeAutomation_Document_Record = GetModelFromPage(new Guid(ID));
        ...
        da_OfficeAutomation_Document_Record_Inherit.Update(t_OfficeAutomation_Document_Record);//修改申请表

        //DA_OfficeAutomation_Document_Record_Detail_Inherit da_OfficeAutomation_Document_Record_Detail_Inherit = new DA_OfficeAutomation_Document_Record_Detail_Inherit();
        //da_OfficeAutomation_Document_Record_Detail_Inherit.Delete(ID);
        //InsertRecordDetail(new Guid(ID));

        Common.AddLog(EmployeeID, EmployeeName, 79, new Guid(MainID), 2);//日志，修改申请表

        if (ddlBusiness.SelectedValue != ds.Tables[0].Rows[0]["OfficeAutomation_Document_Record_Business"].ToString())
            SendMess();
    }
    ...
    /// 新增明细表
    /// </summary>
    /// <param name="gRecordID"></param>
    //private void InsertRecordDetail(Guid gRecordID)
    //{
    //    if (hdDetail.Value == "")
    //        return;

    //    T_OfficeAutomation_Document_Record_Detail t_OfficeAutomation_Document_Record_Detail;
    //    DA_OfficeAutomation_Document_Record_Detail_Inherit da_OfficeAutomation_Document_Record_Detail_Inherit = new DA_OfficeAutomation_Document_Record_Detail_Inherit();
    ...
    //            if (detail[0] == "")
    //                continue;
    //            t_OfficeAutomation_Document_Record_Detail = new T_OfficeAutomation_Document_Record_Detail();
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_ID = Guid.NewGuid();
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_MainID = gRecordID;
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_Property = detail[0];
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_Controler = detail[1];
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_PropertyID = detail[2];
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_PropertyDate = detail[3];
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_OldDeal = detail[4];
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_NewDeal = detail[5];
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_AjustDeal = detail[6];
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_ShouldComm = detail[7];
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_ActualComm = detail[8];
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_AjustComm = detail[9];
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_LeadReason = int.Parse(detail[10]);
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_Commitment = detail[11];
    //            t_OfficeAutomation_Document_Record_Detail.OfficeAutomation_Document_Record_Detail_Reason = detail[12];

    //            da_OfficeAutomation_Document_Record_Detail_Inherit.Insert(t_OfficeAutomation_Document_Record_Detail);
    //        }
    //    }
    //    catch (Exception ee)
    //    {
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite80"] = "1";
        Response.Write("<script>window.open('Apply_Record_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("备案必须的内容.pdf"));//强制下载 
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_Record_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    {
        switch (ddlBusiness.SelectedValue)
        {
            case "业务一部":
                txtTname.Text = "叶英健";
                break;
