...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        { 
            ...
            $("#<%=hiLiveInfoSum.ClientID%>").val(liveInfoSum);//住宿合计
                                        ...
                                        <tbody id="jzqk2">
                                            <tr>
                                              ...
                                              <td style="width:108px">
                                                  <select name="Mode" onchange="show_Hidden(this)">
                                                  <option value="请选择">请选择</option>
                         ...
                         <table style="width: 99%; border-collapse: collapse; text-align: center;margin:0 auto">
                                        ...
                                        <tr>
                                            <td style="text-align:left" colspan="7">
                                                <input class="btnaddRowN" type="button" value="添加新行" onclick="addrow(this, 'jzqk3', null)" />
                                                <input class="btnaddRowN" type="button" onclick="    delrow(this, 'jzqk3')" value="删除一行" />
