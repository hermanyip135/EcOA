...
public partial class Apply_OweSubmit_Apply_OweSubmit_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite40"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite40"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_OweSubmit_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_OweSubmit_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_OweSubmit_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_OweSubmit_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_OweSubmit_Department"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_OweSubmit_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtReplyPhone.Text = dr["OfficeAutomation_Document_OweSubmit_ReplyPhone"].ToString();
        txtSubject.Text = dr["OfficeAutomation_Document_OweSubmit_Subject"].ToString();
        txtName.Text = dr["OfficeAutomation_Document_OweSubmit_Name"].ToString();
        txtBranch.Text = dr["OfficeAutomation_Document_OweSubmit_Branch"].ToString();
        txtPosition.Text = dr["OfficeAutomation_Document_OweSubmit_Position"].ToString();
        txtCertificate.Text = dr["OfficeAutomation_Document_OweSubmit_Certificate"].ToString();
        txtAffiliated.Text = dr["OfficeAutomation_Document_OweSubmit_Affiliated"].ToString();
        txtWhy.Text = dr["OfficeAutomation_Document_OweSubmit_Why"].ToString();
        txtOpinion.Text = dr["OfficeAutomation_Document_OweSubmit_Opinion"].ToString();
        txthukouxz.Text = dr["OfficeAutomation_Document_OweSubmit_Hukouxz"].ToString();
        txthujidz.Text = dr["OfficeAutomation_Document_OweSubmit_Hujidz"].ToString();
        txthouseholdername.Text = dr["OfficeAutomation_Document_OweSubmit_HouseholderName"].ToString();

        try { txtInductionDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_OweSubmit_InductionDate"].ToString()).ToString("yyyy-MM-dd"); }
        catch { txtInductionDate.Text = dr["OfficeAutomation_Document_OweSubmit_InductionDate"].ToString(); }
        try { txtSupplementaryDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_OweSubmit_SupplementaryDate"].ToString()).ToString("yyyy-MM-dd"); }
        catch { txtSupplementaryDate.Text = dr["OfficeAutomation_Document_OweSubmit_SupplementaryDate"].ToString(); }
        lbData.Text = lblApplyDate.Text;

        string cbt = dr["OfficeAutomation_Document_OweSubmit_Detail"].ToString();
        if (cbt.Contains("1"))
            cbDetail1.Checked = true;
        if (cbt.Contains("2"))
            cbDetail2.Checked = true;
        if (cbt.Contains("3"))
            cbDetail3.Checked = true;
        if (cbt.Contains("4"))
            cbDetail4.Checked = true;
        if (cbt.Contains("5"))
            cbDetail5.Checked = true;
        if (cbt.Contains("6"))
            cbDetail6.Checked = true;
        if (cbt.Contains("7"))
            cbDetail7.Checked = true;
        if (cbt.Contains("8"))
            cbDetail8.Checked = true;
        if (cbt.Contains("9"))
            cbDetail9.Checked = true;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_OweSubmit t_OfficeAutomation_Document_OweSubmit = new T_OfficeAutomation_Document_OweSubmit();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "OweSubmit" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 34; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_OweSubmit = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_OweSubmit_Inherit.Insert(t_OfficeAutomation_Document_OweSubmit);//插入申请表

                //InsertOweSubmitDetail(t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_ID);
                ...
                Common.AddLog(EmployeeID, EmployeeName, 38, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_OweSubmit_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_OweSubmit_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_OweSubmit_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_OweSubmit_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_OweSubmit_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_OweSubmit_Apply"]);
                    sbMailBody.Append("<br/>发文部门：" + drRow["OfficeAutomation_Document_OweSubmit_Department"]);
                    sbMailBody.Append("<br/>发文日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_OweSubmit_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>发文编号：" + drRow["OfficeAutomation_Document_OweSubmit_ApplyID"]);
                    sbMailBody.Append("<br/>文件主题：" + drRow["OfficeAutomation_Document_OweSubmit_Subject"]);
                    sbMailBody.Append("<br/>回复电话：" + drRow["OfficeAutomation_Document_OweSubmit_ReplyPhone"]);

                    sbMailBody.Append("<br/>员工姓名：" + drRow["OfficeAutomation_Document_OweSubmit_Name"]);
                    sbMailBody.Append("<br/>分行/组别：" + drRow["OfficeAutomation_Document_OweSubmit_Branch"]);
                    sbMailBody.Append("<br/>担任职位：" + drRow["OfficeAutomation_Document_OweSubmit_Position"]);
                    sbMailBody.Append("<br/>入职日期：" + drRow["OfficeAutomation_Document_OweSubmit_InductionDate"]);
                    sbMailBody.Append("<br/>执业证号：" + drRow["OfficeAutomation_Document_OweSubmit_Certificate"]);
                    sbMailBody.Append("<br/>挂靠单位：" + drRow["OfficeAutomation_Document_OweSubmit_Affiliated"]);
                    sbMailBody.Append("<br/>资料欠交原因：" + drRow["OfficeAutomation_Document_OweSubmit_Why"]);
                    sbMailBody.Append("<br/>资料补交日期：" + drRow["OfficeAutomation_Document_OweSubmit_SupplementaryDate"]);
                    sbMailBody.Append("<br/>处理意见：" + drRow["OfficeAutomation_Document_OweSubmit_Opinion"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_OweSubmit_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private T_OfficeAutomation_Document_OweSubmit GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_OweSubmit t_OfficeAutomation_Document_OweSubmit = new T_OfficeAutomation_Document_OweSubmit();
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_ID = UndertakeProjID;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Apply = EmployeeName;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Department = txtDepartment.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Subject = txtSubject.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_ReplyPhone = txtReplyPhone.Text;

        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Name = txtName.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Branch = txtBranch.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Position = txtPosition.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_InductionDate = txtInductionDate.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Certificate = txtCertificate.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Affiliated = txtAffiliated.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Why = txtWhy.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_SupplementaryDate = txtSupplementaryDate.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Opinion = txtOpinion.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Hukouxz = txthukouxz.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Hujidz = txthujidz.Text;
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_HouseholderName = txthouseholdername.Text;

        string cbt = null;
        if (cbDetail1.Checked == true)
            cbt = "|1";
        if (cbDetail2.Checked == true)
            cbt += "|2";
        if (cbDetail3.Checked == true)
            cbt += "|3";
        if (cbDetail4.Checked == true)
            cbt += "|4";
        if (cbDetail5.Checked == true)
            cbt += "|5";
        if (cbDetail6.Checked == true)
            cbt += "|6";
        if (cbDetail7.Checked == true)
            cbt += "|7";
        if (cbDetail8.Checked == true)
            cbt += "|8";
        if (cbDetail9.Checked == true)
            cbt += "|9";
        t_OfficeAutomation_Document_OweSubmit.OfficeAutomation_Document_OweSubmit_Detail = cbt;


        return t_OfficeAutomation_Document_OweSubmit;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_OweSubmit_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_OweSubmit_ID"].ToString();

        t_OfficeAutomation_Document_OweSubmit = GetModelFromPage(new Guid(ID));
        ...
        da_OfficeAutomation_Document_OweSubmit_Inherit.Update(t_OfficeAutomation_Document_OweSubmit);//修改申请表

        //DA_OfficeAutomation_Document_OweSubmit_Detail_Inherit da_OfficeAutomation_Document_OweSubmit_Detail_Inherit = new DA_OfficeAutomation_Document_OweSubmit_Detail_Inherit();
        //da_OfficeAutomation_Document_OweSubmit_Detail_Inherit.Delete(ID);
        //InsertOweSubmitDetail(new Guid(ID));

        Common.AddLog(EmployeeID, EmployeeName, 38, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    /// 新增明细表
    /// </summary>
    /// <param name="gOweSubmitID"></param>
    //private void InsertOweSubmitDetail(Guid gOweSubmitID)
    //{
    //    if (hdDetail.Value == "")
    //        return;

    //    T_OfficeAutomation_Document_OweSubmit_Detail t_OfficeAutomation_Document_OweSubmit_Detail;
    //    DA_OfficeAutomation_Document_OweSubmit_Detail_Inherit da_OfficeAutomation_Document_OweSubmit_Detail_Inherit = new DA_OfficeAutomation_Document_OweSubmit_Detail_Inherit();
    ...
    //            if (detail[0] == "")
    //                continue;
    //            t_OfficeAutomation_Document_OweSubmit_Detail = new T_OfficeAutomation_Document_OweSubmit_Detail();
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_ID = Guid.NewGuid();
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_MainID = gOweSubmitID;
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_Property = detail[0];
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_Controler = detail[1];
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_PropertyID = detail[2];
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_PropertyDate = detail[3];
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_OldDeal = detail[4];
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_NewDeal = detail[5];
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_AjustDeal = detail[6];
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_ShouldComm = detail[7];
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_ActualComm = detail[8];
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_AjustComm = detail[9];
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_LeadReason = int.Parse(detail[10]);
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_Commitment = detail[11];
    //            t_OfficeAutomation_Document_OweSubmit_Detail.OfficeAutomation_Document_OweSubmit_Detail_Reason = detail[12];

    //            da_OfficeAutomation_Document_OweSubmit_Detail_Inherit.Insert(t_OfficeAutomation_Document_OweSubmit_Detail);
    //        }
    //    }
    //    catch (Exception ee)
    //    {
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite40"] = "1";
        Response.Write("<script>window.open('Apply_OweSubmit_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("延缓提交入职资料申请.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_OweSubmit_Inherit da_OfficeAutomation_Document_OweSubmit_Inherit = new DA_OfficeAutomation_Document_OweSubmit_Inherit();
            DataSet ds = da_OfficeAutomation_Document_OweSubmit_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_OweSubmit_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_OweSubmit_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
