...
public partial class Apply_LegalCommission_Apply_LegalCommission_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite43"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite43"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_LegalCommission_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_LegalCommission_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_LegalCommission_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_LegalCommission_ApplyID"].ToString();
        if(GetQueryString("Dsp") != "")
            txtDepartment.Text = GetQueryString("Dsp");
        else
            txtDepartment.Text = dr["OfficeAutomation_Document_LegalCommission_Department"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_LegalCommission_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtReplyPhone.Text = dr["OfficeAutomation_Document_LegalCommission_ReplyPhone"].ToString();
        txtSubject.Text = dr["OfficeAutomation_Document_LegalCommission_Subject"].ToString();

        txtTotalCoast.Text = dr["OfficeAutomation_Document_LegalCommission_TotalCoast"].ToString();
        txtACMoney.Text = dr["OfficeAutomation_Document_LegalCommission_ACMoney"].ToString();
        txtCname.Text = dr["OfficeAutomation_Document_LegalCommission_Cname"].ToString();
        if (dr["OfficeAutomation_Document_LegalCommission_Cooperation"].ToString() == "True")
        {
            rdbCooperation1.Checked = true;
            txtReason.Text = dr["OfficeAutomation_Document_LegalCommission_Reason"].ToString();
        }
        else
            rdbCooperation2.Checked = true;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_LegalCommission t_OfficeAutomation_Document_LegalCommission = new T_OfficeAutomation_Document_LegalCommission();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "LegalCommission" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 38; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_LegalCommission = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_LegalCommission_Inherit.Insert(t_OfficeAutomation_Document_LegalCommission);//插入申请表

                //InsertLegalCommissionDetail(t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_ID);
                ...
                Common.AddLog(EmployeeID, EmployeeName, 42, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                if(txtDepartment.Text != "法律部")
                    RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_LegalCommission_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                else
                    RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_LegalCommission_Flow2.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_LegalCommission_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_LegalCommission_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (flowIDx == "5") //M_Add：黄志超 20150202
                {
                    T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_LegalCommission_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_LegalCommission_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_LegalCommission_Apply"]);
                    sbMailBody.Append("<br/>发文部门：" + drRow["OfficeAutomation_Document_LegalCommission_Department"]);
                    sbMailBody.Append("<br/>发文日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_LegalCommission_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>发文编号：" + drRow["OfficeAutomation_Document_LegalCommission_ApplyID"]);
                    sbMailBody.Append("<br/>项目名称：" + drRow["OfficeAutomation_Document_LegalCommission_Subject"]);
                    sbMailBody.Append("<br/>回复电话：" + drRow["OfficeAutomation_Document_LegalCommission_ReplyPhone"]);
                    sbMailBody.Append("<br/>合作费用：" + drRow["OfficeAutomation_Document_LegalCommission_TotalCoast"]);
                    sbMailBody.Append("<br/>法律部追佣金额：" + drRow["OfficeAutomation_Document_LegalCommission_ACMoney"]);
                    sbMailBody.Append("<br/>支付合作费原因：" + drRow["OfficeAutomation_Document_LegalCommission_Reason"]);
                    sbMailBody.Append("<br/>合作人员名称：" + drRow["OfficeAutomation_Document_LegalCommission_Cname"]);

                    sbMailBody.Append("<br/><br/>");

                    //sbMailBody.Append("<br/>其它坏账详细情况：");

                    //ds = da_OfficeAutomation_Document_LegalCommission_Detail_Inherit.SelectByMainID(MainID);
                    //foreach (DataRow dr in ds.Tables[0].Rows)
                    //{
                    //    sbMailBody.Append("<br/>经办人：" + dr["OfficeAutomation_Document_LegalCommission_Detail_Controler"]);
                    //    sbMailBody.Append("<br/>物业成交编号：" + dr["OfficeAutomation_Document_LegalCommission_Detail_PropertyID"]);
                    //    sbMailBody.Append("<br/>物业成交日期：" + dr["OfficeAutomation_Document_LegalCommission_Detail_PropertyDate"]);
                    //    sbMailBody.Append("<br/>原成交价：" + dr["OfficeAutomation_Document_LegalCommission_Detail_OldDeal"]);
                    //    sbMailBody.Append("<br/>现成交价：" + dr["OfficeAutomation_Document_LegalCommission_Detail_NewDeal"]);
                    //    sbMailBody.Append("<br/>成交价调整：" + dr["OfficeAutomation_Document_LegalCommission_Detail_AjustDeal"]);
                    //    sbMailBody.Append("<br/>应收佣金：" + dr["OfficeAutomation_Document_LegalCommission_Detail_ShouldComm"]);
                    //    sbMailBody.Append("<br/>实收佣金：" + dr["OfficeAutomation_Document_LegalCommission_Detail_ActualComm"]);
                    //    sbMailBody.Append("<br/>调整佣金：" + dr["OfficeAutomation_Document_LegalCommission_Detail_AjustComm"]);
                    //    sbMailBody.Append("<br/>客户联系电话：" + dr["OfficeAutomation_Document_LegalCommission_Detail_Commitment"]);
                    //    sbMailBody.Append("<br/>坏帐原因：" + dr["OfficeAutomation_Document_LegalCommission_Detail_Reason"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_LegalCommission_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private T_OfficeAutomation_Document_LegalCommission GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_LegalCommission t_OfficeAutomation_Document_LegalCommission = new T_OfficeAutomation_Document_LegalCommission();
        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_ID = UndertakeProjID;
        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_Apply = EmployeeName;
        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_Department = txtDepartment.Text;
        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_Subject = txtSubject.Text;
        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_ReplyPhone = txtReplyPhone.Text;

        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_TotalCoast = txtTotalCoast.Text;
        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_ACMoney = txtACMoney.Text;
        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_Reason = txtReason.Text;
        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_Cname = txtCname.Text;
        t_OfficeAutomation_Document_LegalCommission.OfficeAutomation_Document_LegalCommission_Cooperation = rdbCooperation1.Checked ? true : false;

        return t_OfficeAutomation_Document_LegalCommission;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_LegalCommission_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_LegalCommission_ID"].ToString();

        t_OfficeAutomation_Document_LegalCommission = GetModelFromPage(new Guid(ID));
        ...
        da_OfficeAutomation_Document_LegalCommission_Inherit.Update(t_OfficeAutomation_Document_LegalCommission);//修改申请表

        Common.AddLog(EmployeeID, EmployeeName, 42, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite43"] = "1";
        Response.Write("<script>window.open('Apply_LegalCommission_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("法律部追佣合作费处理申请.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_LegalCommission_Inherit da_OfficeAutomation_Document_LegalCommission_Inherit = new DA_OfficeAutomation_Document_LegalCommission_Inherit();
            DataSet ds = da_OfficeAutomation_Document_LegalCommission_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_LegalCommission_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            if (department != "法律部")
                RunJS("var win=window.showModalDialog(\"Apply_LegalCommission_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
            else
                RunJS("var win=window.showModalDialog(\"Apply_LegalCommission_Flow2.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
        }
        catch (Exception ex)
        {
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_LegalCommission_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_LegalCommission_Inherit();
