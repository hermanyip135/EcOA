...
public partial class Apply_LegalCommission_Apply_LegalCommission_Flow : BasePage
{
    ...
    private void LoadFlow()
    {
        ...
        SbJs.Append("</script>");
        da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdx(MainID, 2); //删除部门负责人环节
    }
}
