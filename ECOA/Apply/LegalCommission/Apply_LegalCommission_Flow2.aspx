<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_LegalCommission_Flow2.aspx.cs" Inherits="Apply_LegalCommission_Apply_LegalCommission_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
        ...
        function save() {
            ...
            for(var y = 1; y <= 2; y++)
            {
                if($("#txtIDx"+y).parent().css("display")!="none") 
                {
                    ...
                    x ++;
                    content+=y*y+":"+$("#txtIDx"+y).val()+";"; //y*y，控制该环节所在的位置
                }
            }
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "text",
                data: 'action=saveCommonFlow&id=<%=EmployeeID %>&name=<%=EmployeeName %>&purview=<%=Purview %>&mainid=<%=MainID %>&content=' + content+'&deleteidxs=1|4',
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <div id="divIDx2" class='item'>接盘部门负责人</div>
