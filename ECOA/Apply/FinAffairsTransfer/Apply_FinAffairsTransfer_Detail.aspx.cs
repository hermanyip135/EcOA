...
public partial class Apply_FinAffairsTransfer_Apply_FinAffairsTransfer_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SerialNumber = "";
        if (Request.QueryString["type"] == "enclosure" )
        {
            string Endatumtypename = UploadName.Value;
            string sEndatumtypename = Request.QueryString["Endatumtypename"];
            sEndatumtypename = Server.UrlDecode(sEndatumtypename); 
            string Enname = Request.QueryString["Enname"];
            string Enpath = Request.QueryString["Enpath"];
            ...
            t_OfficeAutomation_Attach.OfficeAutomation_Attach_Name = sEndatumtypename;
            t_OfficeAutomation_Attach.OfficeAutomation_Attach_Path = Enpath;
    ...
    public void LoadPage()
    {
        ...
        DA_OfficeAutomation_Document_FinAffairsTransfer_Inherit da_OfficeAutomation_Document_FinAffairsTransfer_Inherit = new DA_OfficeAutomation_Document_FinAffairsTransfer_Inherit();
        ...
        ds = da_OfficeAutomation_Document_FinAffairsTransfer_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_FinAffairsTransfer_ID"].ToString();
        string applicant = dr["OfficeAutomation_Main_Apply"].ToString();
        var obj = da_OfficeAutomation_Document_FinAffairsTransfer_Inherit.GetModel("OfficeAutomation_Document_FinAffairsTransfer_ID='" + ID + "'");

        ApplyN = applicant;
        Apply.Text = applicant;
       // var obj = ECOA.Common.SerializationHelper.GetEntity<T_OfficeAutomation_Document_FinAffairsTransfer>(ds.Tables[0]);  //DataSet 转 实体
        CommonSerialization.BindObjectToControl("T_OfficeAutomation_Document_FinAffairsTransfer", obj, this.Page.Master.FindControl("ContentPlaceHolder1"));   //实体给form赋值
        this.hiISFillDetail.Value = obj.OfficeAutomation_Document_FinAffairsTransfer_ISFillDetail ;
       this.hiISReceivablesInput.Value = obj.OfficeAutomation_Document_FinAffairsTransfer_ISReceivablesInput ;
       this.hiISSpareGoldCustodian.Value = obj.OfficeAutomation_Document_FinAffairsTransfer_ISSpareGoldCustodian  ;
        this.hiISSpareGoldInput.Value = obj.OfficeAutomation_Document_FinAffairsTransfer_ISSpareGoldInput ;
       this.hiAction.Value = obj.OfficeAutomation_Document_FinAffairsTransfer_Action ;
        this.ActionRemark.Value =obj.OfficeAutomation_Document_FinAffairsTransfer_ActionRemark;
        this.ttHandoverDepts.Value = obj.OfficeAutomation_Document_FinAffairsTransfer_HandoverDepts;
        DA_OfficeAutomation_Document_FinAffairsTransfer_Detail_Inherit da_OfficeAutomation_Document_FinAffairsTransfer_Detail_Inherit = new DataAccess.Operate.DA_OfficeAutomation_Document_FinAffairsTransfer_Detail_Inherit();
        DA_OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_Inherit da_OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_Inherit = new DataAccess.Operate.DA_OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_Inherit();
       var detaillist = da_OfficeAutomation_Document_FinAffairsTransfer_Detail_Inherit.SelectListByMainID(ID);
       var HandleDetail = da_OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_Inherit.SelectListByMainID(ID);
       if (detaillist != null && detaillist.Count > 0)
       {
           var dlist = detaillist.Select(m => new
           {
               selectReceipt = m. OfficeAutomation_Document_FinAffairsTransfer_Detail_Receipt,
               hiReceipt = m. OfficeAutomation_Document_FinAffairsTransfer_Detail_Receipt,

               ReceivablesOpenNum = m.OfficeAutomation_Document_FinAffairsTransfer_Detail_ReceivablesOpenNum,

           }).ToList();
           this.hidDetail1.Value = JsonConvert.SerializeObject(dlist);
       }
       //代收款收据及发票待处理的明细
       if (HandleDetail != null&&  HandleDetail.Count>0)
        {
        var HandList = HandleDetail.Select(m => new 
        {
            HandleDetailMatter = m.OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_Matter,
            HandleDetailNumber = m.OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_Number,
            HandleDetailReason = m.OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_Reason
        }).ToList();
        this.hiHandleDetail.Value = JsonConvert.SerializeObject(HandList);
        }
        //  lbData.Text = lbApplyDate.Text;
       ...
       // txtHandoverDept.Text = dr["OfficeAutomation_Main_Department"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_FinAffairsTransfer t_OfficeAutomation_Document_FinAffairsTransfer = new T_OfficeAutomation_Document_FinAffairsTransfer();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "FinAffairsTransfer" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 94; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                Guid FinAffairsTransferID = Guid.NewGuid();

                t_OfficeAutomation_Document_FinAffairsTransfer = GetModelFromPage(FinAffairsTransferID);
                ...
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = this.Apply.Text;
                ...
                t_OfficeAutomation_Document_FinAffairsTransfer.OfficeAutomation_Document_FinAffairsTransfer_ApplyDate = DateTime.Now; 
                da_OfficeAutomation_Document_FinAffairsTransfer_Inherit.Add(t_OfficeAutomation_Document_FinAffairsTransfer);//插入申请表
                InsertDetail(this.hidDetail1.Value, t_OfficeAutomation_Document_FinAffairsTransfer.OfficeAutomation_Document_FinAffairsTransfer_ID);
                //InsertBorrowMoneyDetail(t_OfficeAutomation_Document_BorrowMoney.OfficeAutomation_Document_BorrowMoney_ID);
                HandleDetail(this.hiHandleDetail.Value, t_OfficeAutomation_Document_FinAffairsTransfer.OfficeAutomation_Document_FinAffairsTransfer_ID);
                #region 保存默认流程
                ...
                #endregion
              //  UploadFiles(MainID);
                Common.AddLog(EmployeeID, EmployeeName, 86, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_FinAffairsTransfer_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    {
        //hiCostProject =费用 
        var t = new { hiReceipt = "", ReceivablesOpenNum = "" };
        var l = Enumerable.Repeat(t, 1).ToList();
        var list = JsonConvert.DeserializeAnonymousType(json, l);

        var bll = new DataAccess.Operate.DA_OfficeAutomation_Document_FinAffairsTransfer_Detail_Inherit();
        bll.DelByMainID(DetailID.ToString());
        int num = 1;
        foreach (var i in list)
        {
            var obj = new T_OfficeAutomation_Document_FinAffairsTransfer_Detail
            {
                OfficeAutomation_Document_FinAffairsTransfer_Detail_ID = Guid.NewGuid(),
                OfficeAutomation_Document_FinAffairsTransfer_Detail_MainID = DetailID,
                OfficeAutomation_Document_FinAffairsTransfer_Detail_Receipt = i.hiReceipt,
                OfficeAutomation_Document_FinAffairsTransfer_Detail_ReceivablesOpenNum = i.ReceivablesOpenNum,
                OfficeAutomation_Document_FinAffairsTransfer_Detail_Sort = num
            };
            num++;
            bll.Add(obj);
        }
    ...
    private void HandleDetail(string json, Guid DetailID)
    {
        //hiCostProject =费用 
        var t = new { HandleDetailNumber = "", HandleDetailMatter = "", HandleDetailReason = "" };
        var l = Enumerable.Repeat(t, 1).ToList();
        var list = JsonConvert.DeserializeAnonymousType(json, l);

        var bll = new DataAccess.Operate.DA_OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_Inherit();
        bll.DelByMainID(DetailID.ToString());
        int num = 1;
        foreach (var i in list)
        {
            var obj = new T_OfficeAutomation_Document_FinAffairsTransfer_HandleDetail
            {
                OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_ID = Guid.NewGuid(),
                OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_MainID = DetailID,
                OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_Number = i.HandleDetailNumber,
                OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_Matter = i.HandleDetailMatter,
                OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_Reason = i.HandleDetailReason,
                OfficeAutomation_Document_FinAffairsTransfer_HandleDetail_Sort= num
            };
            num++;
            bll.Add(obj);
        }
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_FinAffairsTransfer_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_FinAffairsTransfer_ID"].ToString();
    ...
    private T_OfficeAutomation_Document_FinAffairsTransfer GetModelFromPage(Guid SYSPWDTransfer_ID)
    {
    //    T_OfficeAutomation_Document_FinAffairsTransfer t_OfficeAutomation_Document_SYSPWDTransfer = new T_OfficeAutomation_Document_FinAffairsTransfer();
    ...
    //     return t_OfficeAutomation_Document_SYSPWDTransfer;
         var obj = new T_OfficeAutomation_Document_FinAffairsTransfer();
         obj = CommonSerialization.ReqDeserilizeAnEntity<T_OfficeAutomation_Document_FinAffairsTransfer>("T_OfficeAutomation_Document_FinAffairsTransfer", this.Page.Master.FindControl("ContentPlaceHolder1"));
         obj.OfficeAutomation_Document_FinAffairsTransfer_MainID = new Guid(MainID);
         obj.OfficeAutomation_Document_FinAffairsTransfer_ID = SYSPWDTransfer_ID;
      //   obj.OfficeAutomation_Document_FinAffairsTransfer_Handover = lblApply.Text;
         obj.OfficeAutomation_Document_FinAffairsTransfer_ISFillDetail = this.hiISFillDetail.Value;
        obj.OfficeAutomation_Document_FinAffairsTransfer_ISReceivablesInput = this.hiISReceivablesInput.Value;
        obj.OfficeAutomation_Document_FinAffairsTransfer_ISSpareGoldCustodian = this.hiISSpareGoldCustodian.Value;
        obj.OfficeAutomation_Document_FinAffairsTransfer_ISSpareGoldInput = this.hiISSpareGoldInput.Value;
        obj.OfficeAutomation_Document_FinAffairsTransfer_Action = this.hiAction.Value;
        obj.OfficeAutomation_Document_FinAffairsTransfer_ActionRemark = this.ActionRemark.Value;
        obj.OfficeAutomation_Document_FinAffairsTransfer_HandoverDepts = ttHandoverDepts.Value;
         return obj;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_FinAffairsTransfer_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_FinAffairsTransfer_ID"].ToString();

        t_OfficeAutomation_Document_FinAffairsTransfer = GetModelFromPage(new Guid(ID));
        InsertDetail(hidDetail1.Value, new Guid(ID));
        HandleDetail(this.hiHandleDetail.Value, new Guid(ID));
        string apply = EmployeeName;
        string depname = this.Department.Text;
        string summary = this.Apply.Text;

        string applydate = "";
        string mainid = MainID;

        da_OfficeAutomation_Main_Inherit.UpdateMain(mainid, depname, apply, applydate, summary);
        da_OfficeAutomation_Document_FinAffairsTransfer_Inherit.Edit(t_OfficeAutomation_Document_FinAffairsTransfer);//修改申请表


        Common.AddLog(EmployeeID, EmployeeName, 86, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.open('Apply_FinAffairsTransfer_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("行政助理(财务事项)交接表.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_FinAffairsTransfer_Inherit da_OfficeAutomation_Document_FinAffairsTransfer_Inherit = new DA_OfficeAutomation_Document_FinAffairsTransfer_Inherit();
            DataSet ds = da_OfficeAutomation_Document_FinAffairsTransfer_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Main_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
