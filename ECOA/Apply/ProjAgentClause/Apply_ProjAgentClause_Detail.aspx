<%@ Page ValidateRequest="false" Title="项目销售代理合同条款申请表 - 广州中原电子审批系统" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Apply_ProjAgentClause_Detail.aspx.cs" Inherits="Apply_ProjAgentClause_Apply_ProjAgentClause_Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function() {      
            ...
            i = $("#tbPerformanceProfit tr").length - 1;
        ...
        function check() {
            ...
            if (!$("#<%=rdbContractType1.ClientID %>").prop("checked") && !$("#<%=rdbContractType2.ClientID %>").prop("checked") && !$("#<%=rdbContractType3.ClientID %>").prop("checked")) {
                alert("请选择项合作类型");
                return false;
            }
        ...
        function upload() {
            ...
            if(sReturnValue=='success')
                window.location='Apply_ProjAgentClause_Detail.aspx?MainID=<%=MainID %>';
        }

        function editflow(){
            var win=window.showModalDialog("Apply_ProjAgentClause_Flow.aspx?MainID=<%=MainID %>","","dialogWidth=830px;dialogHeight=280px");
                    if(win=='success')
                        window.location="Apply_ProjAgentClause_Detail.aspx?MainID=<%=MainID %>";
        }
        ...
        function sign(idx) {
            //if(idx!='3'&&idx!='5'&&idx!='6'&&idx!='7'&&idx!='8'&&idx!='10'&&idx!='11'&&idx!='130'&&idx!='131'){
        ...
        function addRow() {
            ...
            var html = '<tr id="trPerformanceProfit' + i + '">'
                + '     <td><input type="text" id="txtStartYear' + i + '" style="width:90px"/>至<input type="text" id="txtEndYear' + i + '" style="width:90px"/></td>'
                + '     <td><input type="text" id="txtPerformance' + i + '"/></td>'
                + '     <td><input type="text" id="txtProfit' + i + '"/></td>'
                + '</tr>';
        ...
        function deleteRow() {
            if (i > 1) {
                $("#tbPerformanceProfit tr:eq(" + i + ")").remove();
                i--;
            } else
                alert("不可删除第一行。");
        }
            ...
            <table id="tbAround" width='640px'>
                ...
                <tr>
                    ...
                    <td class="tl PL10" colspan="3">
                        项目报备是否已审批？
                        <asp:RadioButton ID="projectEY" runat="server" Text="是 " GroupName="AgentMode2" />
                        <asp:RadioButton ID="projectEN" runat="server" Text="否 " GroupName="AgentMode2" />
                    </td>
                </tr>
                <tr>
                    <td>物业性质</td>
                ...
                <tr>
                    ...
                    <td>合同类型</td>
                    <td class="tl PL10"><asp:RadioButton ID="rdbContractType1" runat="server" Text="联动合同" GroupName="ContractType" /><asp:RadioButton ID="rdbContractType2" runat="server" Text="一手销售代理合同" GroupName="ContractType" /><br /><asp:RadioButton ID="rdbContractType3" runat="server" Text="其他" GroupName="ContractType" /><asp:TextBox ID="txtContractTypeOther" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                ...
                <tr><th colspan="4" style="line-height:25px;">合同条款申请</th></tr>
                <tr>
                    <td>结佣条件条款</td>
                    <td class="tl PL10" colspan="3">
                        <asp:textbox id="txtClauseSettleComm" runat="server" TextMode="MultiLine" Width="98%" Rows="10" style="overflow: auto;"></asp:textbox>
                    </td>
                </tr>
                <tr>
                    <td>扣罚条款</td>
                    <td class="tl PL10" colspan="3">
                        <asp:textbox id="txtClauseFine" runat="server" TextMode="MultiLine" Width="98%" Rows="10" style="overflow: auto;"></asp:textbox>
                    </td>
                </tr>
                <tr>
                    <td>区域限制条款</td>
                    <td class="tl PL10" colspan="3">
                        <asp:textbox id="txtClauseAreaLimit" runat="server" TextMode="MultiLine" Width="98%" Rows="10" style="overflow: auto;"></asp:textbox>
                    </td>
                </tr>
                <tr>
                    <td>绩效考核条款</td>
                    <td class="tl PL10" colspan="3">
                        <asp:textbox id="txtClausePerforCheck" runat="server" TextMode="MultiLine" Width="98%" Rows="10" style="overflow: auto;"></asp:textbox>
                    </td>
                </tr>
                <tr>
                    <td>廉洁条款</td>
                    <td class="tl PL10" colspan="3">
                        <asp:textbox id="txtClauseHonest" runat="server" TextMode="MultiLine" Width="98%" Rows="10" style="overflow: auto;"></asp:textbox>
                    </td>
                </tr>
                <tr>
                    <td>其他条款</td>
                    <td class="tl PL10" colspan="3">
                        <asp:textbox id="txtClauseOther" runat="server" TextMode="MultiLine" Width="98%" Rows="5" style="overflow: auto;"></asp:textbox>
                    </td>
                </tr>
                <tr>
                    <td class="tl PL10" colspan="4">
                        备注: 绩效考核条款含客户满意度考核、业绩考核以及其他非业绩考核指标等。如条款无内容，可不填。
                    </td>
                </tr>
                ...
                <tr id="trShowFlow5" class="noborder" style="height: 85px;"> 
                    ...
                    <td colspan="3" class="tl PL10" style=" ">
                        <input id="rdbYesIDx5" type="radio" name="agree5" /><label for="rdbYesIDx5">同意</label><input id="rdbNoIDx5" type="radio" name="agree5" /><label for="rdbNoIDx5">退回申请</label><input id="rdbOtherIDx5" type="radio" name="agree5" /><label for="rdbOtherIDx5">其他意见</label><br />
                ...
                <tr id="trShowFlow6" class="noborder" style="height: 85px;">
                    <td colspan="3" class="tl PL10" style=" ">
                        <input id="rdbYesIDx6" type="radio" name="agree6" /><label for="rdbYesIDx6">同意</label><input id="rdbNoIDx6" type="radio" name="agree6" /><label for="rdbNoIDx6">退回申请</label><input id="rdbOtherIDx6" type="radio" name="agree6" /><label for="rdbOtherIDx6">其他意见</label><br />
                ...
                <tr id="trShowFlow9">
                    <td colspan="3" class="tl PL10" style=" ">
                        ...
                        <textarea id="txtIDx9" rows="5" style="width: 98%; overflow: auto;" cols="20" name="S4"></textarea><input type="button" id="btnSignIDx9" value="签署意见" onclick="sign('9')" style="display: none;" /><div class="signdate">日期：<span id="spanDateIDx9">_________</span></div>
                    </td>
                </tr>
                ...
                <tr id="tlsc1" class="noborder" style="height: 85px; display: none;">
					<td colspan="3" class="tl PL10" style=" ">
						<input id="rdbYesIDx130" type="radio" name="agree130" value="1" /><label for="rdbYesIDx130">同意</label><input id="rdbNoIDx130" type="radio" name="agree130" value="2" /><label for="rdbNoIDx130">不同意</label><input id="rdbOtherIDx130" value="1" type="radio" name="agree130" value="1" /><label for="rdbOtherIDx130">其他意见</label><br />
                ...
                <tr id="trGeneralManager" class="noborder" style="height: 85px; ">
                    <td >董事总经理<br />审批</td>
                    <td colspan="3" class="tl PL10" style=" ">
                        <input id="rdbYesIDx12" type="radio" name="agree12" /><label for="rdbYesIDx12">同意</label><input id="rdbNoIDx12" type="radio" name="agree12" /><label for="rdbNoIDx12">不同意</label><input id="rdbOtherIDx12" type="radio" name="agree12" value="2" /><label for="rdbOtherIDx12">其他意见</label><br />
                        <br />
                ...
                <tr id="tlsc2" class="noborder" style="height: 85px; display: none;">
					<td >董事总经理<br />审批</td>
					<td colspan="3" class="tl PL10" style=" ">
						<input id="rdbYesIDx131" type="radio" name="agree131" value="1" /><label for="rdbYesIDx131">同意</label><input id="rdbNoIDx131" type="radio" name="agree131" value="2" /><label for="rdbNoIDx131">不同意</label><input id="rdbOtherIDx131" type="radio" name="agree131" value="1" /><label for="rdbOtherIDx131">其他意见</label><br />
