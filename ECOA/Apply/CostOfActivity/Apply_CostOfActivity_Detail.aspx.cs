...
public partial class Apply_CostOfActivity_Apply_CostOfActivity_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite50"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite50"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_CostOfActivity_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_CostOfActivity_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_CostOfActivity_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_CostOfActivity_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_CostOfActivity_Department"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_CostOfActivity_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtPhone.Text = dr["OfficeAutomation_Document_CostOfActivity_Phone"].ToString();
        txtSubject.Text = dr["OfficeAutomation_Document_CostOfActivity_Subject"].ToString();
        txtInDepartment.Text = dr["OfficeAutomation_Document_CostOfActivity_InDepartment"].ToString();
        //ddlArea.SelectedValue = dr["OfficeAutomation_Document_CostOfActivity_Area"].ToString(); 由于杨梅宝需要把之前的九个区域改为八个区域，所以注释此方法52100/2016-10-17
        ddlArea.SelectedValue = dr["OfficeAutomation_Document_CostOfActivity_Area"].ToString() == "9" ? "8" : dr["OfficeAutomation_Document_CostOfActivity_Area"].ToString();
        txtYear.Text = dr["OfficeAutomation_Document_CostOfActivity_Year"].ToString();
        txtMan1.Text = dr["OfficeAutomation_Document_CostOfActivity_Man1"].ToString();
        txtFear1.Text = dr["OfficeAutomation_Document_CostOfActivity_Fear1"].ToString();
        txtMan2.Text = dr["OfficeAutomation_Document_CostOfActivity_Man2"].ToString();
        txtFear2.Text = dr["OfficeAutomation_Document_CostOfActivity_Fear2"].ToString();
        txtMan3.Text = dr["OfficeAutomation_Document_CostOfActivity_Man3"].ToString();
        txtFear3.Text = dr["OfficeAutomation_Document_CostOfActivity_Fear3"].ToString();
        txtMan4.Text = dr["OfficeAutomation_Document_CostOfActivity_Man4"].ToString();
        txtFear4.Text = dr["OfficeAutomation_Document_CostOfActivity_Fear4"].ToString();
        txtMan5.Text = dr["OfficeAutomation_Document_CostOfActivity_Man5"].ToString();
        txtFear5.Text = dr["OfficeAutomation_Document_CostOfActivity_Fear5"].ToString();
        txtMan6.Text = dr["OfficeAutomation_Document_CostOfActivity_Man6"].ToString();
        txtFear6.Text = dr["OfficeAutomation_Document_CostOfActivity_Fear6"].ToString();
        hiCycle.Value = dr["OfficeAutomation_Document_CostOfActivity_Cycle"].ToString();
        if (string.IsNullOrEmpty(dr["OfficeAutomation_Document_CostOfActivity_Cycle"].ToString()))
        {
            hiCycle.Value = "1";
        }
       
        txtSummary.Text = dr["OfficeAutomation_Document_CostOfActivity_Summary"].ToString();
        lbData.Text = lblApplyDate.Text;

        float f = 0, g = 0;
        if (float.TryParse(txtFear1.Text, out g))
            f = f + g;
        if (float.TryParse(txtFear2.Text, out g))
            f = f + g;
        if (float.TryParse(txtFear3.Text, out g))
            f = f + g;
        if (float.TryParse(txtFear4.Text, out g))
            f = f + g;
        lbAutoCoculate.Text = f.ToString();
        f = 0;
        g = 0;
        if (float.TryParse(txtFear5.Text, out g))
            f = f + g;
        if (float.TryParse(txtFear6.Text, out g))
            f = f + g;
        lbYearAutoCoculate.Text = f.ToString();
        if (txtMan1.Text != "")
        {
            cbQuarter1.Checked = true;
            txtMan1.Enabled = true;
            txtFear1.Enabled = true;
        }
        if (txtMan2.Text != "")
        {
            cbQuarter2.Checked = true;
            txtMan2.Enabled = true;
            txtFear2.Enabled = true;
        }
        if (txtMan3.Text != "")
        {
            cbQuarter3.Checked = true;
            txtMan3.Enabled = true;
            txtFear3.Enabled = true;
        }
        if (txtMan4.Text != "")
        {
            cbQuarter4.Checked = true;
            txtMan4.Enabled = true;
            txtFear4.Enabled = true;
        }
        if (txtMan5.Text != "")
        {
            cbUpYear.Checked = true;
            txtMan5.Enabled = true;
            txtFear5.Enabled = true;
        }
        if (txtMan6.Text != "")
        {
            cbLoYear.Checked = true;
            txtMan6.Enabled = true;
            txtFear6.Enabled = true;
        }
                    ...
                    switch (curidx)
                    {
                        ...
                        case "6":
                            ...
                            { 
                                ...
                                lbtnAddNManaging.Visible = true;
                                lbtnCancelManaging.Visible = true;
                            }
                            break;
                        default:
                            break;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_CostOfActivity t_OfficeAutomation_Document_CostOfActivity = new T_OfficeAutomation_Document_CostOfActivity();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "CostOfActivity" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 45; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_CostOfActivity = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_CostOfActivity_Inherit.Insert(t_OfficeAutomation_Document_CostOfActivity);//插入申请表

                //InsertCostOfActivityDetail(t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_ID);
                ...
                Common.AddLog(EmployeeID, EmployeeName, 49, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("var win=window.showModalDialog(\"Apply_CostOfActivity_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_CostOfActivity_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_CostOfActivity_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_CostOfActivity_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_CostOfActivity_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_CostOfActivity_Apply"]);
                    sbMailBody.Append("<br/>发文部门：" + drRow["OfficeAutomation_Document_CostOfActivity_Department"]);
                    sbMailBody.Append("<br/>发文日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_CostOfActivity_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>发文编号：" + drRow["OfficeAutomation_Document_CostOfActivity_ApplyID"]);
                    sbMailBody.Append("<br/>发文部门：" + drRow["OfficeAutomation_Document_CostOfActivity_Department"]);
                    sbMailBody.Append("<br/>文件主题：" + drRow["OfficeAutomation_Document_CostOfActivity_Subject"]);
                    sbMailBody.Append("<br/>回复电话：" + drRow["OfficeAutomation_Document_CostOfActivity_Phone"]);

                    sbMailBody.Append("<br/>所在部门：" + drRow["OfficeAutomation_Document_CostOfActivity_InDepartment"]);
                    sbMailBody.Append("<br/>所属区域：" + ddlArea.SelectedItem.Text.ToString());
                    sbMailBody.Append("<br/>所属年份：" + drRow["OfficeAutomation_Document_CostOfActivity_Year"]);
                    sbMailBody.Append("<br/>第一季度人数：" + drRow["OfficeAutomation_Document_CostOfActivity_Man1"]);
                    sbMailBody.Append("<br/>第一季度费用：" + drRow["OfficeAutomation_Document_CostOfActivity_Fear1"]);
                    sbMailBody.Append("<br/>第二季度人数：" + drRow["OfficeAutomation_Document_CostOfActivity_Man2"]);
                    sbMailBody.Append("<br/>第二季度费用：" + drRow["OfficeAutomation_Document_CostOfActivity_Fear2"]);
                    sbMailBody.Append("<br/>第三季度人数：" + drRow["OfficeAutomation_Document_CostOfActivity_Man3"]);
                    sbMailBody.Append("<br/>第三季度费用：" + drRow["OfficeAutomation_Document_CostOfActivity_Fear3"]);
                    sbMailBody.Append("<br/>第四季度人数：" + drRow["OfficeAutomation_Document_CostOfActivity_Man4"]);
                    sbMailBody.Append("<br/>第四季度费用：" + drRow["OfficeAutomation_Document_CostOfActivity_Fear4"]);
                    sbMailBody.Append("<br/>其它情况说明：" + drRow["OfficeAutomation_Document_CostOfActivity_Summary"]);
                    sbMailBody.Append("<br/>合计费用：" + lbAutoCoculate.Text);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_CostOfActivity_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private T_OfficeAutomation_Document_CostOfActivity GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_CostOfActivity t_OfficeAutomation_Document_CostOfActivity = new T_OfficeAutomation_Document_CostOfActivity();
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_ID = UndertakeProjID;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Apply = EmployeeName;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Department = txtDepartment.Text;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Subject = txtSubject.Text;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Phone = txtPhone.Text;

        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_InDepartment = txtInDepartment.Text;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Area = ddlArea.SelectedValue;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Year = txtYear.Text;
        if ("1".Equals(hiCycle.Value))
        {
        
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Man1 = txtMan1.Text;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Fear1 = txtFear1.Text;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Man2 = txtMan2.Text;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Fear2 = txtFear2.Text;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Man3 = txtMan3.Text;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Fear3 = txtFear3.Text;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Man4 = txtMan4.Text;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Fear4 = txtFear4.Text;
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Fear5 = "";
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Man5 = "";
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Fear6 = "";
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Man6 = "";
        }
        else if ("2".Equals(hiCycle.Value))
        {
          //  t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Year = "";
            t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Man1 = "";
            t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Fear1 = "";
            t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Man2 = "";
            t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Fear2 = "";
            t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Man3 = "";
            t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Fear3 = "";
            t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Man4 = "";
            t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Fear4 = "";
            t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Fear5 = txtFear5.Text;
            t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Man5 = txtMan5.Text;
            t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Fear6 = txtFear6.Text;
            t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Man6 = txtMan6.Text;
        }
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Cycle = hiCycle.Value;//周期选择
        t_OfficeAutomation_Document_CostOfActivity.OfficeAutomation_Document_CostOfActivity_Summary = txtSummary.Text;

        return t_OfficeAutomation_Document_CostOfActivity;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_CostOfActivity_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_CostOfActivity_ID"].ToString();

        t_OfficeAutomation_Document_CostOfActivity = GetModelFromPage(new Guid(ID));
        ...
        da_OfficeAutomation_Document_CostOfActivity_Inherit.Update(t_OfficeAutomation_Document_CostOfActivity);//修改申请表

        //DA_OfficeAutomation_Document_CostOfActivity_Detail_Inherit da_OfficeAutomation_Document_CostOfActivity_Detail_Inherit = new DA_OfficeAutomation_Document_CostOfActivity_Detail_Inherit();
        //da_OfficeAutomation_Document_CostOfActivity_Detail_Inherit.Delete(ID);
        //InsertCostOfActivityDetail(new Guid(ID));

        Common.AddLog(EmployeeID, EmployeeName, 49, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite50"] = "1";
        Response.Write("<script>window.open('Apply_CostOfActivity_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("三级市场季会活动费用申请表.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_CostOfActivity_Inherit da_OfficeAutomation_Document_CostOfActivity_Inherit = new DA_OfficeAutomation_Document_CostOfActivity_Inherit();
            DataSet ds = da_OfficeAutomation_Document_CostOfActivity_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_CostOfActivity_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            ...
            if (flows != null)
            {
                ...
                if (i <= 5 && EmployeeID == "13545") //M_AddNWX：20150511
                {
    ...
    protected void cbQuarter1_CheckedChanged(object sender, EventArgs e)
    {
        //if (cbQuarter1.Checked)
        //{
        //    txtMan1.Enabled = true;
        //    txtFear1.Enabled = true;
        //}
        ...
        //    try
        //    {
        //        txtMan1.Enabled = false;
        //        txtFear1.Enabled = false;
        //        txtMan1.Text = "";
        //        txtFear1.Text = "";
        //        //float f = 0, g = 0;
        //        //if (float.TryParse(txtFear1.Text, out g))
    ...
    protected void cbQuarter2_CheckedChanged(object sender, EventArgs e)
    {
        //if (cbQuarter2.Checked)
        //{
        //    txtMan2.Enabled = true;
        //    txtFear2.Enabled = true;
        //}
        ...
        //    try
        //    {
        //        txtMan2.Enabled = false;
        //        txtFear2.Enabled = false;
        //        txtMan2.Text = "";
        //        txtFear2.Text = "";
        //        //float f = 0, g = 0;
        //        //if (float.TryParse(txtFear1.Text, out g))
    ...
    protected void cbQuarter3_CheckedChanged(object sender, EventArgs e)
    {
        //if (cbQuarter3.Checked)
        //{
        //    txtMan3.Enabled = true;
        //    txtFear3.Enabled = true;
        //}
        ...
        //    try
        //    {
        //        txtMan3.Enabled = false;
        //        txtFear3.Enabled = false;
        //        txtMan3.Text = "";
        //        txtFear3.Text = "";
        //        //float f = 0, g = 0;
        //        //if (float.TryParse(txtFear1.Text, out g))
    ...
    protected void cbQuarter4_CheckedChanged(object sender, EventArgs e)
    {
        //if (cbQuarter4.Checked)
        //{
        //    txtMan4.Enabled = true;
        //    txtFear4.Enabled = true;
        //}
        ...
        //    try
        //    {
        //        txtMan4.Enabled = false;
        //        txtFear4.Enabled = false;
        //        txtMan4.Text = "";
        //        txtFear4.Text = "";
        //        //float f = 0, g = 0;
        //        //if (float.TryParse(txtFear1.Text, out g))
    ...
    protected void txtFear1_TextChanged(object sender, EventArgs e)
    {
        //float f = 0, g = 0;
        //if(float.TryParse(txtFear1.Text, out g))
        //    f = f + g;
    ...
    protected void txtFear2_TextChanged(object sender, EventArgs e)
    {
        //float f = 0, g = 0;
        //if (float.TryParse(txtFear1.Text, out g))
        //    f = f + g;
    ...
    protected void txtFear3_TextChanged(object sender, EventArgs e)
    {
        //float f = 0, g = 0;
        //if (float.TryParse(txtFear1.Text, out g))
        //    f = f + g;
    ...
    protected void txtFear4_TextChanged(object sender, EventArgs e)
    {
        //float f = 0, g = 0;
        //if (float.TryParse(txtFear1.Text, out g))
        //    f = f + g;
    ...
    protected void lbtnAddNManaging_Click(object sender, EventArgs e) //SYSREQ201807041631055373927
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        da_OfficeAutomation_Flow_Inherit.InsertNewFlow(new Guid(MainID), "0001", "黄轩明", 20, false);
        Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1); //添加日志，添加流程
        RunJS("alert('审理环节已增加！');window.location='" + Page.Request.Url + "'");
    }
    protected void lbtnCancelManaging_Click(object sender, EventArgs e) //SYSREQ201807041631055373927
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndAfterIdxs(MainID, 20);
        Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 3); //添加日志，添加流程
