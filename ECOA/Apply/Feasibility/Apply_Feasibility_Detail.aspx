<%@ Page ValidateRequest="false" Title="新建分行可行性报告 - 广州中原电子审批系统" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Apply_Feasibility_Detail.aspx.cs" Inherits="Apply_Feasibility_Apply_Feasibility_Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function() {      
		    ...
		    $("#<%=txtRateBeginDate.ClientID%>").datepicker();
		    $("#<%=txtRateEndDate.ClientID%>").datepicker();
		    for (var x = 1; x <= i1a; x++) {
	    ...
	    function check() {
	        ...
	        $("#tbDetail2 tr").each(function(n) {
	            if (n != 0 && n < $("#tbDetail2 tr").size() - 1) {
	                //if ($.trim($("#txtBuildingName" + n).val()) == "") {
	                //    alert("第" + n + "行的楼盘名称必须填写。");
	                //    $("#txtBuildingName" + n).focus();
	                //    flag2 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtCsell" + n).val()) == "") {
	                //    alert("第" + n + "行的可售盘量必须填写。");
	                //    $("#txtCsell" + n).focus();
	                //    flag2 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtMainSquare" + n).val()) == "") {
	                //    alert("第" + n + "行的主要户型面积必须填写。");
	                //    $("#txtMainSquare" + n).focus();
	                //    flag2 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtAvarageCoast" + n).val()) == "") {
	                //    alert("第" + n + "行的均价必须填写。");
	                //    $("#txtAvarageCoast" + n).focus();
	                //    flag2 = false;
	                //    return;
	                //}
	                //else if (!$("#rdbIsMain" + n + "1").prop('checked') && !$("#rdbIsMain" + n + "0").prop('checked')) {
	                //    alert("请选择第" + n + "行的是否新分行的主打盘。");
	                //    $("#rdbIsMain" + n + "1").focus();
	                //    flag2 = false;
	                //}
	                //else
	                    data2 += $.trim($("#txtBuildingName" + n).val()) 
                            + "&&" + $.trim($("#txtCsell" + n).val()) 
                            + "&&" + $.trim($("#txtMainSquare" + n).val())
                            + "&&" + $.trim($("#txtAvarageCoast" + n).val())
                            + "&&"+ ($("#rdbIsMain" + n + "1").prop('checked')?"1":"0")
                            + "||";
	            }
	        });
	        ...
	        if (flag2) {
	            ...
	            $("#<%=HiddenField2.ClientID %>").val(data2);
            }
            else
	            return false;
	        ...
	        $("#tbDetail3 tr").each(function(n) {
	            if (n != 0 && n < $("#tbDetail3 tr").size() - 1) {
	                //if ($.trim($("#txtBusinessName" + n).val()) == "") {
	                //    alert("第" + n + "行的行家名称必须填写。");
	                //    $("#txtBusinessName" + n).focus();
	                //    flag3 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtWitchBranch" + n).val()) == "") {
	                //    alert("第" + n + "行的分行名称必须填写。");
	                //    $("#txtWitchBranch" + n).focus();
	                //    flag3 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtSetUpTime" + n).val()) == "") {
	                //    alert("第" + n + "行的设点时间必须填写。");
	                //    $("#txtSetUpTime" + n).focus();
	                //    flag3 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtResults" + n).val()) == "") {
	                //    alert("第" + n + "行的近期每月业绩必须填写。");
	                //    $("#txtResults" + n).focus();
	                //    flag3 = false;
	                //    return;
	                //}
	                //else
	                    data3 += $.trim($("#txtBusinessName" + n).val()) 
                            + "&&" + $.trim($("#txtWitchBranch" + n).val()) 
                            + "&&" + $.trim($("#txtSetUpTime" + n).val())
                            + "&&" + $.trim($("#txtResults" + n).val())
                            + "||";
	            }
	        });
	        ...
	        if (flag3) {
	            ...
	            $("#<%=HiddenField3.ClientID %>").val(data3);
            }
            else
	            return false;

	        $("#tbDetail4 tr").each(function(n) {
	            if (n != 0 && n < $("#tbDetail4 tr").size() - 1) {
	                //if ($.trim($("#txtWhatBuding" + n).val()) == "") {
	                //    alert("第" + n + "行的楼盘名称必须填写。");
	                //    $("#txtWhatBuding" + n).focus();
	                //    flag4 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtDealBeginDate" + n).val()) == "") {
	                //    alert("第" + n + "行的成交起始时段必须填写。");
	                //    $("#txtDealBeginDate" + n).focus();
	                //    flag4 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtDealEndDate" + n).val()) == "") {
	                //    alert("第" + n + "行的成交结束时段必须填写。");
	                //    $("#txtDealEndDate" + n).focus();
	                //    flag4 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtSumGet" + n).val()) == "") {
	                //    alert("第" + n + "行的买卖宗数必须填写。");
	                //    $("#txtSumGet" + n).focus();
	                //    flag4 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtSumRent" + n).val()) == "") {
	                //    alert("第" + n + "行的租赁宗数必须填写。");
	                //    $("#txtSumRent" + n).focus();
	                //    flag4 = false;
	                //    return;
	                //}
	                //else
	                    data4 += $.trim($("#txtWhatBuding" + n).val()) 
                            + "&&" + $.trim($("#txtDealBeginDate" + n).val()) 
                            + "&&" + $.trim($("#txtDealEndDate" + n).val())
                            + "&&" + $.trim($("#txtSumGet" + n).val())
                            + "&&" + $.trim($("#txtSumRent" + n).val())
                            + "||";
	            }
	        });
	        ...
	        if (flag4) {
	            ...
	            $("#<%=HiddenField4.ClientID %>").val(data4);
            }
            else
	            return false;

	        $("#tbDetail5 tr").each(function(n) {
	            if (n != 0 && n < $("#tbDetail5 tr").size() - 2) {
	                ...
	                //    alert("第" + n + "行的裕丰市占比必须填写。");
	                //    $("#txtYuFengRate" + n).focus();
	                //    flag5 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtOtherNum" + n).val()) == "") {
	                //    alert("第" + n + "行的小中介交易宗数必须填写。");
	                //    $("#txtOtherNum" + n).focus();
	                //    flag5 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtOtherRate" + n).val()) == "") {
	                //    alert("第" + n + "行的小中介交易市占比必须填写。");
	                //    $("#txtOtherRate" + n).focus();
	                //    flag5 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtFreeNum" + n).val()) == "") {
	                //    alert("第" + n + "行的自行成交宗数必须填写。");
	                //    $("#txtFreeNum" + n).focus();
	                //    flag5 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtFreeRate" + n).val()) == "") {
	                //    alert("第" + n + "行的自行成交市占比必须填写。");
	                //    $("#txtFreeRate" + n).focus();
	                //    flag5 = false;
	                //    return;
	                //}
	                //else if ($.trim($("#txtAllSum" + n).val()) == "") {
	                //    alert("第" + n + "行的合计宗数必须填写。");
	                //    $("#txtAllSum" + n).focus();
	                //    flag5 = false;
	                //    return;
	                //}
	                //else
	                    data5 += $.trim($("#txtBname" + n).val()) 
	        ...
	        if (flag5) {
	            ...
	            $("#<%=HiddenField5.ClientID %>").val(data5);
            }
            else
	            return false;
		...
		function upload() {
			...
			if(sReturnValue=='success')
				window.location='Apply_Feasibility_Detail.aspx?MainID=<%=MainID %>';
		}

		function editflow(){
		    var win=window.showModalDialog("Apply_Feasibility_Flow.aspx?MainID=<%=MainID %>","","dialogWidth=830px;dialogHeight=280px");
					if(win=='success')
					    window.location="Apply_Feasibility_Detail.aspx?MainID=<%=MainID %>";
		}
        ...
        function InitTB1(tbid, inputname, val4, val5, val6, val7, val8, val9)
        {
            ...
            {
                var tt = "<td rowspan='" + (array4.length) + "'>总监<br/><input type='button' class='btnaddRow' value='添加新行' onclick='AddRow(this,\"" + inputname + "\",\"szj\")' /><br /><input type='button' class='btnaddRow' value='删除一行' onclick='DelRow(this,\"szj\")' /></td>";
        ...
        function InitTB2(tbid, inputname, val7, val8, val9, val10, val11, val12, val13, val14, val15, val16, val17, val18)
        {
            ...
            {
                var tt = "<td rowspan='" + (array7.length) + "'>总监<br/><input type='button' class='btnaddRow' value='添加新行' onclick='AddRow2(this,\"" + inputname + "\",\"szj\")' /><br /><input type='button' class='btnaddRow' value='删除一行' onclick='DelRow(this,\"szj\")' /></td>";
                html = html + "<tr class='szj'>"+
                               (i == 0 ? tt : "")
        ...
        function InitTB3(tbid, inputname, val6, val7, val8, val9, val10, val11, val12, val13, val14, val15)
        {
            ...
            {
                var tt = "<td rowspan='" + (array6.length) + "'>总监<br/><input type='button' class='btnaddRow' value='添加新行' onclick='AddtbAgentRuleRow(this,\"" + inputname + "\",\"szj\")' /><br /><input type='button' class='btnaddRow' value='删除一行' onclick='DelRow(this,\"szj\")' /></td>";
                html = html + "<tr class='szj'>"+
                               (i == 0 ? tt : "")
        ...
        function InitTB4(tbid, inputname, val6, val7, val8, val9, val10, val11, val12, val13, val14, val15)
        {
            ...
            for(var i = 0 ; i <array6.length && i<array7.length && i < array8.length && i < array9.length && i < array10.length; i++ )
            {
                var tt = "<td rowspan='" + (array6.length) + "'>总监<br/><input type='button' class='btnaddRow' value='添加新行' onclick='AddTable5Row(this,\"" + inputname + "\",\"szj\")' /><br /><input type='button' class='btnaddRow' value='删除一行' onclick='DelRow(this,\"szj\")' /></td>";
                html = html + "<tr class='szj'>"+
                               (i == 0 ? tt : "")
                               +"<td><input type='text' name='" +  inputname + "6' style='width:60px' value='" + array6[i] + "' /></td>"
                               +"<td><input type='text' name='" +  inputname + "7' style='width:60px' value='" + array7[i] + "' /></td>"
        ...
        function PageInit()
        {
            ...
            //table5初始化
            val6 = $("#<%=this.hidStandardSituation6.ClientID%>").val();
            val7 = $("#<%=this.hidStandardSituation7.ClientID%>").val();
            val8 = $("#<%=this.hidStandardSituation8.ClientID%>").val();
            val9 = $("#<%=this.hidStandardSituation9.ClientID%>").val();
            val10 = $("#<%=this.hidStandardSituation10.ClientID%>").val();
            val11 = $("#<%=this.hidStandardSituation11.ClientID%>").val();
            val12 = $("#<%=this.hidStandardSituation12.ClientID%>").val();
            val13 = $("#<%=this.hidStandardSituation13.ClientID%>").val();
            val14 = $("#<%=this.hidStandardSituation14.ClientID%>").val();
            val15 = $("#<%=this.hidStandardSituation15.ClientID%>").val();
            InitTB4("Table5","txtStandardSituation",val6,val7,val8,val9,val10,val11,val12,val13,val14,val15);
        ...
        <div id="tabs" style="text-align: center;width: 840px">
            ...
            <div id="tabs-1">
		        ...
		        <div style='text-align: center'>
			        <h1>广东中原地产代理有限公司</h1>
			       <%-- <h1>新建分行可行性报告</h1>--%>
                    <span style="font-size:20px; font-weight:bold">新建分行可行性报告</span><label id="laIsGroups" runat="server" style="color:red; font-size:15px;"></label>
			        ...
			        <table id="tbAround"  width='700px'>
				        <tr>
					        ...
					        <td class="tl PL10"><asp:TextBox ID="txtBranch" runat="server"></asp:TextBox></td>
					        <td class="auto-style7">开铺性质</td>
					        <td class="tl PL10"><asp:RadioButton ID="rdbOpenType1" runat="server" GroupName="OpenType" Text="新开铺" /><asp:RadioButton ID="rdbOpenType2" runat="server" GroupName="OpenType" Text="转铺" /></td>
				        </tr>
                        <tr>
					        <td class="auto-style4">所属区域</td>
					        <td class="tl PL10"><asp:DropDownList ID="ddlDepartmentType" runat="server">
				        ...
				        <tr>
					        <td class="auto-style4">所属总监</td>
					        <td class="tl PL10"><asp:TextBox ID="txtApplyID" runat="server"></asp:TextBox></td>
					        <td class="auto-style7">隶属区经</td>
					        <td class="tl PL10"><asp:TextBox ID="txtAreaManager" runat="server"></asp:TextBox></td>
				        </tr>
				        <tr>
					        <td class="auto-style4">新分行联络人</td>
					        <td class="tl PL10"><asp:TextBox ID="txtContacter" runat="server"></asp:TextBox></td>
					        <td class="auto-style7">联系电话</td>
					        <td class="tl PL10"><asp:TextBox ID="txtContactPhone" runat="server"></asp:TextBox></td>
				        </tr>
                        <tr>
					        ...
					        <td class="tl PL10"><asp:TextBox ID="txtTurnBranch" runat="server"></asp:TextBox></td>
				        </tr>
                        <tr>
                        ...
                        <tr>
				            <td colspan="4" class="tl PL10"><div class="tc" style="text-align: left; padding-top: 5px; padding-bottom: 5px;">（二）区域及片区的业绩、利润情况（请用<span style="font-weight:bold;text-decoration:underline;">管理帐</span>数据）</div><span>1．上年度（<asp:Label ID="lblLastYear" runat="server" Text=""></asp:Label>年）的区域负责人、总监、区经的累计业绩、利润数据</span>
                                <table id="t" class='sample tc' width='98%' style="margin:0 auto;">
                                    ...
                                    <tr>
                                        <td>区域负责人</td>
                                        <td><asp:TextBox ID="txtLastYearSituation1" runat="server" Width="100"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtLastYearSituation2" runat="server" Width="100"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtLastYearSituation3" runat="server" Width="100"></asp:TextBox></td>
                                    </tr>
                                    <tr class="szj">
                                        <td>
                                            总监<br />
                                        ...
                                        <td><input type="text" name="txtLastYearSituation4" style="width:100px" /></td>
                                        <td><input type="text" name="txtLastYearSituation5" style="width:100px" /></td>
                                        <td><input type="text" name="txtLastYearSituation6" style="width:100px" /></td>
                                    </tr>
                                    <%--<tr class="btntr">
                                        <td colspan="4">
                                    ...
                                    <tr class="sqj">
                                        ...
                                        <td><input type="text" name="txtLastYearSituation7" style="width:100px" /></td>
                                        <td><input type="text" name="txtLastYearSituation8" style="width:100px" /></td>
                                        <td><input type="text" name="txtLastYearSituation9" style="width:100px" /></td>
                                    </tr>
                                    <%--<tr class="btntr">
                                        <td colspan="4">
				                ...
				                <span>2．申请年度（<asp:Label ID="lblThisYear" runat="server" Text=""></asp:Label>年）截止到<asp:TextBox ID="txtThisYearMonth" runat="server" Width="30"></asp:TextBox>月的区域负责人、总监、区经的累计业绩、利润数据</span>
                                <table id="Table2" class='sample tc' width='98%' style="margin:0 auto;">
                                    ...
                                    <tr>
                                        <td>区域负责人</td>
                                        <td><asp:TextBox ID="txtThisYearSituation1" runat="server" Width="100"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtThisYearSituation2" runat="server" Width="100"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtThisYearSituation3" runat="server" Width="100"></asp:TextBox></td>
                                    </tr>
                                    <tr class="szj">
                                        <td>
                                            总监<br />
                                        ...
                                        <td><input type="text" name="txtThisYearSituation4" style="width:100px" /></td>
                                        <td><input type="text" name="txtThisYearSituation5" style="width:100px" /></td>
                                        <td><input type="text" name="txtThisYearSituation6" style="width:100px" /></td>
                                    </tr>
                                    <tr class="sqj">
                                        <td>
                                            区经<br />
                                        ...
                                        <td><input type="text" name="txtThisYearSituation7" style="width:100px" /></td>
                                        <td><input type="text" name="txtThisYearSituation8" style="width:100px" /></td>
                                        <td><input type="text" name="txtThisYearSituation9" style="width:100px" /></td>
                                    </tr>
                                    <%--<tr class="btntr">
                                        <td colspan="4">
                                ...
                                <br /><div class="tc" style="text-align: left; padding-left: 10px; padding-bottom: 5px;"><span>（三）管辖下分行经营情况</span></div>
                                <table id="Table3" class='sample tc' width='98%' style="margin:0 auto;">
                                    ...
                                    <tr>
                                        <td>区域负责人</td>
                                        <td><asp:TextBox ID="txtBusinessSituation1" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtBusinessSituation2" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtBusinessSituation3" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtBusinessSituation4" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtBusinessSituation5" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtBusinessSituation6" runat="server" Width="60px"></asp:TextBox></td>
                                    </tr>
                                    <tr class="szj">
                                        <td>
                                            总监<br />
                                        ...
                                        <td><input type="text" style="width:60px" name="txtBusinessSituation7" /></td>
                                        <td><input type="text" style="width:60px" name="txtBusinessSituation8" /></td>
                                        <td><input type="text" style="width:60px" name="txtBusinessSituation9" /></td>
                                        <td><input type="text" style="width:60px" name="txtBusinessSituation10" /></td>
                                        <td><input type="text" style="width:60px" name="txtBusinessSituation11" /></td>
                                        <td><input type="text" style="width:60px" name="txtBusinessSituation12" /></td>
                                    </tr>
                                    <tr class="sqj">
                                        <td>
                                            区经<br />
                                        ...
                                        <td><input type="text" style="width:60px" name="txtBusinessSituation13" /></td>
                                        <td><input type="text" style="width:60px" name="txtBusinessSituation14" /></td>
                                        <td><input type="text" style="width:60px" name="txtBusinessSituation15" /></td>
                                        <td><input type="text" style="width:60px" name="txtBusinessSituation16" /></td>
                                        <td><input type="text" style="width:60px" name="txtBusinessSituation17" /></td>
                                        <td><input type="text" style="width:60px" name="txtBusinessSituation18" /></td>
                                    </tr>
                                    <%--<tr class="btntr">
                                        <td colspan="7">
                                ...
                                <br /><div class="tc" style="text-align: left; padding-left: 10px; padding-bottom: 5px;"><span>（四）管辖下组别盈利情况</span></div>
                                <table id="Table4" class='sample tc' width='98%' style="margin:0 auto;">
                                    ...
                                    <tr>
                                        <td>区域负责人</td>
                                        <td><asp:TextBox ID="txtProfitSituation1" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtProfitSituation2" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtProfitSituation3" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtProfitSituation4" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtProfitSituation5" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtProfitSituation6" runat="server" Width="60px"></asp:TextBox></td>
                                    </tr>
                                    <tr class="szj">
                                        <td>
                                            总监<br />
                                        ...
                                        <td><input type="text" style="width:60px" name="txtProfitSituation7" /></td>
                                        <td><input type="text" style="width:60px" name="txtProfitSituation8" /></td>
                                        <td><input type="text" style="width:60px" name="txtProfitSituation9" /></td>
                                        <td><input type="text" style="width:60px" name="txtProfitSituation10" /></td>
                                        <td><input type="text" style="width:60px" name="txtProfitSituation11" /></td>
                                        <td><input type="text" style="width:60px" name="txtProfitSituation12" /></td>
                                    </tr>
                                    <tr class="sqj">
                                        <td>
                                            区经<br />
                                        ...
                                        <td><input type="text" style="width:60px" name="txtProfitSituation13" /></td>
                                        <td><input type="text" style="width:60px" name="txtProfitSituation14" /></td>
                                        <td><input type="text" style="width:60px" name="txtProfitSituation15" /></td>
                                        <td><input type="text" style="width:60px" name="txtProfitSituation16" /></td>
                                        <td><input type="text" style="width:60px" name="txtProfitSituation17" /></td>
                                        <td><input type="text" style="width:60px" name="txtProfitSituation18" /></td>
                                    </tr>
                                    <%--<tr class="btntr">
                                        <td colspan="7">
            ...
            <div id="tabs-2">
                <div style='text-align: center'>
                    <table id="tbAround3"  width='700px'>
                        ...
                        <tr>
				            <td colspan="4"><div class="tc" style="text-align: left; padding-left: 10px; padding-bottom: 5px;">（一）区域及片区人员积累情况</div>
                                <table id="tbAgentRule" class='sample tc' width='98%' style="margin:0 auto;">
                                    ...
                                    <tr>
                                        <td>区域负责人</td>
                                        <td><asp:TextBox ID="txtAccumulationSituation1" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtAccumulationSituation2" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtAccumulationSituation3" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtAccumulationSituation4" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtAccumulationSituation5" runat="server" Width="60px"></asp:TextBox></td>
                                    </tr>
                                    <tr class="szj">
                                        <td>
                                            总监<br />
                                        ...
                                        <td><input name="txtAccumulationSituation6" style="width:60px"/></td>
                                        <td><input name="txtAccumulationSituation7" style="width:60px"/></td>
                                        <td><input name="txtAccumulationSituation8" style="width:60px"/></td>
                                        <td><input name="txtAccumulationSituation9" style="width:60px"/></td>
                                        <td><input name="txtAccumulationSituation10" style="width:60px"/></td>
                                    </tr>
                                    <tr class="sqj">
                                        <td>
                                            区经<br />
                                        ...
                                        <td><input name="txtAccumulationSituation11" style="width:60px"/></td>
                                        <td><input name="txtAccumulationSituation12" style="width:60px"/></td>
                                        <td><input name="txtAccumulationSituation13" style="width:60px"/></td>
                                        <td><input name="txtAccumulationSituation14" style="width:60px"/></td>
                                        <td><input name="txtAccumulationSituation15" style="width:60px"/></td>
                                    </tr>
                                    <%--<tr class="btntr">
                                        <td colspan="7">
				                ...
				                <br /><div class="tc" style="text-align: left; padding-left: 10px; padding-bottom: 5px;">（二）最近一季（<asp:TextBox ID="txtRecentlyYear" runat="server" Width="30"></asp:TextBox>年第<asp:TextBox ID="txtRecentlySeason" runat="server" Width="30"></asp:TextBox>季）区域及片区人员达标情况</div>
                                <table id="Table5" class='sample tc' width='98%' style="margin:0 auto;">
                                    ...
                                    <tr>
                                        <td>区域负责人</td>
                                        <td><asp:TextBox ID="txtStandardSituation1" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtStandardSituation2" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtStandardSituation3" runat="server" Width="60px"></asp:TextBox>%</td>
                                        <td><asp:TextBox ID="txtStandardSituation4" runat="server" Width="60px"></asp:TextBox></td>
                                        <td><asp:TextBox ID="txtStandardSituation5" runat="server" Width="60px"></asp:TextBox>%</td>
                                    </tr>
                                    <tr class="szj">
                                        <td>
                                            总监<br />
                                        ...
                                        <td><input name="txtStandardSituation6" style="width:60px"/></td>
                                        <td><input name="txtStandardSituation7" style="width:60px"/></td>
                                        <td><input name="txtStandardSituation8" style="width:60px"/>%</td>
                                        <td><input name="txtStandardSituation9" style="width:60px"/></td>
                                        <td><input name="txtStandardSituation10" style="width:60px"/>%</td>
                                    </tr>
                                    <tr class="sqj">
                                        <td>
                                            区经<br />
                                        ...
                                        <td><input name="txtStandardSituation11" style="width:60px"/></td>
                                        <td><input name="txtStandardSituation12" style="width:60px"/></td>
                                        <td><input name="txtStandardSituation13" style="width:60px"/>%</td>
                                        <td><input name="txtStandardSituation14" style="width:60px"/></td>
                                        <td><input name="txtStandardSituation15" style="width:60px"/>%</td>
                                    </tr>
                                    <%--<tr class="btntr">
                                        <td colspan="7">
				                ...
				                <br /><div class="tc" style="text-align: left; padding-left: 10px; padding-bottom: 5px;">（三）新分行的人员安排</div>
                                ...
                                <table id="tbDetail1a" class='sample tc' width='98%' style="margin:0 auto;">
                                    <tr style="display: none">
                                        ...
                                        <td colspan="2" class="tl PL10" style="padding-top: 5px">
                                            ...
                                            <asp:Button ID="btDiagram" runat="server" Text=" 删　除 " OnClick="btDiagram_Click" Visible="False" />
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                    ...
                                    <tr>
                                        <td  id="ros1a">
                                            区域负责人
                                            <input type="button" id="btnAddRow1a" value="添加新行" onclick="addRow1a();" style="display:none;"/>
					                        <input type="button" id="btnDeleteRow1a" value="删除一行" onclick="deleteRow1a();" style="display:none;"/>
                                        </td>
                                    </tr>
                                    <%=SbHtml1a.ToString()%>
                                ...
                                <table id="tbDetail2a" class='sample tc' width='98%' style="margin:0 auto;">
                                    ...
                                    <%=SbHtml2a.ToString()%>
                                    <tr id="trFlag2a"><td colspan="6"></td></tr>
                                    </table>
                                ...
                                <table id="tbDetail3a" class='sample tc' width='98%' style="margin:0 auto;">
                                    ...
                                    <%=SbHtml3a.ToString()%>
                                    <tr id="trFlag3a"><td colspan="6"></td></tr>
                                    </table>
                                ...
                                <table id="tbDetail4a" class='sample tc' width='98%' style="margin:0 auto;">
                                    ...
                                    <%=SbHtml4a.ToString()%>
                                    <tr id="trFlag4a"><td colspan="6"></td></tr>
                                    </table>
                                ...
                                <table id="tbDetail5a" class='sample tc' width='98%' style="margin:0 auto;">
                                    ...
                                    <%=SbHtml5a.ToString()%>
                                    <tr id="trFlag5a"><td colspan="6">
                                        备注：在（三）新分行的人员安排栏目中，公司的在职员工可直接输入工号，系统将自动识别“职称”“姓名”“执业证号”，隶属上司需手动填写
                                        ，若为未入职员工，所有员工信息需手动输入
                                    </td></tr>
                                    </table>
...
<table id="tbAround4" width='700px'>
                        <tr>
                            <th colspan="4" style="line-height:25px;line-height:25px; text-align: left; padding-left: 10px;" >三、新分行的选址情况</th>
				        </tr>
				        <tr>
					        <td colspan="4"><div class="tc" style="text-align: left; padding-left: 10px; padding-bottom: 5px;">（一）新分行商圈情况与业务潜力</div><div class="tl PL10">1．新分行周边的主要楼盘情况 (具体数据可向公司研究一部收集)</div>
                                <table id="tbDetail2" class='sample tc' width='98%' style="margin:0 auto;">
                                    <tr>
                                        <td>楼盘名称</td>
                                        <td>可售盘量</td>
                                        <td>主要户型面积</td>
                                    ...
                                    <%=SbHtml2.ToString()%>
                                    <tr id="trFlag2"><td colspan="5"></td></tr>
					            </table>
                                <asp:HiddenField ID="HiddenField2" runat="server" />
                                <input type="button" id="btnAddRow2" value="添加新行" onclick="addRow2();" style=" float:left; margin-left:5px; display:none;"/>
					            <input type="button" id="btnDeleteRow2" value="删除一行" onclick="deleteRow2();" style=" float:left; display:none;"/>
				                <br /><br /><div class="tl PL10">2．主要的竞争对手布点及业绩情况</div>
                                <table id="tbDetail3" class='sample tc' width='98%' style="margin:0 auto;">
                                    <tr>
                                        <td>行家名称</td>
                                        <td>分行名称</td>
                                        <td>设点时间</td>
                                    ...
                                    <%=SbHtml3.ToString()%>
                                    <tr id="trFlag3"><td colspan="4"></td></tr>
					            </table>
                                <asp:HiddenField ID="HiddenField3" runat="server" />
                                <input type="button" id="btnAddRow3" value="添加新行" onclick="addRow3();" style=" float:left; margin-left:5px; display:none;"/>
					            <input type="button" id="btnDeleteRow3" value="删除一行" onclick="deleteRow3();" style=" float:left; display:none;"/>
				                <br /><br /><div class="tl PL10">3．区域过往在周边楼盘的成交记录（中原成交）(具体数据可向公司研究一部收集)</div>
                                <table id="tbDetail4" class='sample tc' width='98%' style="margin:0 auto;">
                                    <tr>
                                        <td>楼盘</td>
                                        <td>成交时段</td>
                                        <td>买卖宗数</td>
                                    ...
                                    <%=SbHtml4.ToString()%>
                                    <tr id="trFlag4"><td colspan="4"></td></tr>
					            </table>
                                <asp:HiddenField ID="HiddenField4" runat="server" />
                                <input type="button" id="btnAddRow4" value="添加新行" onclick="addRow4();" style=" float:left; margin-left:5px; display:none;"/>
					            <input type="button" id="btnDeleteRow4" value="删除一行" onclick="deleteRow4();" style=" float:left; display:none;"/>
				                <br /><br /><div class="tl PL10">4. 分行主打盘截至申请月近一年度市占率分析（即<asp:TextBox ID="txtRateBeginDate" runat="server" Width="80"></asp:TextBox>至<asp:TextBox ID="txtRateEndDate" runat="server" Width="80"></asp:TextBox>）</div>
                                <table id="tbDetail5" class='sample tc' width='98%' style="margin:0 auto;">
                                    <tr>
                                        <td rowspan="2">楼盘</td>
                                        <td colspan="2">中原</td>
                                        <td colspan="2">合富</td>
                                    ...
                                    <tr id="sumtr">
                                         <td>合   计：</td>
                                         <td><input type="text" id="txtGzspsNumSum" style="width:30px" /></td>
                                         <td><input type="text" id="txtGzspsRateSum" style="width:35px"/>%</td>
                                         <td><input type="text" id="txtRichNumSum" style="width:30px" /></td>
                                         <td><input type="text" id="txtRichRateSum" style="width:35px"/>%</td>
                                         <td><input type="text" id="txtEveryNumSum" style="width:30px" /></td>
                                         <td><input type="text" id="txtEveryRateSum" style="width:35px"/>%</td>
                                         <td><input type="text" id="txtYuFengNumSum" style="width:30px" /></td>
                                         <td><input type="text" id="txtYuFengRateSum" style="width:35px"/>%</td>
                                         <td><input type="text" id="txtOtherNumSum" style="width:30px" /></td>
                                         <td><input type="text" id="txtOtherRateSum" style="width:35px"/>%</td>
                                         <td><input type="text" id="txtFreeNumSum" style="width:30px" /></td>
                                         <td><input type="text" id="txtFreeRateSum" style="width:35px"/>%</td>
                                         <td><input type="text" id="txtAllSumSum" style="width:35px"/></td>
                                    </tr>
                                    <tr id="trFlag5"><td colspan="14"></td></tr>
					            </table>
                                <asp:HiddenField ID="HiddenField5" runat="server" />
                                <input type="button" id="btnAddRow5" value="添加新行" onclick="addRow5();" style=" float:left; margin-left:5px; display:none;"/>
					            <input type="button" id="btnDeleteRow5" value="删除一行" onclick="deleteRow5();" style=" float:left; display:none;"/>
				                <br /><br /><br /><div class="tc" style="text-align: left; padding-left: 10px; padding-bottom: 5px;">（二）新分行的选址及铺位的相关情况</div>
                                <table id="Table11" class='sample tc' width='98%' style="margin:0 auto;">
                                    <tr>
                                        <td class="auto-style1">1</td>
                                        <td class="auto-style2">具体地址</td>
                                        <td colspan="5"><asp:TextBox ID="txtAddress" runat="server" Width="510px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style1">2</td>
                                        <td class="auto-style2">面积</td>
                                        <td colspan="5"><asp:TextBox ID="txtSquare" runat="server" Width="510px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style1">3</td>
                                        <td class="auto-style2">租金情况</td>
                                        <td><asp:TextBox ID="txtRentSituation" runat="server" Width="114px"></asp:TextBox></td>
                                        <td>按金</td>
                                        <td><asp:TextBox ID="txtDeposit" runat="server" Width="90px"></asp:TextBox></td>
                                        <td class="auto-style8">顶手费</td>
                                        <td><asp:TextBox ID="txtSendCoast" runat="server" Width="65px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style1">4</td>
                                        <td class="auto-style2">产权情况</td>
                                        <td colspan="2"><asp:TextBox ID="txtPropertySituation" runat="server" Width="255px"></asp:TextBox></td>
                                        <td>分租或转租权</td>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        ...
                                        <td>电话</td>
                                        <td><asp:TextBox ID="txtMTelephone" runat="server" Width="120px"></asp:TextBox></td>
                                        <td>光纤</td>
                                        <td colspan="2">（如有）<asp:TextBox ID="txtMOptical" runat="server" Width="95px"></asp:TextBox></td>
                                    </tr>
					            </table>
                                <br /><br /><div class="tc" style="text-align: left; padding-left: 10px; padding-bottom: 5px;">（三）新分行预计的业绩、成本、盈利情况</div>
                                <table id="Table1" class='sample tc' width='98%' style="margin:0 auto;">
                                    <tr>
                                        <td class="auto-style1" >1</td>
                                        <td class="auto-style6" >预估每月的业绩</td>
                                        <td ><asp:TextBox ID="txtMonthlyPerformance" runat="server" Width="170px"></asp:TextBox></td>
                                        <td class="auto-style5" >达到的时间</td>
                                        <td ><asp:TextBox ID="txtReachDate" runat="server"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style1" >2</td>
                                        <td class="auto-style6" >预估总启投入成本</td>
                                        <td colspan="3"><asp:TextBox ID="txtTotalCost" runat="server" Width="425px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style1" >3</td>
                                        <td class="auto-style6" >预估每月日常运作的成本</td>
                                        <td colspan="3"><asp:TextBox ID="txtNormalCost" runat="server" Width="425px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style1" >4</td>
                                        <td class="auto-style6" >预估每月的盈利</td>
                                        <td ><asp:TextBox ID="txtMonthProfit" runat="server" Width="170px"></asp:TextBox></td>
                                        <td class="auto-style5" >达到的时间</td>
                                        <td ><asp:TextBox ID="txtMonthProfitRDate" runat="server"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style1" >5</td>
                                        <td class="auto-style6" >预估投资回报期限</td>
                                        <td colspan="3"><asp:TextBox ID="txtReturnPeriod" runat="server" Width="425px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style1" >6</td>
                                        <td class="auto-style6" >预估分行的盈利率</td>
                                        <td colspan="3"><asp:TextBox ID="txtBankOnForecast" runat="server" Width="425px"></asp:TextBox></td>
                                    </tr>
					            </table>
				            </td>
				        </tr>
                ...
                <div style='text-align: center'>
			        ...
			        <table id="tbAround2" width='640px'>
                        ...
                        <tr>
					        <td>月租金</td>
					        <td class="tl PL10">
                                不含税￥<asp:TextBox ID="txtMonthlyRentNoTax" runat="server" CssClass="pinput"></asp:TextBox>元/月&nbsp;&nbsp;含税￥<asp:TextBox ID="txtMonthlyRentIncludeTax" runat="server" CssClass="pinput"></asp:TextBox>元/月&nbsp;&nbsp;税费￥<asp:TextBox ID="txtMothlyTax" runat="server" CssClass="pinput"></asp:TextBox>元
                                <br />业主是否包发票<asp:RadioButton ID="rdbHasTax1" runat="server" GroupName="UndertakeInvoice" Text="包" /><asp:RadioButton ID="rdbHasTax2" runat="server" GroupName="UndertakeInvoice" Text="不包" />　税率<asp:TextBox ID="txtMonthlyTaxRate" runat="server" Width="60px"></asp:TextBox>%
					        </td>
				        </tr>
                        <tr>
					        <td>租赁期</td>
					        <td class="tl PL10"><asp:TextBox ID="txtLeaseStartDate" runat="server" Width="80"></asp:TextBox>至<asp:TextBox ID="txtLeaseEndDate" runat="server" Width="80"></asp:TextBox>（共<asp:TextBox ID="txtLeaseYears" runat="server" Width="30"></asp:TextBox>年<asp:TextBox ID="txtLeaseMonths" runat="server" Width="30"></asp:TextBox>月）</td>
				        </tr>
                        <tr>
					        <td>免租装修期</td>
					        <td class="tl PL10"><asp:RadioButton ID="rdbIsRentFree1" runat="server" GroupName="RentFree" Text="无" /><asp:RadioButton ID="rdbIsRentFree2" runat="server" GroupName="RentFree" Text="有" /><asp:TextBox ID="txtRentFreeStart" runat="server" Width="80"></asp:TextBox>至<asp:TextBox ID="txtRentFreeEnd" runat="server" Width="80"></asp:TextBox>（共<asp:TextBox ID="txtRentFreeCount" runat="server" Width="40px"></asp:TextBox>天）</td>
				        </tr>
                        ...
                        <tr>
					        ...
					        <td>
                                <table id="tbDetail6" class='sample tc' width='98%' style="margin:0 auto;">
                                    <tr><td>第几年</td><td>不含税￥元/月</td><td>含税￥元/月</td><td>税费￥元</td><td>递增%</td><td>税率%</td></tr>
                                    <%=SbHtml6.ToString()%>
                                    <tr id="trFlag6"><td colspan="6"></td></tr>
                                </table>
                        ...
                        <tr>
					        <td class="tl PL10"><asp:RadioButton ID="rdbInvoice1" runat="server" GroupName="Invoice" Text="发票业主提供" /><asp:RadioButton ID="rdbInvoice2" runat="server" GroupName="Invoice" Text="发票管理处提供" /></td>
				        </tr>
                        <tr>
					        <td>各项按金</td>
                        ...
                        <tr>
					        <td class="tl PL10">支付原因：<br /><asp:TextBox ID="txtPayReason" runat="server" TextMode="MultiLine" Rows="2"  Width="98%" style="overflow:auto;"></asp:TextBox></td>
				        </tr>
                        <tr>
                        ...
                        <tr>
					        <td class="tl PL10">支付对象和收款人原则上需一致，<br />如不一致必须能合理解释收款人与业主/转租客的关系：<br /><asp:TextBox ID="txtRelationship" runat="server" TextMode="MultiLine" Rows="2"  Width="98%" style="overflow:auto;"></asp:TextBox></td>
				        </tr>
                        <tr>
					        <td>租赁印花税</td>
					        <td class="tl PL10"><asp:RadioButton ID="rdbStampDuty1" runat="server" GroupName="StampDuty" Text="租赁双方各付各税" />￥<asp:TextBox ID="txtStampDuty1" runat="server" CssClass="pinput"></asp:TextBox>元&nbsp;&nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rdbStampDuty2" runat="server" GroupName="StampDuty" Text="我司全包" />￥<asp:TextBox ID="txtStampDuty2" runat="server" CssClass="pinput"></asp:TextBox>元</td>
				        </tr>
                        <tr>
					        <td>铺面交吉日期</td>
					        <td class="tl PL10"><asp:TextBox ID="txtCompleteDate" runat="server" Width="80"></asp:TextBox></td>
				        </tr>
                        <tr>
                        ...
                        <tr>
					        <td>租赁按金</td>
					        <td class="tl PL10">￥<asp:TextBox ID="txtLeaseDeposit" runat="server" CssClass="pinput"></asp:TextBox>元&nbsp;<asp:RadioButton ID="rdbLeaseDepositC1" runat="server" GroupName="LeaseDepositC" Text="现金支付" /><asp:RadioButton ID="rdbLeaseDepositC2" runat="server" GroupName="LeaseDepositC" Text="转账支付" /><br />支票抬头<asp:TextBox ID="txtLeaseDepositT" runat="server" Width="365px"></asp:TextBox>
                            </td>
				        </tr>
                        <tr>
					        <td>顶手费</td>
					        <td class="tl PL10">￥<asp:TextBox ID="txtFSendCoast" runat="server" CssClass="pinput"></asp:TextBox>元&nbsp;<asp:RadioButton ID="rdbFSendCoastC1" runat="server" GroupName="FSendCoastC" Text="现金支付" /><asp:RadioButton ID="rdbFSendCoastC2" runat="server" GroupName="FSendCoastC" Text="转账支付" /><br />支票抬头<asp:TextBox ID="txtFSendCoastT" runat="server" Width="365px"></asp:TextBox>
                            </td>
				        </tr>
                        <tr>
					        <td>水电按金</td>
					        <td class="tl PL10">￥<asp:TextBox ID="txtFWEDeposit" runat="server" CssClass="pinput"></asp:TextBox>元&nbsp;<asp:RadioButton ID="rdbFWEDepositC1" runat="server" GroupName="FWEDepositC" Text="现金支付" /><asp:RadioButton ID="rdbFWEDepositC2" runat="server" GroupName="FWEDepositC" Text="转账支付" /><br />支票抬头<asp:TextBox ID="txtFWEDepositT" runat="server" Width="365px"></asp:TextBox>
                            </td>
				        </tr>
                        <tr>
					        <td>管理费按金</td>
                        ...
                        <tr>
                         ...
                         <tr>
					        <td rowspan="5">业权</td>
					        <td>出租人全称</td>
					        <td class="tl PL10"><asp:TextBox ID="txtRentName" runat="server" Width="96%"></asp:TextBox></td>
				        </tr>
                         <tr>
					        <td rowspan="2">出租人身份</td>
					        <td class="tl PL10"><asp:RadioButton ID="rdbRentReal1" runat="server" GroupName="RentIdentity" Text="是真正业主" />　　业主联系资料<asp:TextBox ID="txtRentIdentity" runat="server" Width="235px"></asp:TextBox></td>
				        </tr>
                         <tr>
					        <td class="tl PL10"><asp:RadioButton ID="rdbRentReal2" runat="server" GroupName="RentIdentity" Text="不是真正业主" />　二手转租客联系资料<asp:TextBox ID="txtRentMessage" runat="server" Width="200"></asp:TextBox></td>
				        </tr>
                         <tr>
					        <td>房产性质</td>
					        <td class="tl PL10"><asp:RadioButton ID="rdbEstateProperties1" runat="server" GroupName="EstateProperties" Text="商铺" /><asp:RadioButton ID="rdbEstateProperties2" runat="server" GroupName="EstateProperties" Text="住宅" /><asp:RadioButton ID="rdbEstateProperties3" runat="server" GroupName="EstateProperties" Text="写字楼" /><asp:RadioButton ID="rdbEstateProperties4" runat="server" GroupName="EstateProperties" Text="其他" /></td>
				        </tr>
                         <tr>
					        <td  class="tl PL10" colspan="2">
                                ...
                                <br /><asp:CheckBox ID="cbNatureTitle4" runat="server" Text="企业法人身份证/营业执照（业主属公司）或身份证（业主属个人）/授权委托书" />
                                <br /><asp:CheckBox ID="cbNatureTitle5" runat="server" Text="其他" />
                                <br /><asp:TextBox ID="txtNatureTitleO" runat="server" TextMode="MultiLine" Rows="2" Width="98%" style="overflow:auto;"></asp:TextBox></td>
				        </tr>
                        <tr>
...
<table id="tbAround5"  width='700px'>
                        <tr><th colspan="4" style="line-height:25px;" >申请意见</th></tr>
					...
					<td colspan="3" class="tl PL10" style=" ">
				     ...
				     <tr id="trCoo" class="noborder" style="height: 85px;">
					        ...
					        <td colspan="3" class="tl PL10" style=" ">
                                ...
                                <input id="rdbNoIDx15" type="radio" name="agree15" /><label for="rdbNoIDx15">不同意</label><br />
                ...
                <%=SbHtmlLogisticsFlow.ToString()%>
                        <%--<tr id="trShowFlow14" class="noborder" style="height: 85px;"> 
                ...
                <tr><td style="line-height: 0px"></td><td colspan="3" id="trtpdf" style="line-height: 0px"></td></tr>
				        <tr id="trGeneralManager" class="noborder" style="height: 85px; ">
					        <td >董事总经理</td>
					        <td colspan="3" class="tl PL10" style=" ">
						        <input id="rdbYesIDx26" type="radio" name="agree26" /><label for="rdbYesIDx26">同意</label><input id="rdbNoIDx26" type="radio" name="agree26" /><label for="rdbNoIDx26">不同意</label>
                                <input id="rdbOtherIDx26" type="radio" name="agree26" /><label for="rdbOtherIDx26">其他意见</label><br />
						        <textarea id="txtIDx26" rows="6" style="width: 98%; overflow: auto;"></textarea><input type="button" id="btnSignIDx26" value="签署意见" onclick="sign('26')" style="display: none;" />
                                <br />
                                <span style="padding-right: 30px; padding-bottom: 10px; text-align: right; float: right;">
                                    日期：<span id="spanDateIDx26">_________</span>
                                </span>
					        </td>
				        </tr>
