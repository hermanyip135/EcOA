...
public partial class Apply_Feasibility_Apply_Feasibility_Detail_New : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 103;
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    sbMailBody.Append("<br/>所属大战区负责人：" + drRow["OfficeAutomation_Document_Feasibility_ApplyID"]);
                    ...
                    sbMailBody.Append("<br/>隶属小战区负责人：" + drRow["OfficeAutomation_Document_Feasibility_AreaManager"]);
    ...
    private T_OfficeAutomation_Document_Feasibility GetModelFromPage(Guid UndertakeProjID)
    {
        ...
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_RecentlyYear = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_RecentlySeason = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation1 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation2 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation3 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation4 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation5 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation6 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation7 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation8 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation9 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation10 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation11 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation12 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation13 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation14 = string.Empty;
        t_OfficeAutomation_Document_Feasibility.OfficeAutomation_Document_Feasibility_StandardSituation15 = string.Empty;
