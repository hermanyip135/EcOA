<%@ Page ValidateRequest="false" Title="新建分行可行性报告 - 广州中原电子审批系统" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Apply_Feasibility_Detail_New.aspx.cs" Inherits="Apply_Feasibility_Apply_Feasibility_Detail_New" %>
		        ...
		        <div style='text-align: center'>
			       ...
			       <%-- <h1>新建分行可行性报告</h1>--%>
			        ...
			        <table id="tbAround"  width='700px'>
                        ...
                        <tr>
				            <td colspan="4" class="tl PL10"><div class="tc" style="text-align: left; padding-top: 5px; padding-bottom: 5px;">（二）区域及片区的业绩、利润情况（请用<span style="font-weight:bold;text-decoration:underline;">管理帐</span>数据）</div><span>1．上年度（<asp:Label ID="lblLastYear" runat="server" Text=""></asp:Label>
                                <%--年）的区域负责人、总监、区经的累计业绩、利润数据</span>--%>
                    ...
                    <table id="tbAround3"  width='700px'>
                        ...
                        <tr>
				            <td colspan="4"><div class="tc" style="text-align: left; padding-left: 10px; padding-bottom: 5px;">（一）区域及片区人员积累情况</div>
                                ...
                                <br /><div class="tc" style="text-align: left; padding-left: 10px; padding-bottom: 5px;">（二）新分行的人员安排</div>
