<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_Loan_Flow.aspx.cs" Inherits="Apply_Loan_Apply_Loan_Flow" %>
...
<script type="text/javascript" src="/Script/jquery-1.9.1.js"></script>
    ...
    <script type="text/javascript">
        ...
        function PageInit()
        {
            ...
            if($("#hfMoney").val()>=10000)
            {
                $(".zhuguan").prepend(' <span>区域负责人</span>&nbsp;<input id="txtPerson" class="auditor" name="Auditor" type="text" Idx="5" />');
            }else{
                $(".zhuguan").prepend(' <span>区域负责人</span>&nbsp;<input id="txtPerson" class="auditor" name="Auditor" type="text" Idx="5" /><a id="a2" href="javascript:;" onclick="deleAreaMan()">删除区域</a>');
            }  
                //$(".money").show();
...
<body>
    ...
    <div class="flow">
        ...
        <div class="row clearfix">
            ...
            <div class="item REQUIRED">
                <input class="addbtn" type="image" onclick="flowon(this); return false;" src="/Images/add.png" />
                <span >部门主管</span>&nbsp;<input class="auditor" name="Auditor" type="text" Idx="3" /><span class="zhuguan"></span>
    ...
    <div class="flow">
        <input type="button" id="btnSave2" value="保存"  onclick="save(this);return false;" class="btn button"/>
    </div>
    </form>
    <script type="text/javascript">
        PageInit();
