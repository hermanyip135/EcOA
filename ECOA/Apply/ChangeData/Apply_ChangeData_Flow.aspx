<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_ChangeData_Flow.aspx.cs" Inherits="Apply_ChangeData_Apply_ChangeData_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
        ...
        <div>
            <div class="flow">
                ...
                <div id="divIDx1" class='item'>
                    <input id="btnIDx5" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(1);" />
                    <label id="lblIDx1" for='btnIDx0'>营销总监1</label>
                </div>
                ...
                <div id="divIDx2" class='item'>
                    <input id="btnIDx0" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(2);" />
                ...
                <div id="divIDx3" class='item'>
                    <input id="btnIDx1" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(3);" />
                ...
                <div id="divIDx4" class='item'>
                    <input id="btnIDx2" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(4);" />
            ...
            <div id="divIDx7" class='item'>二级市场总经理</div>
            <div id="divTxtIDx7" class='item'>
                <input type="text" id="txtIDx7" style="width:100px;" /><input id="hdIDx7" type="hidden" />
            </div>
            <img src="/Images/forward.png" class="forward"/>--%>

                <br />
                <br />
                <input type="button" id="btnSave2" value="保存并通知审批" onclick="save(this)" class="btn button" />
            </div>
        </div>
    </form>
    <%=SbJs.ToString() %>
