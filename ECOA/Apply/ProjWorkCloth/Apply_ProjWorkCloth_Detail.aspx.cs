...
public partial class Apply_ProjWorkCloth_Apply_ProjWorkCloth_Detail : BasePage
{
    ...
    public void LoadPage()
    {
        ...
        for (int i = 0; i < drc.Count; i++)
        {
            ...
            {
                showf = false;
                SbJs.Append("$(\"#trShowFlow6\").hide();$(\"#trShowFlow7\").prepend('<td>行政部意见</td>');");
                SbJs.Append("$(\"#trShowFlow11\").hide();$(\"#trShowFlow22\").prepend('<td>财务部意见</td>');");
                SbJs.Append("$(\"#trShowFlow13\").hide();$(\"#trShowFlow24\").prepend('<td>后勤事务部</td>');");
            }
                ...
                if (curemp.Contains(EmployeeName))
                {
                    switch (curidx)
                    {
                        case "6":
                            if (EmployeeID == "8772")
                            {
                                lbAddL1.Visible = true;
                                lbAddM1.Visible = true;
                            }
                            break;
                        case "7":
                            if (EmployeeID == "3397")
                            {
                                lbAddL2.Visible = true;
                                lbAddM2.Visible = true;
                            }
                            break;
                        case "21":
                            if (EmployeeID == "13545") //M_AddNWX：20150511
                            {
                               ...
                               // lbAddL3.Visible = true;
                                lbAddM3.Visible = true;
                            }
                            break;
                        case "22":
                            if (EmployeeID == "0025")
                            {
                               // lbAddL4.Visible = true;
                                lbAddM4.Visible = true;
                            }
                            break;
                        default:
                            break;
        ...
        if (flows != null)
            ...
            SbJs.Append("$('#trShowFlow24').hide();$('#trGeneralManager').hide();$('#tlsc1').show();$('#tlsc2').show();");

        flows = da_OfficeAutomation_Flow_Inherit.SelectByMainIDAndIdx(MainID, 24);
        if (flows != null)
           //SbJs.Append("$('#trLogistics1').show();$('#trLogistics2').show();");
            SbJs.Append("$('#trShowFlow13').show();$('#trShowFlow24').show();");
        flows = da_OfficeAutomation_Flow_Inherit.SelectByMainIDAndIdx(MainID, 11);
        if (flows != null)
            SbJs.Append("$('#trCoo').show();$('#trCoo').show();");
        ...
        if (flowState == "2" && applicant == EmployeeName && !tpdf) //2041215：M_AlterC
        ...
        //{
            ...
            if (IsNewApply)
            {
                ...
                if (decimal.Parse(t_OfficeAutomation_Document_ProjWorkCloth.OfficeAutomation_Document_ProjWorkCloth_SumPrice) <= 20000)
                {
                    ...
                    da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "25"); 
                }
                    ...
                    if (hdIsAgree.Value != "0")//同意或其他意见
                    {
                        ...
                        if (da_OfficeAutomation_Flow_Inherit.IsFlowComplete(MainID))
                        {
                            ...
                            if (decimal.Parse(txtSumPrice.Text) > 20000)
                                ...
                                employname = CommonConst.EMP_PROJECT_COPYTO_NAME + ",张绍欣,黄瑛,黄轩明";
                            employnames = employname.Split(',');
                            for (int i = 0; i < employnames.Length; i++)
                            {
                                if (!employeeList.Contains(employnames[i]))
    ...
    protected void lbAddL_Click(object sender, EventArgs e)
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
        ...
        if (flows == null)
        {
            ...
            //da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);
            //20180919注释 SYSREQ201809191704283679559 
            //t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
            //t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = CommonConst.EMP_LOGISTICS_MANAGER_ID;
            //t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = CommonConst.EMP_LOGISTICS_MANAGER_NAME;
            ...
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_Idx = 11;
            da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);
            RunJS("alert('添加首席运营官审批成功');window.location.href='" + Page.Request.Url + "';");
        }
        else
        {
    ...
    protected void lbAddM_Click(object sender, EventArgs e)
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
        t_OfficeAutomation_Flow.OfficeAutomation_Flow_MainID = new Guid(MainID);
