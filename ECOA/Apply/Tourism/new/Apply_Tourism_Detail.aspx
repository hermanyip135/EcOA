<%@ Page ValidateRequest="false" Title="营运部门自组织外出活动申请 - 广州中原电子审批系统" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Apply_Tourism_Detail.aspx.cs" Inherits="Apply_Tourism_new_Apply_Tourism_Detail" %>
		...
		<div style='text-align: center'>
			...
			<table id="tbAround"  width='640px'>
				...
				<tr id="trManager3" class="noborder" style="height: 85px;">
					...
					<td colspan="3" class="tl PL10">
						<input id="rdbYesIDx3" type="radio" name="agree3" /><label for="rdbYesIDx3">同意</label><input id="rdbNoIDx3" type="radio" name="agree3" /><label for="rdbNoIDx3">不同意</label><input id="rdbOtherIDx3" type="radio" name="agree3" /><label for="rdbOtherIDx3">其他意见</label><br />
				...
				<tr class="noborder" style="height: 85px;">
					...
					<td colspan="3" class="tl PL10" style=" ">
                        ...
                        <div class="signdate">日期：<span id="spanDateIDx4">_________</span>  &nbsp
                         ...
                         <asp:Button  Text="增加后勤审核" runat="server"   Visible="false" ID="addhq" OnClick="addhq_Click"/>
					</td>
				</tr>
                ...
                <tr id="trl1" class="noborder" style="height:85px;display:none"> 
					<td rowspan="1" class="auto-style5" >营运支持</td>                                                                                                           
					<td colspan="3" class="tl PL10" style=" ">
						<input id="rdbYesIDx7" type="radio" name="agree7" /><label for="rdbYesIDx7">确认</label><input id="rdbNoIDx7" type="radio" name="agree7" /><label for="rdbNoIDx7">不同意</label>
				...
				<tr id="trl2" class="noborder" style="height:85px;display:none">
                    <td rowspan="1" class="auto-style5" >后勤事务部</td>         
					<td colspan="3" class="tl PL10" style=" ">
            ...
            <tr id="trGeneralManager" class="noborder" style="height: 85px; display: none;">
					...
					<td colspan="3" class="tl PL10" style=" ">
						...
						<textarea id="txtIDx9" style="width: 98%; overflow: auto; height: 87px;"></textarea><input type="button" id="btnSignIDx9" value="签署意见" onclick="sign('9')" style="display: none;" /><div class="signdate">日期：<span id="spanDateIDx9">_________</span></div>
					</td>
				</tr>
			</table>
			<!--打印正文结束-->
