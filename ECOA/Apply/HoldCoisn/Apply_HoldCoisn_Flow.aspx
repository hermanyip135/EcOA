<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_HoldCoisn_Flow.aspx.cs" Inherits="Apply_HoldCoisn_Apply_HoldCoisn_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
    ...
    <div>
        <div class="flow">
            ...
            <div id="divIDx1" class='item'><input id="btnIDx1" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(1);" />
                <label id="lblIDx1" for='btnIDx1'>分行主管</label>
            </div>
            ...
            <div id="divIDx2" class='item'><input id="btnIDx2" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(2);" />
                <label id="lblIDx2" for='btnIDx2'>高级经理</label>
            </div>
            ...
            <div id="divIDx3" class='item'><input id="btnIDx3" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(3);" />
                <label id="lblIDx3" for='btnIDx3'>区域经理</label>
            </div>
            ...
            <div id="divIDx4" class='item' style="width: 220px"><input id="btnIDx4" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(4);" />
                <label id="lblIDx4" for='btnIDx4'>区域总监/区域副总监</label>
            </div>
            ...
            <div id="divIDx5" class='item'>区域负责人</div>
