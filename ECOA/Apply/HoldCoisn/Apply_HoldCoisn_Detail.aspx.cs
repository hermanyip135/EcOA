...
public partial class Apply_HoldCoisn_Apply_HoldCoisn_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite79"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite79"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_HoldCoisn_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_HoldCoisn_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_HoldCoisn_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_HoldCoisn_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_HoldCoisn_Department"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_HoldCoisn_ApplyDate"].ToString()).ToString("yyyy-MM-dd");

        txtArea.Text = dr["OfficeAutomation_Document_HoldCoisn_Area"].ToString();
        txtClerk.Text = dr["OfficeAutomation_Document_HoldCoisn_Clerk"].ToString();
        txtDealDate.Text = dr["OfficeAutomation_Document_HoldCoisn_DealDate"].ToString();
        txtAddress.Text = dr["OfficeAutomation_Document_HoldCoisn_Address"].ToString();
        txtReason.Text = dr["OfficeAutomation_Document_HoldCoisn_Reason"].ToString();
        txtTurnDate.Text = dr["OfficeAutomation_Document_HoldCoisn_TurnDate"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_HoldCoisn t_OfficeAutomation_Document_HoldCoisn = new T_OfficeAutomation_Document_HoldCoisn();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "HoldCoisn" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 74; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_HoldCoisn = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_HoldCoisn_Inherit.Insert(t_OfficeAutomation_Document_HoldCoisn);//插入申请表

                //InsertHoldCoisnDetail(t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_ID);
                ...
                Common.AddLog(EmployeeID, EmployeeName, 78, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_HoldCoisn_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_HoldCoisn_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_HoldCoisn_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_HoldCoisn_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_HoldCoisn_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_HoldCoisn_Apply"]);
                    sbMailBody.Append("<br/>分行（组别）：" + drRow["OfficeAutomation_Document_HoldCoisn_Department"]);
                    sbMailBody.Append("<br/>填写日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_HoldCoisn_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>成交编号：" + drRow["OfficeAutomation_Document_HoldCoisn_ApplyID"]);
                    sbMailBody.Append("<br/>区名：" + drRow["OfficeAutomation_Document_HoldCoisn_Area"]);
                    sbMailBody.Append("<br/>营业员：" + drRow["OfficeAutomation_Document_HoldCoisn_Clerk"]);

                    sbMailBody.Append("<br/>成交物业时间：" + drRow["OfficeAutomation_Document_HoldCoisn_DealDate"]);
                    sbMailBody.Append("<br/>成交物业地址：" + drRow["OfficeAutomation_Document_HoldCoisn_Address"]);
                    sbMailBody.Append("<br/>原因：" + drRow["OfficeAutomation_Document_HoldCoisn_Reason"]);
                    sbMailBody.Append("<br/>网上转介时间：" + drRow["OfficeAutomation_Document_HoldCoisn_TurnDate"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_HoldCoisn_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private T_OfficeAutomation_Document_HoldCoisn GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_HoldCoisn t_OfficeAutomation_Document_HoldCoisn = new T_OfficeAutomation_Document_HoldCoisn();
        t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_ID = UndertakeProjID;
        t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_Apply = EmployeeName;
        t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_Department = txtDepartment.Text;

        t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_Area = txtArea.Text;
        t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_Clerk = txtClerk.Text;
        t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_DealDate = txtDealDate.Text;
        t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_Address = txtAddress.Text;
        t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_Reason = txtReason.Text;
        t_OfficeAutomation_Document_HoldCoisn.OfficeAutomation_Document_HoldCoisn_TurnDate = txtTurnDate.Text;

        return t_OfficeAutomation_Document_HoldCoisn;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_HoldCoisn_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_HoldCoisn_ID"].ToString();

        t_OfficeAutomation_Document_HoldCoisn = GetModelFromPage(new Guid(ID));
        ...
        da_OfficeAutomation_Document_HoldCoisn_Inherit.Update(t_OfficeAutomation_Document_HoldCoisn);//修改申请表

        //DA_OfficeAutomation_Document_HoldCoisn_Detail_Inherit da_OfficeAutomation_Document_HoldCoisn_Detail_Inherit = new DA_OfficeAutomation_Document_HoldCoisn_Detail_Inherit();
        //da_OfficeAutomation_Document_HoldCoisn_Detail_Inherit.Delete(ID);
        //InsertHoldCoisnDetail(new Guid(ID));

        Common.AddLog(EmployeeID, EmployeeName, 78, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    /// 新增明细表
    /// </summary>
    /// <param name="gHoldCoisnID"></param>
    //private void InsertHoldCoisnDetail(Guid gHoldCoisnID)
    //{
    //    if (hdDetail.Value == "")
    //        return;

    //    T_OfficeAutomation_Document_HoldCoisn_Detail t_OfficeAutomation_Document_HoldCoisn_Detail;
    //    DA_OfficeAutomation_Document_HoldCoisn_Detail_Inherit da_OfficeAutomation_Document_HoldCoisn_Detail_Inherit = new DA_OfficeAutomation_Document_HoldCoisn_Detail_Inherit();
    ...
    //            if (detail[0] == "")
    //                continue;
    //            t_OfficeAutomation_Document_HoldCoisn_Detail = new T_OfficeAutomation_Document_HoldCoisn_Detail();
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_ID = Guid.NewGuid();
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_MainID = gHoldCoisnID;
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_Property = detail[0];
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_Controler = detail[1];
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_PropertyID = detail[2];
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_PropertyDate = detail[3];
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_OldDeal = detail[4];
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_NewDeal = detail[5];
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_AjustDeal = detail[6];
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_ShouldComm = detail[7];
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_ActualComm = detail[8];
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_AjustComm = detail[9];
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_LeadReason = int.Parse(detail[10]);
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_Commitment = detail[11];
    //            t_OfficeAutomation_Document_HoldCoisn_Detail.OfficeAutomation_Document_HoldCoisn_Detail_Reason = detail[12];

    //            da_OfficeAutomation_Document_HoldCoisn_Detail_Inherit.Insert(t_OfficeAutomation_Document_HoldCoisn_Detail);
    //        }
    //    }
    //    catch (Exception ee)
    //    {
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite79"] = "1";
        Response.Write("<script>window.open('Apply_HoldCoisn_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("超三天转介解除汇瀚HOLD佣申请.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_HoldCoisn_Inherit da_OfficeAutomation_Document_HoldCoisn_Inherit = new DA_OfficeAutomation_Document_HoldCoisn_Inherit();
            DataSet ds = da_OfficeAutomation_Document_HoldCoisn_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_HoldCoisn_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_HoldCoisn_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    //protected void lbtnAddMH_Click(object sender, EventArgs e)
    //{
    //    DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
    //    T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
    ...
    //        da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);
    //        RunJS("alert('汇瀚营运总监的审批流程已添加。');window.location.href='" + Page.Request.Url + "';");
    //    }
    //    else
    //    {
    //        RunJS("alert('汇瀚营运总监的审批流程已添加！');window.location.href='" + Page.Request.Url + "';");
    //    }
    //}
    protected void lbtnAddCOO_Click(object sender, EventArgs e)
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
        t_OfficeAutomation_Flow.OfficeAutomation_Flow_MainID = new Guid(MainID);
