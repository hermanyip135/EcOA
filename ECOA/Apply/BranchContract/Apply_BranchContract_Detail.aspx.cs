...
public partial class Apply_BranchContract_Apply_BranchContract_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Document_BranchContract.OfficeAutomation_Document_BranchContract_Reason = txtReason.Text;
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.open('Apply_BranchContract_Detail.aspx?MainID=" + MainID + "');</script>");
    }
