    ...
    <script type="text/javascript">
		...
		function addRow2() {
		    ...
		    var html = '<tr id="trDetail2' + i2 + '">'
                ...
                + '         <td><input type="text" id="txtSum' + i2 + '" style="width:50px"/></td>'
                + '         <td><input type="text" id="txtGzspsNum' + i2 + '" style="width:40px"/></td>'
                + '         <td><input type="text" id="txtGzspsRate' + i2 + '" style="width:40px"/></td>'
                + '         <td><input type="text" id="txtEveryNum' + i2 + '" style="width:40px"/></td>'
                + '         <td><input type="text" id="txtEveryRate' + i2 + '" style="width:40px"/></td>'
                + '         <td><input type="text" id="txtRichNum' + i2 + '" style="width:40px"/></td>'
                + '         <td><input type="text" id="txtRichRate' + i2 + '" style="width:40px"/></td>'
                + '         <td><input type="text" id="txtYuFengNum' + i2 + '" style="width:40px"/></td>'
                + '         <td><input type="text" id="txtYuFengRate' + i2 + '" style="width:40px"/></td>'
                + '         <td><input type="text" id="txtFreeNum' + i2 + '" style="width:40px"/></td>'
                + '         <td><input type="text" id="txtFreeRate' + i2 + '" style="width:40px"/></td>'
                + '         <td><input type="text" id="txtOtherNum' + i2 + '" style="width:40px"/></td>'
                + '         <td><input type="text" id="txtOtherRate' + i2 + '" style="width:40px"/></td>'
				+ '     </tr>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<div style='text-align: center; width: 840px; margin: 0 auto;'>
		...
		<div style='text-align: center'>
            ...
            <div id="snum" style="width:650px;margin:0 auto;"><span style="float:right;" class="file_number">文档编码(自动生成)：<%=SerialNumber %></span></div>
			<table id="tbAround"  width='650px'>
				<tr>
				...
				<tr>
					<td class="tl PL10" colspan="4" style="line-height: 30px">
						...
						<input type="button" id="btnAddRow" value="添加新行" onclick="addRow();" style=" float:left; display:none; margin-left: 50px;"/>
                        ...
                        <span style="font-weight: bolder">
                            5、分行最近12个月，即<asp:textbox id="txtRecentlyBeginData" runat="server" Font-Bold="False"></asp:textbox>至<asp:textbox id="txtRecentlyEndData" runat="server" Font-Bold="False"></asp:textbox><br />
                        ...
                        <span style="font-weight: bolder">
                           6、上一年度，即<asp:textbox id="txtLastYear" runat="server" Font-Bold="False"></asp:textbox>年，财务管理帐的累计业绩￥<asp:textbox id="txtLastYearResults" runat="server" Font-Bold="False"></asp:textbox>元，<br />
                        　　累计盈利￥<asp:textbox id="txtLastYearProfit" runat="server" Font-Bold="False"></asp:textbox>元。
                        </span><br />
                        <span style="font-weight: bolder">
                           7、分行本年度截至申请日（即<asp:textbox id="txtThisYearAsOfData" runat="server" Font-Bold="False"></asp:textbox>至<asp:textbox id="txtThisYearAsOfEndData" runat="server" Font-Bold="False"></asp:textbox>）<br />
                        　　财务管理帐的累计业绩￥<asp:textbox id="txtThisYearCP" runat="server" Font-Bold="False"></asp:textbox>元，及累计利润￥<asp:textbox id="txtThisYearPS2" runat="server" Font-Bold="False"></asp:textbox>元。
                        </span><br />
                        <span style="font-weight: bolder">
                           8、分行的装修费摊销余额截至<asp:textbox id="txtAmortizationBeginData" runat="server" Font-Bold="False"></asp:textbox>￥<asp:textbox id="txtAmortizationMoney" runat="server" Font-Bold="False"></asp:textbox>元，<br />
                        　　摊销期至<asp:textbox id="txtAmortizationEndData" runat="server" Font-Bold="False"></asp:textbox>止。
                        </span>（由区域填）<br />
                        <span style="font-weight: bolder">
                            9、分行主打盘近一年度市占率统计情况：
                        </span><br />
