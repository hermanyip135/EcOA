...
public partial class Apply_BranchContract_Apply_BranchContract_Detail : BasePage
{
    ...
    public void LoadPage()
    {
        ...
        try { txtRecentlyBeginData.Text = DateTime.Parse(dr["OfficeAutomation_Document_BranchContract_RecentlyBeginData"].ToString()).ToString("yyyy-MM-dd"); }
        catch { txtRecentlyBeginData.Text = dr["OfficeAutomation_Document_BranchContract_RecentlyBeginData"].ToString(); }
        try { txtRecentlyEndData.Text = DateTime.Parse(dr["OfficeAutomation_Document_BranchContract_RecentlyEndData"].ToString()).ToString("yyyy-MM-dd"); }
        catch { txtRecentlyEndData.Text = dr["OfficeAutomation_Document_BranchContract_RecentlyEndData"].ToString(); }
        try { txtThisYearAsOfData.Text = DateTime.Parse(dr["OfficeAutomation_Document_BranchContract_ThisYearAsOfData"].ToString()).ToString("yyyy-MM-dd"); }
        catch { txtThisYearAsOfData.Text = dr["OfficeAutomation_Document_BranchContract_ThisYearAsOfData"].ToString(); }
        try { txtThisYearAsOfEndData.Text = DateTime.Parse(dr["OfficeAutomation_Document_BranchContract_ThisYearAsOfEndData"].ToString()).ToString("yyyy-MM-dd"); }
        catch { txtThisYearAsOfEndData.Text = dr["OfficeAutomation_Document_BranchContract_ThisYearAsOfEndData"].ToString(); }
        try { txtAmortizationBeginData.Text = DateTime.Parse(dr["OfficeAutomation_Document_BranchContract_AmortizationBeginData"].ToString()).ToString("yyyy-MM-dd"); }
        catch { txtAmortizationBeginData.Text = dr["OfficeAutomation_Document_BranchContract_AmortizationBeginData"].ToString(); }
        try { txtAmortizationEndData.Text = DateTime.Parse(dr["OfficeAutomation_Document_BranchContract_AmortizationEndData"].ToString()).ToString("yyyy-MM-dd"); }
        catch { txtAmortizationEndData.Text = dr["OfficeAutomation_Document_BranchContract_AmortizationEndData"].ToString(); }
        try { txtStatisticalBeginData.Text = DateTime.Parse(dr["OfficeAutomation_Document_BranchContract_StatisticalBeginData"].ToString()).ToString("yyyy-MM-dd"); }
        catch { txtStatisticalBeginData.Text = dr["OfficeAutomation_Document_BranchContract_StatisticalBeginData"].ToString(); }
        try { txtStatisticalEndData.Text = DateTime.Parse(dr["OfficeAutomation_Document_BranchContract_StatisticalEndData"].ToString()).ToString("yyyy-MM-dd"); }
        ...
        else
        {
            ...
            for (int n = 0; n < detailCount; n++)
            {
                ...
                try { SbJs.Append("$('#txtBeginData" + i + "').val('" + DateTime.Parse(dr["OfficeAutomation_Document_BranchContract_LeaseTerm_BeginData"].ToString()).ToString("yyyy-MM-dd") + "');"); }
                catch { SbJs.Append("$('#txtBeginData" + i + "').val('" + dr["OfficeAutomation_Document_BranchContract_LeaseTerm_BeginData"] + "');"); }
                try { SbJs.Append("$('#txtEndData" + i + "').val('" + DateTime.Parse(dr["OfficeAutomation_Document_BranchContract_LeaseTerm_EndData"].ToString()).ToString("yyyy-MM-dd") + "');"); }
    ...
    public void DrawDetailTable2(int n)
    {
        ...
        for (int i = 1; i <= n; i++)
        {
            ...
            SbHtml2.Append("<td><input type=\"text\" id=\"txtSum" + i + "\" style=\"width:50px\"/></td>");
            SbHtml2.Append("<td><input type=\"text\" id=\"txtGzspsNum" + i + "\" style=\"width:40px\"/></td>");
            SbHtml2.Append("<td><input type=\"text\" id=\"txtGzspsRate" + i + "\" style=\"width:40px\"/></td>");
            SbHtml2.Append("<td><input type=\"text\" id=\"txtEveryNum" + i + "\" style=\"width:40px\"/></td>");
            SbHtml2.Append("<td><input type=\"text\" id=\"txtEveryRate" + i + "\" style=\"width:40px\"/></td>");
            SbHtml2.Append("<td><input type=\"text\" id=\"txtRichNum" + i + "\" style=\"width:40px\"/></td>");
            SbHtml2.Append("<td><input type=\"text\" id=\"txtRichRate" + i + "\" style=\"width:40px\"/></td>");
            SbHtml2.Append("<td><input type=\"text\" id=\"txtYuFengNum" + i + "\" style=\"width:40px\"/></td>");
            SbHtml2.Append("<td><input type=\"text\" id=\"txtYuFengRate" + i + "\" style=\"width:40px\"/></td>");
            SbHtml2.Append("<td><input type=\"text\" id=\"txtFreeNum" + i + "\" style=\"width:40px\"/></td>");
            SbHtml2.Append("<td><input type=\"text\" id=\"txtFreeRate" + i + "\" style=\"width:40px\"/></td>");
            SbHtml2.Append("<td><input type=\"text\" id=\"txtOtherNum" + i + "\" style=\"width:40px\"/></td>");
            SbHtml2.Append("<td><input type=\"text\" id=\"txtOtherRate" + i + "\" style=\"width:40px\"/></td>");
