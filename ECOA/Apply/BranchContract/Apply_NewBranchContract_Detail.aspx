<%@ Page Title="分行续约申请报告 - 广州中原电子审批系统" Language="C#" AutoEventWireup="true" ValidateRequest="false" MasterPageFile="~/MasterPage.master" CodeFile="Apply_NewBranchContract_Detail.aspx.cs" Inherits="Apply_BranchContract_Apply_NewBranchContract_Detail" %>
...
function getSuggestion(idx)
{
    ...
    <style type="text/css">
        ...
        [id*="btnAddRow"] {
            background: rgba(0, 0, 0, 0) url("../../Images/bsm_add1_33.png") repeat-x scroll 0 0;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style='text-align: center; width: 950px; margin: 0 auto;'>
        ...
        <div style='text-align: center'>
            <h1>广东中原地产代理有限公司</h1>
            <%--<h1>分行续约申请报告</h1>--%>
            <span style="font-size: 20px; font-weight: bold">分行续约申请报告</span><label id="laIsGroups" runat="server" style="color: red; font-size: 15px;"></label>
            <input type="button" id="btnADelete" value="是否同意删除？" onclick="DeleteT();" style="display: none;" />
            <div id="snum" style="width: 750px; margin: 0 auto;"><span style="float: right;" class="file_number">文档编码(自动生成)：<%=SerialNumber %></span></div>
            <table id="tbAround" width='750px'>
                <tr>
                ...
                <tr>
                    ...
                    <td class="tl PL10">
                        <asp:TextBox ID="txtDepartment" runat="server" Width="200px"></asp:TextBox><input type="hidden" id="hdDepartmentID" runat="server" /></td>
                ...
                <tr>
                    ...
                    <td class="tl PL10">
                        <asp:TextBox ID="txtApplyPhone" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="tl PL10" colspan="4" style="line-height: 30px">
                        ...
                        <table style="border-collapse: collapse" align="center">
                            ...
                            <tr>
                                <td style="padding-right: 3px; padding-left: 3px">
                                    <asp:TextBox ID="txtBranch" runat="server" Width="110px"></asp:TextBox></td>
                                <td style="padding-right: 3px; padding-left: 3px">
                                    <asp:TextBox ID="txtContractEndDate" runat="server" Width="75px"></asp:TextBox></td>
                                <td style="padding-right: 3px; padding-left: 3px">
                                    <asp:TextBox ID="txtLastMonthRent" runat="server" Width="60px"></asp:TextBox></td>
                                <td style="padding-right: 3px; padding-left: 3px">
                                    <asp:TextBox ID="txtFirstYearRent" runat="server" Width="60px"></asp:TextBox></td>
                                <td style="padding-right: 3px; padding-left: 3px">
                                    <asp:TextBox ID="txtRentAmplitude" runat="server" Width="50px"></asp:TextBox></td>
                                <td style="padding-right: 3px; padding-left: 3px">
                                    <asp:TextBox ID="txtContractPeriod" runat="server" Width="75px"></asp:TextBox></td>
                                <td style="padding-right: 3px; padding-left: 3px">
                                    <asp:TextBox ID="txtBranchSuqare" runat="server" Width="50px"></asp:TextBox></td>
                                <td style="padding-right: 3px; padding-left: 3px">
                                    <asp:TextBox ID="txtBranchAddress" runat="server" Width="150px"></asp:TextBox></td>
                            </tr>
                        </table>
                        ...
                        <table id="tbDetail" width='85%' class='sample tc' align="center">
                            ...
                            <%=SbHtml.ToString()%>
                            <tr id="trFlag">
                                <td colspan="5" rowspan="2" style="text-align: left; padding-left: 5px;">备注：1、在分行续租合同上必须填写含税租金。<br />
                        ...
                        <span style="font-weight: bolder">2、需增加（或减少）租赁按金：￥<asp:TextBox ID="txtLeaseDeposit" runat="server" Font-Bold="False"></asp:TextBox>元。
                        </span>
                        <br />
                        <span style="font-weight: bolder">3、需增加的其他费用<asp:TextBox ID="txtOtherFees" runat="server" Font-Bold="False"></asp:TextBox>(如有，并具体说明)
                        <br />
                            <asp:TextBox ID="txtOtherSummy" runat="server" Font-Bold="False" Height="70px" TextMode="MultiLine" Width="98%"></asp:TextBox>
                        </span>
                        <br />
                        <span style="font-weight: bolder">4、本次续约的分行主要跟进责任人：（必须是分行营业经理级别以上人员，姓名和联络电话）<br />
                        ...
                        <br />
                        <span style="font-weight: bolder">5、分行最近12个月，即<asp:TextBox ID="txtRecentlyBeginData" runat="server" Font-Bold="False" Width="100px"></asp:TextBox>至<asp:TextBox ID="txtRecentlyEndData" runat="server" Font-Bold="False" Width="100px"></asp:TextBox>
                        ...
                        <br />
                        <span style="font-weight: bolder">6、上一年度，即<asp:TextBox ID="txtLastYear" runat="server" Font-Bold="False"></asp:TextBox>年，财务管理帐的累计业绩￥<asp:TextBox ID="txtLastYearResults" runat="server" Font-Bold="False"></asp:TextBox>元，累计盈利￥<asp:TextBox ID="txtLastYearProfit" runat="server" Font-Bold="False"></asp:TextBox>元。
                        </span>
                        <br />
                        <span style="font-weight: bolder">7、分行本年度截至申请日（即<asp:TextBox ID="txtThisYearAsOfData" runat="server" Font-Bold="False" Width="100px"></asp:TextBox>至<asp:TextBox ID="txtThisYearAsOfEndData" runat="server" Font-Bold="False" Width="100px"></asp:TextBox>）财务管理帐的累计业绩￥<asp:TextBox ID="txtThisYearCP" runat="server" Font-Bold="False" Width="100px"></asp:TextBox>元，及累计利润￥<asp:TextBox ID="txtThisYearPS2" runat="server" Font-Bold="False" Width="100px"></asp:TextBox>元。
                        </span>
                        <br />
                        <span style="font-weight: bolder">8、分行的装修费摊销余额截至<asp:TextBox ID="txtAmortizationBeginData" runat="server" Font-Bold="False"></asp:TextBox>￥<asp:TextBox ID="txtAmortizationMoney" runat="server" Font-Bold="False"></asp:TextBox>元，摊销期至<asp:TextBox ID="txtAmortizationEndData" runat="server" Font-Bold="False"></asp:TextBox>止。
                        </span>（由区域填）<br />
                        ...
                        <div style="font-weight: bolder; text-align: center;">
                            ...
                            <table id="tbDetail2" class='sample tc' width='98%' align="left">
                                <thead>
                                    <tr>
                                        <td rowspan="2">楼盘名</td>
                                        <td rowspan="2">合计</td>
                        ...
                        <span style="font-weight: bolder">
                            11、分行对线上系统的使用情况（由后勤事务部填写）：<br />
                            （1）分行近半年（即<asp:textbox id="txtBranchRecentlyStartDate" runat="server" Font-Bold="False" Width="100px"></asp:textbox>至<asp:textbox id="txtBranchRecentlyEndDate" runat="server" Font-Bold="False" Width="100px"></asp:textbox>）端口月均达标率<asp:textbox id="txtAvgMonthStandardRate" runat="server" Font-Bold="False" Width="100px"></asp:textbox>%，A+系统月均登录次数：Sales<asp:textbox id="txtSalesAvgMthLoginCount" runat="server" Font-Bold="False" Width="100px"></asp:textbox>次，主管<asp:textbox id="txtManagerAvgMthLoginCount" runat="server" Font-Bold="False" Width="100px"></asp:textbox>次，区经<asp:textbox id="txtAreaManagerAvgMthLoginCount" runat="server" Font-Bold="False" Width="100px"></asp:textbox>次，总监<asp:textbox id="txtDirectorAvgMthLoginCount" runat="server" Font-Bold="False" Width="100px"></asp:textbox>次。<br /><br />
                            （2）分行主打盘A+系统盘源数<asp:textbox id="txtHouseNum" runat="server" Font-Bold="False" Width="100px"></asp:textbox>个，满盘率：<asp:textbox id="txtPlatefulRate" runat="server" Font-Bold="False" Width="100px"></asp:textbox>%，有效房源数：<asp:textbox id="txtValidHouseNum" runat="server" Font-Bold="False" Width="100px"></asp:textbox>，有效房源占比<asp:textbox id="txtValidHouseProportion" runat="server" Font-Bold="False" Width="100px"></asp:textbox>%。<br />
                            （3）二手特攻队量化工作：分行由<asp:textbox id="txtSecondTeGongStartDate" runat="server" Font-Bold="False" Width="100px"></asp:textbox>至<asp:textbox id="txtSecondTeGongEndDate" runat="server" Font-Bold="False" Width="100px"></asp:textbox>二手特工队人员配置月均<asp:textbox id="txtAvgMthPeopleNum" runat="server" Font-Bold="False" Width="100px"></asp:textbox>人，人均月均新收盘<asp:textbox id="txtAvgPerMthNewHouse" runat="server" Font-Bold="False" Width="100px"></asp:textbox>个，人均月均新收客<asp:textbox id="txtAvgPerMthNewCustom" runat="server" Font-Bold="False" Width="100px"></asp:textbox>个，人均月均带看量<asp:textbox id="txtAvgPerMthTakeWath" runat="server" Font-Bold="False" Width="100px"></asp:textbox>次。<br />
                       </span><br /><br />--%>

                        <div class="formtb">
                            <h4>9、如因分行近一年度管理帐累计利润出现亏损，请在下框内说明：申请续租的理由及承诺达到的目标，确保在多久期限内扭亏为盈和分行主打盘市占赢行家，<br />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;怎样保证网签量提升？需要写清楚不能履行承诺时怎样处罚。<span style="color: red">（*若在承诺期限内分行主打盘市占赢行家，则可豁免以上处罚。）</span></h4>
                            <div id="ksdiv" class="formtbbody">

                                <p>
                                    <asp:TextBox ID="kcdesiption" runat="server" TextMode="MultiLine" Style="display: block; width: 98%; height: 134px"></asp:TextBox></p>
                                <p style="display: none;">区域负责人是否实行PS制度：<input id="psyes" name="rdPS" type="radio" value="1" disabled="disabled" /><label for="psyes">是</label>&nbsp;&nbsp;&nbsp;&nbsp;<input id="psno" name="rdPS" type="radio" value="0" disabled="disabled" /><label for="psno">否</label></p>
                                <p style="display: none;">区域负责人是否参与123奖励计划：<input id="awardyes" name="rdAward" type="radio" value="1" disabled="disabled" /><label for="awardyes">是</label>&nbsp;&nbsp;&nbsp;&nbsp;<input id="awardno" name="rdAward" type="radio" value="0" disabled="disabled" /><label for="awardno">否</label></p>
                ...
                <tr id="trGeneralGroups" class="noborder" style="height: 85px; display: none">
                    ...
                    <td colspan="3" class="tl PL10" style="">
                        ...
                        <textarea id="txtIDx1000" rows="5" style="width: 98%; overflow: auto;"></textarea><input type="button" id="btnSignIDx1000" value="签署意见" onclick="sign('1000')" style="display: none;" />
                        <br />
                        <span style="padding-right: 30px; padding-bottom: 10px; text-align: right; float: right;">日期：<span id="spanDateIDx1000">_________</span>
                        </span>
                        <%--<div class="signdate">日期：<span id="spanDateIDx11">_________</span></div>--%>
                    </td>
                </tr>
        ...
        <div class="noprint">
            ...
            <div id="PageBottom">
                ...
                <asp:Button runat="server" ID="btnSaveInfo" Text="保存线上平台数据" OnClick="btnSaveInfo_Click" Visible="False" />
