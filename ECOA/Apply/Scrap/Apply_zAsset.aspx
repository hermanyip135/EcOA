...
<%--                <asp:TemplateField HeaderText="归属" ItemStyle-Width="13%" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                        <asp:TextBox ID="txtPlaceRec" runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>--%>
                <asp:BoundField HeaderText="归　属" DataField="txtType" ItemStyle-Width="13%" ItemStyle-VerticalAlign="Middle"></asp:BoundField>
