...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        ...
        function SelectAsset() { //20150519：M_AssetSelt
            ...
            var url = "/Apply/Apply_Asset.aspx?mainID=<%=MainID %>&Asset_Dpm=" + escape($.trim($("#<%=txtDispatchDepartment.ClientID %>").val()));
            ...
            if(sReturnValue){
                ...
                $.each(dataObj.Assets,function(idx,item){
                    ...
                    if(item.cv.indexOf("3") != -1){
                        $("#<%=hdIsL.ClientID %>").val("3");
                        flgL = 1;
                    }
                    if(!flgL)
                        $("#<%=hdIsL.ClientID %>").val("0");
                    ...
                    <table id="tbAround"  width='640px'>
                        ...
                        <tr id="trMoney1" class="noborder" style="height:30px; ">
                            ...
                            <td colspan="3" style=" " class="tl PL10" >
                                ...
                                <asp:LinkButton ID="lbAddLg3" runat="server" Visible="False" OnClick="lbAddLg_Click">添加后勤事务部审批</asp:LinkButton>　
                                <asp:LinkButton ID="lbDelLg3" runat="server" Visible="False" OnClick="lbDelLg_Click">删除后勤事务部审批</asp:LinkButton><br />
                            </td>       
                         </tr>
