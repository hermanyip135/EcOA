<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_Scrap_Flow.aspx.cs" Inherits="Apply_Scrap_Apply_Scrap_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "text",
                data: 'action=saveScrapFlow&id=<%=EmployeeID %>&name=<%=EmployeeName %>&purview=<%=Purview %>&mainid=<%=MainID %>&content=' + content,
                success: function(info) {
                    if (info == "success") {
                        alert('流程编辑成功!');
        ...
        window.onbeforeunload =  function (){
            if($.trim($("#txtIDx4").val())==""&&$.trim($("#txtIDx6").val())==""&&$.trim($("#txtIDx8").val())=="")
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <div id="divIDx4" class='item'><input id="btnIDx4" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(4);" /><label id="lblIDx4" for='btnIDx4'>部门主管</label></div><div id="divTxtIDx4" class='item' style="display:none;"><input type="text" id="txtIDx4" style="width:200px;" /><input id="hdIDx4" type="hidden" /><a href="javascript:;" onclick="return showOrHideIDx(4);">取消</a></div><img src="/Images/forward.png" class="forward"/>
            <div id="divIDx6" class='item'><input id="btnIDx6" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(6);" /><label id="lblIDx6" for='btnIDx6'>隶属主管</label></div><div id="divTxtIDx6" class='item' style="display:none;"><input type="text" id="txtIDx6" style="width:100px;" /><input id="hdIDx6" type="hidden" /><a href="javascript:;" onclick="return showOrHideIDx(6);">取消</a></div><img src="/Images/forward.png" class="forward"/>
            <div id="divTxtIDx8" class='item'><label id="lblIDx8" for='btnIDx8'>部门负责人</label><input type="text" id="txtIDx8" style="width:100px;" /><input id="hdIDx8" type="hidden" /></div>
            <br /><br />
