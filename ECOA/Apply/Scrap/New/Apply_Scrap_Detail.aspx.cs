...
public partial class Apply_Scrap_Apply_Scrap_Detail : BasePage
{
    ...
    public void LoadPage()
    {
        ...
        this.FlowStateID.Value = dr["OfficeAutomation_Main_FlowStateID"].ToString();
        ...
        if (EmployeeName == CommonConst.EMP_ADMINISTRATION_OPERATOR_NAME || EmployeeName=="曹雄")
        {
            GetAllDepartment();
            this.btnSelect.Visible = true;
            this.btnSave.Visible = true;
        ...
        else
        {
            ...
            for (int n = 0; n < detailCount; n++)
            {
                ...
                SbJs.Append("$('#txtRemainingCosts" + i + "').val('" + dr["OfficeAutomation_Document_Scrap_Detail_Cost"].ToString() + "元" + dr["OfficeAutomation_Document_Scrap_Detail_SurplusValue"].ToString() + "');");
                ...
                if (curemp.Contains(EmployeeName))
                {
                    switch (curidx)
                    {
                        ...
                        case "13":
                            ...
                            lbAddLg18.Visible = true;
                            lbDelLg18.Visible = true;
                            break;
                        case "24":
        ...
        if (flag18)
            SbJs.Append("$('#trManager18').show();$('#trManager19').show();");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            RunJS("alert('该申请没保存资产明细,请先保存资产明细再保存申请');window.location.href='" + Page.Request.Url + "';");
            return;
        }
        try
        {
                    ...
                    if (tempsave)
                    {
                        ...
                        if (ds != null && ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                        {
                         ...
                         /*   if (haveITAsset)//是否有IT类资产，如果有则添加2步IT流程：第10步IT部维护组主管意见，第12步IT部负责人意见
                            ...
                            {
                                DA_OfficeAutomation_Document_Scrap_Detail_Inherit da_OfficeAutomation_Document_Scrap_Detail_Inherit = new DA_OfficeAutomation_Document_Scrap_Detail_Inherit();
                                bool hdisL = da_OfficeAutomation_Document_Scrap_Detail_Inherit.IsITAsset(ID, "3");
                                if (hdisL)
                                {
                                    da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "16");
                                    t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = CommonConst.EMP_LOGISTICS_MANAGER_ID;
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (flowIDx == "1")
                {
                    ...
                    {
                        T_OfficeAutomation_Flow flows = da_OfficeAutomation_Flow_Inherit.SelectByMainIDAndIdx(MainID, 2);
                            if (flows == null)
                            {
                    ...
                    decimal totalSurplusValue = decimal.Parse(this.txtRemainingsCostsTotal.Text.Trim() == "" ? "0" : this.txtRemainingsCostsTotal.Text);
                    //20160512 是否增加sky与黄生的流程
                    AddSkyFlow(totalSurplusValue);
                }
                ...
                if (flowIDx == "2")
                {
                    ...
                    decimal totalSurplusValue = decimal.Parse(this.txtRemainingsCostsTotal.Text);
                     //折旧总结以手工填写的为准
                    AddSkyFlow(totalSurplusValue);
                }
                        ...
                        if (da_OfficeAutomation_Flow_Inherit.IsFlowComplete(MainID))
                        {
                            foreach (DataRow dr in dsDetail.Tables[0].Rows)
                            {
                                ...
                                if (hdIsAgree.Value == "1")
                                {
                                    ...
                                    bool reuslt = ws.AssetAdjustmentPass(dr["OfficeAutomation_Document_Scrap_Detail_AdjustmentID"].ToString());
                                    try
                                    {
    ...
    private void Update()
    {
        ...
        t_OfficeAutomation_Document_Scrap.OfficeAutomation_Document_Scrap_ApplyID = EmployeeID;
      ...
      //  bool IsAPOS = da_OfficeAutomation_Document_Scrap_Detail_Inherit.IsAPOS(ID);

        bool haveITAsset = da_OfficeAutomation_Document_Scrap_Detail_Inherit.IsITAsset(ID,"1");
        DataSet dsID = da_OfficeAutomation_Document_Scrap_Inherit.SelectByMainID(MainID);
        ID = dsID.Tables[0].Rows[0]["OfficeAutomation_Document_Scrap_ID"].ToString();
        //DA_OfficeAutomation_Document_Scrap_Detail_Inherit da_OfficeAutomation_Document_Scrap_Detail_Inherit = new DA_OfficeAutomation_Document_Scrap_Detail_Inherit();
        bool IsAPOS = da_OfficeAutomation_Document_Scrap_Detail_Inherit.IsAPOS(ID);
        ...
        if (IsAPOS)
        {
            da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdx(MainID, 24);
            ...
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_Idx = 24;
            da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);
        }
        if (haveITAsset)//是否有IT类资产，如果有则添加2步IT流程：第10步IT部维护组主管意见，第12步IT部负责人意见
        {
    ...
    */
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            if (flows != null)
            {
                ...
                if (i <= 24 && EmployeeID == "13545") //M_AddNWX：20150511
                {
    ...
    #region 加COO审批
    protected void lbAddLg18_Click(object sender, EventArgs e)
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        T_OfficeAutomation_Flow flows;
        ...
        if (flows == null)
        {
            ...
            da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);
            RunJS("alert('首席运营官的审批环节已增加。');window.location='" + Page.Request.Url + "'");
        }
        else
            RunJS("alert('首席运营官的审批环节已增加！');window.location='" + Page.Request.Url + "'");
    }
    protected void lbDelLg18_Click(object sender, EventArgs e)
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "18");
        RunJS("alert('已删除首席运营官的审批环节！');window.location='" + Page.Request.Url + "'");
    }
    #endregion
    #region 加黄生审批
    protected void lbAddLg_Click(object sender, EventArgs e)
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        T_OfficeAutomation_Flow flows;
        //SYSREQ201805231810438085823 由黄瑛变更为总经办-黄轩明。
        ...
        if (flows == null)
        {
          ...
          //  t_OfficeAutomation_Flow.OfficeAutomation_Flow_Idx = 16;
            ...
            RunJS("alert('总经办的审批环节已增加。');window.location='" + Page.Request.Url + "'");
        }
        else
            //RunJS("alert('后勤事务部的审批环节已增加！');window.location='" + Page.Request.Url + "'");
            RunJS("alert('总经办的审批环节已增加！');window.location='" + Page.Request.Url + "'");
    ...
    protected void lbDelLg_Click(object sender, EventArgs e)
    {
       ...
       // RunJS("alert('已删除后勤事务部的审批环节！');window.location='" + Page.Request.Url + "'");
        da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "27");
        RunJS("alert('已删除总经办的审批环节！');window.location='" + Page.Request.Url + "'");
    }
    #endregion
    ...
    private void AddSkyFlow(decimal totalSurplusValue)
    {
        ...
        var t_OfficeAutomation_Flow = new DataEntity.T_OfficeAutomation_Flow();
          bool  IsBeyond1K =da_OfficeAutomation_Document_Scrap_Detail_Inherit.IsBeyond1K(MainID);//是否超1000
        //20160511 SYSREQ201605101532160391670
        //折旧总加>2w 增加sky 黄生审批流程
        //SYSREQ201805231810438085823  由黄瑛变更为总经办-黄轩明
        if (totalSurplusValue > 20000)
        {
            //sky 增加审核流程
            ...
            //增加黄生审核流程
            T_OfficeAutomation_Flow temp = da_OfficeAutomation_Flow_Inherit.SelectByMainIDAndIdx(MainID, 27);
            if (temp == null)
            {
                t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
                t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = CommonConst.EMP_GENERALMANAGER_ID;
        ...
        else if (totalSurplusValue <= 20000)
        {
            //资产报废净值 <= 1000 只需固定流程idx=13审核 无需idx=16、17审核 
            //if (totalSurplusValue <= 1000)
            if (!IsBeyond1K)
            {
                da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "26,27");
            }
                //如果单件资产超过1000加黄生审核
             //else if (totalSurplusValue > 1000)
            else if (IsBeyond1K)
            {
    ...
    protected void btnTempSave_Click(object sender, EventArgs e)
    {
         ...
         SerialNumber = "Scrap" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
        var DocumentID = 4;
        var Creater = EmployeeName;
        var da_OfficeAutomation_Main_Inherit = new DA_OfficeAutomation_Main_Inherit();
        DA_OfficeAutomation_Document_Scrap_Inherit da_OfficeAutomation_Document_Scrap_Inherit = new DA_OfficeAutomation_Document_Scrap_Inherit();
        //插入主表
        var t_OfficeAutomation_Main = da_OfficeAutomation_Main_Inherit.InsertMain(MainID, SerialNumber, DocumentID, EmployeeName, txtDispatchDepartment.Text);
        ...
        //判断是否多次点击保存按钮
        DataSet ds = new DataSet();
        var t_OfficeAutomation_Document_Scrap = new T_OfficeAutomation_Document_Scrap();
        t_OfficeAutomation_Document_Scrap.OfficeAutomation_Document_Scrap_MainID = t_OfficeAutomation_Main.OfficeAutomation_Main_ID;
        t_OfficeAutomation_Document_Scrap.OfficeAutomation_Document_Scrap_Department = txtDispatchDepartment.Text;
        t_OfficeAutomation_Document_Scrap.OfficeAutomation_Document_Scrap_Apply = txtApplicant.Text;
        t_OfficeAutomation_Document_Scrap.OfficeAutomation_Document_Scrap_ApplyDate = DateTime.Parse(txtApplyDate.Text);
        ...
        t_OfficeAutomation_Document_Scrap.OfficeAutomation_Document_Scrap_UserTeam = txtUserTeam.Text;
        t_OfficeAutomation_Document_Scrap.OfficeAutomation_Document_Scrap_ReqReason = txtScrapReason.Text;
        t_OfficeAutomation_Document_Scrap.OfficeAutomation_Document_Scrap_Suc = "";
        t_OfficeAutomation_Document_Scrap.OfficeAutomation_Document_Scrap_SurplusValue = "";
        t_OfficeAutomation_Document_Scrap.OfficeAutomation_Document_Scrap_ApplyID = EmployeeID;
        ds = da_OfficeAutomation_Document_Scrap_Inherit.SelectByMainID(MainID);
        bool result = false;
        if (ds.Tables[0].Rows.Count == 0)
        {
            ...
            t_OfficeAutomation_Document_Scrap.OfficeAutomation_Document_Scrap_ID = Guid.NewGuid();
            result=da_OfficeAutomation_Document_Scrap_Inherit.Insert(t_OfficeAutomation_Document_Scrap);
        }
        else
        {
            t_OfficeAutomation_Document_Scrap.OfficeAutomation_Document_Scrap_ID = new Guid(ds.Tables[0].Rows[0]["OfficeAutomation_Document_Scrap_ID"].ToString());
           result= da_OfficeAutomation_Document_Scrap_Inherit.Update(t_OfficeAutomation_Document_Scrap);
        }         
        ...
        if (result)
        {
          //  RunJS("window.showModalDialog(\"/Apply/Scrap/New/Scrap_Apply_Asset.aspx?mainID=" + MainID + "\",\"\",\"dialogHeight=\"+screen.height+\"px;dialogWidth=\"+screen.width+\"px;\")");
            string sUrl;
            if (Request.QueryString.ToString() == "") {
                 sUrl = "/Apply/Scrap/New/Scrap_Apply_Asset.aspx?" +"mainID=" + MainID;
                Response.Redirect(sUrl);
                return;
            }
            
             sUrl = "/Apply/Scrap/New/Scrap_Apply_Asset.aspx?" + Request.QueryString;
            Response.Redirect(sUrl);
            return;
        }
        else
    ...
    public void btnToAsset_Click(object sender, EventArgs e) 
    {
        string sUrl;
            if (Request.QueryString.ToString() == "") {
                 sUrl = "/Apply/Scrap/New/Scrap_Apply_Asset.aspx?" +"mainID=" + MainID;
    ...
    protected void TOPDF(string serialNumber,System.Data.DataTable dt,decimal sum)
    {
        ...
        try
        {
            ...
            myPhrase.Add("\n");
              myPhrase.Add (new iTextSharp.text.Phrase("               一共报废" +(dt.Rows.Count-1) + "件资产，合计折旧摊分剩余费用为：" + sum + "元。", fontChinesebig));
    ...
    protected void btnAssetToPDF_Click(object sender, EventArgs e)
    {
        ...
        ds = da_OfficeAutomation_Document_Scrap_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        string id = dr["OfficeAutomation_Document_Scrap_ID"].ToString();
        ...
        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
        {
            ...
            myDataRow["序号"] = i + 1;
            myDataRow["使用部门"] = ds.Tables[0].Rows[i]["OfficeAutomation_Document_Scrap_Detail_DpmExp"].ToString();
            myDataRow["存放地点"] = ds.Tables[0].Rows[i]["OfficeAutomation_Document_Scrap_Detail_PlaceExp"].ToString();
            myDataRow["资产名称"] = ds.Tables[0].Rows[i]["OfficeAutomation_Document_Scrap_Detail_AssetName"].ToString();
            myDataRow["财务编号"] = ds.Tables[0].Rows[i]["OfficeAutomation_Document_Scrap_Detail_AssetTag"].ToString();
            myDataRow["规格型号"] = ds.Tables[0].Rows[i]["OfficeAutomation_Document_Scrap_Detail_Model"].ToString();
            myDataRow["购买时间"] = ds.Tables[0].Rows[i]["OfficeAutomation_Document_Scrap_Detail_BuyDate"].ToString() == "1900/1/1" ? "" : DateTime.Parse( ds.Tables[0].Rows[i]["OfficeAutomation_Document_Scrap_Detail_BuyDate"].ToString()).ToShortDateString();
            myDataRow["折旧摊分剩余费用"] = ds.Tables[0].Rows[i]["OfficeAutomation_Document_Scrap_Detail_Cost"].ToString();
            myDataRow["备注"] = ds.Tables[0].Rows[i]["OfficeAutomation_Document_Scrap_Detail_SurplusValue"].ToString();
            myDataTable.Rows.Add(myDataRow);
            sum = sum + decimal.Parse(ds.Tables[0].Rows[i]["OfficeAutomation_Document_Scrap_Detail_Cost"].ToString());
        }
        myDataRow = myDataTable.NewRow();
        myDataRow["序号"] = "合计折旧";
        myDataRow["使用部门"] = "";
        ...
        myDataRow["规格型号"] = "";
        myDataRow["购买时间"] = "";
        myDataRow["折旧摊分剩余费用"] = sum + ""; ;
        myDataRow["备注"] = "";
        myDataTable.Rows.Add(myDataRow);
        TOPDF(serialNumber, myDataTable, sum);
    }
    #endregion
