<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_FyqNotUnProject_Flow.aspx.cs" Inherits="Apply_FyqNotUnProject_Apply_FyqNotUnProject_Flow"  Title="流程编辑 - 广州中原电子审批系统" %>
<!DOCTYPE html>
        ...
        function save() {
            ...
            if(content != ""){
                $.ajax({
                    ...
                    type: "post",
                    dataType: "text",
                    data: 'action=saveCommonFlow&id=<%=EmployeeID %>&name=<%=EmployeeName %>&purview=<%=Purview %>&mainid=<%=MainID %>&content=' + content+'&deleteidxs=2|3|4|5',
                    success: function(info) {
                        if (info == "success") {
        ...
        <div class="flow">
            ...
            <div id ="ddl1" style="float: left; margin-top: 20px;display:none">
                ...
                <div id="divTxtIDx1" class='item'>
                    <input type="text" id="txtIDx1" style="width:200px;" disabled="disabled" /><input id="hdIDx1" type="hidden" />
                </div>
            </div>
            <%--<img src="/Images/forward.png" class="forward"/><br />--%>
             <div id ="ddl2" style="float: left; margin-top: 20px;">
