...
public partial class Apply_FyqNotUnProject_Apply_FyqNotUnProject_Detail : BasePage
{
    ...
    public void LoadPage()
    {
        ...
        DA_OfficeAutomation_Document_FyqNotUnProject_Inherit da_OfficeAutomation_Document_FyqNotUnProject_Inherit = new DA_OfficeAutomation_Document_FyqNotUnProject_Inherit();
        ...
        ds = da_OfficeAutomation_Document_FyqNotUnProject_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_FyqNotUnProject_ID"].ToString();
        string applicant = dr["OfficeAutomation_Main_Creater"].ToString();
        ApplyN = applicant;
        this.txtDepartment.Text = dr["OfficeAutomation_Document_FyqNotUnProject_Department"].ToString();
        this.txtCharge.Text = dr["OfficeAutomation_Document_FyqNotUnProject_Charge"].ToString();
        this.txtSale.Text = dr["OfficeAutomation_Document_FyqNotUnProject_Sale"].ToString();

        this.txtFyqDepartment.Text = dr["OfficeAutomation_Document_FyqNotUnProject_FyqDepartment"].ToString();

        this.txtFyqSale.Text = dr["OfficeAutomation_Document_FyqNotUnProject_FyqSale"].ToString();

        this.txtFyqCharge.Text = dr["OfficeAutomation_Document_FyqNotUnProject_FyqCharge"].ToString();

        this.txtLocation.Text = dr["OfficeAutomation_Document_FyqNotUnProject_Location"].ToString();
        this.txtMaster.Text = dr["OfficeAutomation_Document_FyqNotUnProject_Master"].ToString();

        this.txtBuyers.Text = dr["OfficeAutomation_Document_FyqNotUnProject_Buyers"].ToString();
        this.txtMaster1.Text = this.txtMaster.Text;
        this.txtMaster2.Text = this.txtMaster.Text;
        this.txtBuyer1.Text = this.txtBuyers.Text;
        this.txtBuyer2.Text = this.txtBuyers.Text;
        if (dr["OfficeAutomation_Document_FyqNotUnProject_PersonType"].ToString() == "1")
        {
            this.chkMaster.Checked = true;
            this.chkBuyers.Checked = false;
        }
        else
        {
            this.chkBuyers.Checked = true;
            this.chkMaster.Checked = false;
        }
        this.txtBank.Text = dr["OfficeAutomation_Document_FyqNotUnProject_Bank"].ToString();
        this.txtBankBranch.Text = dr["OfficeAutomation_Document_FyqNotUnProject_BankBranch"].ToString();
        this.txtMortgage.Text = dr["OfficeAutomation_Document_FyqNotUnProject_Mortgage"].ToString();

        this.lblApply.Text = applicant;
        this.lbData.Text = DateTime.Parse(dr["OfficeAutomation_Document_FyqNotUnProject_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_FyqNotUnProject t_OfficeAutomation_Document_FyqNotUnProject = new T_OfficeAutomation_Document_FyqNotUnProject();
        ...
        DataSet dsem = da_Employee_Inherit.GetEmployeeInfoByEmployeeNames(this.txtSale.Text);
        if (dsem.Tables[0].Rows.Count < 1)
          ...
          dsem = da_Employee_Inherit.GetEmployeeInfoByEmployeeNames(this.txtFyqSale.Text);
          if (dsem.Tables[0].Rows.Count < 1)
          {
              Alert("经办人不存在！");
              return;
        ...
        try
        {
            if (MainID == "")
            {
                ...
                dispatchDepartmentID = this.hdFyqDepartment.Value;

                if (dispatchDepartmentID == "")
                {
                    Alert("请填写关键字后点选房友圈按揭金融中心业务！");
                    return;
                }
                t_OfficeAutomation_Main.OfficeAutomation_Main_ID = Guid.NewGuid();
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "FYQNOTUN" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 90;
               ...
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_ID=Guid.NewGuid();
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_MainId=t_OfficeAutomation_Main.OfficeAutomation_Main_ID;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Department=this.txtDepartment.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Charge=this.txtCharge.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Sale=this.txtSale.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_FyqDepartment=this.txtFyqDepartment.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_FyqSale=this.txtFyqSale.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_FyqCharge=this.txtFyqCharge.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Location=this.txtLocation.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Master=this.txtMaster.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Buyers=this.txtBuyers.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_PersonType=this.chkBuyers.Checked==true ?0:1;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Bank=this.txtBank.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_BankBranch=this.txtBankBranch.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Mortgage=this.txtMortgage.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Apply=this.lblApply.Text;
               t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_ApplyDate = DateTime.Now;


              // t_OfficeAutomation_Main.OfficeAutomation_Main_Apply = this.txtSale.Text;
               ...
               t_OfficeAutomation_Main.OfficeAutomation_Main_Department = this.txtDepartment.Text;
                ...
                t_OfficeAutomation_Main.OfficeAutomation_Main_ApplyDate = t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_ApplyDate;

                da_OfficeAutomation_Main_Inherit.Insert(t_OfficeAutomation_Main);//插入公文主表
                da_OfficeAutomation_Document_FyqNotUnProject_Inherit.Add (t_OfficeAutomation_Document_FyqNotUnProject);

                #region 保存默认流程

                addflow(saleId, salename, t_OfficeAutomation_Main.OfficeAutomation_SerialNumber, this.txtDepartment.Text);
                #endregion

                Common.AddLog(EmployeeID, EmployeeName, 90, new Guid(MainID), 1);//日志，

                RunJS("alert('保存成功！');window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_FyqNotUnProject_Flow.aspx?MainID=" + MainID + "&dpm=" + Server.UrlEncode(txtDepartment.Text) + "&flowsadd=" + flowsadd + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
                ...
                if (Purview.Contains("OA_ITPower_001"))//是否有编辑权限
                {
                    DataSet ds = new DataSet();
                    ds = da_OfficeAutomation_Document_FyqNotUnProject_Inherit.SelectByMainID(MainID);
                    ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_FyqNotUnProject_ID"].ToString();
                    t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_ID = new Guid(ID);
                    t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_MainId =new Guid(MainID);
                    t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Department = this.txtDepartment.Text;
                    t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Charge = this.txtCharge.Text;
                    t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Sale = this.txtSale.Text;
                    t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_FyqDepartment = this.txtFyqDepartment.Text;
                    ...
                    t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Mortgage = this.txtMortgage.Text;
                    t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Apply = this.lblApply.Text;
                    t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_ApplyDate = DateTime.Parse( ds.Tables[0].Rows[0]["OfficeAutomation_Document_FyqNotUnProject_ApplyDate"].ToString());


                   // string apply = this.txtSale.Text;
                    string apply = this.lblApply.Text;
                    string depname = this.txtDepartment.Text;
                    string summary ="";
                    string applydate = t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_ApplyDate.ToString();
                    string mainid = MainID;

                    da_OfficeAutomation_Main_Inherit.UpdateMain(mainid, depname, apply, applydate, summary);
                    da_OfficeAutomation_Document_FyqNotUnProject_Inherit.Edit(t_OfficeAutomation_Document_FyqNotUnProject);//修改软件系统开发需求申请表

                    Common.AddLog(EmployeeID, EmployeeName, 90, new Guid(MainID), 2);//日志，修改软件系统开发需求申请表
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_FyqNotUnProject_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_FyqNotUnProject_ID"].ToString();
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_FyqNotUnProject_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_FyqNotUnProject_FyqDepartment"].ToString();
                    string applyUrl = Page.Request.Url.ToString();
                    applyUrl = applyUrl.Substring(applyUrl.ToLowerInvariant().IndexOf("/apply/"));
                    applyUrl = "内部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["InternalURL"] + applyUrl + "?MainID=" + MainID;
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_FyqNotUnProject_Apply"]);
                    sbMailBody.Append("<br/>申请部门：" + drRow["OfficeAutomation_Document_FyqNotUnProject_FyqDepartment"]);
                    sbMailBody.Append("<br/>发文日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_FyqNotUnProject_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));

                    sbMailBody.Append("<br/>物业地址：" + drRow["OfficeAutomation_Document_FyqNotUnProject_Location"]);
                    sbMailBody.Append("<br/>业主：" + drRow["OfficeAutomation_Document_FyqNotUnProject_Master"]);
                    sbMailBody.Append("<br/>买家：" + drRow["OfficeAutomation_Document_FyqNotUnProject_Buyers"]);

                    sbMailBody.Append("<br/>房友圈按揭不承办知会函");
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_FyqNotUnProject_Inherit da_OfficeAutomation_Document_FyqNotUnProject_Inherit = new DA_OfficeAutomation_Document_FyqNotUnProject_Inherit();
            DataSet ds = da_OfficeAutomation_Document_FyqNotUnProject_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_FyqNotUnProject_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnSAlterC_Click(object sender, EventArgs e) //20141216：M_AlterC
    {
        try
        {
            ...
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_FyqNotUnProject_Apply"].ToString();
            string datetime = ds.Tables[0].Rows[0]["OfficeAutomation_Document_FyqNotUnProject_ApplyDate"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
            string department = drRow["OfficeAutomation_Document_FyqNotUnProject_FyqDepartment"].ToString();
            ...
            if (Purview.Contains("OA_ITPower_001"))
            {
                ...
                t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Mortgage = this.txtMortgage.Text;
                t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_Apply = this.lblApply.Text;
                t_OfficeAutomation_Document_FyqNotUnProject.OfficeAutomation_Document_FyqNotUnProject_ApplyDate = DateTime.Parse(datetime);
                ...
                da_OfficeAutomation_Main_Inherit.UpdateMain(mainid, depname, apply, applydate, summary);
                da_OfficeAutomation_Document_FyqNotUnProject_Inherit.Edit(t_OfficeAutomation_Document_FyqNotUnProject);//修改软件系统开发需求申请表
                da_OfficeAutomation_Document_FyqNotUnProject_Inherit.Edit(t_OfficeAutomation_Document_FyqNotUnProject);
