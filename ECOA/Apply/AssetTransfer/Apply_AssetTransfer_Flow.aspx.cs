...
public partial class Apply_AssetTransfer_Apply_AssetTransfer_Flow : BasePage
{
    ...
    private void GetAllDepartment()
    {
        ...
        {
            sbDepartmentJSON.Append("{\"id\":\"" + dr["id"].ToString() + "\",\"label\":\"" + dr["name"].ToString() + "\",\"value\":\"" + dr["name"].ToString() + "\"},");
        }
