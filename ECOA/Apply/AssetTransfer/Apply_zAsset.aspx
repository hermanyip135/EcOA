<%@ Page Title="查找资产 - 广州中原电子审批系统" Language="C#" AutoEventWireup="true" CodeFile="Apply_zAsset.aspx.cs" Inherits="Apply_Apply_zAsset" %>
...
<body>
    ...
    <table style="width:90%;margin:0 auto;margin-bottom:5px;">
        <tr class="noborder">
            <td>
                资产名称：<asp:TextBox ID="txtClassesId" runat="server"></asp:TextBox>　
                财务编号：<asp:TextBox ID="txtAssetNo" runat="server"></asp:TextBox>　
                <asp:TextBox ID="txtBeginTime" runat="server" Visible="False"></asp:TextBox><asp:TextBox ID="txtEndTime" runat="server" Visible="False"></asp:TextBox>　
    ...
    OnPageIndexChanging="gvData_PageIndexChanging" GridLines="None" Width="90%" AllowPaging="true" PageSize="20" DataKeyNames="Asset_id" BorderWidth="0px" BorderStyle="None" HorizontalAlign="Center" OnRowDataBound="gvData_RowDataBound" EmptyDataText="没有找到相关的资产，请检查输入的资料有没有正确">
            <Columns>
                ...
                <asp:TemplateField HeaderText="调出部门" ItemStyle-Width="13%" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                        <asp:TextBox ID="txtDpmExp" runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="接收部门" ItemStyle-Width="13%" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                        <asp:TextBox ID="txtDpmRec" runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="接收地点" ItemStyle-Width="13%" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                        <asp:TextBox ID="txtPlaceRec" runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField HeaderText="资产名称" DataField="txtClasses" ItemStyle-Width="15%" ItemStyle-VerticalAlign="Middle"></asp:BoundField>
                <asp:BoundField HeaderText="财务编号" DataField="Asset_AssetNo" ItemStyle-Width="17%" ItemStyle-VerticalAlign="Middle"></asp:BoundField>
                <asp:BoundField HeaderText="归　属" DataField="txtType" ItemStyle-Width="10%" ItemStyle-VerticalAlign="Middle"></asp:BoundField>
                <asp:BoundField HeaderText="规格型号" DataField="txtTS" ItemStyle-Width="17%" ItemStyle-VerticalAlign="Middle"></asp:BoundField>
                <%--<asp:BoundField HeaderText="入账时间" DataField="Asset_RecordedTime" ItemStyle-Width="10%" ItemStyle-VerticalAlign="Middle"></asp:BoundField>--%>
            </Columns>
