...
public partial class Apply_Apply_Uploads : BasePage
{
    #region Page_Load
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        //string uploadPath = Page.Request.PhysicalApplicationPath + "Maintain\\Uploads\\";
        ...
        try
        {
            ...
            //Attach.OfficeAutomation_MCOA_Attach_Name = addn + "（" + DateTime.Now.ToString("yyMMdd") + UnitName + " - " + EmployeeName + "上传）" + this.txtFilePath.Value.Substring(this.txtFilePath.Value.LastIndexOf('\\') + 1);
