...
public partial class Apply_PersInterests_Apply_PersInterests_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite13"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite13"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        sbJS.Append("<script type=\"text/javascript\">$(\"#btnUpload\").show();$(\"#spanApplyFor\").show();$(\"#spanFollower\").show();");
        ...
        ID = dr["OfficeAutomation_Document_PersInterests_ID"].ToString();
        string applicant=dr["OfficeAutomation_Document_PersInterests_Apply"].ToString();
        ApplyN = applicant;
        ddlDepartmentType.SelectedValue = dr["OfficeAutomation_Document_PersInterests_DepartmentTypeID"].ToString();
        this.txtDepartment.Value = dr["OfficeAutomation_Document_PersInterests_Department"].ToString();
        this.txtApplyForID.Text = dr["OfficeAutomation_Document_PersInterests_ApplyForID"].ToString();
        this.txtApplyFor.Value = dr["OfficeAutomation_Document_PersInterests_ApplyFor"].ToString();
        this.txtApplyForDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_PersInterests_ApplyForDate"].ToString()).ToString("yyyy-MM-dd");
        int intereststypeid = Convert.ToInt32(dr["OfficeAutomation_Document_PersInterests_InterestsTypeID"].ToString());
        ddlInterestsType.SelectedValue = intereststypeid == 1 ? "7" : intereststypeid == 2 ? "9" : intereststypeid == 4 ? "8" : "";
        this.txtFollowerID.Text = dr["OfficeAutomation_Document_PersInterests_FollowerID"].ToString();
        this.txtFollower.Value = dr["OfficeAutomation_Document_PersInterests_Follower"].ToString();
        this.txtFollowerDepartment.Value = dr["OfficeAutomation_Document_PersInterests_FollowerDepartment"].ToString();
        this.txtAddress.Text = dr["OfficeAutomation_Document_PersInterests_Address"].ToString();
        switch (dr["OfficeAutomation_Document_PersInterests_DealTypeID"].ToString())
        {
            case "1":
        ...
        this.txtRelative.Text = dr["OfficeAutomation_Document_PersInterests_Relative"].ToString();
        this.txtRelativeDepartment.Text = dr["OfficeAutomation_Document_PersInterests_RelativeDepartment"].ToString();
        this.txtRelativePosition.Text = dr["OfficeAutomation_Document_PersInterests_RelativePosition"].ToString();
        this.txtRelativeRelation.Text = dr["OfficeAutomation_Document_PersInterests_RelativeRelation"].ToString();
        this.txtApplyDetail.Text = dr["OfficeAutomation_Document_PersInterests_ApplyDetail"].ToString();
        this.lblApplicant.Text = dr["OfficeAutomation_Document_PersInterests_Apply"].ToString();
        this.lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_PersInterests_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        ...
        bool IsApplicant=EmployeeName == dr["OfficeAutomation_Document_PersInterests_Apply"].ToString();
        if (IsApplicant)
        {
        ...
        if(EmployeeName == CommonConst.EMP_HR_OPERATOR_NAME&&flowState=="3")
        ...
        if (flowState == "2" && lblApplicant.Text == EmployeeName) //20141215：M_AlterC
        {
            string[] immediateboss = CommonConst.EMP_IMMEDIATEBOSS_NAME.Split('|');
            foreach (string boss in immediateboss)
            {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_PersInterests t_OfficeAutomation_Document_PersInterests = new T_OfficeAutomation_Document_PersInterests();
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "PersInterests" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 8;
                ...
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_MainID = t_OfficeAutomation_Main.OfficeAutomation_Main_ID;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_DepartmentTypeID = int.Parse(hdDepartmentType.Value);
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_Department = this.txtDepartment.Value;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_Apply = EmployeeName;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_ApplyDate = DateTime.Now;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_ApplyForID = this.txtApplyForID.Text;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_ApplyFor = this.txtApplyFor.Value;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_ApplyForDate = DateTime.Parse(this.txtApplyForDate.Text);
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_InterestsTypeID = int.Parse(hdInterestsType.Value);
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_FollowerID = this.txtFollowerID.Text;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_Follower = this.txtFollower.Value;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_FollowerDepartment = this.txtFollowerDepartment.Value;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_Address = this.txtAddress.Text;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_DealTypeID = this.rdbType1.Checked ? 1 : this.rdbType2.Checked ? 2 : 0;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_Relative = this.txtRelative.Text;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_RelativeDepartment = this.txtRelativeDepartment.Text;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_RelativePosition = this.txtRelativePosition.Text;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_RelativeRelation = this.txtRelativeRelation.Text;
                t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_ApplyDetail = this.txtApplyDetail.Text;
                ...
                da_OfficeAutomation_Document_PersInterests_Inherit.Insert(t_OfficeAutomation_Document_PersInterests);//插入申请表
                ...
                if (ds != null && ds.Tables != null && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (string boss in immediateboss)
                    {
                        if (t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_ApplyFor == boss)
                        {
                            isImmediste = true;
                ...
                Common.AddLog(EmployeeID, EmployeeName, 12, new Guid(MainID), 1);//日志，创建申请表
                ...
                if (isImmediste)
                    ...
                    RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_PersInterests_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=250px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_PersInterests_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_PersInterests_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                //if (da_OfficeAutomation_Flow_Inherit.UpdateContainIsAgreeForSignAndMulti(MainID, signEmployeeID, signEmployeeName, hdSuggestion.Value, flowIDx, hdIsAgree.Value))
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_PersInterests_Apply"].ToString();
                    string employname;
                    string serialNumber = ds.Tables[0].Rows[0]["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    ...
                    if (hdIsAgree.Value != "0")//同意或其他意见
                    {
                        ...
                        if (da_OfficeAutomation_Flow_Inherit.IsFlowComplete(MainID))
                        {
                            ...
                            DataRow drPersInterests = da_OfficeAutomation_Document_PersInterests_Inherit.SelectByMainID(MainID).Tables[0].Rows[0];
                            string msnBody = "";
                            StringBuilder sbMailBody = new StringBuilder();
                            string mailBody = "";
                            sbMailBody.Append("<br/><br/>部门名称：" + drPersInterests["OfficeAutomation_Document_PersInterests_Department"].ToString());
                            sbMailBody.Append("<br/>申请人：" + drPersInterests["OfficeAutomation_Document_PersInterests_ApplyFor"].ToString());
                            sbMailBody.Append("<br/>申请日期：" + drPersInterests["OfficeAutomation_Document_PersInterests_ApplyForDate"].ToString());
                            sbMailBody.Append("<br/>利益申报类别：" + drPersInterests["OfficeAutomation_PersInterestsType_Name"].ToString());
                            switch (drPersInterests["OfficeAutomation_Document_PersInterests_InterestsTypeID"].ToString())
                            {
                                case "1":
                                    sbMailBody.Append("<br/>跟进人：" + drPersInterests["OfficeAutomation_Document_PersInterests_Follower"].ToString());
                                    sbMailBody.Append("<br/>跟进分行：" + drPersInterests["OfficeAutomation_Document_PersInterests_FollowerDepartment"].ToString());
                                    sbMailBody.Append("<br/>房产地址：" + drPersInterests["OfficeAutomation_Document_PersInterests_Address"].ToString());
                                    sbMailBody.Append("<br/>交易类型：" + drPersInterests["OfficeAutomation_DealType_Name"].ToString());
                                    break;
                                case "4":
                                    sbMailBody.Append("<br/>亲属姓名：" + drPersInterests["OfficeAutomation_Document_PersInterests_Relative"].ToString());
                                    sbMailBody.Append("<br/>所在部门：" + drPersInterests["OfficeAutomation_Document_PersInterests_RelativeDepartment"].ToString());
                                    sbMailBody.Append("<br/>担任职位：" + drPersInterests["OfficeAutomation_Document_PersInterests_RelativePosition"].ToString());
                                    sbMailBody.Append("<br/>亲属关系：" + drPersInterests["OfficeAutomation_Document_PersInterests_RelativeRelation"].ToString());
                                    break;
                                default:
                                    sbMailBody.Append("<br/>申报内容：" + drPersInterests["OfficeAutomation_Document_PersInterests_ApplyDetail"].ToString());
                                    break;
                            }
    ...
    private void Update()
    {
        ...
        t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_ID = new Guid(ID);
        t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_DepartmentTypeID = int.Parse(hdDepartmentType.Value);
        t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_Department = this.txtDepartment.Value;
        t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_ApplyForID = this.txtApplyForID.Text;
        t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_ApplyFor = this.txtApplyFor.Value;
        ...
        da_OfficeAutomation_Document_PersInterests_Inherit.Update(t_OfficeAutomation_Document_PersInterests);//修改申请表
        ...
        foreach (string boss in immediateboss)
        {
            if (t_OfficeAutomation_Document_PersInterests.OfficeAutomation_Document_PersInterests_ApplyFor == boss)
            {
                da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "1,2,3,6,7");
        ...
        Common.AddLog(EmployeeID, EmployeeName, 12, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite13"] = "1";
        Response.Write("<script>window.open('Apply_PersInterests_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    ...
    protected void btnSaveLogisticsFlow_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_PersInterests_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_PersInterests_ID"].ToString(); //在不同的表要注意修改
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_PersInterests_Inherit da_OfficeAutomation_Document_PersInterests_Inherit = new DA_OfficeAutomation_Document_PersInterests_Inherit();
            DataSet ds = da_OfficeAutomation_Document_PersInterests_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_PersInterests_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
            string department = drRow["OfficeAutomation_Document_PersInterests_Department"].ToString();
            string applyUrl = Page.Request.Url.ToString();
            applyUrl = applyUrl.Substring(applyUrl.IndexOf("/Apply/"));
            applyUrl = "内部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["InternalURL"] + applyUrl;
                        //+ "<br />外部网地址：" + System.Configuration.ConfigurationSettings.AppSettings["ExternalURL"] + applyUrl;
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_PersInterests_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
