<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_PersInterests_Flow.aspx.cs" Inherits="Apply_PersInterests_Apply_PersInterests_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "text",
                data: 'action=savePersInterestsFlow&id=<%=EmployeeID %>&name=<%=EmployeeName %>&purview=<%=Purview %>&mainid=<%=MainID %>&content=' + content,
                success: function(info) {
                    if (info == "success") {
        ...
        window.onbeforeunload =  function (){
            if($.trim($("#txtIDx2").val())==""&&$.trim($("#txtIDx3").val())==""&&$.trim($("#txtIDx4").val())=="")
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <div id="divIDx3" class='item'><input id="btnIDx3" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(3);" /><label id="lblIDx3" for='btnIDx3'>隶属主管</label></div><div id="divTxtIDx3"class='item' style="display:none;"><input type="text" id="txtIDx3" style="width:100px;" /><input id="hdIDx3" type="hidden" /><a href="javascript:;" onclick="showOrHideIDx(3)">取消</a></div><img src="/Images/forward.png" class="forward"/>
