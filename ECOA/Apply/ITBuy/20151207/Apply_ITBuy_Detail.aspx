...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function sign(idx) {
            //if(idx!='11'&&idx!='12'){
            //if(idx=='1'||idx=='2'||idx=='3'||idx=='9'||idx=='8'||idx=='14'||idx=='130'||idx=='131'){//789
         ...
         function saveScrapURL(){
             ...
             if(url!=''){
                 ...
                 if(index>-1)
                 {
                     ...
                     url="http://"+window.location.host+"/Apply/Scrap/Old/Apply_Scrap_Detail.aspx?"+mainid;
    ...
    <div style='text-align:center; width:840px; margin:0px auto;'>
        ...
        <div style='text-align:center'>            
            ...
            <table id="tbAround"  width='640px'>
                        ...
                        <table>
                            ...
                            <tr class="noborder">
                                <td colspan="2" class="tl PL10">
                                    ...
                                    <asp:RadioButton ID="rdbAdd" runat="server" GroupName="type" onclick="$('#divScrap').hide();$('#aScrap').hide();"/><label for="<%=rdbAdd.ClientID %>">新增</label>
                                    <%--</span>--%>
                ...
                <tr id="trHR3" class="noborder" style="height:30px; display:none; ">
                    <td colspan="3" class="tl PL10" style=" " >
                        ...
                        <textarea id="txtIDx6" rows="3" style="width:98%; overflow:auto;"></textarea><input type="button" id="btnSignIDx6" value="签署意见" onclick="sign('6')" style="display:none;"/><div style="text-align: right; padding-right: 30px; padding-bottom: 10px;">日期：<span id="spanDateIDx6">_________</span></div>
                    </td>       
                </tr>
                <tr id="trX3" class="noborder" style="height:30px; display:none; ">
                    ...
                    <td colspan="3" class="tl PL10" style=" " >
                        ...
                        <textarea id="txtIDx7" rows="3" style="width:98%; overflow:auto;" cols="20" name="S1"></textarea><input type="button" id="btnSignIDx7" value="签署意见" onclick="sign('7')" style="display:none;"/><div style="text-align: right; padding-right: 30px; padding-bottom: 10px;">日期：<span id="spanDateIDx7">_________</span></div>
                    </td>       
                </tr>
                ...
                <tr class="noborder" style="height:30px; ">
                    ...
                    <td colspan="3" class="tl PL10" style=" " >
                        ...
                        <asp:Button ID="btnAddLogistics" runat="server" Text="大于2万，增加首席运营官及董事总经理审批" OnClick="btnAddLogistics_Click" OnClientClick="return confirm('是否确定大于2万，增加首席运营官及董事总经理审批？');" Visible="false" Width="300px" /><br />
                ...
                <tr class="noborder" style="height:30px; ">
                    <td colspan="3" class="tl PL10" style=" " >
                        ...
                        <textarea id="txtIDx11" rows="3" style="width:98%; overflow:auto;"></textarea><input type="button" id="btnSignIDx11" value="签署意见" onclick="sign('11')" style="display:none;"/><div style="text-align: right; padding-right: 30px; padding-bottom: 10px;">日期：<span id="spanDateIDx11">_________</span></div>
                    </td>       
                </tr>
                    <tr id="trCoo" class="noborder" style="height:30px; display:none; ">
                    <td>首席运营官</td>
                    <td colspan="3" class="tl PL10" style=" " >
                        ...
                        <textarea id="Textarea15" rows="3" style="width:98%; overflow:auto;" cols="20" name="S1"></textarea>
                        <input type="button" id="btnSignIDx15" value="签署意见" onclick="sign('15')" style="display:none;"/>
                        <div style="text-align: right; padding-right: 30px; padding-bottom: 10px;">日期：<span id="spanDateIDx15">_________</span></div>
                    </td>       
                </tr>
                <tr class="noborder" style="height:30px; ">
                    <td rowspan="2" >财务部意见</td>
                    <td colspan="3" class="tl PL10" style=" " >
                        <input id="rdbYesIDx22" type="radio" name="agree22" /><label for="rdbYesIDx22">同意</label><input id="rdbNoIDx22" type="radio" name="agree22" /><label for="rdbNoIDx22">不同意</label><input id="rdbOtherIDx22" type="radio" name="agree22" /><label for="rdbOtherIDx22">其他意见</label>
                        　<asp:LinkButton ID="lbtnAddN" runat="server" OnClick="lbtnAddN_Click" Visible="False">添加宁伟雄审批</asp:LinkButton>
                        <br />
                        <textarea id="txtIDx22" rows="3" style="width:98%; overflow:auto;"></textarea><input type="button" id="btnSignIDx22" value="签署意见" onclick="sign('22')" style="display:none;"/>
                        <br />
                ...
                <tr class="noborder" style="height:30px; ">
                    <td colspan="3" class="tl PL10" style=" " >
                        <input id="rdbYesIDx23" type="radio" name="agree23" /><label for="rdbYesIDx23">同意</label>
                        <input id="rdbNoIDx23" type="radio" name="agree23" /><label for="rdbNoIDx13">不同意</label>
                        <input id="rdbOtherIDx23" type="radio" name="agree23" /><label for="rdbOtherIDx23">其他意见</label><br />
                        <textarea id="txtIDx23" rows="3" style="width:98%; overflow:auto;"></textarea>
                ...
                <tr id="trLogistics" class="noborder" style="height:30px; display:none; ">
                    ...
                    <td colspan="3" class="tl PL10" style=" " >
                      ...
                      　<a id="dfd" href="javascript:void(0)" style="display: none;" onclick="deleteFlow()">删除添加的审批环节</a><br />
                        <textarea id="txtIDx24" rows="3" style="width:98%; overflow:auto;"></textarea><input type="button" id="btnSignIDx24" value="签署意见" onclick="sign('24')" style="display:none;"/><div style="text-align: right; padding-right: 30px; padding-bottom: 10px;">日期：<span id="spanDateIDx24">_________</span></div>
                    </td>
                </tr>
                <tr id="trManager" class="noborder" style="height:30px; display:none; ">
                    <td >董事总经理批示</td>
                    <td colspan="3" class="tl PL10" style=" " >
                        <input id="rdbYesIDx25" type="radio" name="agree25" /><label for="rdbYesIDx25">同意</label><input id="rdbNoIDx25" type="radio" name="agree25" /><label for="rdbNoIDx25">不同意</label>
                        <input id="rdbOtherIDx25" type="radio" name="agree25" /><label for="rdbOtherIDx25">其他意见</label><br />
                        <textarea id="txtIDx25" rows="3" style="width:98%; overflow:auto;"></textarea><input type="button" id="btnSignIDx25" value="签署意见" onclick="sign('25')" style="display:none;"/><div style="text-align: right; padding-right: 30px; padding-bottom: 10px;">日期：<span id="spanDateIDx25">_________</span></div>
                    </td>
                </tr>
