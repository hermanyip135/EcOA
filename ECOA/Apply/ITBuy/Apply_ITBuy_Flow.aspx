<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_ITBuy_Flow.aspx.cs" Inherits="Apply_ITBuy_Apply_ITBuy_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "text",
                data: 'action=saveITBuyFlow&id=<%=EmployeeID %>&name=<%=EmployeeName %>&purview=<%=Purview %>&mainid=<%=MainID %>&content=' + content,
                success: function(info) {
                    if (info == "success") {
                        alert('流程编辑成功!');
