<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_ContractTerms_Flow.aspx.cs" Inherits="Apply_ContractTerms_Apply_ContractTerms_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "text",
                data: 'action=saveCommonFlow2&id=<%=EmployeeID %>&name=<%=EmployeeName %>&purview=<%=Purview %>&mainid=<%=MainID %>&content=' + content+'&deleteidxs=1|2|3',
    ...
    //window.onbeforeunload =  function (){
        ...
        window.onbeforeunload =  function (){
            if($.trim($("#txtIDx1").val())=="" || $.trim($("#txtIDx2").val())=="" || $.trim($("#txtIDx3").val())=="")
                return '此流程第1、2及第3环节必须填写不能为空，否则申请将作废！';   
        }
    </script>
</head>
<body>
    ...
    <div>
        <div class="flow">
            ...
            <div id="divIDx2" class='item'>申请部门主管</div>
            ...
            <div id="divIDx3" class='item'>申请部门负责人</div>
