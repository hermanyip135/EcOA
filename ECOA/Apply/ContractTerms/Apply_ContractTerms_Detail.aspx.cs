...
public partial class Apply_ContractTerms_Apply_ContractTerms_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite45"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite45"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_ContractTerms_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_ContractTerms_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_ContractTerms_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_ContractTerms_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_ContractTerms_Department"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ContractTerms_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtReplyPhone.Text = dr["OfficeAutomation_Document_ContractTerms_ReplyPhone"].ToString();
        txtSubject.Text = dr["OfficeAutomation_Document_ContractTerms_Subject"].ToString();
        txtFax.Text = dr["OfficeAutomation_Document_ContractTerms_Fax"].ToString();
        txtDescribe.Text = dr["OfficeAutomation_Document_ContractTerms_Describe"].ToString();
        txtReceiveDepartment.Text = dr["OfficeAutomation_Document_ContractTerms_ReceiveDepartment"].ToString();
        txtOSDepartment.Text = dr["OfficeAutomation_Document_ContractTerms_OSDepartment"].ToString();
        if (dr["OfficeAutomation_Document_ContractTerms_IsApproval"].ToString() == "True")
            rdbIsApproval1.Checked = true;
        else
            rdbIsApproval2.Checked = true;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_ContractTerms t_OfficeAutomation_Document_ContractTerms = new T_OfficeAutomation_Document_ContractTerms();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "ContractTerms" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 40; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_ContractTerms = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_ContractTerms_Inherit.Insert(t_OfficeAutomation_Document_ContractTerms);//插入申请表

                //InsertContractTermsDetail(t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_ID);
                ...
                Common.AddLog(EmployeeID, EmployeeName, 44, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_ContractTerms_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    {
        var SerialNumber = "ContractTerms" + DateTime.Now.ToString("yyyyMMddHHmmssff");
        var DocumentID = 40;
        ...
        if (ds.Tables[0].Rows.Count == 0)
        {
            ...
            var ContractTerms_ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ContractTerms_ID"].ToString();
            t_OfficeAutomation_Document_ContractTerms = GetModelFromPage(new Guid(ContractTerms_ID));
        }

        var result = da_OfficeAutomation_Document_ContractTerms_Inherit.HandleBase(t_OfficeAutomation_Document_ContractTerms);//插入申请表
        if (result)
        {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_ContractTerms_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_ContractTerms_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ContractTerms_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_ContractTerms_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_ContractTerms_Apply"]);
                    sbMailBody.Append("<br/>发文部门：" + drRow["OfficeAutomation_Document_ContractTerms_Department"]);
                    sbMailBody.Append("<br/>发文日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_ContractTerms_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>发文编号：" + drRow["OfficeAutomation_Document_ContractTerms_ApplyID"]);
                    sbMailBody.Append("<br/>收文部门：" + drRow["OfficeAutomation_Document_ContractTerms_ReceiveDepartment"]);
                    sbMailBody.Append("<br/>抄送部门：" + drRow["OfficeAutomation_Document_ContractTerms_OSDepartment"]);
                    sbMailBody.Append("<br/>文件主题：" + drRow["OfficeAutomation_Document_ContractTerms_Subject"]);
                    sbMailBody.Append("<br/>回复电话：" + drRow["OfficeAutomation_Document_ContractTerms_ReplyPhone"]);
                    sbMailBody.Append("<br/>回复传真：" + drRow["OfficeAutomation_Document_ContractTerms_Fax"]);
                    sbMailBody.Append("<br/>原因详述：" + drRow["OfficeAutomation_Document_ContractTerms_Describe"]);

                    sbMailBody.Append("<br/><br/>");

                    //sbMailBody.Append("<br/>其它坏账详细情况：");

                    //ds = da_OfficeAutomation_Document_ContractTerms_Detail_Inherit.SelectByMainID(MainID);
                    //foreach (DataRow dr in ds.Tables[0].Rows)
                    //{
                    //    sbMailBody.Append("<br/>经办人：" + dr["OfficeAutomation_Document_ContractTerms_Detail_Controler"]);
                    //    sbMailBody.Append("<br/>物业成交编号：" + dr["OfficeAutomation_Document_ContractTerms_Detail_PropertyID"]);
                    //    sbMailBody.Append("<br/>物业成交日期：" + dr["OfficeAutomation_Document_ContractTerms_Detail_PropertyDate"]);
                    //    sbMailBody.Append("<br/>原成交价：" + dr["OfficeAutomation_Document_ContractTerms_Detail_OldDeal"]);
                    //    sbMailBody.Append("<br/>现成交价：" + dr["OfficeAutomation_Document_ContractTerms_Detail_NewDeal"]);
                    //    sbMailBody.Append("<br/>成交价调整：" + dr["OfficeAutomation_Document_ContractTerms_Detail_AjustDeal"]);
                    //    sbMailBody.Append("<br/>应收佣金：" + dr["OfficeAutomation_Document_ContractTerms_Detail_ShouldComm"]);
                    //    sbMailBody.Append("<br/>实收佣金：" + dr["OfficeAutomation_Document_ContractTerms_Detail_ActualComm"]);
                    //    sbMailBody.Append("<br/>调整佣金：" + dr["OfficeAutomation_Document_ContractTerms_Detail_AjustComm"]);
                    //    sbMailBody.Append("<br/>客户联系电话：" + dr["OfficeAutomation_Document_ContractTerms_Detail_Commitment"]);
                    //    sbMailBody.Append("<br/>坏帐原因：" + dr["OfficeAutomation_Document_ContractTerms_Detail_Reason"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_ContractTerms_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_ContractTerms_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ContractTerms_ID"].ToString();
        t_OfficeAutomation_Document_ContractTerms = GetModelFromPage(new Guid(ID));
        ...
        da_OfficeAutomation_Document_ContractTerms_Inherit.Update(t_OfficeAutomation_Document_ContractTerms);//修改申请表

        //DA_OfficeAutomation_Document_ContractTerms_Detail_Inherit da_OfficeAutomation_Document_ContractTerms_Detail_Inherit = new DA_OfficeAutomation_Document_ContractTerms_Detail_Inherit();
        //da_OfficeAutomation_Document_ContractTerms_Detail_Inherit.Delete(ID);
        //InsertContractTermsDetail(new Guid(ID));

        Common.AddLog(EmployeeID, EmployeeName, 44, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    private T_OfficeAutomation_Document_ContractTerms GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_ContractTerms t_OfficeAutomation_Document_ContractTerms = new T_OfficeAutomation_Document_ContractTerms();
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_ID = UndertakeProjID;
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_Apply = EmployeeName;
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_Department = txtDepartment.Text;
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_Subject = txtSubject.Text;
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_ReplyPhone = txtReplyPhone.Text;
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_Fax = txtFax.Text;
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_ReceiveDepartment = txtReceiveDepartment.Text;
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_OSDepartment = txtOSDepartment.Text;
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_IsApproval = rdbIsApproval1.Checked ? true : false;
        t_OfficeAutomation_Document_ContractTerms.OfficeAutomation_Document_ContractTerms_Describe = txtDescribe.Text;


        return t_OfficeAutomation_Document_ContractTerms;
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite45"] = "1";
        Response.Write("<script>window.open('Apply_ContractTerms_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("合同条款申请表.pdf"));//强制下载 
    ...
    protected void btnSaveLogisticsFlow_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_ContractTerms_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ContractTerms_ID"].ToString(); //在不同的表要注意修改
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_ContractTerms_Inherit da_OfficeAutomation_Document_ContractTerms_Inherit = new DA_OfficeAutomation_Document_ContractTerms_Inherit();
            DataSet ds = da_OfficeAutomation_Document_ContractTerms_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ContractTerms_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_ContractTerms_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_ContractTerms_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_ContractTerms_Inherit();
