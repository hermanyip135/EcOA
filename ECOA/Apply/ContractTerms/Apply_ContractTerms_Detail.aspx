<%@ Page ValidateRequest="false" Title="合同条款申请表 - 广州中原电子审批系统" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Apply_ContractTerms_Detail.aspx.cs" Inherits="Apply_ContractTerms_Apply_ContractTerms_Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
		...
		$(function() {      
		    ...
		    $("#<%=txtOSDepartment.ClientID %>").autocomplete({ 
		        source: jJSON,
		        select: function(event,ui) {
		            $("#<% =hdDepartmentID.ClientID%>").val(ui.item.id);
		        }
	    ...
	    function check() {
	        ...
	        if($.trim($("#<%=txtOSDepartment.ClientID %>").val())=="") {
	            alert("抄送部门不可为空！");
	            $("#<%=txtOSDepartment.ClientID %>").focus();
	            return false;
	        }
	        if (!$("#<%=rdbIsApproval1.ClientID %>").prop("checked") && !$("#<%=rdbIsApproval2.ClientID %>").prop("checked")) {
	            alert("请选择项目报备是否已审批！");
	            $("#<%=rdbIsApproval1.ClientID%>").focus();
	            return false;
            }
		...
		function upload() {
			...
			if(sReturnValue=='success')
				window.location='Apply_ContractTerms_Detail.aspx?MainID=<%=MainID %>';
		}

		function editflow(){
			var win=window.showModalDialog("Apply_ContractTerms_Flow.aspx?MainID=<%=MainID %>","","dialogWidth=800px;dialogHeight=320px");
					if(win=='success')
						window.location="Apply_ContractTerms_Detail.aspx?MainID=<%=MainID %>";
		}
	    ...
	    function sign(idx) {
	        //if(idx!='4'&&idx!='5'&&idx!='6'&&idx!='7'&&idx!='10'&&idx!='131'){
		...
		<div style='text-align: center'>
			...
			<table id="tbAround"  width='640px'>
                <tr>
					...
					<td class="tl PL10" ><asp:TextBox ID="txtReceiveDepartment" runat="server"></asp:TextBox></td>
				...
				<tr>
                    <td>抄送部门</td>
					<td class="tl PL10"><asp:TextBox ID="txtOSDepartment" runat="server"></asp:TextBox></td>
					<td>回复电话</td>
					<td class="tl PL10"><asp:textbox id="txtReplyPhone" runat="server"></asp:textbox></td>
				</tr>
                <tr>
                    <td>文件主题</td>
                    <td class="tl PL10">关于<asp:textbox id="txtSubject" runat="server" Width="230px"></asp:textbox><br />的申请</td>
                    <td>回复传真</td>
				...
				<tr>
                    <td colspan="4">
                        ...
                        <asp:textbox id="txtDescribe" runat="server" Width="550px" Height="400px" TextMode="MultiLine"></asp:textbox>
                    </td>
				</tr>
                <tr>
                    <td>项目报备是否已审批</td>
                    <td colspan="3" style="text-align: left; padding-left: 10px;">
                        <asp:RadioButton ID="rdbIsApproval1" runat="server" Text="是" GroupName="IsApproval" />　
                        <asp:RadioButton ID="rdbIsApproval2" runat="server" Text="否" GroupName="IsApproval" />
                    </td>
                </tr>
                ...
                <tr id="trShowFlow8">
					<td colspan="3" class="tl PL10" style=" ">
                        ...
                        <input id="rdbNoIDx8" type="radio" name="agree8" value="2" />
                        <label for="rdbNoIDx8">不同意</label>
                        <input id="rdbOtherIDx8" type="radio" name="agree8" value="3" />
                        <label for="rdbOtherIDx8">其他意见</label><br />
						<textarea id="txtIDx8" rows="5" style="width: 98%; overflow: auto;" cols="20" name="S4"></textarea>
               ...
               <%-- <tr id="trLogistics1" class="noborder" style="height: 85px;">
				...
				<tr id="trLogistics2" class="noborder" style="height: 85px;">
					...
					<td colspan="3" class="tl PL10" style=" ">
                        ...
                        <input id="rdbOtherIDx10" type="radio" name="agree10" /><label for="rdbOtherIDx10">其他意见</label><br /><br />
                ...
                <tr id="tlsc1" class="noborder" style="height: 85px; display: none;">
					<td colspan="3" class="tl PL10" style=" ">
                        ...
                        <input id="rdbOtherIDx130" type="radio" name="agree130" /><label for="rdbOtherIDx130">其他意见</label><br /><br /><br />
				...
				<tr id="trGeneralManager" class="noborder" style="height: 85px;">
					...
					<td colspan="3" class="tl PL10" style=" ">
                        ...
                        <input id="rdbOtherIDx11" type="radio" name="agree11" /><label for="rdbOtherIDx11">其他意见</label><br /><br />
