<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_SocialSecurity_Flow.aspx.cs" Inherits="Apply_SocialSecurity_Apply_SocialSecurity_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <div id="divIDx1" class='item'>隶属主管</div>
            ...
            <div id="divIDx2" class='item'>部门主管</div>
            ...
            <div id="divIDx3" class='item' style="width:140px; display: none;" >
            ...
            <div id="divTxtIDx3" class='item' style="display:none;">
                <input type="text" id="txtIDx3" style="width:200px;" />
