...
public partial class Apply_SocialSecurity_Apply_SocialSecurity_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite55"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite55"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_SocialSecurity_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_SocialSecurity_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_SocialSecurity_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_SocialSecurity_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_SocialSecurity_Department"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_SocialSecurity_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtCode.Text = dr["OfficeAutomation_Document_SocialSecurity_Code"].ToString();
        txtEnterDate.Text = dr["OfficeAutomation_Document_SocialSecurity_EnterDate"].ToString();
        txtName.Text = dr["OfficeAutomation_Document_SocialSecurity_Name"].ToString();
        txtRank.Text = dr["OfficeAutomation_Document_SocialSecurity_Rank"].ToString();
        txtPosition.Text = dr["OfficeAutomation_Document_SocialSecurity_Position"].ToString();
        ddlResults.Text = dr["OfficeAutomation_Document_SocialSecurity_Results"].ToString();
        txtDescribe.Text = dr["OfficeAutomation_Document_SocialSecurity_Describe"].ToString();
        txtMoney.Text = dr["OfficeAutomation_Document_SocialSecurity_Money"].ToString();
        txtSureTime.Text = dr["OfficeAutomation_Document_SocialSecurity_SureTime"].ToString();
        ...
        try
        {
            if ((EmployeeID == "33690" || EmployeeID == "23799" || EmployeeID == "30602" || EmployeeID == "34498")
                && dr["OfficeAutomation_Document_SocialSecurity_Results"].ToString() != "公积金免缴申请"
                && flows.OfficeAutomation_Flow_AuditorID != ""
                )
                SbJs.Append("$(\"#trCcess\").show();");
        }
        catch
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_SocialSecurity t_OfficeAutomation_Document_SocialSecurity = new T_OfficeAutomation_Document_SocialSecurity();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "SocialSecurity" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 50; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_SocialSecurity = GetModelFromPage(Guid.NewGuid());
                ...
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = ddlResults.Text;
                ...
                da_OfficeAutomation_Document_SocialSecurity_Inherit.Insert(t_OfficeAutomation_Document_SocialSecurity);//插入申请表

                //InsertSocialSecurityDetail(t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_ID);
                ...
                if (ddlResults.Text != "公积金免缴申请")
                {
                    ...
                    t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = "人力资源部";
                ...
                //RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_SocialSecurity_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                RunJS("alert('申请表现已保存成功！');var win=window.showModalDialog(\"Apply_SocialSecurity_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_SocialSecurity_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_SocialSecurity_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            ...
            //{
                ...
                if (flowIDx == "5" && txtMoney.Text.Trim() == string.Empty)
                {
                    RunJS("alert('请填写全额费用。');window.location.href='" + Request.RawUrl + "';");
                    return;
                }
                else if (flowIDx == "5")
                {
                    da_OfficeAutomation_Document_SocialSecurity_Inherit.UpdateMoney(MainID, txtMoney.Text);
                }
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_SocialSecurity_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_SocialSecurity_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>填写人：" + drRow["OfficeAutomation_Document_SocialSecurity_Apply"]);
                    sbMailBody.Append("<br/>填写日期：" + drRow["OfficeAutomation_Document_SocialSecurity_ApplyDate"]);
                    sbMailBody.Append("<br/>现任职部门：" + DateTime.Parse(drRow["OfficeAutomation_Document_SocialSecurity_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>发文编号：" + drRow["OfficeAutomation_Document_SocialSecurity_ApplyID"]);
                    sbMailBody.Append("<br/>姓名：" + drRow["OfficeAutomation_Document_SocialSecurity_Name"]);
                    sbMailBody.Append("<br/>工号：" + drRow["OfficeAutomation_Document_SocialSecurity_Code"]);
                    sbMailBody.Append("<br/>入职日期：" + drRow["OfficeAutomation_Document_SocialSecurity_EnterDate"]);
                    sbMailBody.Append("<br/>现职位：" + drRow["OfficeAutomation_Document_SocialSecurity_Position"]);
                    sbMailBody.Append("<br/>现职级：" + drRow["OfficeAutomation_Document_SocialSecurity_Rank"]);
                    sbMailBody.Append("<br/>申请类型：" + drRow["OfficeAutomation_Document_SocialSecurity_Results"]);
                    sbMailBody.Append("<br/>申请内容：" + drRow["OfficeAutomation_Document_SocialSecurity_Describe"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_SocialSecurity_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private T_OfficeAutomation_Document_SocialSecurity GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_SocialSecurity t_OfficeAutomation_Document_SocialSecurity = new T_OfficeAutomation_Document_SocialSecurity();
        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_ID = UndertakeProjID;
        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_Apply = EmployeeName;
        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_Department = txtDepartment.Text;
        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_Code = txtCode.Text;
        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_EnterDate = txtEnterDate.Text;

        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_Name = txtName.Text;
        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_Rank = txtRank.Text;
        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_Position = txtPosition.Text;
        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_Results = ddlResults.Text;
        t_OfficeAutomation_Document_SocialSecurity.OfficeAutomation_Document_SocialSecurity_Describe = txtDescribe.Text;

        return t_OfficeAutomation_Document_SocialSecurity;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_SocialSecurity_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_SocialSecurity_ID"].ToString();

        t_OfficeAutomation_Document_SocialSecurity = GetModelFromPage(new Guid(ID));

        string apply = EmployeeName;
        string depname = txtDepartment.Text;
        string summary = ddlResults.Text;
        string applydate = "";
        string mainid = MainID;

        da_OfficeAutomation_Main_Inherit.UpdateMain(mainid, depname, apply, applydate, summary);
        da_OfficeAutomation_Document_SocialSecurity_Inherit.Update(t_OfficeAutomation_Document_SocialSecurity);//修改申请表

        //DA_OfficeAutomation_Document_SocialSecurity_Detail_Inherit da_OfficeAutomation_Document_SocialSecurity_Detail_Inherit = new DA_OfficeAutomation_Document_SocialSecurity_Detail_Inherit();
        //da_OfficeAutomation_Document_SocialSecurity_Detail_Inherit.Delete(ID);
        //InsertSocialSecurityDetail(new Guid(ID));
        T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        T_OfficeAutomation_Flow flows;
        flows = da_OfficeAutomation_Flow_Inherit.SelectByMainIDAndIdx(MainID, 8);
        ...
        else if (flows != null && ddlResults.Text == "公积金免缴申请")
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite55"] = "1";
        Response.Write("<script>window.open('Apply_SocialSecurity_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("社保公积金特殊缴纳申请表.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_SocialSecurity_Inherit da_OfficeAutomation_Document_SocialSecurity_Inherit = new DA_OfficeAutomation_Document_SocialSecurity_Inherit();
            DataSet ds = da_OfficeAutomation_Document_SocialSecurity_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_SocialSecurity_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_SocialSecurity_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    protected void btnSureS_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
            DA_OfficeAutomation_Document_SocialSecurity_Inherit da_OfficeAutomation_Document_SocialSecurity_Inherit = new DA_OfficeAutomation_Document_SocialSecurity_Inherit();
            ds = da_OfficeAutomation_Document_SocialSecurity_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_SocialSecurity_Apply"].ToString();
            string applyUrl = Page.Request.Url.ToString();
            applyUrl = applyUrl.Substring(applyUrl.IndexOf("/Apply/"));
            ...
            if (txtSureTime.Text.Trim() == string.Empty)
            {
                RunJS("alert('请填确认时间。');window.location.href='" + Request.RawUrl + "';");
                return;
            }
            else
            {
                da_OfficeAutomation_Document_SocialSecurity_Inherit.UpdateSureTime(MainID, txtSureTime.Text);
            }

            //通知申请人
            msnBody = "您好" + apply + "，" + EmployeeName + "确认了您的社保公积金全额费用已以现金形式上交给财务部。<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
            Common.SendMessageEX(false, apply, EmployeeName + "费用缴交已确认" + documentName, msnBody, msnBody);
            ...
            //da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);
            da_OfficeAutomation_Flow_Inherit.SetNullByMainIDAndIdxs(MainID, 8);
            da_OfficeAutomation_Flow_Inherit.UpdateContainIsAgreeForSign(MainID, EmployeeID, "人力资源部", apply + "已于" + txtSureTime .Text+ "将全额费用以现金形式上交给财务部", "8", "1");
            //da_OfficeAutomation_Main_Inherit.UpdateFlowForCancel(MainID);
            RunJS("alert('操作成功，稍后系统会通知申请人。');window.location.href='" + Page.Request.Url + "';");
        }
        catch (Exception ee)
        {
            RunJS("alert('操作失败，" + ee.Message + "');window.location.href='" + Page.Request.Url + "';");
        }
    }
}