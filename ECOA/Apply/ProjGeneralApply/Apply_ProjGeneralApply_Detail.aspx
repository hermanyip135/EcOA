<%@ Page ValidateRequest="false" Title="项目部通用申请表 - 广州中原电子审批系统" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Apply_ProjGeneralApply_Detail.aspx.cs" Inherits="Apply_ProjGeneralApply_Apply_ProjGeneralApply_Detail" %>
        ...
        function checkChecked() {
            ...
            function upload() {
                ...
                if(sReturnValue=='success')
                    window.location='Apply_ProjGeneralApply_Detail.aspx?MainID=<%=MainID %>';
                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style='text-align: center; width: 840px; margin: 0 auto;'>
        ...
        <div style='text-align: center'>
            <h1>广东中原地产代理有限公司</h1>
          <%--  <h1>项目部通用申请表</h1>--%>
            <span style="font-size:20px; font-weight:bold">项目部通用申请表</span><label id="laIsGroups" runat="server" style="color:red; font-size:15px;"></label>
            ...
            <table id="tbAround" width='640px'>
                ...
                <tr id="trcansee">
                    ...
                    <td class="tl PL10" colspan="3">
                        <asp:TextBox ID="txtCanSeeEmp" runat="server" Width="300"></asp:TextBox>
                        <span style="margin-left:15px;"><asp:Button ID="btnSaveCanSeeEmp" runat="server" Text="保存查阅人" Visible="false" OnClientClick="return CheckCanseeEmp()" OnClick="saveCanSeeEmp_Click"/></span>
                    </td>
                    <asp:HiddenField id="hdCanSeeEmpCode" runat="server"/><asp:HiddenField id="hdGroupName" runat="server"/>
                </tr>
