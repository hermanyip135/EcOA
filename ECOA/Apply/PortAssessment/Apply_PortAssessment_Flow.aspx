<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_PortAssessment_Flow.aspx.cs" Inherits="Apply_PortAssessment_Apply_PortAssessment_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <div id="divIDx1" class='item'>拓展跟进人</div>
            ...
            <div id="divIDx2" class='item'>拓展主管</div>
