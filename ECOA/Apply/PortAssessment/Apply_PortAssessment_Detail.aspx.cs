...
public partial class Apply_PortAssessment_Apply_PortAssessment_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    public string ApplyDisplayPart = "$(\"#btnAddRow\").show();$(\"#btnDeleteRow\").show();$(\"#divUploadMenber\").show();";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite56"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite56"] = null;
                }
            }
            catch
            {
    ...
    public void NewPage()
    {
        ...
        SbJs.Append("</script>");
        IsNewApply = true;
        DA_Employee_Inherit da_Employee_Inherit = new DataAccess.Operate.DA_Employee_Inherit();
        DataSet ds = da_Employee_Inherit.GetEmployeeInfoByEmployeeID(EmployeeID);
    ...
    public void LoadPage()
    {
        ...
        DA_OfficeAutomation_Document_PortAssessment_Menber_Inherit da_OfficeAutomation_Document_PortAssessment_Menber_Inherit = new DataAccess.Operate.DA_OfficeAutomation_Document_PortAssessment_Menber_Inherit();
        ...
        ds = da_OfficeAutomation_Document_PortAssessment_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_PortAssessment_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_PortAssessment_Apply"].ToString();
        ApplyN = applicant;
        txtDepartment.Text = dr["OfficeAutomation_Document_PortAssessment_Department"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_PortAssessment_ApplyDate"].ToString()).ToString("yyyy-MM-dd");

        SerialNumber = dr["OfficeAutomation_SerialNumber"].ToString();

        ds = da_OfficeAutomation_Document_PortAssessment_Menber_Inherit.SelectByID(ID);
        int detailCount = ds.Tables[0].Rows.Count;
        if (detailCount == 0)
            DrawMenberTable(0);
        else
        {
            DrawMenberTable(detailCount);
            ...
            for (int n = 0; n < detailCount; n++)
            {
                ...
                SbJs.Append("$('#txtMenber_GridAx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridAx"] + "');");
                SbJs.Append("$('#txtMenber_GridBx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridBx"] + "');");
                SbJs.Append("$('#txtMenber_GridCx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridCx"] + "');");
                SbJs.Append("$('#txtMenber_GridDx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridDx"] + "');");
                SbJs.Append("$('#txtMenber_GridEx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridEx"] + "');");
                SbJs.Append("$('#txtMenber_GridFx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridFx"] + "');");
                SbJs.Append("$('#txtMenber_GridGx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridGx"] + "');");
                SbJs.Append("$('#txtMenber_GridHx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridHx"] + "');");
                SbJs.Append("$('#txtMenber_GridIx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridIx"] + "');");
                SbJs.Append("$('#txtMenber_GridJx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridJx"] + "');");
                SbJs.Append("$('#txtMenber_GridKx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridKx"] + "');");
                SbJs.Append("$('#txtMenber_GridLx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridLx"] + "');");
                SbJs.Append("$('#txtMenber_GridMx" + i + "').val('" + dr["OfficeAutomation_Document_PortAssessment_Menber_GridMx"] + "');");
            }
        }
        ...
        try
        {
            if (ViewState["FLG_ReWrite"].ToString() == "1")
            {
                ...
                IsNewApply = true;
                DA_Employee_Inherit da_Employee_Inherit = new DataAccess.Operate.DA_Employee_Inherit();
                DataSet dst = da_Employee_Inherit.GetEmployeeInfoByEmployeeID(EmployeeID);
                txtDepartment.Text = dst.Tables[0].Rows[0]["DepartmentName"].ToString();
                MainID = Guid.NewGuid().ToString();
                return;
            }
        }
    ...
    public void DrawMenberTable(int n)
    {
        ...
        for (int i = 1; i <= n; i++)
        {
            ...
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridAx" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridBx" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridCx" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridDx" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridEx" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridFx" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridGx" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridHx" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridIx" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridJx" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridKx" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridLx" + i + "\" style=\"width:50px\"/></td>");
            SbHtml.Append("<td><input type=\"text\" id=\"txtMenber_GridMx" + i + "\" style=\"width:50px\"/></td>");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_PortAssessment t_OfficeAutomation_Document_PortAssessment = new T_OfficeAutomation_Document_PortAssessment();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "PortAssessment" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 51; //在《申请表字典表》找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_PortAssessment = GetModelFromPage(Guid.NewGuid());
                da_OfficeAutomation_Document_PortAssessment_Inherit.Insert(t_OfficeAutomation_Document_PortAssessment);//插入申请表

                InsertPortAssessmentDetail(t_OfficeAutomation_Document_PortAssessment.OfficeAutomation_Document_PortAssessment_ID); //新增详情表
                ...
                Common.AddLog(EmployeeID, EmployeeName, 55, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_PortAssessment_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=340px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        if (files.Count > 0)
        {
            ...
            Common.AddLog(EmployeeID, EmployeeName, 55, new Guid(MainID), 8);
        }
        else
            Alert("请勾选文件再下载！");
    }
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DA_OfficeAutomation_Document_PortAssessment_Inherit da_OfficeAutomation_Document_PortAssessment_Inherit = new DA_OfficeAutomation_Document_PortAssessment_Inherit();
        DA_OfficeAutomation_Document_PortAssessment_Menber_Inherit da_OfficeAutomation_Document_PortAssessment_Menber_Inherit = new DA_OfficeAutomation_Document_PortAssessment_Menber_Inherit();

        DataSet ds = da_OfficeAutomation_Document_PortAssessment_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_PortAssessment_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_PortAssessment_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_PortAssessment_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>填写人：" + drRow["OfficeAutomation_Document_PortAssessment_Apply"]);
                    sbMailBody.Append("<br/>发文部门：" + drRow["OfficeAutomation_Document_PortAssessment_Department"]);
                    sbMailBody.Append("<br/>填写日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_PortAssessment_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_PortAssessment_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private T_OfficeAutomation_Document_PortAssessment GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_PortAssessment t_OfficeAutomation_Document_PortAssessment = new T_OfficeAutomation_Document_PortAssessment();
        t_OfficeAutomation_Document_PortAssessment.OfficeAutomation_Document_PortAssessment_ID = UndertakeProjID;
        t_OfficeAutomation_Document_PortAssessment.OfficeAutomation_Document_PortAssessment_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_PortAssessment.OfficeAutomation_Document_PortAssessment_Apply = EmployeeName;
        t_OfficeAutomation_Document_PortAssessment.OfficeAutomation_Document_PortAssessment_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_PortAssessment.OfficeAutomation_Document_PortAssessment_ApplyID = "";
        t_OfficeAutomation_Document_PortAssessment.OfficeAutomation_Document_PortAssessment_Department = txtDepartment.Text;

        return t_OfficeAutomation_Document_PortAssessment;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_PortAssessment_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_PortAssessment_ID"].ToString();

        t_OfficeAutomation_Document_PortAssessment = GetModelFromPage(new Guid(ID));
        da_OfficeAutomation_Document_PortAssessment_Inherit.Update(t_OfficeAutomation_Document_PortAssessment); //修改申请表

        //先删除后增加详情表
        DA_OfficeAutomation_Document_PortAssessment_Menber_Inherit da_OfficeAutomation_Document_PortAssessment_Menber_Inherit = new DA_OfficeAutomation_Document_PortAssessment_Menber_Inherit();
        da_OfficeAutomation_Document_PortAssessment_Menber_Inherit.Delete(ID);
        InsertPortAssessmentDetail(new Guid(ID));

        Common.AddLog(EmployeeID, EmployeeName, 55, new Guid(MainID), 2); //日志，修改申请表
    }
    ...
    /// 新增详情表
    /// </summary>
    /// <param name="gPortAssessmentID"></param>
    private void InsertPortAssessmentDetail(Guid gPortAssessmentID)
    {
        if (hdDetail.Value == "")
            return;

        T_OfficeAutomation_Document_PortAssessment_Menber t_OfficeAutomation_Document_PortAssessment_Menber;
        DA_OfficeAutomation_Document_PortAssessment_Menber_Inherit da_OfficeAutomation_Document_PortAssessment_Menber_Inherit = new DA_OfficeAutomation_Document_PortAssessment_Menber_Inherit();
        ...
        try
        {
            for (int i = 0; i < details.Length; i++)
            {
                ...
                if (detail[0] == "")
                    continue;
                t_OfficeAutomation_Document_PortAssessment_Menber = new T_OfficeAutomation_Document_PortAssessment_Menber();
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_MainID = gPortAssessmentID;
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridAx = detail[0];
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridBx = detail[1];
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridCx = detail[2];
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridDx = detail[3];
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridEx = detail[4];
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridFx = detail[5];
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridGx = detail[6];
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridHx = detail[7];
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridIx = detail[8];
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridJx = detail[9];
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridKx = detail[10];
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridLx = detail[11];
                t_OfficeAutomation_Document_PortAssessment_Menber.OfficeAutomation_Document_PortAssessment_Menber_GridMx = detail[12];

                da_OfficeAutomation_Document_PortAssessment_Menber_Inherit.Insert(t_OfficeAutomation_Document_PortAssessment_Menber);
            }
        }
        catch(Exception ee)
        {
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite56"] = "1";
        Response.Write("<script>window.open('Apply_PortAssessment_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    #region 自动导入详情表
    /// <summary>
    /// 自动导入详情表
    /// </summary>
    protected void btnUploadMenber_Click(object sender, EventArgs e)
    {
        SbJs.Append("<script type=\"text/javascript\">" + ApplyDisplayPart);

        string path = hdFilePathMenber.Value;
        if (path != "")
        {
            ...
            System.Data.OleDb.OleDbDataAdapter ImportCommand = new System.Data.OleDb.OleDbDataAdapter("select * from [Sheet1$]", ImportConnection);
            DataSet ds = new DataSet();
            int i = 0;
            try
            {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                try
                {
                    ...
                    {
                        success++;
                        SbJs.Append("$('#txtMenber_GridAx" + success + "').val('" + ds.Tables[0].Rows[i]["区域"].ToString().Trim() + "');");
                        SbJs.Append("$('#txtMenber_GridBx" + success + "').val('" + ds.Tables[0].Rows[i]["所属总监"].ToString().Trim() + "');");
                        SbJs.Append("$('#txtMenber_GridCx" + success + "').val('" + ds.Tables[0].Rows[i]["所属区经"].ToString().Trim() + "');");
                        SbJs.Append("$('#txtMenber_GridDx" + success + "').val('" + ds.Tables[0].Rows[i]["姓名"].ToString().Trim() + "');");
                        SbJs.Append("$('#txtMenber_GridEx" + success + "').val('" + ds.Tables[0].Rows[i]["工号"].ToString().Trim() + "');");
                        SbJs.Append("$('#txtMenber_GridFx" + success + "').val('" + ds.Tables[0].Rows[i]["手机号"].ToString().Trim() + "');");
                        SbJs.Append("$('#txtMenber_GridGx" + success + "').val('" + ds.Tables[0].Rows[i]["门店名称(组别）"].ToString().Trim() + "');");
                        SbJs.Append("$('#txtMenber_GridHx" + success + "').val('" + ds.Tables[0].Rows[i]["发布优质房源数量"].ToString().Trim() + "');");
                        SbJs.Append("$('#txtMenber_GridIx" + success + "').val('" + ds.Tables[0].Rows[i]["新增优质房源数量"].ToString().Trim() + "');");
                        SbJs.Append("$('#txtMenber_GridJx" + success + "').val('" + ds.Tables[0].Rows[i]["房源点击量"].ToString().Trim() + "');");
                        SbJs.Append("$('#txtMenber_GridKx" + success + "').val('" + DateTime.Parse(ds.Tables[0].Rows[i]["首次开通日期"].ToString()).ToString("yyyy-MM-dd") + "');");
                        SbJs.Append("$('#txtMenber_GridLx" + success + "').val('" + ds.Tables[0].Rows[i]["套餐类型"].ToString().Trim() + "');");
                        SbJs.Append("$('#txtMenber_GridMx" + success + "').val('" + ds.Tables[0].Rows[i]["安居客使用考核"].ToString().Trim() + "');");
                    }

                    DrawMenberTable(success);
                }
    ...
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("网络端口考核数据确认表.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_PortAssessment_Inherit da_OfficeAutomation_Document_PortAssessment_Inherit = new DA_OfficeAutomation_Document_PortAssessment_Inherit();
            DataSet ds = da_OfficeAutomation_Document_PortAssessment_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_PortAssessment_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_PortAssessment_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=340px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
