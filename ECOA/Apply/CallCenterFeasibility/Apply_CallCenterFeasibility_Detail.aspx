<%@ Page Title="新建呼叫中心可行性报告 - 广州中原电子审批系统" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Apply_CallCenterFeasibility_Detail.aspx.cs" Inherits="Apply_CallCenterFeasibility_Apply_CallCenterFeasibility_Detail" %>
                    ...
                    <table id="tbAround" width='700px'>
                        ...
                        <tr>
                            <td colspan="4" class="tl PL10">
                                ...
                                <span>1．上年度（<asp:Label ID="lblLastYear" runat="server" Text=""></asp:Label>年）的区域负责人、总监、区经的累计业绩、利润数据</span>
