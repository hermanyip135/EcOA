...
public partial class Apply_CommissionOfMonth_Apply_CommissionOfMonth_Detail : BasePage
{
    ...
    public void LoadPage()
    {
        ...
        if (EmployeeID == "43781" || EmployeeID == "3575" || EmployeeID == "34498")
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (IsNewApply)
        {
            ...
            //RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_CommissionOfMonth_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
            RunJS("alert('申请表现已保存成功！');var win=window.showModalDialog(\"Apply_CommissionOfMonth_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
            #endregion
        }
        else
        {
