...
public partial class Apply_Budgetab_Apply_Budgetab_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    public StringBuilder SbHtml0 = new StringBuilder(); //M_Detail：20151030
    ...
    public string DisplayPart = "$(\"[id^=btnAddRow]\").show();$(\"[id^=btnDeleteRow]\").show();";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite61"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite61"] = null;
                }
            }
            catch
            {
    ...
    public void NewPage()
    {
        ...
        //lbData.Text = txtApplyDate.Text;
        SbJs.Append("<script type=\"text/javascript\">" + DisplayPart);
        DrawDetailTable0(1); //M_Detail：20151030
        DrawDetailTable1(1);
        DrawDetailTable2(1);
        DrawDetailTable3(1);
        DrawDetailTable4(1);
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_Budgetab_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_Budgetab_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_Budgetab_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_Budgetab_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_Budgetab_Department"].ToString();
        txtApply.Text = applicant;
        txtApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_Budgetab_ApplyDate"].ToString()).ToString("yyyy-MM-dd");

        txtPhone.Text = dr["OfficeAutomation_Document_Budgetab_Phone"].ToString();

        string cbt = dr["OfficeAutomation_Document_Budgetab_AProject"].ToString();
        if (cbt.Contains("1"))
            cbAProject1.Checked = true;
        if (cbt.Contains("2"))
            cbAProject2.Checked = true;
        if (cbt.Contains("3"))
            cbAProject3.Checked = true;
        if (cbt.Contains("4"))
            cbAProject4.Checked = true;
        if (cbt.Contains("5"))
            cbAProject5.Checked = true;
        if (cbt.Contains("6"))
            cbAProject6.Checked = true;
        if (cbt.Contains("7"))
            cbAProject7.Checked = true;
        //if (cbAProject1.Checked == true)
        //{
        //    txtAkind.Text = dr["OfficeAutomation_Document_Budgetab_Akind"].ToString();
        //    txtAitem.Text = dr["OfficeAutomation_Document_Budgetab_Aitem"].ToString();
        //    txtAdjustableKind.Text = dr["OfficeAutomation_Document_Budgetab_AdjustableKind"].ToString();
        //    txtAdjustableItem.Text = dr["OfficeAutomation_Document_Budgetab_AdjustableItem"].ToString();
        //    txtPrice.Text = dr["OfficeAutomation_Document_Budgetab_Price"].ToString();
        //}
        hdDetail0.Value = dr["OfficeAutomation_Document_Budgetab_Akind"].ToString(); //M_Detail：20151030
        if (cbAProject3.Checked == true)
        {
            hdDetail1.Value = dr["OfficeAutomation_Document_Budgetab_AdvertisingItem"].ToString();
            //txtAdvertisingItem.Text = dr["OfficeAutomation_Document_Budgetab_AdvertisingItem"].ToString();
            //txtAdvertisingPrice.Text = dr["OfficeAutomation_Document_Budgetab_AdvertisingPrice"].ToString();
        }
        if (cbAProject4.Checked == true)
        {
            hdDetail2.Value = dr["OfficeAutomation_Document_Budgetab_PrintingItem"].ToString();
            //txtPrintingPrice.Text = dr["OfficeAutomation_Document_Budgetab_PrintingPrice"].ToString();
        }
        if (cbAProject5.Checked == true)
        {
            hdDetail3.Value = dr["OfficeAutomation_Document_Budgetab_MaterialItem"].ToString();
            //txtMaterialPrice.Text = dr["OfficeAutomation_Document_Budgetab_MaterialPrice"].ToString();
        }
        if (cbAProject6.Checked == true)
        {
            hdDetail4.Value = dr["OfficeAutomation_Document_Budgetab_ActivityItem"].ToString();
            //txtActivityPrice.Text = dr["OfficeAutomation_Document_Budgetab_ActivityPrice"].ToString();
        }
        if (cbAProject7.Checked == true)
        {
            hdDetail5.Value = dr["OfficeAutomation_Document_Budgetab_AnotherItem"].ToString();
            //txtAnotherPrice.Text = dr["OfficeAutomation_Document_Budgetab_AnotherPrice"].ToString();
        }
        txtReason.Text = dr["OfficeAutomation_Document_Budgetab_Reason"].ToString();
        if (dr["OfficeAutomation_Document_Budgetab_Statement"].ToString().Contains("1"))
            rdbStatement1.Checked = true;
        if (dr["OfficeAutomation_Document_Budgetab_Statement"].ToString().Contains("2"))
            rdbStatement2.Checked = true;

        SerialNumber = dr["OfficeAutomation_SerialNumber"].ToString();

        try
        {
            string[] details0 = Regex.Split(this.hdDetail0.Value, "\\|\\|"); //M_Detail：20151030
            int c0 = details0.Length;
            DrawDetailTable0(c0);
            for (int i = 0; i < c0; i++)
            {
                string[] detail = Regex.Split(details0[i], "\\&\\&");

                int n = i + 1;
                SbJs.Append("$('#txtAkind" + n + "').val('" + detail[0] + "');");
                SbJs.Append("$('#txtAitem" + n + "').val('" + detail[1] + "');");
                SbJs.Append("$('#txtAdjustableKind" + n + "').val('" + detail[2] + "');");
                SbJs.Append("$('#txtAdjustableItem" + n + "').val('" + detail[3] + "');");
                SbJs.Append("$('#txtPrice" + n + "').val('" + detail[4] + "');");
            }
        }
        catch
        {
        ...
        try
        {
            string[] details1 = Regex.Split(this.hdDetail1.Value, "\\|\\|");
            int c1 = details1.Length;
            DrawDetailTable1(c1);
            for (int i = 0; i < c1; i++)
            {
                string[] detail = Regex.Split(details1[i], "\\&\\&");

                int n = i + 1;
                SbJs.Append("$('#txtAdvertisingItem" + n + "').val('" + detail[0] + "');");
                SbJs.Append("$('#txtAdvertisingPrice" + n + "').val('" + detail[1] + "');");
            }
        }
        catch
        {
        ...
        try
        {
            string[] details2 = Regex.Split(this.hdDetail2.Value, "\\|\\|");
            int c2 = details2.Length;
            DrawDetailTable2(c2);
            for (int i = 0; i < c2; i++)
            {
                string[] detail = Regex.Split(details2[i], "\\&\\&");

                int n = i + 1;
                SbJs.Append("$('#txtPrintingItem" + n + "').val('" + detail[0] + "');");
                SbJs.Append("$('#txtPrintingPrice" + n + "').val('" + detail[1] + "');");
            }
        }
        catch
        {
        ...
        try
        {
            string[] details3 = Regex.Split(this.hdDetail3.Value, "\\|\\|");
            int c3 = details3.Length;
            DrawDetailTable3(c3);
            for (int i = 0; i < c3; i++)
            {
                string[] detail = Regex.Split(details3[i], "\\&\\&");

                int n = i + 1;
                SbJs.Append("$('#txtMaterialItem" + n + "').val('" + detail[0] + "');");
                SbJs.Append("$('#txtMaterialPrice" + n + "').val('" + detail[1] + "');");
            }
        }
        catch
        {
        ...
        try
        {
            string[] details4 = Regex.Split(this.hdDetail4.Value, "\\|\\|");
            int c4 = details4.Length;
            DrawDetailTable4(c4);
            for (int i = 0; i < c4; i++)
            {
                string[] detail = Regex.Split(details4[i], "\\&\\&");

                int n = i + 1;
                SbJs.Append("$('#txtActivityItem" + n + "').val('" + detail[0] + "');");
                SbJs.Append("$('#txtActivityPrice" + n + "').val('" + detail[1] + "');");
            }
        }
        catch
        {
        ...
        try
        {
            string[] details5 = Regex.Split(this.hdDetail5.Value, "\\|\\|");
            int c5 = details5.Length;
            DrawDetailTable5(c5);
            for (int i = 0; i < c5; i++)
            {
                string[] detail = Regex.Split(details5[i], "\\&\\&");

                int n = i + 1;
                SbJs.Append("$('#txtAnotherItem" + n + "').val('" + detail[0] + "');");
                SbJs.Append("$('#txtAnotherPrice" + n + "').val('" + detail[1] + "');");
            }
        }
        catch
        {
        ...
        if (isApplicant)
        {
            SbJs.Append("$(\"#btnUpload\").show();" + DisplayPart); //M_Detail：20151030
            if (flowState == "1")
            {
                GetAllDepartment();
                btnSave.Visible = true;
        ...
        for (int i = 0; i < drc.Count; i++)
        {
            ...
            if (drc[i]["OfficeAutomation_Flow_Audit"].ToString() == "True")
            {
                ...
                else if (drc[i]["OfficeAutomation_Flow_IsAgree"].ToString() == "12")
                    SbJs.Append("$('#rdbYesIDx" + drc[i]["OfficeAutomation_Flow_IDx"] + "').attr('checked','checked');$('#rdbOtherIDx" + drc[i]["OfficeAutomation_Flow_IDx"] + "').attr('checked','checked');");
                else
            ...
            else
            {
                ...
                if (flag && da_OfficeAutomation_Agent_Inherit.IsHaveSignPower(drc[i]["OfficeAutomation_Flow_Employee"].ToString(), drc[i]["OfficeAutomation_Flow_EmployeeID"].ToString(),
                    ...
                    SbJs.Append("$('#btnSignIDx" + drc[i]["OfficeAutomation_Flow_IDx"] + "').show();$('#ctl00_ContentPlaceHolder1_lbtAddMaster" + drc[i]["OfficeAutomation_Flow_IDx"] + "').show();");
            ...
            var flows = da_OfficeAutomation_Flow_Inherit.SelectByMainIDAndIdx(MainID, 7);
            if (flows != null)
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_Budgetab t_OfficeAutomation_Document_Budgetab = new T_OfficeAutomation_Document_Budgetab();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "Budgetab" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 56; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_Budgetab = GetModelFromPage(Guid.NewGuid());
                ...
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = txtPhone.Text;
                ...
                da_OfficeAutomation_Document_Budgetab_Inherit.Insert(t_OfficeAutomation_Document_Budgetab);//插入申请表

                //InsertBudgetabDetail(t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_ID);
                ...
                Common.AddLog(EmployeeID, EmployeeName, 60, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                if (txtDepartment.Text == "市场部")
                {
                    RunJS("var sReturnValue= window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");window.location='/Apply/Apply_Search.aspx';");
                }
                else 
                {
                    RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_Budgetab_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                }
                #endregion
            }
            else
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_Budgetab_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_Budgetab_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Budgetab_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_Budgetab_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_Budgetab_Apply"]);
                    sbMailBody.Append("<br/>发文部门：" + drRow["OfficeAutomation_Document_Budgetab_Department"]);
                    sbMailBody.Append("<br/>申请日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_Budgetab_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>发文编号：" + drRow["OfficeAutomation_Document_Budgetab_ApplyID"]);
                    sbMailBody.Append("<br/>联系电话/传真：" + drRow["OfficeAutomation_Document_Budgetab_Phone"]);
                    sbMailBody.Append("<br/>申请原由：" + drRow["OfficeAutomation_Document_Budgetab_Reason"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_Budgetab_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    #region 添加首席运营官审批流
    protected void lbtAddMaster_Click(object sender, EventArgs e)
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
        ...
        if (flows == null)
        {
            ...
            da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);
            RunJS("alert('首席运营官的审批流程已添加');window.location.href='" + Page.Request.Url + "';");
        }
        else
        {
            RunJS("alert('首席运营官的审批流程已存在');window.location.href='" + Page.Request.Url + "';");
        }
    ...
    public void DrawDetailTable0(int n1) //M_Detail：20151030
    {
        for (int i = 1; i <= n1; i++)
        {
            SbHtml0.Append("<tr id='trDetail0" + i + "' class=\"addTb\">");
            SbHtml0.Append("     <td class=\"addTb\">由：<input type=\"text\" id=\"txtAkind" + i + "\" style=\"width:95px\"/>类");
            SbHtml0.Append("     <input type=\"text\" id=\"txtAitem" + i + "\" style=\"width:95px\"/>项预算调至：");
            SbHtml0.Append("     <input type=\"text\" id=\"txtAdjustableKind" + i + "\" style=\"width:95px\"/>类");
            SbHtml0.Append("     <input type=\"text\" id=\"txtAdjustableItem" + i + "\" style=\"width:95px\"/>项，金额为");
            SbHtml0.Append("     <input type=\"text\" id=\"txtPrice" + i + "\" style=\"width:95px\"/></td>");
            SbHtml0.Append("</tr>");
        }
        SbJs.Append("i0=" + n1 + ";");
    }

    public void DrawDetailTable1(int n1)
    {
        for (int i = 1; i <= n1; i++)
        {
            SbHtml1.Append("<tr id='trDetail1" + i + "' class=\"addTb\">");
            SbHtml1.Append("     <td class=\"addTb\"><input type=\"text\" id=\"txtAdvertisingItem" + i + "\" />项；金额为￥ ");
            SbHtml1.Append("     <input type=\"text\" id=\"txtAdvertisingPrice" + i + "\" />元。</td>");
            SbHtml1.Append("</tr>");
        }
        SbJs.Append("i1=" + n1 + ";");
    }

    public void DrawDetailTable2(int n2)
    {
        for (int i = 1; i <= n2; i++)
        {
            SbHtml2.Append("<tr id='trDetail2" + i + "' class=\"addTb\">");
            SbHtml2.Append("     <td class=\"addTb\"><input type=\"text\" id=\"txtPrintingItem" + i + "\" />项；金额为￥ ");
            SbHtml2.Append("     <input type=\"text\" id=\"txtPrintingPrice" + i + "\" />元。</td>");
            SbHtml2.Append("</tr>");
        }
        SbJs.Append("i2=" + n2 + ";");
    }
    public void DrawDetailTable3(int n3)
    {
        for (int i = 1; i <= n3; i++)
        {
            SbHtml3.Append("<tr id='trDetail3" + i + "' class=\"addTb\">");
            SbHtml3.Append("     <td class=\"addTb\"><input type=\"text\" id=\"txtMaterialItem" + i + "\" />项；金额为￥ ");
            SbHtml3.Append("     <input type=\"text\" id=\"txtMaterialPrice" + i + "\" />元。</td>");
            SbHtml3.Append("</tr>");
        }
        SbJs.Append("i3=" + n3 + ";");
    }
    public void DrawDetailTable4(int n4)
    {
        for (int i = 1; i <= n4; i++)
        {
            SbHtml4.Append("<tr id='trDetail4" + i + "' class=\"addTb\">");
            SbHtml4.Append("     <td class=\"addTb\"><input type=\"text\" id=\"txtActivityItem" + i + "\" />项；金额为￥ ");
            SbHtml4.Append("     <input type=\"text\" id=\"txtActivityPrice" + i + "\" />元。</td>");
            SbHtml4.Append("</tr>");
        }
        SbJs.Append("i4=" + n4 + ";");
    }
    public void DrawDetailTable5(int n5)
    {
        for (int i = 1; i <= n5; i++)
        {
            SbHtml5.Append("<tr id='trDetail5" + i + "' class=\"addTb\">");
            SbHtml5.Append("     <td class=\"addTb\"><input type=\"text\" id=\"txtAnotherItem" + i + "\" />项；金额为￥ ");
            SbHtml5.Append("     <input type=\"text\" id=\"txtAnotherPrice" + i + "\" />元。</td>");
            SbHtml5.Append("</tr>");
        }
        SbJs.Append("i5=" + n5 + ";");
    }
    ...
    private T_OfficeAutomation_Document_Budgetab GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_Budgetab t_OfficeAutomation_Document_Budgetab = new T_OfficeAutomation_Document_Budgetab();
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_ID = UndertakeProjID;
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_Apply = txtApply.Text;
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_Department = txtDepartment.Text;
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_Phone = txtPhone.Text;

        string cbt = null;
        if (cbAProject1.Checked == true)
            cbt = "|1";
        if (cbAProject2.Checked == true)
            cbt += "|2";
        if (cbAProject3.Checked == true)
            cbt += "|3";
        if (cbAProject4.Checked == true)
        ...
        if (cbAProject7.Checked == true)
            cbt += "|7";
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_AProject = cbt;

        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_Akind = hdDetail0.Value; //M_Detail：20151030
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_Aitem = "";
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_AdjustableKind = "";
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_AdjustableItem = "";
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_Price = "";
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_AdvertisingItem = hdDetail1.Value;
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_AdvertisingPrice = "";
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_PrintingItem = hdDetail2.Value;
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_PrintingPrice = "";
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_MaterialItem = hdDetail3.Value;
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_MaterialPrice = "";
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_ActivityItem = hdDetail4.Value;
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_ActivityPrice = "";
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_AnotherItem = hdDetail5.Value;
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_AnotherPrice = "";
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_Reason = txtReason.Text;

        string cz = null;
        if (rdbStatement1.Checked == true)
            cz = "|1";
        if (rdbStatement2.Checked == true)
            cz += "|2";
        t_OfficeAutomation_Document_Budgetab.OfficeAutomation_Document_Budgetab_Statement = cz;

        return t_OfficeAutomation_Document_Budgetab;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_Budgetab_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Budgetab_ID"].ToString();

        t_OfficeAutomation_Document_Budgetab = GetModelFromPage(new Guid(ID));

        string apply = EmployeeName;
        string depname = txtDepartment.Text;
        string summary = txtPhone.Text;
        string applydate = "";
        string mainid = MainID;

        da_OfficeAutomation_Main_Inherit.UpdateMain(mainid, depname, apply, applydate, summary);
        da_OfficeAutomation_Document_Budgetab_Inherit.Update(t_OfficeAutomation_Document_Budgetab);//修改申请表

        //DA_OfficeAutomation_Document_Budgetab_Detail_Inherit da_OfficeAutomation_Document_Budgetab_Detail_Inherit = new DA_OfficeAutomation_Document_Budgetab_Detail_Inherit();
        //da_OfficeAutomation_Document_Budgetab_Detail_Inherit.Delete(ID);
        //InsertBudgetabDetail(new Guid(ID));

        Common.AddLog(EmployeeID, EmployeeName, 60, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    /// 新增明细表
    /// </summary>
    /// <param name="gBudgetabID"></param>
    //private void InsertBudgetabDetail(Guid gBudgetabID)
    //{
    //    if (hdDetail.Value == "")
    //        return;

    //    T_OfficeAutomation_Document_Budgetab_Detail t_OfficeAutomation_Document_Budgetab_Detail;
    //    DA_OfficeAutomation_Document_Budgetab_Detail_Inherit da_OfficeAutomation_Document_Budgetab_Detail_Inherit = new DA_OfficeAutomation_Document_Budgetab_Detail_Inherit();
    ...
    //            if (detail[0] == "")
    //                continue;
    //            t_OfficeAutomation_Document_Budgetab_Detail = new T_OfficeAutomation_Document_Budgetab_Detail();
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_ID = Guid.NewGuid();
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_MainID = gBudgetabID;
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_Property = detail[0];
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_Controler = detail[1];
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_PropertyID = detail[2];
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_PropertyDate = detail[3];
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_OldDeal = detail[4];
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_NewDeal = detail[5];
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_AjustDeal = detail[6];
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_ShouldComm = detail[7];
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_ActualComm = detail[8];
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_AjustComm = detail[9];
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_LeadReason = int.Parse(detail[10]);
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_Commitment = detail[11];
    //            t_OfficeAutomation_Document_Budgetab_Detail.OfficeAutomation_Document_Budgetab_Detail_Reason = detail[12];

    //            da_OfficeAutomation_Document_Budgetab_Detail_Inherit.Insert(t_OfficeAutomation_Document_Budgetab_Detail);
    //        }
    //    }
    //    catch (Exception ee)
    //    {
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite61"] = "1";
        Response.Write("<script>window.open('Apply_Budgetab_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("广告宣传预算使用异常申请表.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_Budgetab_Inherit da_OfficeAutomation_Document_Budgetab_Inherit = new DA_OfficeAutomation_Document_Budgetab_Inherit();
            DataSet ds = da_OfficeAutomation_Document_Budgetab_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Budgetab_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_Budgetab_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_Budgetab_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_Budgetab_Inherit();
