...
public partial class Apply_CommissionAdjust_Apply_CommissionAdjust_Flow : BasePage
{
    ...
    private void LoadFlow()
    {
       ...
       string  Sign = drRow["OfficeAutomation_Document_CommissionAdjust_Sign"].ToString();
       this.hfSign.Value = Sign;
        ...
        foreach (DataRow dr in drc)
        {
            ...
            else if (idx == "2" || idx == "3" || idx == "4" || idx == "7")
            {
