...
public partial class Apply_ProjectCarAllowance_Apply_ProjectCarAllowance_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite57"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite57"] = null;
                }
            }
            catch
            {
    ...
    {
        DA_Dic_OfficeAutomation_MoneyGrade_Operate2 da_Dic_OfficeAutomation_MoneyGrade_Operate = new DA_Dic_OfficeAutomation_MoneyGrade_Operate2();
        DataSet ds = da_Dic_OfficeAutomation_MoneyGrade_Operate.SelectAll();

        RadioButtonListBind(rblMoneyGrade, ds.Tables[0], "OfficeAutomation_MoneyGrade_ID", "OfficeAutomation_MoneyGrade_Name", "");
        RadioButtonListBind(rblAgreeMoneyGrade, ds.Tables[0], "OfficeAutomation_MoneyGrade_ID", "OfficeAutomation_MoneyGrade_Name", "");
    }
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_ProjectCarAllowance_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_ProjectCarAllowance_ID"].ToString();
        string applicant=dr["OfficeAutomation_Document_ProjectCarAllowance_Apply"].ToString();
        ApplyN = applicant;
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ProjectCarAllowance_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtName.Value = dr["OfficeAutomation_Document_ProjectCarAllowance_ApplyForName"].ToString();
        txtCode.Text = dr["OfficeAutomation_Document_ProjectCarAllowance_ApplyForCode"].ToString();
        txtEntryDate.Value = DateTime.Parse(dr["OfficeAutomation_Document_ProjectCarAllowance_EntryDate"].ToString()).ToString("yyyy-MM-dd");
        txtDepartment.Value = dr["OfficeAutomation_Document_ProjectCarAllowance_Department"].ToString();
        txtPosition.Value = dr["OfficeAutomation_Document_ProjectCarAllowance_Position"].ToString();
        txtGrade.Value = dr["OfficeAutomation_Document_ProjectCarAllowance_Grade"].ToString();
        switch (dr["OfficeAutomation_Document_ProjectCarAllowance_IsPositive"].ToString())
        {
            case "True":
                rdbIsPositive1.Checked = true;
                break;
            case "False":
                rdbIsPositive2.Checked = true;
                break;
        }
        switch (dr["OfficeAutomation_Document_ProjectCarAllowance_ApplyType"].ToString())
        {
            case "True":
        ...
        rblMoneyGrade.Items.FindByValue(dr["OfficeAutomation_Document_ProjectCarAllowance_MoneyGradeID"].ToString()).Selected = true;
        hdMoneyGradeID.Value = dr["OfficeAutomation_Document_ProjectCarAllowance_MoneyGradeID"].ToString();
        txtEffectiveDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_ProjectCarAllowance_EffectiveDate"].ToString()).ToString("yyyy-MM-dd");
        if (dr["OfficeAutomation_Document_ProjectCarAllowance_AgreeMoneyGradeID"].ToString() != "" && dr["OfficeAutomation_Document_ProjectCarAllowance_AgreeMoneyGradeID"].ToString()!="0")
        {
            rblAgreeMoneyGrade.Items.FindByValue(dr["OfficeAutomation_Document_ProjectCarAllowance_AgreeMoneyGradeID"].ToString()).Selected = true;
        }
        hdAgreeMoneyGradeID.Value = dr["OfficeAutomation_Document_ProjectCarAllowance_AgreeMoneyGradeID"].ToString();
        ...
        bool isApplicant=EmployeeName == dr["OfficeAutomation_Document_ProjectCarAllowance_Apply"].ToString();
        if (isApplicant)
        {
            //SbJs.Append("$(\"#btnUpload\").show();");
            if (flowState == "1")
        ...
        #region 登录人为HR经办人，且流程为完成状态时，标识留档按钮开启。

        if (EmployeeName == CommonConst.EMP_HR_OPERATOR1_NAME && flowState == "3")
       ...
       // if (flowState == "1" && applicant == EmployeeName)
        //if (flowState == "1" && "63258" == EmployeeID)
        //{
       ...
       // if (flowState == "2" && applicant == EmployeeName) //20141215：M_AlterC
        if (flowState == "2" && "64200" == EmployeeID)
        {
            string[] immediateboss = CommonConst.EMP_IMMEDIATEBOSS_NAME.Split('|');
            foreach (string boss in immediateboss)
            {
        ...
        if ((flowState == "1" || flowState == "2") && (applicant == EmployeeName))
        {
         btnEditFlow2.Visible = true;
        }
        SbFlow.Append("</div>");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_ProjectCarAllowance t_OfficeAutomation_Document_ProjectCarAllowance = new T_OfficeAutomation_Document_ProjectCarAllowance();
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "PCAllowance" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 52;
                ...
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_MainID = t_OfficeAutomation_Main.OfficeAutomation_Main_ID;
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_Apply = EmployeeName;
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_ApplyDate = DateTime.Now;
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_ApplyForName = txtName.Value;
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_ApplyForCode = txtCode.Text;
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_EntryDate = DateTime.Parse(txtEntryDate.Value);
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_Department = txtDepartment.Value;
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_Position = txtPosition.Value;
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_Grade = txtGrade.Value;
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_IsPositive = rdbIsPositive1.Checked;
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_MoneyGradeID = int.Parse(hdMoneyGradeID.Value);
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_EffectiveDate = DateTime.Parse(txtEffectiveDate.Text);
                t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_ApplyType = this.rdbApplyType1.Checked;
                ...
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = txtName.Value;
                ...
                da_OfficeAutomation_Document_ProjectCarAllowance_Inherit.Insert(t_OfficeAutomation_Document_ProjectCarAllowance);//插入申请表
                ...
                T_OfficeAutomation_Flow tflow = da_OfficeAutomation_Flow_Inherit.SelectByMainIDAndIdx(MainID, 1);
                  if (tflow == null)
                    {
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = txtCode.Text.Trim();
                        t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = txtName.Value;
                ...
                if (ds != null && ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    //如果申请人为直属上司为黄生的人员，则添加1步流程：17董事总经理
                    string[] immediateboss = CommonConst.EMP_IMMEDIATEBOSS_NAME.Split('|');

                    foreach (string boss in immediateboss)
                    {
                        if (t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_ApplyForName == boss)
                        {
                            IsImmediste = true;
                            ...
                            //通知HR经办人审核
                            string email = CommonConst.EMP_HR_OPERATOR1_NAME;
                            string messageBody = "您好，" + email + "：您有编号为" + serialNumber + "的" + documentName + "需要您的审批。申请表地址为：" + Page.Request.Url;
                ...
                Common.AddLog(EmployeeID, EmployeeName, 56, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程
                if (IsImmediste)
                    RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");alert('" + CommonConst.MSG_APPLY_SUCCESSCOMMIT + "');window.location='/Apply/Apply_Search.aspx'; ");
                else
                  //  RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_ProjectCarAllowance_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=250px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                    RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");alert('" + CommonConst.MSG_APPLY_SUCCESSCOMMIT + "');window.location='/Apply/Apply_Search.aspx'; ");
                #endregion
            }
            else
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DA_OfficeAutomation_Document_ProjectCarAllowance_Inherit da_OfficeAutomation_Document_ProjectCarAllowance_Inherit=new DA_OfficeAutomation_Document_ProjectCarAllowance_Inherit();
        DataSet ds = da_OfficeAutomation_Document_ProjectCarAllowance_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ProjectCarAllowance_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (da_OfficeAutomation_Flow_Inherit.UpdateContainIsAgreeForSignAndMulti(MainID, signEmployeeId, signEmployeeName, hdSuggestion.Value, flowIDx, hdIsAgree.Value))
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ProjectCarAllowance_Apply"].ToString();
                    string employname;
                    string serialNumber = ds.Tables[0].Rows[0]["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    ...
                    if (hdIsAgree.Value != "0")//同意或其他意见
                    {
                        ...
                        //如果为hr负责人签名时，则更新同意申请金额档次
                        if (flowIDx == "6")
                            da_OfficeAutomation_Document_ProjectCarAllowance_Inherit.UpdateAgreeMoneyGradeIDByID(ID, hdAgreeMoneyGradeID.Value);
                        ...
                        if (da_OfficeAutomation_Flow_Inherit.IsFlowComplete(MainID))
                        {
                            ...
                            DataRow drProjectCarAllowance = da_OfficeAutomation_Document_ProjectCarAllowance_Inherit.SelectByMainID(MainID).Tables[0].Rows[0];
                            StringBuilder sbMailBody = new StringBuilder();
                            sbMailBody.Append("<br/><br/>申请人：" + drProjectCarAllowance["OfficeAutomation_Document_ProjectCarAllowance_ApplyForName"]);
                            sbMailBody.Append("<br/>申请日期：" + DateTime.Parse(drProjectCarAllowance["OfficeAutomation_Document_ProjectCarAllowance_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                            sbMailBody.Append("<br/>入职日期：" + DateTime.Parse(drProjectCarAllowance["OfficeAutomation_Document_ProjectCarAllowance_EntryDate"].ToString()).ToString("yyyy-MM-dd"));
                            sbMailBody.Append("<br/>现任职部门：" + drProjectCarAllowance["OfficeAutomation_Document_ProjectCarAllowance_Department"]);
                            sbMailBody.Append("<br/>现职位：" + drProjectCarAllowance["OfficeAutomation_Document_ProjectCarAllowance_Position"]);
                            sbMailBody.Append("<br/>现职级：" + drProjectCarAllowance["OfficeAutomation_Document_ProjectCarAllowance_Grade"]);
                            sbMailBody.Append("<br/>通过试用期：" + (drProjectCarAllowance["OfficeAutomation_Document_ProjectCarAllowance_IsPositive"].ToString() == "True" ? "是" : "否"));
                            sbMailBody.Append("<br/>生效日期：" + DateTime.Parse(drProjectCarAllowance["OfficeAutomation_Document_ProjectCarAllowance_EffectiveDate"].ToString()).ToString("yyyy-MM-dd"));
                            sbMailBody.Append("<br/>申请金额档次：" + drProjectCarAllowance["MoneyGrade"]);
                            sbMailBody.Append("<br/>同意申请金额档次：" + drProjectCarAllowance["AgreeMoneyGrade"]);
                            ...
                            foreach (DataRow dr in ds.Tables[0].Rows)
                            {
                                ...
                                {
                                    string msnBody = "您好，" + employnames[i] + "：您审理过的编号为" + serialNumber + "的" + documentName + "已通过所有人的审理。申请表地址为：" + Page.Request.Url;
                                    email = employnames[i];
                                    if (hdIsAgree.Value == "2")
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (EmployeeName == CommonConst.EMP_HR_OPERATOR1_NAME)
                da_OfficeAutomation_Document_ProjectCarAllowance_Inherit.AddRemarkByID(ID, CommonConst.SIGN_HR);
            Alert("标记成功。");
        }
        catch
        {
    ...
    private void Update()
    {
        ...
        t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_ID = new Guid(ID);
        t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_ApplyForName = txtName.Value;
        t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_ApplyForCode = txtCode.Text;
        t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_EntryDate = DateTime.Parse(txtEntryDate.Value);
        t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_Department = txtDepartment.Value;
        ...
        t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_Grade = txtGrade.Value;
        t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_IsPositive = rdbIsPositive1.Checked;
        //t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_MoneyGradeID = int.Parse(rblMoneyGrade.SelectedValue);
        t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_MoneyGradeID = int.Parse(hdMoneyGradeID.Value);
        t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_EffectiveDate = DateTime.Parse(txtEffectiveDate.Text);
        t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_ApplyType = this.rdbApplyType1.Checked;
        ...
        string summary = txtName.Value;
        string applydate = "";
        string mainid = MainID;

        da_OfficeAutomation_Main_Inherit.UpdateMain(mainid, depname, apply, applydate, summary);
        da_OfficeAutomation_Document_ProjectCarAllowance_Inherit.Update(t_OfficeAutomation_Document_ProjectCarAllowance);//修改申请表
        ...
        //如果申请人为直属上司为黄生的人员，则添加1步流程：7董事总经理
        string[] immediateboss = CommonConst.EMP_IMMEDIATEBOSS_NAME.Split('|');
        foreach (string boss in immediateboss)
        {
            if (t_OfficeAutomation_Document_ProjectCarAllowance.OfficeAutomation_Document_ProjectCarAllowance_ApplyForName == boss)
            {
                da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "1,2,3,7");
        ...
        Common.AddLog(EmployeeID, EmployeeName, 56, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite57"] = "1";
        Response.Write("<script>window.open('Apply_ProjectCarAllowance_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("小汽车津贴申请表（项目部）.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_ProjectCarAllowance_Inherit da_OfficeAutomation_Document_ProjectCarAllowance_Inherit = new DA_OfficeAutomation_Document_ProjectCarAllowance_Inherit();
            DataSet ds = da_OfficeAutomation_Document_ProjectCarAllowance_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ProjectCarAllowance_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
            string department = drRow["OfficeAutomation_Document_ProjectCarAllowance_Department"].ToString();
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_ProjectCarAllowance_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_ProjectCarAllowance_Inherit();
