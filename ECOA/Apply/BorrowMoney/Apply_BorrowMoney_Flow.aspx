<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_BorrowMoney_Flow.aspx.cs" Inherits="Apply_BorrowMoney_Apply_BorrowMoney_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
    ...
    //window.onbeforeunload =  function (){
        ...
        window.onbeforeunload =  function (){
            if($.trim($("#txtIDx1").val())=="" || $.trim($("#txtIDx3").val())=="")
                return '此流程第1及第3环节必须填写不能为空，否则申请将作废！';   
        }
    </script>
</head>
<body>
   ...
   <%-- <div>
        <div class="flow">
            ...
            <div id="divIDx2" class='item'><input id="btnIDx0" class="forward" type="image" src="/Images/add.png" onclick="return showOrHideIDx(2);" />
                <label id="lblIDx2" for='btnIDx2'>部门主管1</label>
            </div>
            ...
            <div id="divIDx3" class='item'>部门主管2</div>
            <div id="divTxtIDx3" class='item'>
                <input type="text" id="txtIDx3" style="width:150px;" /><input id="hdIDx3" type="hidden" />
            </div>
            <img src="/Images/forward.png" class="forward"/>

            <div id="divIDx4" class='item'>部门主管3</div>
            ...
            <div id="divIDx5" class='item'>部门负责人</div>
            <div id="divTxtIDx5" class='item'>
                <input type="text" id="txtIDx5" style="width:150px;" /><input id="hdIDx5" type="hidden" />
            </div>
        ...
        <div class="flow">
            ...
            <div id="divIDx1" class='item'>申请人</div><div id="divTxtIDx1" class='item'><input type="text" id="txtIDx1" style="width:200px;"readonly="readonly" /><input id="hdIDx1" type="hidden" /></div><img src="/Images/forward.png" class="forward"/>
            <div id="divIDx2" class='item'>部门主管</div><div id="divTxtIDx2" class='item'><input type="text" id="txtIDx2" style="width:200px;" /><input id="hdIDx2" type="hidden" /></div>
            <br /><img src="/Images/forward.png" class="forward"/>
            <div id="divIDx3" class='item'>部门负责人</div><div id="divTxtIDx3" class='item'><input type="text" id="txtIDx3" style="width:200px;" readonly="readonly" /><input id="hdIDx3" type="hidden" /></div>
            <br /><br />
            <input type="button" id="btnSave2" value="保存并通知审批" onclick="save();this.disabled ='disabled'" class="btn button"/>
        </div>
    </div>
