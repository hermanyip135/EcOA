...
public partial class Apply_ChangeFyq_Apply_ChangeFyq_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    public void InitPage(string UrlMainID)
    {
        ...
        //{
        //    MainID = UrlMainID;
        //    DA_OfficeAutomation_Document_ChangeFyq_Inherit da_OfficeAutomation_Document_ChangeFyq_Inherit = new DA_OfficeAutomation_Document_ChangeFyq_Inherit();
        //    DataSet ds = da_OfficeAutomation_Document_ChangeFyq_Inherit.SelectByMainID(MainID);
        //    DataRow dr = ds.Tables[0].Rows[0];
        //    string rdbs = dr["OfficeAutomation_Document_ChangeFyq_SpecialApply"].ToString();
        //    if (rdbs.Contains("3"))
        //        flowsl += "3";
        //    if (rdbs.Contains("4"))
        //        flowsl += "4";
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_ChangeFyq_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_ChangeFyq_ID"].ToString();
        string applicant = dr["OfficeAutomation_Main_Creater"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_ChangeFyq_ApplyID"].ToString();
        txtDepartment.Text = dr["OfficeAutomation_Document_ChangeFyq_Department"].ToString();
        lblApply.Text = applicant;
        txtApply.Text = dr["OfficeAutomation_Document_ChangeFyq_Apply"].ToString();
        lbData.Text = DateTime.Parse(dr["OfficeAutomation_Document_ChangeFyq_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtPhone.Text = dr["OfficeAutomation_Document_ChangeFyq_Phone"].ToString();
        ddlArea.Text = dr["OfficeAutomation_Document_ChangeFyq_Area"].ToString();
        txtLocation.Text = dr["OfficeAutomation_Document_ChangeFyq_Location"].ToString();
        txtMaster.Text = dr["OfficeAutomation_Document_ChangeFyq_Master"].ToString();
        txtBuyers.Text = dr["OfficeAutomation_Document_ChangeFyq_Buyers"].ToString();
        txtCDate.Text = dr["OfficeAutomation_Document_ChangeFyq_CDate"].ToString();
        if (dr["OfficeAutomation_Document_ChangeFyq_IsContract"].ToString() == "1")
            rdbIsContract1.Checked = true;
        else if (dr["OfficeAutomation_Document_ChangeFyq_IsContract"].ToString() == "0")
            rdbIsContract2.Checked = true;
        if (dr["OfficeAutomation_Document_ChangeFyq_IsCommission"].ToString() == "1")
            rdbIsCommission1.Checked = true;
        else if (dr["OfficeAutomation_Document_ChangeFyq_IsCommission"].ToString() == "0")
        ...
        if (rdbs.Contains("1"))
        {
            ...
            ddlPayWay.Text = dr["OfficeAutomation_Document_ChangeFyq_PayWay"].ToString();
        }
        if (rdbs.Contains("2"))
        ...
        if (rdbs.Contains("3"))
        {
            ...
            if (dr["OfficeAutomation_Document_ChangeFyq_WhoKeep"].ToString().Contains("1"))
                rdbWhoKeep1.Checked = true;
            if (dr["OfficeAutomation_Document_ChangeFyq_WhoKeep"].ToString().Contains("2"))
                rdbWhoKeep2.Checked = true;
        }
        if (rdbs.Contains("4"))
        {
            rdbSpecialApply4.Checked = true;
            txtSurePrice.Text = dr["OfficeAutomation_Document_ChangeFyq_SurePrice"].ToString();
            ddlCompareP.Text = dr["OfficeAutomation_Document_ChangeFyq_CompareP"].ToString();
        }
        if (rdbs.Contains("5"))
        {
        ...
        if (rdbs.Contains("6"))
        {
            ...
            txtHandleDate.Text = dr["OfficeAutomation_Document_ChangeFyq_HandleDate"].ToString();
        }
        if (rdbs.Contains("7"))
        ...
        if (rdbs.Contains("9"))
        {
            ...
            txtOthers.Text = dr["OfficeAutomation_Document_ChangeFyq_Others"].ToString();
        }
        txtDetailed.Text = dr["OfficeAutomation_Document_ChangeFyq_Detailed"].ToString();
        string cbt = dr["OfficeAutomation_Document_ChangeFyq_CNS"].ToString();
        if (cbt.Contains("1"))
        {
            cbCNS1.Checked = true;
            //20170221注释
            // ddlRelationship.Text = dr["OfficeAutomation_Document_ChangeFyq_Relationship"].ToString();
        }
        if (cbt.Contains("2"))
            cbCNS2.Checked = true;
        if (cbt.Contains("3"))
        ...
        {
            cbCNS6.Checked = true;
            ddlPriceChange.Text = dr["OfficeAutomation_Document_ChangeFyq_PriceChange"].ToString();
            ddlCompareOfChange.Text = dr["OfficeAutomation_Document_ChangeFyq_CompareOfChange"].ToString();
        }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_ChangeFyq t_OfficeAutomation_Document_ChangeFyq = new T_OfficeAutomation_Document_ChangeFyq();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "ChangeFyq" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 89; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_ChangeFyq = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_ChangeFyq_Inherit.Insert(t_OfficeAutomation_Document_ChangeFyq);//插入申请表

                //InsertChangeFyqDetail(t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_ID);
                ...
                if (flowsadd != "A")
                    RunJS("alert('保存成功！');window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_ChangeFyq_Flow.aspx?MainID=" + MainID + "&dpm=" + Server.UrlEncode(txtDepartment.Text) + "&flowsadd=" + flowsadd + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                else
                    RunJS("alert('申请表保存成功，稍后会由房友圈网签组来编辑审批流程！');var returnVaulue=window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");window.location='/Apply/Apply_Search.aspx';");
                #endregion
            }
            else
            {
                ...
                if (Purview.Contains("OA_ITPower_001"))//是否有编辑权限
                {
                    ...
                    SpecialFlow();//特殊审批流
                    if (flowsadd != "A")
                        RunJS("alert('保存成功！');var win=window.showModalDialog(\"Apply_ChangeFyq_Flow.aspx?MainID=" + MainID + "&dpm=" + Server.UrlEncode(txtDepartment.Text) + "&flowsadd=" + flowsadd + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                    else
                        RunJS("alert('申请表保存成功，稍后会由房友圈网签组来编辑审批流程！');window.location='/Apply/Apply_Search.aspx';");
                }
                else
                    Alert("未开通编辑修改权限。");
                #endregion
    ...
    #endregion
    private void SpecialFlow()
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
        //SYSREQ201804261802075853410 秘书选择第一部分特殊申请的第二点，第三点，和第四点时候需要中原法律部审批，其中第四点与成交价对比低于5成  报高价（此选项需要加上）时才需要法律部审批。其余选项不需要
        //if (rdbSpecialApply2.Checked == true || rdbSpecialApply3.Checked == true || (rdbSpecialApply4.Checked == true && ddlCompareP.SelectedValue == "低于成交价5成") || (cbCNS6.Checked == true && ddlCompareOfChange.SelectedValue == "低于成交价5成（含5成）"))
      //后来经过房友圈同法律部沟通过取消
        if (rdbSpecialApply2.Checked == true || rdbSpecialApply3.Checked == true)
        {
            ...
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_Suggestion = "";
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = "13398,6189,1865";
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = "何恺鹏,陈宇平,李蓬桂";
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_Idx = 7;
            da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);

            //if (ddlArea.SelectedValue == "荔湾区(含芳村、南海)" || ddlArea.SelectedValue == "越秀区")
            //{
            //    t_OfficeAutomation_Flow.OfficeAutomation_Flow_MainID = new Guid(MainID);
            //    t_OfficeAutomation_Flow.OfficeAutomation_Flow_Suggestion = "";
            //    t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
            ...
            //    da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);
            //}
            //else if (ddlArea.SelectedValue == "番禺区")
            //{
            //    t_OfficeAutomation_Flow.OfficeAutomation_Flow_MainID = new Guid(MainID);
            //    t_OfficeAutomation_Flow.OfficeAutomation_Flow_Suggestion = "";
            //    t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
            ...
            //    da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);
            //}
            //else if (ddlArea.SelectedValue == "天河区")
            //{
            //    t_OfficeAutomation_Flow.OfficeAutomation_Flow_MainID = new Guid(MainID);
            //    t_OfficeAutomation_Flow.OfficeAutomation_Flow_Suggestion = "";
            //    t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        ID = drRow["OfficeAutomation_Document_ChangeFyq_ID"].ToString();
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ChangeFyq_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_ChangeFyq_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_ChangeFyq_Apply"]);
                    sbMailBody.Append("<br/>申请分行：" + drRow["OfficeAutomation_Document_ChangeFyq_Department"]);
                    sbMailBody.Append("<br/>发文日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_ChangeFyq_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>成交编号：" + drRow["OfficeAutomation_Document_ChangeFyq_ApplyID"]);
                    sbMailBody.Append("<br/>联系电话：" + drRow["OfficeAutomation_Document_ChangeFyq_Phone"]);
                    sbMailBody.Append("<br/>区域：" + drRow["OfficeAutomation_Document_ChangeFyq_Location"]);

                    sbMailBody.Append("<br/>物业地址：" + drRow["OfficeAutomation_Document_ChangeFyq_Location"]);
                    sbMailBody.Append("<br/>业主：" + drRow["OfficeAutomation_Document_ChangeFyq_Master"]);
                    sbMailBody.Append("<br/>买家：" + drRow["OfficeAutomation_Document_ChangeFyq_Buyers"]);
                    if (drRow["OfficeAutomation_Document_ChangeFyq_IsContract"].ToString() == "1")
                        sbMailBody.Append("<br/>已完成网签版合同");
                    else if (drRow["OfficeAutomation_Document_ChangeFyq_IsContract"].ToString() == "0")
                        sbMailBody.Append("<br/>未完成网签版合同");
                    if (drRow["OfficeAutomation_Document_ChangeFyq_IsCommission"].ToString() == "1")
                        sbMailBody.Append("<br/>已收佣");
                    else if (drRow["OfficeAutomation_Document_ChangeFyq_IsCommission"].ToString() == "0")
                        sbMailBody.Append("<br/>未收佣");
                    sbMailBody.Append("<br/>收佣日期：" + drRow["OfficeAutomation_Document_ChangeFyq_CDate"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_ChangeFyq_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private T_OfficeAutomation_Document_ChangeFyq GetModelFromPage(Guid UndertakeProjID)
    {
        T_OfficeAutomation_Document_ChangeFyq t_OfficeAutomation_Document_ChangeFyq = new T_OfficeAutomation_Document_ChangeFyq();
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_ID = UndertakeProjID;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_Apply = txtApply.Text;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_Department = txtDepartment.Text;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_Phone = txtPhone.Text;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_Area = ddlArea.SelectedValue;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_Location = txtLocation.Text;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_Master = txtMaster.Text;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_Buyers = txtBuyers.Text;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_IsContract = rdbIsContract1.Checked ? "1" : "0";
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_IsCommission = rdbIsCommission1.Checked ? "1" : "0";
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_CDate = txtCDate.Text;
        ...
        if (rdbSpecialApply9.Checked == true)
            rdbs += "|9";
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_SpecialApply = rdbs;

        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_PayWay = ddlPayWay.SelectedValue;
        string WhoKeep = "";
        if (rdbWhoKeep1.Checked == true)
            WhoKeep += "|1";
        if (rdbWhoKeep2.Checked == true)
            WhoKeep += "|2";
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_WhoKeep = WhoKeep;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_SurePrice = txtSurePrice.Text;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_CompareP = ddlCompareP.SelectedValue;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_HandleDate = txtHandleDate.Text;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_Others = txtOthers.Text;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_Detailed = txtDetailed.Text;
        ...
        if (cbCNS4.Checked == true)
            cbt += "|4";
        if (cbCNS6.Checked == true)
            cbt += "|6";
        
        if (cbCNS8.Checked == true)
            cbt += "|8";
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_CNS = cbt;

        //20170221修改，取消关系证明
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_Relationship = "";
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_PriceChange = ddlPriceChange.SelectedValue;
        t_OfficeAutomation_Document_ChangeFyq.OfficeAutomation_Document_ChangeFyq_CompareOfChange = ddlCompareOfChange.SelectedValue;

        return t_OfficeAutomation_Document_ChangeFyq;
    }
    ...
    private void Update()//*-
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_ChangeFyq_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ChangeFyq_ID"].ToString();

        t_OfficeAutomation_Document_ChangeFyq = GetModelFromPage(new Guid(ID));
        ...
        da_OfficeAutomation_Document_ChangeFyq_Inherit.Update(t_OfficeAutomation_Document_ChangeFyq);//修改申请表

        //DA_OfficeAutomation_Document_ChangeFyq_Detail_Inherit da_OfficeAutomation_Document_ChangeFyq_Detail_Inherit = new DA_OfficeAutomation_Document_ChangeFyq_Detail_Inherit();
        //da_OfficeAutomation_Document_ChangeFyq_Detail_Inherit.Delete(ID);
        //InsertChangeFyqDetail(new Guid(ID));
       // AddFlows();
    ...
    /// 新增明细表
    /// </summary>
    /// <param name="gChangeFyqID"></param>
    //private void InsertChangeFyqDetail(Guid gChangeFyqID)
    //{
    //    if (hdDetail.Value == "")
    //        return;

    //    T_OfficeAutomation_Document_ChangeFyq_Detail t_OfficeAutomation_Document_ChangeFyq_Detail;
    //    DA_OfficeAutomation_Document_ChangeFyq_Detail_Inherit da_OfficeAutomation_Document_ChangeFyq_Detail_Inherit = new DA_OfficeAutomation_Document_ChangeFyq_Detail_Inherit();
    ...
    //            if (detail[0] == "")
    //                continue;
    //            t_OfficeAutomation_Document_ChangeFyq_Detail = new T_OfficeAutomation_Document_ChangeFyq_Detail();
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_ID = Guid.NewGuid();
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_MainID = gChangeFyqID;
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_Property = detail[0];
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_Controler = detail[1];
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_PropertyID = detail[2];
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_PropertyDate = detail[3];
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_OldDeal = detail[4];
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_NewDeal = detail[5];
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_AjustDeal = detail[6];
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_ShouldComm = detail[7];
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_ActualComm = detail[8];
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_AjustComm = detail[9];
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_LeadReason = int.Parse(detail[10]);
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_Commitment = detail[11];
    //            t_OfficeAutomation_Document_ChangeFyq_Detail.OfficeAutomation_Document_ChangeFyq_Detail_Reason = detail[12];

    //            da_OfficeAutomation_Document_ChangeFyq_Detail_Inherit.Insert(t_OfficeAutomation_Document_ChangeFyq_Detail);
    //        }
    //    }
    //    catch (Exception ee)
    //    {
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.open('Apply_ChangeFyq_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    ...
    protected void btnSaveLogisticsFlow_Click(object sender, EventArgs e)
    {
        ...
        DA_OfficeAutomation_Document_ChangeFyq_Inherit changens_Inherits = new DA_OfficeAutomation_Document_ChangeFyq_Inherit();
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_ChangeFyq_Inherit da_OfficeAutomation_Document_ChangeFyq_Inherit = new DA_OfficeAutomation_Document_ChangeFyq_Inherit();
            DataSet ds = da_OfficeAutomation_Document_ChangeFyq_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ChangeFyq_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
    ...
    protected void btnSAlterC_Click(object sender, EventArgs e) //20141216：M_AlterC
    {
        try
        {
            ...
            if (Purview.Contains("OA_ITPower_001"))//是否有编辑权限
            {
                ...
                if (flowsadd != "A")
                    RunJS("alert('所作的修改已保存！');var win=window.showModalDialog(\"Apply_ChangeFyq_Flow.aspx?MainID=" + MainID + "&dpm=" + Server.UrlEncode(txtDepartment.Text) + "&flowsadd=" + flowsadd + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='" + Page.Request.Url + "'; }");
                else
                    RunJS("alert('所作的修改已保存，稍后会由房友圈网签组来编辑审批流程！');window.location='/Apply/Apply_Search.aspx';");
            }
            else
                Alert("未开通编辑修改权限。");
            #endregion
    ...
    protected void AddFlows()
    {
        ...
        T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
            ...
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_Suggestion = "";
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = "41451";
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = "张杰汉";
           ...
           if ((rdbSpecialApply4.Checked && ddlCompareP.SelectedValue != "与成交价一致" && rdbSpecialApply3.Checked) || rdbSpecialApply2.Checked)
           {
    ...
    //    系统弹出提醒框：“请使用《特殊个案申请表》进行申请或联系房友圈经办人进行申请！（已不能再做下一步操作）”*/
    //    if (ddlPayWay.SelectedValue == "按揭")
    //    {
    //        ddlPayWay.SelectedValue = "请选择";
    //        RunJS("alert('请使用《特殊个案申请表》进行申请或联系房友圈经办人进行申请！');");
    //    }
    //}

    #region 房友圈网签组的人添加区域总监和区域负责人
    ...
    public void insertGeneralApplyDetail()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_ChangeFyq_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_ChangeFyq_ID"].ToString(); //在不同的表要注意修改
