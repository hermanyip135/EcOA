<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_ChangeFyq_Flow.aspx.cs" Inherits="Apply_ChangeFyq_Apply_ChangeFyq_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
                ...
                $.ajax({
                    ...
                    success: function(info) {
                        ...
                        else
                        {
                            ...
                            //if($.trim($("#txtIDx3").val()) == "" && flod.indexOf("4") != -1){ 
                            //    $("#ddl3").hide(); 
                            //    $("#ddl4").show();
                            //}
                            //if($.trim($("#txtIDx4").val()) == "" && flod.indexOf("5") != -1){
                            //    $("#ddl4").hide();
                            //    $("#ddl5").show();
                            //}
                            //后一个txtIDx非空，前一个txtIDx空：后一个show
                        }
                    }
                })
            }
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <div id ="ddl1" style="float: left; margin-top: 20px;">
                <div id="divIDx1" class='item'>分行主管</div>
                <div id="divTxtIDx1" class='item'>
                    <input type="text" id="txtIDx1" style="width:200px;" /><input id="hdIDx1" type="hidden" />
                </div>
            </div>
            <%--<img src="/Images/forward.png" class="forward"/><br />--%>

            <div id="divIDx2" class='item' style="display: none">分行主管</div>
            ...
            <div id ="ddl3" style="float: left; margin-top: 20px; display: none">
                ...
                <div id="divIDx3" class='item'>区域经理</div>
                <div id="divTxtIDx3" class='item'>
                    <input type="text" id="txtIDx3" runat="server" style="width:200px;" /><input id="hdIDx3" type="hidden" />
                </div>
            </div>

            <div id ="ddl4" style="float: left; margin-top: 20px; display: none">
                <img src="/Images/forward.png" class="forward"/>
                <div id="divIDx4" class='item'>区域总监</div>
                <div id="divTxtIDx4" class='item'>
                    <input type="text" id="txtIDx4" runat="server" style="width:200px;" /><input id="hdIDx4" type="hidden" />
                </div>
            </div>

            <div id ="ddl5" style="float: left; margin-top: 20px; display: none">
                <img src="/Images/forward.png" class="forward"/>
