...
public partial class Apply_Apply_SpecialUpload : BasePage
{
    #region Page_Load
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            t_OfficeAutomation_Attach.OfficeAutomation_Attach_Name = "SpecialUplX" +  this.txtFilePath.Value.Substring(this.txtFilePath.Value.LastIndexOf('\\') + 1);
