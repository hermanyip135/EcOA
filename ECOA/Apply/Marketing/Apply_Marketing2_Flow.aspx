<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_Marketing2_Flow.aspx.cs" Inherits="Apply_Marketing2_Apply_Marketing2_Flow" Title="流程编辑 - 广州中原电子审批系统" %>
...
<body>
    ...
    <div>
        <div class="flow">
            ...
            <div id="divIDx2" class='item'>申请部门主管</div><div id="divTxtIDx2" class='item'><input type="text" id="txtIDx2" style="width:200px;" /><input id="hdIDx2" type="hidden" /></div>
            <br /><img src="/Images/forward.png" class="forward"/><div id="divIDx3" class='item'>部门负责人</div><div id="divTxtIDx3" class='item'><input type="text" id="txtIDx3" style="width:200px;" /><input id="hdIDx3" type="hidden" /></div>
            <br /><br />
