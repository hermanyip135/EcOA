...
public partial class Apply_Marketing_Apply_Marketing_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite48"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite48"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        ds = da_OfficeAutomation_Document_Marketing_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_Marketing_ID"].ToString();

        string applicant = dr["OfficeAutomation_Document_Marketing_Apply"].ToString();
        ApplyN = applicant;
        lblApply.Text = applicant;
        txtDepartment.Text = dr["OfficeAutomation_Document_Marketing_Department"].ToString();
        txtApplyID.Text = dr["OfficeAutomation_Document_Marketing_ApplyID"].ToString();
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_Marketing_ApplyDate"].ToString()).ToString("yyyy-MM-dd");
        txtReceiveDP.Text = dr["OfficeAutomation_Document_Marketing_ReceiveDP"].ToString();
        txtTelephone.Text = dr["OfficeAutomation_Document_Marketing_Telephone"].ToString();
        txtFax.Text = dr["OfficeAutomation_Document_Marketing_Fax"].ToString();
        txtSubject.Text = dr["OfficeAutomation_Document_Marketing_Subject"].ToString();
        txtDescribe.Text = dr["OfficeAutomation_Document_Marketing_Describe"].ToString();
        ...
        //if (EmployeeID == "16947" || EmployeeID == "13110" || EmployeeID == "4229")
        //{
            SbJs.Append("$(\"#addOne\").show();");
        //}

        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        T_OfficeAutomation_Flow flows;
        if (dr["OfficeAutomation_Document_Marketing_Department"].ToString() == "市场部")
        ...
        if (flows != null)
            SbJs.Append("$('#trLogistics').show();$('#trLogistics2').remove();$('#trGeneralManager').hide();$('#tlsc1').show();$('#tlsc2').show();");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_Marketing t_OfficeAutomation_Document_Marketing = new T_OfficeAutomation_Document_Marketing();
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "Marketing" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 43; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_Marketing = GetModelFromPage(Guid.NewGuid());
                ...
                da_OfficeAutomation_Document_Marketing_Inherit.Insert(t_OfficeAutomation_Document_Marketing);//插入申请表
                ...
                Common.AddLog(EmployeeID, EmployeeName, 47, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                if (txtDepartment.Text != "市场部")
                    RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_Marketing_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                else
                {
                    da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "4,5,6");
                    RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_Marketing_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                }
                #endregion
            }
    ...
    private T_OfficeAutomation_Document_Marketing GetModelFromPage(Guid MarketingID)
    {
        T_OfficeAutomation_Document_Marketing t_OfficeAutomation_Document_Marketing = new T_OfficeAutomation_Document_Marketing();
        t_OfficeAutomation_Document_Marketing.OfficeAutomation_Document_Marketing_ID = MarketingID;
        t_OfficeAutomation_Document_Marketing.OfficeAutomation_Document_Marketing_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_Marketing.OfficeAutomation_Document_Marketing_Apply = EmployeeName;
        t_OfficeAutomation_Document_Marketing.OfficeAutomation_Document_Marketing_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_Marketing.OfficeAutomation_Document_Marketing_Department = txtDepartment.Text;
        t_OfficeAutomation_Document_Marketing.OfficeAutomation_Document_Marketing_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_Marketing.OfficeAutomation_Document_Marketing_ReceiveDP = txtReceiveDP.Text;
        t_OfficeAutomation_Document_Marketing.OfficeAutomation_Document_Marketing_Telephone = txtTelephone.Text;
        t_OfficeAutomation_Document_Marketing.OfficeAutomation_Document_Marketing_Fax = txtFax.Text;
        t_OfficeAutomation_Document_Marketing.OfficeAutomation_Document_Marketing_Subject = txtSubject.Text;
        t_OfficeAutomation_Document_Marketing.OfficeAutomation_Document_Marketing_Describe = HiddenField1.Value;
   
        return t_OfficeAutomation_Document_Marketing;
    }
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_Marketing_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_Marketing_ID"].ToString();
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Marketing_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    string department = drRow["OfficeAutomation_Document_Marketing_Department"].ToString();
                    string applyUrl = Page.Request.Url.ToString();
                    //string plantime = drRow["OfficeAutomation_Document_Marketing_PlanDate"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_Marketing_Apply"]);
                    sbMailBody.Append("<br/>发文日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_Marketing_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>发文编号：" + drRow["OfficeAutomation_Document_Marketing_ApplyID"]);
                    sbMailBody.Append("<br/>发文部门：" + drRow["OfficeAutomation_Document_Marketing_Department"]);
                    sbMailBody.Append("<br/>收文部门：" + drRow["OfficeAutomation_Document_Marketing_ReceiveDP"]);
                    sbMailBody.Append("<br/>回复电话：" + drRow["OfficeAutomation_Document_Marketing_Telephone"]);
                    sbMailBody.Append("<br/>回复传真：" + drRow["OfficeAutomation_Document_Marketing_Fax"]);
                    sbMailBody.Append("<br/>文件主题：" + drRow["OfficeAutomation_Document_Marketing_Subject"]);
                    sbMailBody.Append("<br/>申请正文：" + drRow["OfficeAutomation_Document_Marketing_Describe"]);
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_Marketing_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_Marketing_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Marketing_ID"].ToString();

        t_OfficeAutomation_Document_Marketing = GetModelFromPage(new Guid(ID));
        ...
        da_OfficeAutomation_Document_Marketing_Inherit.Update(t_OfficeAutomation_Document_Marketing);//修改申请表
        ...
        else
        {
            ...
            //if (flows == null)
            //{
            //    t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = "16947";
            //    t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = "文玉仪";
            //    t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
        ...
        Common.AddLog(EmployeeID, EmployeeName, 47, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite48"] = "1";
        Response.Write("<script>window.open('Apply_Marketing_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("市场推广费用申请.pdf"));//强制下载 
    ...
    protected void btnSaveLogisticsFlow_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_Marketing_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Marketing_ID"].ToString(); //在不同的表要注意修改
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_Marketing_Inherit da_OfficeAutomation_Document_Marketing_Inherit = new DA_OfficeAutomation_Document_Marketing_Inherit();
            DataSet ds = da_OfficeAutomation_Document_Marketing_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_Marketing_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            ...
            if (flows != null)
            {
                ...
                if (i == 1)
                    da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "12,13,50"); //加首席运营官黄蕙晶之后黄生14idx变50
    ...
    protected void btnSAlterC_Click(object sender, EventArgs e) //20141216：M_AlterC
    {
        try
        {
            ...
            if (Purview.Contains("OA_ITPower_001"))//是否有编辑权限
            {
                ...
                da_OfficeAutomation_Flow_Inherit.DeleteByMainIDAndIdxs(MainID, "12,13,50");  //加首席运营官黄蕙晶之后黄生idx14变50
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_Marketing_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    protected void lbtAddOperateAuditor_Click(object sender, EventArgs e)
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        T_OfficeAutomation_Flow t_OfficeAutomation_Flow = new T_OfficeAutomation_Flow();
        t_OfficeAutomation_Flow.OfficeAutomation_Flow_MainID = new Guid(MainID);
        ...
        if (flows == null)
        {
            ...
            da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);
            //RunJS("alert('后勤及董事总经理的审批流程已添加');window.location.href='" + Page.Request.Url + "';");
    ...
    protected void lbtAddMaster_Click(object sender, EventArgs e)
    {
        ...
        flows = da_OfficeAutomation_Flow_Inherit.SelectByMainIDAndIdx(MainID, 50);  //加首席运营官黄蕙晶之后黄生idx14变50
        if (flows == null)
        {
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_EmployeeID = CommonConst.EMP_GENERALMANAGER_ID;
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_Employee = CommonConst.EMP_GENERALMANAGER_NAME;
            t_OfficeAutomation_Flow.OfficeAutomation_Flow_Idx = 50;
            da_OfficeAutomation_Flow_Inherit.Insert(t_OfficeAutomation_Flow);
            //RunJS("alert('后勤及董事总经理的审批流程已添加');window.location.href='" + Page.Request.Url + "';");
            RunJS("alert('董事总经理的审批流程已添加');window.location.href='" + Page.Request.Url + "';");
        }
        else
        {
            RunJS("alert('董事总经理的审批流程已添加');window.location.href='" + Page.Request.Url + "';");
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_Marketing_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_Marketing_Inherit();
