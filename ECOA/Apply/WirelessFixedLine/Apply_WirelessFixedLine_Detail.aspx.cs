...
public partial class Apply_WirelessFixedLine_Apply_WirelessFixedLine_Detail : BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (Session["FLG_ReWrite34"].ToString() == "1")
                {
                    ViewState["FLG_ReWrite"] = "1";
                    Session["FLG_ReWrite34"] = null;
                }
            }
            catch
            {
    ...
    public void LoadPage()
    {
        ...
        DA_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit da_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit = new DataAccess.Operate.DA_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit();
        ...
        ds = da_OfficeAutomation_Document_WirelessFixedLine_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_WirelessFixedLine_ID"].ToString();
        string applicant = dr["OfficeAutomation_Document_WirelessFixedLine_Apply"].ToString();
        ApplyN = applicant;
        txtApplyID.Text = dr["OfficeAutomation_Document_WirelessFixedLine_ApplyID"].ToString();
        txtSumNumber.Text = dr["OfficeAutomation_Document_WirelessFixedLine_SumNumber"].ToString();
        lblApply.Text = applicant;
        lblApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Document_WirelessFixedLine_ApplyDate"].ToString()).ToString("yyyy-MM-dd");

        SerialNumber = dr["OfficeAutomation_SerialNumber"].ToString();

        ds = da_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit.SelectByID(ID);
        ...
        else
        {
            ...
            for (int n = 0; n < detailCount; n++)
            {
                ...
                SbJs.Append("$('#txtDivision" + i + "').val('" + dr["OfficeAutomation_Document_WirelessFixedLine_Detail_Division"] + "');");
                SbJs.Append("$('#txtName" + i + "').val('" + dr["OfficeAutomation_Document_WirelessFixedLine_Detail_Name"] + "');");
                SbJs.Append("$('#txtNumber" + i + "').val('" + dr["OfficeAutomation_Document_WirelessFixedLine_Detail_Number"] + "');");
                SbJs.Append("$('#txtTime" + i + "').val('" + DateTime.Parse(dr["OfficeAutomation_Document_WirelessFixedLine_Detail_Time"].ToString()).ToString("yyyy-MM-dd") + "');");
                SbJs.Append("$('#txtEndTime" + i + "').val('" + DateTime.Parse(dr["OfficeAutomation_Document_WirelessFixedLine_Detail_EndTime"].ToString()).ToString("yyyy-MM-dd") + "');");
            }
        }
    ...
    public void DrawDetailTable(int n)
    {
        ...
        for (int i = 1; i <= n; i++)
        {
            ...
            SbHtml.Append("<td class=\"tl PL10\" style=\"line-height: 30px\"><input type=\"text\" id=\"txtDivision" + i + "\" style=\"width:150px\"/></td>");
            SbHtml.Append("<td class=\"tl PL10\" style=\"line-height: 30px\"><input type=\"text\" id=\"txtName" + i + "\" style=\"width:150px\"/><br /></td>");
            SbHtml.Append("<td class=\"tl PL10\" style=\"line-height: 30px\"><input type=\"text\" id=\"txtNumber" + i + "\" style=\"width:100px;\"/><br /></td>");
            SbHtml.Append("<td class=\"tl PL10\" style=\"line-height: 30px\"><input type=\"text\" id=\"txtTime" + i + "\" style=\"width:80px;\"/>～");
            SbHtml.Append("<input type=\"text\" id=\"txtEndTime" + i + "\" style=\"width:80px;\"/><br /></td>");
			SbHtml.Append("</tr>");
        }
        SbJs.Append("i=" + n + ";");
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_WirelessFixedLine t_OfficeAutomation_Document_WirelessFixedLine = new T_OfficeAutomation_Document_WirelessFixedLine();
        ...
        try
        {
            if (MainID == "")
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "WirelessFixedLine" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 28; //在《申请表字典表》找到该表的主键，这步一错则会打开别的表
                ...
                t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_ID = Guid.NewGuid();
                t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_MainID = t_OfficeAutomation_Main.OfficeAutomation_Main_ID;
                t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_Apply = EmployeeName;
                t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_ApplyDate = DateTime.Now;
                t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_ApplyID = txtApplyID.Text;
                t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_SumNumber = txtSumNumber.Text;

                t_OfficeAutomation_Main.OfficeAutomation_Main_Apply = EmployeeName;
                t_OfficeAutomation_Main.OfficeAutomation_Main_Department = "项目部";
                ...
                da_OfficeAutomation_Document_WirelessFixedLine_Inherit.Insert(t_OfficeAutomation_Document_WirelessFixedLine);//插入申请表

                InsertWirelessFixedLineDetail(t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_ID);
                ...
                //if (t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_MoneyCount > 20000)
                //{
                ...
                Common.AddLog(EmployeeID, EmployeeName, 32, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_WirelessFixedLine_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        if (files.Count > 0)
        {
            ...
            Common.AddLog(EmployeeID, EmployeeName, 32, new Guid(MainID), 8);
        }
        else
            Alert("请勾选文件再下载！");
    }
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DA_OfficeAutomation_Document_WirelessFixedLine_Inherit da_OfficeAutomation_Document_WirelessFixedLine_Inherit = new DA_OfficeAutomation_Document_WirelessFixedLine_Inherit();
        DA_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit da_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit = new DA_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit();

        DataSet ds = da_OfficeAutomation_Document_WirelessFixedLine_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_WirelessFixedLine_ID"].ToString(); 
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_WirelessFixedLine_Apply"].ToString();
                    string employname;
                    string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
                    string documentName = da_OfficeAutomation_Flow_Inherit.GetDocumentNameByMainID(MainID);
                    //string department = drRow["OfficeAutomation_Document_WirelessFixedLine_Department"].ToString();
                    ...
                    sbMailBody.Append("<br/><br/>申请人：" + drRow["OfficeAutomation_Document_WirelessFixedLine_Apply"]);
                    sbMailBody.Append("<br/>申请部门：项目部");
                    sbMailBody.Append("<br/>申请日期：" + DateTime.Parse(drRow["OfficeAutomation_Document_WirelessFixedLine_ApplyDate"].ToString()).ToString("yyyy-MM-dd"));
                    sbMailBody.Append("<br/>文件主题：关于关于项目部无线电话使用申请");
                    sbMailBody.Append("<br/>回复电话：020-83926206");
                    sbMailBody.Append("<br/>合计数量：" + drRow["OfficeAutomation_Document_WirelessFixedLine_SumNumber"]);

                    sbMailBody.Append("<br/>申请详情：");

                    ds = da_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit.SelectByMainID(MainID);
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        sbMailBody.Append("<br/>所属事业部：" + dr["OfficeAutomation_Document_WirelessFixedLine_Detail_Division"]);
                        sbMailBody.Append("<br/>项目名称：" + dr["OfficeAutomation_Document_WirelessFixedLine_Detail_Name"]);
                        sbMailBody.Append("<br/>租用数量：" + dr["OfficeAutomation_Document_WirelessFixedLine_Detail_Number"]);
                        sbMailBody.Append("<br/>租用起始时间：" + DateTime.Parse(dr["OfficeAutomation_Document_WirelessFixedLine_Detail_Time"].ToString()).ToString("yyyy-MM-dd"));
                        sbMailBody.Append("<br/>租用结束时间：" + DateTime.Parse(dr["OfficeAutomation_Document_WirelessFixedLine_Detail_EndTime"].ToString()).ToString("yyyy-MM-dd"));
                    ...
                    if (hdIsAgree.Value != "0")//同意或其他意见
                    {
                        ...
                        if (da_OfficeAutomation_Flow_Inherit.IsFlowComplete(MainID))
                        {
                            ...
                            //完成后抄送，财务部-黄洁珍、后勤事务部-黄瑛
                            if (employeeList.Contains("黄轩明"))
                                employname = CommonConst.EMP_GMO_NAME + ",宁伟雄,黄洁珍,黄瑛";
                            else
                                employname = "宁伟雄,黄洁珍,黄瑛";
                            employnames = employname.Split(',');
                            for (int i = 0; i < employnames.Length; i++)
                            {
                                if (!employeeList.Contains(employnames[i]))
                                {
                                    msnBody = "您好，" + employnames[i] + "：" + "项目部的编号为" + serialNumber + "的" + documentName + "已通过所有人的审理。" + sagree + "<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
                                    email = employnames[i];
                                    if (hdIsAgree.Value == "2")
                                        Common.SendMessageEX(false, email, "其他意见", msnBody + mailBody, msnBody);
                                    else
                        ...
                        else
                        {
                            ...
                            if (!employname.Contains(EmployeeName))
                            {
                                ...
                                {
                                    email = employnames[i];
                                    msnBody = "您好，" + employnames[i] + "：您有项目部"
                            ...
                            if (employname.Contains(CommonConst.EMP_GENERALMANAGER_NAME))
                            {
                                ...
                                {
                                    email = employnames[i];
                                    msnBody = "您好，" + employnames[i] + "：请注意总经理有" + "项目部的编号为" + serialNumber + "的" + documentName + "需要审理。<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
                    ...
                    else //不同意
                    {
                        ...
                        if (EmployeeID == "0001") //抄送到总办
                        {
                            ...
                            for (int i = 0; i < employnames.Length; i++)
                            {
                                msnBody = "您好，" + employnames[i] + "：项目部的编号为" + serialNumber + "的" + documentName + "已通过" + signEmployeeName + "的审理。" + sagree + "<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
                                email = employnames[i];
    ...
    protected void btnSignSave_Click(object sender, EventArgs e)
    {
        ...
        //        da_OfficeAutomation_Document_WirelessFixedLine_Inherit.AddRemarkByID(ID, CommonConst.SIGN_FINANCE);
        //    Alert("标记成功。");
        //}
        //catch
        //{
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_WirelessFixedLine_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_WirelessFixedLine_ID"].ToString();

        t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_ID = new Guid(ID);
        t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_MainID = new Guid(MainID);
        t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_Apply = EmployeeName;
        t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_ApplyDate = DateTime.Now;
        t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_ApplyID = txtApplyID.Text;
        t_OfficeAutomation_Document_WirelessFixedLine.OfficeAutomation_Document_WirelessFixedLine_SumNumber = txtSumNumber.Text;
        ...
        da_OfficeAutomation_Document_WirelessFixedLine_Inherit.Update(t_OfficeAutomation_Document_WirelessFixedLine);//修改申请表

        DA_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit da_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit = new DA_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit();
        da_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit.Delete(ID);
        InsertWirelessFixedLineDetail(new Guid(ID));
    ...
    /// 新增变更资料申请明细
    /// </summary>
    /// <param name="gWirelessFixedLineID"></param>
    private void InsertWirelessFixedLineDetail(Guid gWirelessFixedLineID)
    {
        if (hdDetail.Value == "")
            return;

        T_OfficeAutomation_Document_WirelessFixedLine_Detail t_OfficeAutomation_Document_WirelessFixedLine_Detail;
        DA_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit da_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit = new DA_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit();
        ...
        for (int i = 0; i < details.Length; i++)
        {
            ...
            if (detail[0] == "")
                continue;
            t_OfficeAutomation_Document_WirelessFixedLine_Detail = new T_OfficeAutomation_Document_WirelessFixedLine_Detail();
            t_OfficeAutomation_Document_WirelessFixedLine_Detail.OfficeAutomation_Document_WirelessFixedLine_Detail_ID = Guid.NewGuid();
            t_OfficeAutomation_Document_WirelessFixedLine_Detail.OfficeAutomation_Document_WirelessFixedLine_Detail_MainID = gWirelessFixedLineID;
            t_OfficeAutomation_Document_WirelessFixedLine_Detail.OfficeAutomation_Document_WirelessFixedLine_Detail_Division = detail[0];
            t_OfficeAutomation_Document_WirelessFixedLine_Detail.OfficeAutomation_Document_WirelessFixedLine_Detail_Name = detail[1];
            t_OfficeAutomation_Document_WirelessFixedLine_Detail.OfficeAutomation_Document_WirelessFixedLine_Detail_Number = detail[2];
            t_OfficeAutomation_Document_WirelessFixedLine_Detail.OfficeAutomation_Document_WirelessFixedLine_Detail_Time = DateTime.Parse(detail[3]);
            t_OfficeAutomation_Document_WirelessFixedLine_Detail.OfficeAutomation_Document_WirelessFixedLine_Detail_EndTime = DateTime.Parse(detail[4]);

            da_OfficeAutomation_Document_WirelessFixedLine_Detail_Inherit.Insert(t_OfficeAutomation_Document_WirelessFixedLine_Detail);
        }
    }
    ...
    protected void btnReWrite_Click(object sender, EventArgs e)
    {
        ...
        Session["FLG_ReWrite34"] = "1";
        Response.Write("<script>window.open('Apply_WirelessFixedLine_Detail.aspx?MainID=" + MainID + "');</script>");
    }
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("无线固话申请表.pdf"));//强制下载 
    ...
    protected void btnSaveLogisticsFlow_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_WirelessFixedLine_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_WirelessFixedLine_ID"].ToString(); //在不同的表要注意修改
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_WirelessFixedLine_Inherit da_OfficeAutomation_Document_WirelessFixedLine_Inherit = new DA_OfficeAutomation_Document_WirelessFixedLine_Inherit();
            DataSet ds = da_OfficeAutomation_Document_WirelessFixedLine_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Document_WirelessFixedLine_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
            ...
            if (flows != null)
            {
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    for (int i2 = 0; i2 < employnames.Length; i2++)
                    {
                        msnBody = "您好，" + employnames[i2] + "：您审理过的编号为" + serialNumber + "的" + documentName + "已被" + signEmployeeName + "撤销审理，待会需要您重审。<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
    ...
    protected void btnEditFlow_DoClick(object sender, EventArgs e)
    {
        try
        {
            ...
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                ...
                for (int i2 = 0; i2 < employnames.Length; i2++)
                {
                    msnBody = "您好，" + employnames[i2] + "：您审理过的编号为" + serialNumber + "的" + documentName + "已被" + EmployeeName + "修改了审批流程。<br />申请表" + applyUrl + "<br /><br /><span style=\"font-weight: bolder\">注意：该链接需要登陆门户系统并打开电子审批系统后才能进入，否则只能跳到登陆页面。</span>";
                    email = employnames[i2];if(email != "")
            ...
            //在不同的表中要修改
            RunJS("var win=window.showModalDialog(\"Apply_WirelessFixedLine_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=830px;dialogHeight=280px\");if(win=='success'){window.location='/Ajax/Editor_Flow.ashx?MainID=" + MainID + "&applyUrl=" + applyUrl + "&apply=" + apply + "&serialNumber=" + serialNumber + "&department=" + department + "&Jhref=" + Page.Request.Url + "&mid=" + EmployeeID + "'; }");
    ...
    {
        DA_OfficeAutomation_Flow_Inherit da_OfficeAutomation_Flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        DA_OfficeAutomation_Document_WirelessFixedLine_Inherit da_OfficeAutomation_Document_BadDebts_Inherit = new DA_OfficeAutomation_Document_WirelessFixedLine_Inherit();
