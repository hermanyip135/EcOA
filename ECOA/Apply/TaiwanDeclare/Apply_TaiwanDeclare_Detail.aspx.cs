...
public partial class Apply_TaiwanDeclare_Apply_TaiwanDeclare_Detail :BasePage
{
    #region 变量声明及定义
    bool tpdf = false;
    ...
    public void LoadPage()
    {
        ...
        DA_OfficeAutomation_Document_TaiwanDeclare_Inherit da_OfficeAutomation_Document_TaiwanDeclare_Inherit = new DA_OfficeAutomation_Document_TaiwanDeclare_Inherit();
        ...
        ds = da_OfficeAutomation_Document_TaiwanDeclare_Inherit.SelectByMainID(MainID);
        DataRow dr = ds.Tables[0].Rows[0];
        ID = dr["OfficeAutomation_Document_TaiwanDeclare_ID"].ToString();
        string applicant = dr["OfficeAutomation_Main_Apply"].ToString();
        T_OfficeAutomation_Document_TaiwanDeclare obj = da_OfficeAutomation_Document_TaiwanDeclare_Inherit.GetModel("OfficeAutomation_Document_TaiwanDeclare_ID='" + ID + "'");
        CommonSerialization.BindObjectToControl("T_OfficeAutomation_Document_TaiwanDeclare", obj, this.Page.Master.FindControl("ContentPlaceHolder1"));   //实体给form赋值

        this.lblApply.Text = obj.OfficeAutomation_Document_TaiwanDeclare_Name;
        this.Remarks.Value = obj.OfficeAutomation_Document_TaiwanDeclare_Remarks;
        ApplyN = applicant;
        lblApply.Text = applicant;
        lbApplyDate.Text = DateTime.Parse(dr["OfficeAutomation_Main_CrTime"].ToString()).ToString("yyyy-MM-dd");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_OfficeAutomation_Document_TaiwanDeclare t_OfficeAutomation_Document_TaiwanDeclare = new T_OfficeAutomation_Document_TaiwanDeclare();
        ...
        try
        {
            ...
            if (IsNewApply)
            {
                ...
                t_OfficeAutomation_Main.OfficeAutomation_SerialNumber = "TaiwanDeclare" + DateTime.Now.ToString("yyyyMMddHHmmssfffffff");
                t_OfficeAutomation_Main.OfficeAutomation_DocumentID = 95; //在《申请表字典表》t_Dic_OfficeAutomation_Document，找到该表的主键，这步一错则会打开别的表
                ...
                Guid TaiwanDeclareID = Guid.NewGuid();

                t_OfficeAutomation_Document_TaiwanDeclare = GetModelFromPage(TaiwanDeclareID);

                t_OfficeAutomation_Main.OfficeAutomation_Main_Apply = EmployeeName;
                t_OfficeAutomation_Main.OfficeAutomation_Main_Department = this.IsScope.Value == "1" ? this.DeptName.Text.Trim() : this.DeptName1.Text.Trim();
                t_OfficeAutomation_Main.OfficeAutomation_Main_Summary = this.Remarks.Value;
                ...
                da_OfficeAutomation_Document_TaiwanDeclare_Inherit.Add(t_OfficeAutomation_Document_TaiwanDeclare);//插入申请表
                ...
                Common.AddLog(EmployeeID, EmployeeName, 87, new Guid(MainID), 1);//日志，创建申请表
                Common.AddLog(EmployeeID, EmployeeName, 3, new Guid(MainID), 1);//日志，创建流程

                RunJS("window.showModalDialog(\"/Apply/Apply_UploadFile.aspx?MainID=" + MainID + "\", '" + MainID + "', \"dialogHeight=165px\");var win=window.showModalDialog(\"Apply_TaiwanDeclare_Flow.aspx?MainID=" + MainID + "\",\"\",\"dialogWidth=800px;dialogHeight=320px\");if(win=='success'){window.location='/Apply/Apply_Search.aspx'; }");
                #endregion
            }
            else
            {
    ...
    protected void btnSign_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = da_OfficeAutomation_Document_TaiwanDeclare_Inherit.SelectByMainID(MainID);
        DataRow drRow = ds.Tables[0].Rows[0];
        ID = drRow["OfficeAutomation_Document_TaiwanDeclare_ID"].ToString();
        ...
        if (Purview.Contains("OA_ITPower_002"))
        {
            try
            {
                ...
                if (isSignSuccess)
                {
                    ...
                    sbMailBody.Append("<br/>申请日期：" + DateTime.Parse(drRow["OfficeAutomation_Main_CrTime"].ToString()).ToString("yyyy-MM-dd"));
    ...
    private T_OfficeAutomation_Document_TaiwanDeclare GetModelFromPage(Guid TaiwanDeclare_ID)
    {
        var obj = new T_OfficeAutomation_Document_TaiwanDeclare();
        obj = CommonSerialization.ReqDeserilizeAnEntity<T_OfficeAutomation_Document_TaiwanDeclare>("T_OfficeAutomation_Document_TaiwanDeclare", this.Page.Master.FindControl("ContentPlaceHolder1"));
        obj.OfficeAutomation_Document_TaiwanDeclare_MainID = new Guid(MainID);
        obj.OfficeAutomation_Document_TaiwanDeclare_ID = TaiwanDeclare_ID;
        obj.OfficeAutomation_Document_TaiwanDeclare_Remarks = this.Remarks.Value;
        return obj;
    }
    ...
    private void Update()
    {
        ...
        DataSet ds = new DataSet();
        ds = da_OfficeAutomation_Document_TaiwanDeclare_Inherit.SelectByMainID(MainID);
        ID = ds.Tables[0].Rows[0]["OfficeAutomation_Document_TaiwanDeclare_ID"].ToString();

        t_OfficeAutomation_Document_TaiwanDeclare = GetModelFromPage(new Guid(ID));

        string apply = EmployeeName;
     //   string depname = this.HandoverDept.Text;
         string depname ="";
        ...
        da_OfficeAutomation_Document_TaiwanDeclare_Inherit.Edit(t_OfficeAutomation_Document_TaiwanDeclare);//修改申请表


        Common.AddLog(EmployeeID, EmployeeName, 87, new Guid(MainID), 2);//日志，修改申请表
    }
    ...
    protected void btnSPDF_Click(object sender, EventArgs e) //M_PDF
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("三级市场中台人员申报表.pdf"));//强制下载 
    ...
    protected void btnCancelSign_Click(object sender, EventArgs e) //20141202：CancelSign
    {
        try
        {
            ...
            string signEmployeeName = EmployeeName;
            DA_OfficeAutomation_Document_TaiwanDeclare_Inherit da_OfficeAutomation_Document_TaiwanDeclare_Inherit = new DA_OfficeAutomation_Document_TaiwanDeclare_Inherit();
            DataSet ds = da_OfficeAutomation_Document_TaiwanDeclare_Inherit.SelectByMainID(MainID); //在不同的表中要修改
            DataRow drRow = ds.Tables[0].Rows[0];
            string apply = ds.Tables[0].Rows[0]["OfficeAutomation_Main_Apply"].ToString();
            string employname;
            string serialNumber = drRow["OfficeAutomation_SerialNumber"].ToString();
