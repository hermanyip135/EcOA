...
public partial class Apply_zDetailed_Apply_zDetailed_UploadFile : BasePage
{
    #region Page_Load
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            t_OfficeAutomation_Attach.OfficeAutomation_Attach_Name = addn+"（" + DateTime.Now.ToString("yyMMdd") + LoginUser.Unit + " - " + EmployeeName + "上传）" + this.txtFilePath.Value.Substring(this.txtFilePath.Value.LastIndexOf('\\') + 1);
