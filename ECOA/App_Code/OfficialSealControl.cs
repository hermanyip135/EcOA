...
public class OfficialSealControl
{
    ...
    //            try
    //            {
    //                if (flows == null || flows.OfficeAutomation_Flow_EmployeeID != "1401")
    //                {
    //                    t_OfficeAutomation_Flow.OfficeAutomation_Flow_ID = Guid.NewGuid();
    ...
    public static int NewCreateFlow(string s, string MainID)
    {
        ...
        for (int i = 0; i < ems.Length; i++)
        {
            if (selectlist.Where(p => p == ems[i]).FirstOrDefault() != null)
            {
                ...
                try
                {
                    //if (flows == null || flows.OfficeAutomation_Flow_EmployeeID != "31317")
                    //{
                    //    AddFlow(MainID, 13, "杨斯敏", "31317");   
                    //}

                    //2019-08-19 业务调整，杨斯敏 改成 岑嘉琦
                    if (flows == null || flows.OfficeAutomation_Flow_EmployeeID != "71880")
                    {
                        AddFlow(MainID, 13, "岑嘉琦", "71880");
                    }
                }
                catch
                {
        ...
        for (int i = 0; i < ems.Length; i++)
        {
            if (selectlist.Where(p => p == ems[i]).FirstOrDefault() != null)
            {
                ...
                try
                {
                    ...
                    //}
                    if (flows == null || flows.OfficeAutomation_Flow_EmployeeID != "21779,66458,65678,67067")
                    {
                        AddFlow(MainID, 13, "王子君,谭丽仪A,朱素会,罗斌C", "21779,66458,65678,67067");
                    }
                }
                catch
                {
        ...
        for (int i = 0; i < ems.Length; i++)
        {
            if (selectlist.Where(p => p == ems[i]).FirstOrDefault() != null)
            {
                ...
                try
                {
                    //if (flows == null || flows.OfficeAutomation_Flow_EmployeeID != "16945,61275,43781,41960,64185")
                    //{
                    //    AddFlow(MainID, 11, "胡雅丝,冯琰,钟惠贤,官东升,刘韵", "16945,61275,43781,41960,64185");    
                    //}


                    #region [2019-10-21 财务部将 胡雅丝（16945） 权限移交比 钟惠贤（43781）]
                    if (flows == null || flows.OfficeAutomation_Flow_EmployeeID != "61275,43781,41960,64185")
                    {
                        AddFlow(MainID, 11, "冯琰,钟惠贤,官东升,刘韵", "61275,43781,41960,64185");
                    }
                    #endregion
            ...
            if (selectlist.Where(p => p == ems[i]).FirstOrDefault() != null)
            {
                ...
                try
                {
                    if (flows == null || flows.OfficeAutomation_Flow_EmployeeID != "3189")
                    {
                        ...
                        //AddFlow(MainID, 26, "潘慧敏", "1401"); 
                        //2018-04-23 晖哥说更改
                        AddFlow(MainID, 26, "何旭晖", "3189"); 
                       // da_OfficeAutomation_Flow_Inherit.Insert(flows);
                    }
                }
                catch
                {
        ...
        for (int i = 0; i < ems.Length; i++)
        {
            if (selectlist.Where(p => p == ems[i]).FirstOrDefault() != null)
            {
                ...
                try
                {
                    ...
                    //}
                    if (flows == null || flows.OfficeAutomation_Flow_EmployeeID != "0111")
                    {
                        AddFlow(MainID, 28, "黄蕙晶", "0111");
        ...
        for (int i = 0; i < ems.Length; i++)
        {
            if (selectlist.Where(p => p == ems[i]).FirstOrDefault() != null)
            {
                ...
                try
                {
                    //if (flows == null || flows.OfficeAutomation_Flow_EmployeeID != "1401")
                    //{
                    //    AddFlow(MainID, 27, "潘慧敏", "1401");
                    //}
                    //2019-04-10 潘慧敏要求要改 李翔宇
                    if (flows == null || flows.OfficeAutomation_Flow_EmployeeID != "66766")
                    {
                        AddFlow(MainID, 27, "李翔宇", "66766");
                    }
                }
                catch
                {
