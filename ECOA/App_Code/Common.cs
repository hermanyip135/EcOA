...
public class Common
{
    ...
    public static string getDocumentLink(string DocumentName, string ApplyDate)
    {
        ...
        switch (DocumentName)
        {
            ...
            case "(后勤/汇瀚/二级市场)IT权限申请表":
                ...
                break;
            case "报废申请表":
                if (DateTime.Parse(ApplyDate) >= DateTime.Parse("2017-11-04"))
            ...
            case "软件系统特殊修改申请":
                ...
                break;
            case "软件系统测试需求申请表":
                applypath = "ITTest/Apply_ITTest";
                F_Model = "91";
                break;
            case "房友圈网签变更、特殊申请表":
                applypath = "ChangeFyq/Apply_ChangeFyq_Detail";
                F_Model = "92";
                break;
            case "房友圈按揭不承办知会函":
                applypath = "FyqNotUnProject/Apply_FyqNotUnProject_Detail";
                F_Model = "93";
                break;
            case "房友圈退案申请表":
                applypath = "FyqBackProject/Apply_FyqBackProject_Detail";
                F_Model = "94";
                break;
            case "项目差旅申请表":
                applypath = "BusinessTravel/Apply_BusinessTravel_Detail";
                F_Model = "95";
                break;

            case "系统及密码交接表":
                applypath = "SYSPWDTransfer/Apply_SYSPWDTransfer_Detail";
                F_Model = "96";
                break;

            case "三级市场中台人员申报表":
                applypath = "TaiwanDeclare/Apply_TaiwanDeclare_Detail";
                F_Model = "97";
                break;
            //case "电子传真申请":
            //    applypath = "Fax/Apply_Fax_Detail";
            //    F_Model = "98";
            //    break;
            case "电子传真申请":
                applypath = "ElectronicFax/Apply_ElectronicFax_Detail";
                F_Model = "98";
                break;
            case "公积金缴存基数年度调整申请表(营业部)":
                applypath = "HousingFundBaseAdjust/Apply_HousingFundBaseAdjust_Detail";
                F_Model = "99";
                break;
            case "行政助理(财务事项)交接表":
                applypath = "FinAffairsTransfer/Apply_FinAffairsTransfer_Detail";
                F_Model = "100";
                break;
            case "公章使用申请表(项目部)":
                applypath = "ProjOfficialSeal/Apply_ProjOfficialSeal_Detail";
                F_Model = "101";
                break;
            case "UI设计需求申请表":
                applypath = "UIReq/Apply_UIReq_Detail";
                F_Model = "102";
                break;
            case "三级市场一手项目豁免自动坏申请":
                applypath = "ExemptionBadDebt/Apply_ExemptionBadDebt_Detail";
                F_Model = "103";
                break;
            case "假期申请表":
                applypath = "OndutyVacation/Apply_OndutyVacation_Detail";
                F_Model = "104";
                break;
            case "减让佣/现金奖申请表(房友圈电商类)":
                applypath = "ReduceComm/Apply_NewReduceComm_Detail";
                F_Model = "105";
                break;
            case "新建分行可行性报告":
                applypath = "Feasibility/201909/Apply_Feasibility_Detail_New";
                F_Model = "106";
                break;
            case "新建呼叫中心可行性报告":
                applypath = "CallCenterFeasibility/201909/Apply_CallCenterFeasibility_Detail_New";
                F_Model = "107";
                break;
            case "联动统筹中心入职申请表":
                applypath = "LinkageCoordination/Apply_LinkageCoordination_Detail";
                F_Model = "108";
                break;
            case "联动统筹中心离职申请表":
                applypath = "LinkageCoordination/Apply_LinkageCoordination_Detail";
    ...
    public static void SendMessageEX(bool isa, string applyTableName, string sMailToUserName, string sMailSubject, string sMailBody, string sMSNBody, string mainID)
    {
        ...
        if (System.Configuration.ConfigurationManager.AppSettings["IsTesting"].ToString() == "True")//如果在测试，则发送至开发人员邮箱
        {
            try
            {
                ...
                SendDirectPushMessageNew(applyTableName, "50203", sMailToUserName, sMailSubject, mainID); //手机推送
                SendTodoPushFKBMessageNew(applyTableName, "50203", sMailToUserName, sMailSubject, mainID); //手机房客帮推送
                da_OfficeAutomation_Message_Inherit.Insert(t_OfficeAutomation_Message);
            }
            catch
            {
        ...
        else
        {
            ...
            foreach (string name in names)
            {
                try
                {
                    ...
                    SendDirectPushMessageNew(applyTableName, ds.Tables[0].Rows[0]["Code"].ToString(), sMailToUserName, sMailSubject, mainID); //手机推送
                    SendTodoPushFKBMessageNew(applyTableName, ds.Tables[0].Rows[0]["Code"].ToString(), sMailToUserName, sMailSubject, mainID); //手机房客帮推送
                    da_OfficeAutomation_Message_Inherit.Insert(t_OfficeAutomation_Message);
                }
                catch
                {
    ...
    public static string GetHRTreeByDepartmentID(string departmentid)
    {
        ...
        if (ds != null && ds.Tables != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (units.Contains("黄轩明") || unitids.Contains("0001"))
                return "fail";
        ...
        else
        {
            ...
            //网络营销部
            if ("6adfecef-af19-4147-9a74-176762e0b03c".Equals(departmentid))
            {
                unitids = "0111";
                units = "黄蕙晶";
                return unitids + "|" + units;
            ...
            else
            {
                ...
                if (unitids.Contains("0001") || unitids.Contains("黄轩明"))
                    return "fail";
                return unitids + "|" + units;
            }
        }
    ...
    public static void SendTodoPushFKBMessageNew(string documentName, string code, string empname, string title, string mainid)
    {
        DA_OfficeAutomation_Flow_Inherit flow_Inherit = new DA_OfficeAutomation_Flow_Inherit();
        string url = "http://webapp.gzcentaline.com.cn:8081/ThirdPartyApi/api/FangKeBang/pushMessage";
        string summary = "您好，" + empname + "：您有[" + documentName + "]需要审批。";

        string tablename = flow_Inherit.GetTableNameByMainID(mainid);
        int lastindex = tablename.LastIndexOf("_") + 1;
        string subname = tablename.Substring(lastindex, tablename.Length - lastindex);
        SendTodoFKB sendTodoFKB = new SendTodoFKB();
        sendTodoFKB.ReceiveEmpCode = code;
        sendTodoFKB.PushModuleCode = "sysApproval";
        sendTodoFKB.MsgText = summary;

        MsgJson msgJson = new MsgJson();
        msgJson.msgType = "link";
        MsgData msgData = new MsgData();
        msgData.path = "1@" + documentName + "@" + mainid;
        msgData.isNewWindow = "true";
        msgData.appId = "mcoa_approval";
        msgJson.msgData = msgData;

        string json = Newtonsoft.Json.JsonConvert.SerializeObject(msgJson);
        sendTodoFKB.MsgJson = json;
        string json1 = Newtonsoft.Json.JsonConvert.SerializeObject(sendTodoFKB);
        json1 = json1.Substring(0, json1.Length - 1); ;
        ProcessPost(url, json1);
    }
    ...
    {
        ////网络营销部//内容运营部/品牌营销部
        //public static readonly string YingBu = "KD01.0001.0002.0035.0004";
        ////非营业部
        ...
        //public static readonly string brandmarketing = "KD01.0001.0002.0035";
        ////汇瀚、广州市汇瀚有限公司
        //public static readonly string huihan = "KD01.0001.0003,KD01.0007";
        ////物业部（大海珠区、大越秀区、番禺一部）、
        //public static readonly string wuye1 = "KD01.0001.0001.0001.0047.0001,KD01.0001.0001.0001.0035,KD01.0001.0001.0001.0015.0003,KD01.0001.0001.0001.0047.0004,KD01.0001.0001.0001.0047.0005";
        ...
        //品牌营销部 KD01.0013.0001.0035.0004.0001
        //内容运营部 KD01.0013.0001.0035.0004.0001.0001
        //网络营销部 KD01.0013.0001.0035.0004.0002
        //public static readonly string YingBu = "KD01.0013.0001.0035.0004";
        ////非营业部
        //public static readonly string feiyingye = "KD01.0013.0001";
        ////非营业部营运支持
        //public static readonly string yingyunzhichi = "KD01.0013.0001.0033";
        ////非营业部营运支持中心
        //public static readonly string yingyunzhichizhongxin = "KKD01.0013.0001.0033.0004";
        ...
        public static readonly string yingyunzhichizhongxin = "KKD01.0013.0001.0033.0004";
        //非营业部 谭丽仪
        public static readonly string feiyingye1 = @"KD01.0013.0001.0008,KD01.0013.0001.0031,KD01.0013.0001.0031.0001,KD01.0013.0001.0031.0002
,KD01.0013.0001.0033,KD01.0013.0001.0033.0001,KD01.0013.0001.0033.0005,KD01.0013.0001.0033.0006,KD01.0013.0001.0034,KD01.0013.0001.0035
,KD01.0013.0001.0035.0002,KD01.0013.0001.0035.0003,KD01.0013.0001.0037,KD01.0013.0001.0038,KD01.0013.0001.0039,KD01.0013.0001.0040";

        //项目部
        public static readonly string xiangmubu = "KD01.0013.0003.0001";
        //首席运营官
        public static readonly string brandmarketing = "KD01.0013.0001.0035";
        //汇瀚、广州市汇瀚有限公司
        public static readonly string huihan = "KD01.0001.0003,KD01.0007";
        //物业部（大天河区、大越秀区） 朱素会
        public static readonly string wuye1 = "KD01.0013.0003.0002.0008,KD01.0013.0003.0002.0007";
        //物业部（大白云区、花都区、工商铺一、二部） 罗斌
        public static readonly string wuye2 = "KD01.0013.0003.0002.0009,KD01.0013.0003.0002.0006,KD01.0013.0003.0003";
        //物业部（大番禺区、海珠东区、海珠西区） 谭丽仪
        public static readonly string wuye3 = "KD01.0013.0003.0002.0004,KD01.0013.0003.0002.0005,KD01.0013.0003.0002.0011";
    ...
    public static List<RentHouse> ReturnRentHouseListByType(DataTable dt)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            renthouse.Attach = dt.Rows[i][15].ToString();
    ...
    public static List<FamilyRelation> ReturnFRListByType(DataTable dt)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            familyrelation.Attach = dt.Rows[i][12].ToString();
    ...
    public static List<LiWu> ReturnLiWuListByType(DataTable dt)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            liwu.Attach = dt.Rows[i][10].ToString();
            liwuList.Add(liwu);
        }
        return liwuList;
    ...
    public static List<CommercialActivities> ReturnCAListByType(DataTable dt)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            commercialActivities.Attach = dt.Rows[i][13].ToString();
    ...
    public static List<PartTiemJob> ReturnPartTimeJobListByType(DataTable dt)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            partTiemJob.Attach = dt.Rows[i][11].ToString();
    ...
    public static string[] ReturnarrByType(int type)
    {
        ...
        if (type == 7)
        {
            string[] headnames = { "empcode", "empname", "dept", "depttypename", "applydate", "create", "createdate", "dealkind", "dealproperty", "flowcode", "flowname", "flowdept", "propertyhander", "building", "anothersummary", "Attach" };
            return headnames;
        }
        else if (type == 8)
        {
            string[] headnames = { "empcode", "empname", "dept", "depttypename", "applydate", "create", "createdate", "relativesname", "relativedept", "position", "relationship", "anothersummary", "Attach" };
            return headnames;
        }
        else if (type == 9)
        {
            string[] headnames = { "empcode", "empname", "dept", "depttypename", "applydate", "create", "createdate", "applysomething", "giverorcompany", "anothersummary", "Attach" };
            return headnames;
        }
        else if (type == 10)
        {
            string[] headnames = { "empcode", "empname", "dept", "depttypename", "applydate", "create", "createdate", "entrust", "buildingkind", "flowcode", "flowname", "flowdept", "anothersummary", "Attach" };
            return headnames;
        }
        else
        {
            string[] headnames = { "empcode", "empname", "dept", "depttypename", "applydate", "create", "createdate", "anotheractivity", "investment", "ipossitio", "anothersummary", "Attach" };
            return headnames;
        }
    }
    #endregion
...
public class SendTodoFKB
{
    public string ReceiveEmpCode { get; set; }
    public string PushModuleCode { get; set; }
