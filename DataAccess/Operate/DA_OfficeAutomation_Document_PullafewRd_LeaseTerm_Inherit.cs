...
{
    public class DA_OfficeAutomation_Document_PullafewRd_LeaseTerm_Inherit : DA_OfficeAutomation_Document_PullafewRd_LeaseTerm_Operate
    {
        /// <summary>
        /// 根据退佣申请表主键获取其下对应的详情
        /// </summary>
        ...
        public DataSet SelectByID(string id)
        {
            string sql = "SELECT  * "
                          ...
                          + "   FROM [DB_EcOfficeAutomation].[dbo].[t_OfficeAutomation_Document_PullafewRd_LeaseTerm]"
                          + " WHERE [OfficeAutomation_Document_PullafewRd_LeaseTerm_MainID]='" + id + "'"
                          + " ORDER BY [OfficeAutomation_Document_PullafewRd_LeaseTerm_1a] ASC";
        ...
        public DataSet SelectByMainID(string mainID)
        {
            string sql = "SELECT *"
                          ...
                          //+ "            ,[OfficeAutomation_Document_PullafewRd_LeaseTerm_1f]"
                          + "   FROM [DB_EcOfficeAutomation].[dbo].[t_OfficeAutomation_Document_PullafewRd_LeaseTerm]"
                          + " WHERE [OfficeAutomation_Document_PullafewRd_LeaseTerm_MainID]= (SELECT toads.OfficeAutomation_Document_PullafewRd_ID"
