...
{
    public class DA_OfficeAutomation_Document_PullafewTwo_Statistical_Inherit : DA_OfficeAutomation_Document_PullafewTwo_Statistical_Operate
    {
        /// <summary>
        /// 根据退佣申请表主键获取其下对应的详情
        /// </summary>
        ...
        {
            string sql = "SELECT [OfficeAutomation_Document_PullafewTwo_Statistical_ID]"
                          ...
                          + "   FROM [DB_EcOfficeAutomation].[dbo].[t_OfficeAutomation_Document_PullafewTwo_Statistical]"
                          + " WHERE [OfficeAutomation_Document_PullafewTwo_Statistical_MainID]='" + id + "'"
                          + " ORDER BY [OfficeAutomation_Document_PullafewTwo_Statistical_1a] ASC";
        ...
        public DataSet SelectByMainID(string mainID)
        {
            string sql = "SELECT [OfficeAutomation_Document_PullafewTwo_Statistical_ID]"
                          ...
                          + "            ,[OfficeAutomation_Document_PullafewTwo_Statistical_1k]"
                          + "   FROM [DB_EcOfficeAutomation].[dbo].[t_OfficeAutomation_Document_PullafewTwo_Statistical]"
                          + " WHERE [OfficeAutomation_Document_PullafewTwo_Statistical_MainID]= (SELECT toads.OfficeAutomation_Document_BackComm_ID"
